 ...
 * @param {String} [pPage]  Page ID of the current page, which can be optionally used to set the page ID for the URL, instead of the value of pFlowStepId.
 * @return {String}
 *
 * @example
 *
        ...
        if ( pData.hasOwnProperty( lKey )) {
            ...
            if ( lKey === "pageItems" ) {
                ...
                if ( $.isArray( pData.pageItems )) {
                    for ( i = 0, lItem; i < pData.pageItems.length; i++ ) {
