        ...
        if ( lNodeDisplay$.length > 0 ) {
            ...
            if ( pShowRow ) {
                ...
                if ( apex.jQuery.isFunction( _self.callbacks.show )) {
                    ...
                    lNodeDisplay$ = apex.jQuery( '#' + lNodeId + '_DISPLAY', apex.gPageContext$ );
                    if ( lNodeDisplay$.length > 0 ) {
                        lNodeDisplay$.show();
                    } else {
                ...
                if ( lNodeId ) {
                    apex.jQuery( 'label[for=' + lNodeId + ']', apex.gPageContext$ ).show();
                }
            }
        }
    } // end show
    ...
    function hide( pHideRow ) {
        ...
        if ( lNodeDisplay$.length > 0 ) {
            ...
            if ( pHideRow ) {
                ...
                if ( lNodeId ) {
                    apex.jQuery( 'label[for=' + lNodeId + ']', apex.gPageContext$ ).hide();
                }
            }
        }
    } // end hide
   ...
   /**
    ...
    function setFocus() {
        ...
        if ( 'setFocusTo' in _self.callbacks ) {
            ...
            lSetFocusTo$ = apex.jQuery( "#" + apex.util.escapeCSS( _self.id ), apex.gPageContext$ );
        }
        lSetFocusTo$.focus();
    } // end setFocus
    ...
    function setStyle( pPropertyName, pPropertyValue ) {
        ...
        if ( 'setStyleTo' in _self.callbacks ) {
            ...
            // Default handling is to use the element with the ID of the page item
            lSetStyleTo$ = apex.jQuery( "#" + apex.util.escapeCSS( _self.id ), apex.gPageContext$ );
        }
