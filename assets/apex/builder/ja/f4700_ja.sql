...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902294378613408255')
...
,p_substitution_value_09=>'アプリケーションに戻る'
,p_substitution_string_10=>'MSG_LANGUAGE'
,p_substitution_value_10=>'言語'
,p_substitution_string_11=>'PRODUCT_TYPE'
,p_substitution_value_11=>'ワークスペースのリクエスト'
,p_substitution_string_12=>'MSG_COPYRIGHT'
,p_substitution_value_12=>'Copyright &copy; 1999, 2015, Oracle. All rights reserved.'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1352228430926978.4709)
...
'    return FALSE;',
'end if;'))
,p_error_message=>'ワークスペースのリクエストが有効化されていません。'
...
,p_lov_disp_value=>'データベースから既存のスキーマの使用'
...
,p_lov_disp_value=>'新しいスキーマのリクエスト'
...
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'パッケージ・アプリケーションのみ'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824976787312308427.4709)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4709)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977164944308427.4709)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4709)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977534964308429.4709)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4709)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977932305308429.4709)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4709)
...
,p_shortcut=>'<a href="javascript:popupFieldHelp(''#CURRENT_ITEM_ID#'',''&SESSION.'')" tabindex="999" title="このアイテムのヘルプです。"><img src="#IMAGE_PREFIX#infoicon_status_gray.gif" width="16" height="16" /></a>'
);
end;
/
...
,p_last_upd_yyyymmddhh24miss=>'20150428184612'
);
...
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4709)
,p_tab_set=>'HOME'
,p_name=>'ワークスペースのリクエスト'
,p_page_mode=>'NORMAL'
,p_step_title=>'サービスのリクエスト'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
...
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_header=>'<p class="a-Wizard-subHeading">どのタイプのワークスペースをリクエストしますか。</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page(
 p_id=>2.4709
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4709)
,p_name=>'ワークスペースのリクエスト - 2ページ目'
,p_page_mode=>'NORMAL'
,p_step_title=>'ワークスペースのリクエスト - 2ページ目'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'アカウント情報が、この電子メール・アドレスに送信されます。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
,p_field_template=>wwv_flow_api.id(481972771960821314.4709)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'必要なワークスペースの名前を入力してください。ワークスペースがプロビジョニングされた後、ワークスペース/ユーザー名/パスワードの組合せを使用してログインします。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'BOTH'
...
'return true;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'別のワークスペース名を入力してください。'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(624350696578280086.4709)
...
,p_plug_name=>'ワークスペースがリクエストされました。'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(481970015003751305.4709)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18348331817861713.4709)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18348522944868646.4709)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18348331817861713.4709)
,p_button_name=>'FINISH'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(481975658518888812.4709)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'サインイン画面に進みます'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4709)
,p_tab_set=>'HOME'
,p_name=>'ワークスペースのリクエスト - スキーマの指定'
,p_page_mode=>'NORMAL'
,p_step_title=>'ワークスペースのリクエスト - スキーマの指定'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4709)
,p_page_template_options=>'#DEFAULT#'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'必要なディスク領域の量を選択してください。スキーマの作成後、必要に応じて追加領域をリクエストできます。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
'スキーマ名は、データベース・オブジェクトを所有するOracleデータベース・ユーザーです。スキーマの変更は複雑なタスクのため、このスキーマ名は慎重に選択してください。サービスがプロビジョニングされると、スキーマのパスワードおよびログイン・パスワードが送信されます。ワークスペースの作成後、そのワークスペースにスキーマを追加できます。',
'',
'',
'',
'スキーマ名は次のガイドラインに従う必要があります。',
'',
'- 名前の長さは1から30バイト',
'',
'- 引用符は使用不可',
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'新しい&PRODUCT_NAME.ワークスペースにアクセスできるようにするスキーマの名前を入力します。ワークスペースの作成後、そのワークスペースにスキーマを追加できます。',
''))
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'新しいワークスペースに対して、新規データベース・スキーマを作成するか、既存のデータベース・スキーマを構成するかを選択します。'
,p_attribute_01=>'1'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'スキーマ名を指定する必要があります。'
,p_always_execute=>'N'
...
,p_error_message=>'スキーマ&EXISTING_SCHEMA_NAME.は存在しません。'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''NO'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(11472001772984287.4709)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'別のスキーマ名を入力してください。'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4709)
...
,p_error_message=>'スキーマ名に空白を含めることはできません。'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4709)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'スキーマ名に引用符を含めることはできません。'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4709)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'スキーマ名(&SCHEMA_NAME.)は、予約されているか制限されています。別のスキーマを入力してください。'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4709)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'スキーマ名は有効ではありません。別の名前を指定してください。'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4709)
...
wwv_flow_api.create_page(
 p_id=>26.4709
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4709)
,p_name=>'ワークスペースのリクエスト - スキーマに関する警告'
,p_page_mode=>'NORMAL'
,p_step_title=>'ワークスペースのリクエスト - スキーマに関する警告'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4709)
,p_page_template_options=>'#DEFAULT#'
...
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4709)
,p_tab_set=>'HOME'
,p_name=>'ワークスペースのリクエスト - プロジェクトの説明'
,p_page_mode=>'NORMAL'
,p_step_title=>'ワークスペースのリクエスト - プロジェクトの説明'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4709)
,p_page_template_options=>'#DEFAULT#'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p class="a-Wizard-text">この情報によって&PRODUCT_NAME.管理者は、ユーザーがこのサービスをどのように使用するかを理解できます。</p>',
...
,p_prompt=>'このサービスをリクエストする理由は何ですか。'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'サービスのリクエストの目的を入力してください。この情報は&PRODUCT_NAME.管理者によって使用されます。'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'企業またはサービスの契約でリクエストの正当性を証明する必要がある場合、正当性を入力してください。'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'このサービスのリクエスト理由を説明する必要があります。'
,p_always_execute=>'N'
...
,p_page_is_public_y_n=>'N'
,p_cache_mode=>'NOCACHE'
,p_last_upd_yyyymmddhh24miss=>'20150428184613'
);
wwv_flow_api.create_page_plug(
...
,p_error_message=>'続行する前に条件を受諾する必要があります。'
,p_always_execute=>'N'
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'<p class="a-Wizard-text">ワークスペース・リクエストを確認してください。</p>'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'ボックスに表示されている検証コードを入力する必要があります。',
'<b>大/小文字</b>が区別されるため、文字を入力する際には注意してください。'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'正しく設定されていない値があります。ワークスペース・リクエスト・プロセスを再実行してください。'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(318141939408.4709)
,p_associated_item=>wwv_flow_api.id(.4709)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'条件が正しく受諾されていません。'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(318141939408.4709)
,p_associated_item=>wwv_flow_api.id(.4709)
...
'end;'))
,p_process_error_message=>'&MSG_COMPANY.をリクエスト中にエラーが発生しました。'
...
wwv_flow_api.create_page(
 p_id=>73.4709
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4709)
,p_name=>'&PRODUCT_NAME.ワークスペースの作成'
,p_page_mode=>'NORMAL'
,p_step_title=>'&PRODUCT_NAME.ワークスペースの作成'
,p_allow_duplicate_submissions=>'N'
...
'<h2 class="a-Wizard-subTitle">ワークスペースは正常に作成されました</h2>'))
);
wwv_flow_api.create_page_plug(
