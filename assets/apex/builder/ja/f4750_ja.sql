...
prompt APPLICATION 4759 - Oracle APEX Packaged Applications
--
-- Application Export:
--   Application:     4759
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902296115802410883')
...
,p_substitution_value_10=>'完了'
,p_substitution_string_11=>'TOP'
,p_substitution_value_11=>'トップ'
...
,p_substitution_value_18=>'アプリケーションに戻る'
,p_substitution_string_19=>'DELETE_MSG'
,p_substitution_value_19=>'この削除操作を実行しますか。'
,p_substitution_string_20=>'PAGE'
,p_substitution_value_20=>'ページ'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719115788931175389.4759)
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'パッケージ・アプリケーション・ギャラリ'
,p_list_item_link_target=>'f?p=&APP_ID.:50:&SESSION.::&DEBUG.:50:::'
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'パッケージ・アプリケーション管理'
...
,p_list_item_disp_cond_type=>'PLSQL_EXPRESSION'
,p_list_item_disp_condition=>'wwv_flow_platform.get_preference(''SERVICE_REQUESTS_ENABLED'') = ''Y'''
,p_list_text_01=>'追加記憶域へのアクセス、またはワークスペースの終了をリクエストします。'
...
,p_list_text_01=>'ワークスペースの機能を制御するプリファレンスを構成します。'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>wwv_flow_api.id(404682514053862570)
,p_list_item_current_type=>'TARGET_PAGE'
);
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'ユーザーの管理'
,p_list_item_link_target=>'f?p=&APP_ID.:300:&SESSION.::&DEBUG.:300:::'
,p_list_item_icon=>'icon-apex-user'
,p_list_text_01=>'Application Expressワークスペース管理者、アプリケーション開発者およびエンド・ユーザーのアクセスを制御します。'
,p_translate_list_text_y_n=>'Y'
...
,p_list_item_link_text=>'保存されたレポート'
,p_list_item_link_target=>'f?p=&APP_ID.:13:&SESSION.::&DEBUG.:RP:::'
,p_list_item_icon=>'icon-saved-reports'
,p_list_text_01=>'パッケージ・アプリケーションのユーザーによって作成された保存済対話モード・レポートを表示および管理します。'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'サブスクリプション'
,p_list_item_link_target=>'f?p=&APP_ID.:17:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'icon-report-subscriptions'
,p_list_text_01=>'パッケージ・アプリケーションのユーザーによって作成された対話モード・レポートのサブスクリプションを表示および管理します。'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
end;
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'表領域使用率の詳細レポート(数秒かかります)'
...
,p_list_item_link_text=>'リクエストの指定'
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'リクエストの定義'
...
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'複数ユーザーの削除'
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'アプリケーション・アクティビティ'
,p_list_item_link_target=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'icon-utilities-activity'
,p_list_text_01=>'日別の個別ユーザーおよびページ・ビュー合計をレポートするアプリケーション・アクティビティの月次カレンダ。'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'トップ・ユーザー'
,p_list_item_link_target=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.:RP,30:::'
,p_list_item_icon=>'icon-apex-user'
,p_list_text_01=>'ユーザーごとに集計されたページ・ビューのレポート。'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list(
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1355859641927129.4759)
...
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
,p_attribute_01=>'SQL'
,p_error_message=>'SQLワークショップを使用する権限がありません。'
...
,p_error_message=>'この開発環境は外部認証を使用しています'
...
,p_error_message=>'パッケージ・アプリケーションをインストールする権限がありません'
...
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'ユーザー名を完全な電子メール・アドレスに設定'
,p_lov_return_value=>'N'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805346868716446830.4759)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'ユーザー名の一部として@ドメインを除外'
,p_lov_return_value=>'Y'
);
wwv_flow_api.create_list_of_values(
...
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Application Expressユーザーの作成'
,p_lov_return_value=>'Y'
);
wwv_flow_api.create_list_of_values(
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(805102768336534835.4759)
,p_lov_name=>'REQUEST SERVICE'
,p_lov_query=>'.'||wwv_flow_api.id(805102768336534835)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103010621534839.4759)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'スキーマのリクエスト'
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103339867534842.4759)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'記憶域のリクエスト'
,p_lov_return_value=>'STORAGE'
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103624199534842.4759)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'終了のリクエスト'
,p_lov_return_value=>'TERMINATION'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4759)
,p_short_name=>'パッケージ・アプリケーションの削除'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4759)
,p_short_name=>'パッケージ・アプリケーションのインストール'
,p_link=>'f?p=&APP_ID.:83:&SESSION.::&DEBUG.:::'
,p_page_id=>83
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(492872210530717222.4759)
,p_parent_id=>wwv_flow_api.id(806264496767109365.4759)
,p_short_name=>'パッケージ・アプリケーションのインストール'
...
,p_short_name=>'パッケージ・アプリケーションのロック解除'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4759)
,p_short_name=>'パッケージ・アプリケーションの更新'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(750897172696068128.4759)
,p_parent_id=>wwv_flow_api.id(.4759)
,p_short_name=>'<span class="u-VisuallyHidden">アプリケーション</span><span class="a-Icon icon-breadcrumb-previous"></span>'
,p_link=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::'
,p_page_id=>1
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(788162743515607361.4759)
,p_parent_id=>wwv_flow_api.id(750897172696068128.4759)
,p_short_name=>'パッケージ・アプリケーション・ダッシュボード'
...
,p_parent_id=>wwv_flow_api.id(798343358044477984.4759)
,p_short_name=>'ワークスペース・プリファレンスの設定'
...
,p_parent_id=>wwv_flow_api.id(750897172696068128.4759)
,p_short_name=>'パッケージ・アプリケーション・ギャラリ'
...
,p_short_name=>'パッケージ・アプリケーションの詳細'
...
,p_parent_id=>wwv_flow_api.id(798343358044477984.4759)
,p_short_name=>'トップ・ユーザー'
,p_link=>'f?p=&APP_ID.:30:&SESSION.'
,p_page_id=>30
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(1224179617523676528.4759)
,p_parent_id=>wwv_flow_api.id(788162743515607361.4759)
,p_short_name=>'パッケージ・アプリケーション'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747469399730136676.4759)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747469775365136676.4759)
,p_page_template_id=>wwv_flow_api.id(741366253443994295.4759)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970712970659339897.4759)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970713375545339897.4759)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4759)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970713743513339897.4759)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4759)
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714187781339897.4759)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4759)
,p_name=>'Right Side Bar'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714515296339897.4759)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4759)
,p_name=>'After Body'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714940759339898.4759)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4759)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970715378375339898.4759)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4759)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824980978803308434.4759)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4759)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824981311553308434.4759)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4759)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824981767148308434.4759)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4759)
,p_name=>'Wizard Title'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824982170342308434.4759)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4759)
...
,p_display_name=>'INTERNAL Application Expressアカウント'
,p_supported_ui_types=>'DESKTOP'
...
,p_display_name=>'すべてのチェックボックスを選択の追加'
,p_category=>'MISC'
,p_supported_ui_types=>'DESKTOP'
...
,p_subscribe_plugin_settings=>true
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>「すべてのチェックボックスを選択の追加」動的アクションにより、#CHECK_ALL_CHECKBOX#文字列を含む列ヘッダーを対応する列のすべてのチェックボックスを選択および選択解除するアクセス可能なすべてのスタイルのチェックボックスの選択に変換します。<p>',
'<p>',
'このプラグインを使用するには、次の属性が設定されていることを確認してください。',
'<ol>',
'<li>レポート列で、見出しの値として''#CHECK_ALL_CHECKBOX#''を定義します。</li>',
'<li>「動的アクションの時期」属性の場合、列を含むレポート・リージョンを選択します。</li>',
'<li>''リフレッシュ後''を起動する動的アクションおよび''ページのロード時に実行''するアクションを定義します。(ページ・デザイナの''レンダリング''セクションのリージョンを選択し、そこから動的アクションを作成して動的アクションが作成される場合は、両方に適宜デフォルトが設定されます。)</li>',
'<li>これは各行でレンダリングされたチェックボックスのアクセシビリティを処理しません。これをリージョン・ソースで個別に実行する必要があります(例は、4000:656 ''Regions''リージョンを参照)。</li>',
'</ol>',
'</p>'))
,p_version_identifier=>'1.0'
);
...
,p_subscribe_plugin_settings=>true
,p_help_text=>'<p>このプラグインでは、ラベルおよび値だけでなく、アイコンも含む横棒グラフを描画します</p>'
,p_version_identifier=>'1.0'
,p_files_version=>16
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006268931685907537.4759)
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006277098711907541.4759)
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006269307704907538.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4759)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006269805212907538.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4759)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006270313871907538.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4759)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006270898104907538.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006271224803907539.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006271675789907539.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272020373907539.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272490890907539.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272846289907539.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006268931685907537.4759)
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006273272857907539.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006273675862907539.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006274092256907540.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006279811153907542.4759)
,p_depending_on_condition_type=>'IN_LIST'
,p_depending_on_expression=>'CUSTOM'
,p_help_text=>'<p>A list of CSS supported colors separated by colons.</p>'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006274433061907540.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006274824808907540.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006274433061907540.4759)
,p_display_sequence=>10
,p_display_value=>'Value'
,p_return_value=>'VALUE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006275327182907540.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006274433061907540.4759)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006275868271907541.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>12
,p_display_sequence=>120
...
,p_is_required=>false
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_api.id(2006274433061907540.4759)
,p_depending_on_condition_type=>'IN_LIST'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006276251069907541.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>13
,p_display_sequence=>130
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006276652694907541.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>14
,p_display_sequence=>140
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006277098711907541.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>15
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006277474563907541.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006277098711907541.4759)
,p_display_sequence=>10
,p_display_value=>'Icon Chart'
,p_return_value=>'ICON'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006277997330907541.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006277098711907541.4759)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006278471627907542.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>16
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006278897464907542.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006278471627907542.4759)
,p_display_sequence=>10
,p_display_value=>'Absolute'
,p_return_value=>'ABSOLUTE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006279373310907542.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006278471627907542.4759)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006279811153907542.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>17
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006280226737907543.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4759)
,p_display_sequence=>5
,p_display_value=>'Default'
,p_return_value=>'DEFAULT'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006280711849907543.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4759)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006281297160907543.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4759)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006281704972907543.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4759)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006282208978907543.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4759)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006282788751907543.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4759)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006283223942907543.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4759)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006283798141907544.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>18
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006284193963907544.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006283798141907544.4759)
,p_display_sequence=>10
,p_display_value=>'Above the bar'
,p_return_value=>'ABOVE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006284698759907545.4759)
,p_plugin_attribute_id=>wwv_flow_api.id(2006283798141907544.4759)
,p_display_sequence=>20
...
begin
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006285119215907545.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>19
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006285570964907546.4759)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4759)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>20
...
,p_name=>'グローバル・ページ - デスクトップ'
,p_page_mode=>'NORMAL'
,p_step_title=>'グローバル・ページ - デスクトップ'
...
,p_last_upd_yyyymmddhh24miss=>'20150428184614'
);
...
wwv_flow_api.create_page(
 p_id=>1.4759
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4759)
,p_name=>'パッケージ・アプリケーション・ホーム'
,p_page_mode=>'NORMAL'
,p_step_title=>'パッケージ・アプリケーション・ホーム'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750747661941502571.4759)
,p_plug_name=>'情報'
...
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>パッケージ・アプリケーションは、わずか数回のクリックで簡単にインストールできるビジネス生産性アプリケーションのスイートです。これらのソリューションは、ビジネス・プロセスを改善するために本番アプリケーションとして容易に使用でき、Oracleで完全にサポートされます。</p>',
''))
,p_plug_query_row_template=>1
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750750940971502582.4759)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750751542816502585.4759)
,p_plug_name=>'アクセシビリティ・モード'
,p_region_css_classes=>' a-Region--stacked a-Region--padded a-Region--flush a-Region--sideRegion'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750867860695912536.4759)
,p_plug_name=>'アプリケーション'
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(750862626609892264.4759)
,p_plug_source_type=>'NATIVE_LIST'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(787083093555047575.4759)
,p_name=>'インストールしたパッケージ・アプリケーション'
...
,p_query_no_data_found=>'パッケージ・アプリケーションがインストールされていません。'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(656958519483052405.4759)
,p_query_column_id=>1
,p_column_alias=>'APP_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'アプリケーション'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448306370861802.4759)
,p_query_column_id=>2
,p_column_alias=>'RUN_APP_LINK'
,p_column_display_sequence=>4
,p_column_heading=>'アプリケーション・リンクの実行'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(656958784419052407.4759)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(886493838302981514.4759)
,p_query_column_id=>4
,p_column_alias=>'APP_ID'
,p_column_display_sequence=>9
,p_column_heading=>'アプリケーションID'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(886493647565981512.4759)
,p_query_column_id=>5
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448453999861803.4759)
,p_query_column_id=>6
,p_column_alias=>'MODIFY_APP_BUTTON'
,p_column_display_sequence=>5
,p_column_heading=>'アプリケーション・ボタンの変更'
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448530210861804.4759)
,p_query_column_id=>7
,p_column_alias=>'RUN_APP_BUTTON'
,p_column_display_sequence=>6
,p_column_heading=>'アプリケーション・ボタンの実行'
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(864570195174731021.4759)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(864570463503731024.4759)
,p_query_column_id=>9
,p_column_alias=>'APP_INFO'
,p_column_display_sequence=>7
,p_column_heading=>'アプリケーション情報'
,p_use_as_row_header=>'N'
,p_column_format=>'SINCE'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2310796521456520805.4759)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2310796924341520807.4759)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1494304199802239903.4759)
,p_plug_name=>'機能付きパッケージ・アプリケーション'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1199601170102177728.4759)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(787083093555047575.4759)
,p_button_name=>'NEW_INSTALLED_APPS'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404711161197908978.4759)
,p_button_image_alt=>'パッケージ・アプリケーションの作成'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(787719037872821217.4759)
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404711161197908978.4759)
,p_button_image_alt=>'インストールされたアプリケーションの表示'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(750755519256502601.4759)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(750751746540502585.4759)
,p_name=>'P1_ACCESSIBILITY_MODE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(750751542816502585.4759)
,p_use_cache_before_default=>'NO'
,p_item_default=>'STANDARD'
,p_prompt=>'アクセシビリティ・モード'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'case ',
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(933144624364626643.4759)
,p_name=>'RENDERING: Page - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(787083093555047575.4759)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(933144967905626652.4759)
,p_event_id=>wwv_flow_api.id(933144624364626643.4759)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(750754662427502591.4759)
...
'    end if;',
'end;'))
,p_process_error_message=>'アクセシビリティ・モードの設定エラー中にエラーが発生しました'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when=>'P1_ACCESSIBILITY_MODE'
,p_process_when_type=>'REQUEST_EQUALS_CONDITION'
,p_process_success_message=>'アクセシビリティ・モードが設定されました'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959145671052411.4759)
,p_plug_name=>'トップ・パッケージ・アプリケーション'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959251264052412.4759)
,p_plug_name=>'ユーザーはパッケージ・アプリケーションをインストールしました'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4759)
,p_plug_display_sequence=>50
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959463401052414.4759)
,p_plug_name=>'パッケージ・アプリケーション'
...
'end loop;'))
,p_plug_source_type=>'NATIVE_PLSQL'
,p_plug_query_row_template=>wwv_flow_api.id(741378333819007312.4759)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959880777052418.4759)
,p_plug_name=>'情報'
,p_region_css_classes=>'a-Region--stacked a-Region--padded a-Region--flush a-Region--sideRegion'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4759)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'ワークスペース内のパッケージ・アプリケーションに関するメトリック。'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959992513052419.4759)
,p_plug_name=>'パッケージ・アプリケーション・ビュー'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788159425426560907.4759)
,p_plug_name=>'インストール済'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4759)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788164282527649493.4759)
,p_plug_name=>'アップグレードに使用可能'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4759)
,p_plug_display_sequence=>40
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788166095908674996.4759)
,p_plug_name=>'未インストール'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4759)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788982827579790091.4759)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788983890794795218.4759)
,p_plug_name=>'Hidden'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(788983363220793228.4759)
,p_name=>'P2_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(788983890794795218.4759)
...
,p_lov_display_extra=>'YES'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'このページに表示される監視問合せを制約する時間枠を設定してください。'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(789119577877826005.4759)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(789084545317643151.4759)
,p_name=>'RENDERING: Dashboard - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(788982827579790091.4759)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(789084801764643152.4759)
,p_event_id=>wwv_flow_api.id(789084545317643151.4759)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page(
 p_id=>3.4759
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4759)
,p_name=>'パッケージ・アプリケーション'
,p_page_mode=>'NORMAL'
,p_step_title=>'パッケージ・アプリケーション'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1224170433387563371.4759)
,p_plug_name=>'パッケージ・アプリケーション'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(1224170516463563371.4759)
,p_name=>'Packaged Applications'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'このレポートの最大行数は#MAX_ROW_COUNT#行です。フィルタを適用して、問合せのレコード数を削減してください。'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224170864888563380.4759)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171279819563380.4759)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224170911190563380.4759)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171038140563380.4759)
,p_db_column_name=>'INSTALLED'
,p_display_order=>32
,p_column_identifier=>'D'
,p_column_label=>'インストール済'
,p_column_type=>'STRING'
,p_display_text_as=>'LOV_ESCAPE_SC'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171103374563380.4759)
,p_db_column_name=>'UPGRADE_AVAILABLE'
,p_display_order=>42
,p_column_identifier=>'E'
,p_column_label=>'アップグレード可能'
,p_column_type=>'STRING'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_api.id(801893675976261985)
,p_rpt_show_filter_lov=>'1'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171357038563381.4759)
,p_db_column_name=>'TARGET_URL'
,p_display_order=>52
,p_column_identifier=>'G'
,p_column_label=>'ターゲットURL'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962307327400233.4759)
,p_db_column_name=>'CATEGORY_NAME'
,p_display_order=>62
,p_column_identifier=>'H'
,p_column_label=>'カテゴリ名'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1473925915428744023.4759)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962433555400234.4759)
,p_db_column_name=>'IS_NOT_INSTALLED'
,p_display_order=>73
,p_column_identifier=>'J'
,p_column_label=>'インストールされていません'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962551146400235.4759)
,p_db_column_name=>'UPGRADE_IS_AVAILABLE'
,p_display_order=>83
,p_column_identifier=>'K'
,p_column_label=>'アップグレードを使用できます'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(973962130782400231.4759)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(1224170433387563371.4759)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(973962236123400232.4759)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(1224170433387563371.4759)
,p_button_name=>'Reset'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page(
 p_id=>5.4759
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4759)
,p_name=>'ダッシュボード・レポート時間枠の設定'
,p_page_mode=>'MODAL'
,p_step_title=>'ダッシュボード・レポート時間枠の設定'
...
,p_lov_display_extra=>'NO'
,p_help_text=>'ダッシュボードに表示される監視問合せを制約する時間枠を設定してください。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_da_event(
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'管理では、権限に応じて、ワークスペース内のパッケージ・アプリケーションを管理および監視できます。'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
...
,p_plug_name=>'パッケージ・アプリケーションで保存されたレポート'
...
,p_max_row_count_message=>'この問合せは10,000を超える行数を返します。結果が完全になるようにデータをフィルタ処理してください。'
,p_no_data_found_message=>'パッケージ・アプリケーションに、ユーザーによって保存されたレポートがありません。'
,p_allow_report_categories=>'N'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
...
,p_error_message=>'削除するレポートを選択する必要があります。'
,p_always_execute=>'N'
...
'    end loop;',
'end loop;'))
,p_process_error_message=>'レポートを削除できません。'
,p_process_when_button_id=>wwv_flow_api.id(802126337999115511.4759)
,p_process_success_message=>'レポートが削除されました。'
);
end;
/
...
,p_max_row_count=>'10000'
,p_max_row_count_message=>'この問合せは10,000を超える行数を返します。結果が完全になるようにデータをフィルタ処理してください。'
,p_no_data_found_message=>'パッケージ・アプリケーションにサブスクリプションがありません。'
,p_allow_report_categories=>'N'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
'return true;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'削除するサブスクリプションを選択する必要があります。'
,p_always_execute=>'N'
...
'    end loop;',
'end loop;'))
,p_process_error_message=>'サブスクリプションを削除できません。'
,p_process_when_button_id=>wwv_flow_api.id(805213568160829552.4759)
,p_process_success_message=>'サブスクリプションが削除されました。'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>22.4759
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4759)
,p_name=>'ワークスペース・プリファレンスの設定'
,p_page_mode=>'NORMAL'
,p_step_title=>'ワークスペース・プリファレンスの設定'
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'プリファレンスにより、ワークスペースの機能を制御します。'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
,p_plug_name=>'ワークスペース・プリファレンスの設定'
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'&PRODUCT_NAME.エンドユーザー・アカウントで有効期限またはロックの機能を使用するかどうかを選択します。この機能は、',
'&PRODUCT_NAME.ユーザー管理インタフェースを使用して作成されたエンドユーザー・アカウントにのみ適用されます。',
'使用可能なオプションは次のとおりです。',
'<ul>',
'<li>有効化</li>',
'<li>無効化</li>',
'</ul>',
'この機能は、追加的なアプリケーションの認証セキュリティを提供します。',
'「<b>有効化</b>」を選択した場合、ユーザー・アカウント・パスワードは設定した期間を過ぎると期限切れになり、',
'アカウントは設定した回数分、連続で認証に失敗するとロックされます。また、アカウント・パスワードは初回使用時以降は期限切れになるよう設定できます。',
'<p>',
'このインストールの&PRODUCT_NAME.管理者が環境設定の「<b>ユーザー・アカウントの有効期限およびロックが必要</b>」を「はい」に設定した場合、この機能がすべてのワークスペースで有効化され、このアイテムには「<b>有効化</b>」と表示されて、ワークスペース管理者による変更が不可能になります。'))
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'エンドユーザーのアカウントがロックされるまでの連続失敗最大回数として設定する正の整数を入力します。',
'このフィールドに値を指定しない場合、サイトレベルの「<b>許可されるログイン失敗の最大回数</b>」の環境設定が使用されます。'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'    45 )'))
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_prompt=>'エンドユーザー・アカウント・ライフタイム(日):'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'エンドユーザー・アカウントが期限切れになるまでの、アカウント・パスワードの最大有効日数として使用する正の整数を入力します。このフィールドに値を指定しない場合、サイトレベルの「<b>アカウント・パスワード・ライフタイム</b>」の環境設定が使用されます。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'値は正の整数である必要があります。'
,p_always_execute=>'N'
...
'end if;'))
,p_process_error_message=>'ワークスペース・プリファレンスを適用できません。'
,p_process_when_button_id=>wwv_flow_api.id(805414831280857790.4759)
,p_process_success_message=>'ワークスペース・プリファレンスが適用されました。'
);
wwv_flow_api.create_page_process(
...
,p_error_message=>'ユーザー名が正しく設定されていません。ブラウザを完全に閉じてから、再度パスワードを変更してください。'
,p_always_execute=>'N'
...
wwv_flow_api.create_page(
 p_id=>27.4759
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4759)
,p_name=>'アプリケーション・アクティビティ'
,p_page_mode=>'NORMAL'
,p_step_title=>'アプリケーション・アクティビティ'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(741368521013994306.4759)
,p_page_template_options=>'#DEFAULT#'
...
,p_cache_mode=>'NOCACHE'
,p_help_text=>'No help is available for this page.'
,p_last_upd_yyyymmddhh24miss=>'20150428184615'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(818291832742192134.4759)
...
'<script type="text/javascript">',
'// 動的属性はレンダリングされた後すぐに非表示にされます。',
'// jQuery.readyの実行に時間がかかる場合があります。',
...
'        commit;',
' end;'))
,p_process_error_message=>'アプリケーションが正常に更新されませんでした。'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492892500116858121.4759)
,p_process_success_message=>'アプリケーション認証スキームが正常に更新されました。'
);
wwv_flow_api.create_page_process(
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492892500116858121.4759)
,p_process_success_message=>'アプリケーションの認証が変更されました。'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1119586009828190520.4759)
,p_plug_name=>'アプリケーションJSON'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(404672496027804677.4759)
,p_plug_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'Y'
...
,p_plug_name=>'パッケージ・アプリケーション・ギャラリ'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1212073820889771903.4759)
,p_plug_name=>'検索コンテナ'
,p_region_template_options=>'#DEFAULT#'
...
,p_prompt=>'検索'
,p_placeholder=>'パッケージ・アプリケーションの検索'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
,p_name=>'パッケージ・アプリケーションの詳細'
,p_page_mode=>'NORMAL'
,p_step_title=>'パッケージ・アプリケーションの詳細'
...
wwv_flow_api.create_page(
 p_id=>83.4759
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4759)
,p_name=>'パッケージ・アプリケーションのインストール'
,p_page_mode=>'MODAL'
,p_step_title=>'パッケージ・アプリケーションのインストール'
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4759)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'アプリケーションのインストール'
,p_button_position=>'REGION_TEMPLATE_CREATE'
...
,p_button_template_id=>wwv_flow_api.id(758581488338548971.4759)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Webシート・データベース・オブジェクトの管理'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(1164736283212438414.4759)
...
,p_process_error_message=>'アプリケーションが正常にインストールされませんでした。'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'アプリケーションがインストールされました。'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>100.4759
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4759)
,p_name=>'サービスのリクエスト - リクエストの指定'
,p_page_mode=>'NORMAL'
,p_step_title=>'サービスのリクエスト - リクエストの指定'
...
,p_prompt=>'リクエストするサービスのタイプを指定してください:'
,p_source=>'STORAGE'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_RADIOGROUP'
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'サービス変更リクエストを選択して、「<b>次へ</b>」をクリックします。'
,p_attribute_01=>'3'
,p_attribute_02=>'NONE'
...
,p_error_message=>'無効な記憶域量がリクエストされました。'
,p_always_execute=>'N'
...
wwv_flow_api.create_page(
 p_id=>101.4759
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4759)
,p_name=>'記憶域のリクエスト - リクエストの定義'
,p_page_mode=>'NORMAL'
,p_step_title=>'記憶域のリクエスト - リクエストの定義'
...
wwv_flow_api.create_page(
 p_id=>102.4759
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4759)
,p_name=>'サービスの終了のリクエスト - リクエストの定義'
,p_page_mode=>'NORMAL'
,p_step_title=>'サービスの終了のリクエスト - リクエストの定義'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'データベース・アプリケーションが見つかりません。'
,p_query_num_rows_type=>'ROW_RANGES_WITH_LINKS'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_csv_output=>'N'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'Webシート・アプリケーションが見つかりません。'
,p_query_num_rows_type=>'ROW_RANGES_WITH_LINKS'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_csv_output=>'N'
...
'<p>ワークスペース管理者はこのページを使用してサービスの終了をリクエストします。</p>'))
...
,p_column_display_sequence=>3
,p_column_heading=>'最初にプロビジョニングされたスキーマ'
,p_use_as_row_header=>'N'
,p_lov_show_nulls=>'NO'
,p_include_in_export=>'Y'
);
...
,p_column_display_sequence=>2
,p_column_heading=>'デフォルトの表領域'
,p_use_as_row_header=>'N'
,p_lov_show_nulls=>'NO'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(805274418118000233.4759)
,p_name=>'アプリケーション開発者'
,p_template=>wwv_flow_api.id(662132465401686364.4759)
,p_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(805274700563000235.4759)
,p_query_column_id=>1
,p_column_alias=>'THE_NAME'
,p_column_display_sequence=>1
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(805274820294000235.4759)
,p_query_column_id=>2
,p_column_alias=>'THE_NAME'
,p_column_display_sequence=>2
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_page(
 p_id=>103.4759
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4759)
,p_name=>'表領域使用率の詳細レポート'
,p_page_mode=>'MODAL'
,p_step_title=>'表領域使用率の詳細レポート'
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>リクエストを確認してください。</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
'end;'))
,p_process_error_message=>'記憶域の追加リクエスト中にエラーが発生しました。'
,p_process_when_button_id=>wwv_flow_api.id(805366770901561427.4759)
,p_process_success_message=>'&P101_STORAGE. MBの記憶域の追加をリクエストしました。'
...
wwv_flow_api.create_page(
 p_id=>105.4759
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4759)
,p_name=>'プロビジョニング: サービスの終了のリクエスト'
,p_page_mode=>'NORMAL'
,p_step_title=>'プロビジョニング: サービスの終了のリクエスト'
...
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>このページでは、ワークスペースの管理者は現在接続しているサービスの終了をリクエストできます。<br/><br/>',
'',
'<b>重要</b>: すべてのデータ、データベース・オブジェクト、データベース・スキーマ、表領域、アプリケーション、スクリプト、ファイルなどは、サービスの終了時に削除されます。</p>',
'',
'<p>サービスの終了を確認します。</p>'))
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
...
,p_error_message=>'サービスの終了のリクエストは、このワークスペースにすでに存在します。'
,p_always_execute=>'N'
...
'    p_service_attribute_2  => wwv_flow_user_api.get_email(p_username => upper(wwv_flow.g_user)));',
'end;'))
,p_process_error_message=>'サービスの終了リクエストの送信中にエラーが発生しました。'
,p_process_when_button_id=>wwv_flow_api.id(805380789015646517.4759)
,p_process_success_message=>'サービスの終了リクエストが送信されました。'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>209.4759
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4759)
,p_name=>'Application Expressアカウントの設定'
,p_page_mode=>'MODAL'
,p_step_title=>'Application Expressアカウントの設定'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(492818829813527218.4759)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#:a-ButtonRegion--noUI'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(492819635063527220.4759)
,p_plug_name=>'アカウントの設定'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(770118466855390796.4759)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(492818829813527218.4759)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4759)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(492819215638527220.4759)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(492818829813527218.4759)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492819882805527221.4759)
,p_name=>'P209_APP_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4759)
,p_prompt=>'アプリケーション名:'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
,p_field_template=>wwv_flow_api.id(741376158824001765.4759)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820018143527222.4759)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820296100527225.4759)
,p_name=>'P209_SCHEMA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4759)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820409273527225.4759)
,p_name=>'P209_METHOD'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4759)
,p_item_default=>'E'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820697304527226.4759)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820844713527226.4759)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492821075748527226.4759)
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'パッケージ・アプリケーションへのログインに使用するユーザー名を指定します。ユーザー名には次の制限があります: <p/><ul><li>',
'最大100文字</li><li>',
'空白を含まない</li>',
'<li>特殊文字は@およびピリオド(.)のみ使用可能</li></ul>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492821585156527227.4759)
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4759)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'パスワードを指定してください。パスワードは大/小文字が区別されます。'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492822027856527228.4759)
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4759)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'パスワードを再入力してください。'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492822594676527228.4759)
,p_name=>'P209_EMAIL'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4759)
,p_prompt=>'電子メール'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4759)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'通常の通信およびパスワードの再設定に関する通知などに使用する電子メール・アドレスを指定してください。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(656958442251052404.4759)
...
,p_cSize=>30
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(750871254241940005.4759)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch:a-Form-fieldContainer--autoLabelWidth'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(777061579764817791.4759)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823118333527228.4759)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823384065527229.4759)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823728079527229.4759)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492823955896527229.4759)
...
,p_associated_item=>wwv_flow_api.id(492821075748527226.4759)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824175298527231.4759)
...
,p_associated_item=>wwv_flow_api.id(492822594676527228.4759)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824349197527231.4759)
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'無効な電子メール・アドレスです。'
,p_always_execute=>'N'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824530875527231.4759)
...
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_api.id(492821585156527227.4759)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824717510527231.4759)
...
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_api.id(492822027856527228.4759)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824939547527231.4759)
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'確認用パスワードと入力したパスワードが一致しません。'
,p_always_execute=>'N'
,p_validation_condition=>'P209_CREATE_USER'
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(492819215638527220.4759)
,p_associated_item=>wwv_flow_api.id(.4759)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825193741527232.4759)
,p_validation_name=>'strong password'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825374747527232.4759)
...
'return true;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'ユーザー名はすでに存在します。'
,p_always_execute=>'N'
,p_validation_condition=>'P209_CREATE_USER'
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825541202527232.4759)
,p_validation_name=>'P209_EXISTING_USER Should Not Be Null'
,p_validation_sequence=>80
,p_validation=>'P209_EXISTING_USER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'既存のユーザーがいない場合は、新しいユーザーを作成する必要があります。'
,p_always_execute=>'N'
...
,p_when_button_pressed=>wwv_flow_api.id(492819215638527220.4759)
,p_only_for_changed_rows=>'Y'
,p_associated_item=>wwv_flow_api.id(492820844713527226.4759)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(492826451491527234.4759)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492826790590527234.4759)
,p_event_id=>wwv_flow_api.id(492826451491527234.4759)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492826968456527234.4759)
,p_event_id=>wwv_flow_api.id(492826451491527234.4759)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827153196527234.4759)
,p_event_id=>wwv_flow_api.id(492826451491527234.4759)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(492827265876527234.4759)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827513295527235.4759)
,p_event_id=>wwv_flow_api.id(492827265876527234.4759)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827728196527235.4759)
,p_event_id=>wwv_flow_api.id(492827265876527234.4759)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827960709527235.4759)
,p_event_id=>wwv_flow_api.id(492827265876527234.4759)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492828182378527235.4759)
,p_event_id=>wwv_flow_api.id(492827265876527234.4759)
,p_event_result=>'FALSE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(770119774478414886.4759)
,p_name=>'Close Dialog'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(770118466855390796.4759)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(770120016874414887.4759)
,p_event_id=>wwv_flow_api.id(770119774478414886.4759)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(492825632290527232.4759)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4759)
,p_process_when=>'wwv_flow_global.g_cloud and :P83_AUTH = ''NATIVE_APEX_ACCOUNTS'' and :P81_APP_TYPE = ''DATABASE'''
,p_process_when_type=>'PLSQL_EXPRESSION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(492825893428527233.4759)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'    ); ',
'end;'))
,p_process_error_message=>'Webシート管理者を定義できません。'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4759)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(770120150142419290.4759)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4759)
,p_process_success_message=>'アプリケーションを実行するためのアカウントが設定されました。'
);
end;
/
...
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_plug_header=>'パッケージ・アプリケーションがインストールされました。ただし、データベース・オブジェクトとシード・データのインストールに失敗しました。'
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
);
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'インストール結果が見つかりません'
...
wwv_flow_api.create_page(
 p_id=>234.4759
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4759)
,p_name=>'パッケージ・アプリケーションのロック解除'
,p_page_mode=>'MODAL'
,p_step_title=>'パッケージ・アプリケーションのロック解除'
...
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_header=>'パッケージ・アプリケーションのロックを解除するとアプリケーションは<strong>今後のアップグレードを受けられなくなり</strong>、Oracleサポートによる<strong>サポートの対象外</strong>になります。'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4759)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'アプリケーションのロック解除'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
...
'  end loop;',
'end;'))
,p_process_error_message=>'アプリケーションのロック解除中にエラーが発生しました'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'アプリケーションのロックが解除されました'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>237.4759
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4759)
,p_name=>'パッケージ・アプリケーションの削除'
,p_page_mode=>'MODAL'
,p_step_title=>'パッケージ・アプリケーションの削除'
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4759)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'アプリケーションの削除'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
...
'  end if;',
'end;'))
,p_process_error_message=>'アプリケーションの削除中にエラーが発生しました'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'アプリケーションが削除されました'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>262.4759
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4759)
,p_name=>'パッケージ・アプリケーションの更新'
,p_page_mode=>'MODAL'
,p_step_title=>'パッケージ・アプリケーションの更新'
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4759)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'アプリケーションの更新'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
...
,p_process_error_message=>'アプリケーションが正常に更新されませんでした。'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'アプリケーションが正常に更新されました。'
);
wwv_flow_api.create_page_process(
...
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'アプリケーションが更新されました。'
);
end;
/
...
,p_last_upd_yyyymmddhh24miss=>'20150428184616'
);
wwv_flow_api.create_page_plug(
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'データの参照、アプリケーションの作成およびSQLスクリプトの実行に使用するデフォルトのスキーマを指定します。複数の有効なスキーマを持つワークスペースを使用する場合、このスキーマがアプリケーションの作成やSQL問合せの実行などでデフォルトとして使用されます。この機能はユーザー・プリファレンスのみを制御し、セキュリティは制御しません。'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
...
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(801868755606261949.4759)
,p_prompt=>'アクセス可能なスキーマ(すべて可とする場合は空)'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>32
,p_cMaxlength=>4000
,p_cHeight=>1
...
,p_help_text=>'SQLワークショップを使用する場合は、この開発者が権限を持つスキーマのリストを、コロンで区切って入力してください。ここで入力したスキーマのリストによって、ワークスペースにプロビジョニングされたすべてのスキーマのうちの一部のスキーマにユーザーが制限され、SQLワークショップに表示されるスキーマ名が決定されます。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'このユーザーがワークスペースの管理者権限を持つ必要があるかどうかを指定します。管理者はすべてのコンポーネントへのアクセス権を付与されます。また、ユーザー・アカウント、グループおよび開発サービスも管理できます。',
'',
'コンポーネントは、インスタンス管理者によってオフにされていると、使用できない場合があります。'))
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'このユーザーが開発者権限を所有する必要があるかどうかを指定してください。開発者は、パッケージ・アプリケーションをインストール、削除またはアップグレードできます。'
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
,p_attribute_04=>'VERTICAL'
);
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'開発者がアプリケーション・ビルダーへのアクセス権を持つかどうかを決定します。<br>',
'<br>',
'管理者は常にアプリケーション・ビルダーへのアクセス権を持ちます。<br>',
'開発者にはアプリケーション・ビルダーまたはSQLワークショップ、あるいはその両方へのアクセス権が必要です。<br>',
'<br>',
'管理者によってアプリケーション・ビルダーへのアクセス権がワークスペースについて無効にされていると、この属性は常に無効になります。'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'開発者がWebシート開発へのアクセス権を持つかどうかを決定します。<br>',
'<br>',
'管理者は常にWebシート開発へのアクセス権を持ちます。<br>',
'',
'<br>',
'管理者によってWebシート開発へのアクセス権がワークスペースについて無効にされていると、この属性は常に無効になります。'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'開発者がSQLワークショップへのアクセス権を持つかどうかを決定します。<br>',
'<br>',
'管理者は常にSQLワークショップへのアクセス権を持ちます。<br>',
'開発者にはアプリケーション・ビルダーまたはSQLワークショップ、あるいはその両方へのアクセス権が必要です。<br>',
'<br>',
'管理者によってSQLワークショップへのアクセス権がワークスペースについて無効にされていると、この属性は常に無効になります。'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'ユーザーがチーム開発へのアクセス権を持つかどうかを決定します。<br>',
'<br>',
'管理者は常にチーム開発へのアクセス権を持ちます。<br>',
'<br>',
'管理者によってチーム開発へのアクセス権がワークスペースについて無効にされていると、この属性は常に無効になります。'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>'アカウントを使用不可にするには 「<b>ロック済</b>」を選択します。アカウントを使用可能にするには「<b>ロック解除済</b>」を選択します。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'システムへのログインに使用するユーザー名を指定します。ユーザー名には次の制限があります。<ul><li>',
'最大100文字</li><li>',
'空白を含まない</li>',
'<li>特殊文字は@およびピリオド(.)のみ使用可能</li></ul>',
'<p>ユーザー名はモニター・アプリケーションを使用してユーザー・アクティビティを参照する際にも使用されます。バインド変数<code>:app_user</code>は、アプリケーションの構築時に現行ユーザーの値を戻します。</p>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4759)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'さらに詳細にユーザーを識別するには、名を指定します。このフィールドはオプションであり、情報提供の目的でのみ使用されます。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4759)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'さらに詳細にユーザーを識別するには、姓を指定します。このフィールドはオプションであり、情報提供の目的でのみ使用されます。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4759)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'情報提供の目的でのみユーザーに関するコメントを記入するには、このフィールドを使用してください。'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'Y'
,p_attribute_04=>'NONE'
...
,p_use_cache_before_default=>'NO'
,p_prompt=>'パスワード'
,p_post_element_text=>' <span class="instructiontext">パスワードは大/小文字が区別されます</span>'
,p_display_as=>'NATIVE_PASSWORD'
,p_cSize=>30
,p_cMaxlength=>255
,p_field_template=>wwv_flow_api.id(741376307162001773.4759)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'パスワードを指定してください。パスワードは大/小文字が区別されます。開発者は、開発者自身のパスワードを変更できます。管理者権限を持つ開発者は、同じワークスペース内のユーザーのパスワードを変更できます。'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'「<b>はい</b>」を選択すると、このアカウントのユーザーは、現在のパスワードを使用して最初にログインした後、パスワードをすぐに変更するよう要求されます。このルールは、ワークスペースの管理または開発にこのアカウントを使用する場合や、開発したアプリケーションへのログインにこのアカウントを使用する場合に適用されます。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'ユーザー名を指定する必要があります。'
,p_always_execute=>'N'
...
,p_validation_type=>'NOT_EXISTS'
,p_error_message=>'ユーザー&F4750_P301_USER_NAME.は、すでに存在しています。'
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
,p_associated_item=>wwv_flow_api.id(801875696425261961.4759)
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'「電子メール・アドレス」に値を指定する必要があります。'
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'「デフォルトのスキーマ」は、「アクセス可能なスキーマ」内に存在する必要があります。'
,p_always_execute=>'N'
...
'END;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'開発者にはアプリケーション・ビルダーまたはSQLワークショップ、あるいはその両方へのアクセス権が必要です。'
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
...
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'ユーザー名がインスタンスに定義されている式と一致しません。'
,p_always_execute=>'N'
,p_validation_condition=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
'end;',
'commit;'))
,p_process_error_message=>'エラー: #SQLERRM#'
,p_process_when=>'SUBMIT,CREATE_ANOTHER'
,p_process_when_type=>'REQUEST_IN_CONDITION'
,p_process_success_message=>'ユーザーが作成されました。'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>カンマ、セミコロンまたは改行で区切られた電子メール・アドレスを入力するか、コピーして貼り付けます。電子メール・メッセージから電子メール・アドレスをコピーして貼り付ける場合、余分なテキストはフィルタ処理で除外されます。指定されたすべての電子メール・ユーザーは、選択されたロールとして追加されます。既存または重複した電子メール・アドレスは無視されます。',
'',
'<p>指定するパスワードが各ユーザーに割り当てられるので、ユーザーはログイン時にパスワードを変更する必要があることに注意ししてください。</p>'))
,p_plug_query_row_template=>1
,p_plug_column_width=>'valign=top'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'カンマ、セミコロンまたは改行で区切られた電子メール・アドレスを入力するか、コピーして貼り付けます。電子メール・メッセージから電子メール・アドレスをコピーして貼り付ける場合、余分なテキストはフィルタ処理で除外されます。'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'完全な電子メール・アドレスを含めるか、またはドメイン名を除外するかを指定してください。オプションは次のとおりです。',
'<ul>',
'<li>ユーザー名を完全な電子メール・アドレスに設定 - 完全な電子メール・アドレスが含まれます。</li>',
'<li>ユーザー名の一部として@ドメインを除外 - @記号以降のすべてのテキストを削除します(たとえば、<code>user1@xyz.com</code>は<code>user1</code>になります)。</li>',
'</ul>'))
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'これらのユーザーがワークスペースの管理者権限を所有する必要があるかどうかを指定してください。開発者と同様、ワークスペース管理者はアプリケーションおよびデータベース・オブジェクトを作成、変更できます。さらに、ユーザー・アカウント、グループおよび開発サービスの管理も可能です。'
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'これらのユーザーが開発者権限を所有する必要があるかどうかを指定してください。開発者は、アプリケーションおよびデータベース・オブジェクトを作成、変更できます。'
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_error_message=>'パスワードと確認が一致しません。'
,p_always_execute=>'N'
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'有効な電子メール・アドレスが見つかりません。'
,p_query_num_rows_type=>'0'
,p_query_row_count_max=>5000
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_break_type_flag=>'DEFAULT_BREAK_FORMATTING'
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'無効な新規ユーザーが見つかりません'
,p_query_num_rows_type=>'0'
,p_query_row_count_max=>5000
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_break_type_flag=>'DEFAULT_BREAK_FORMATTING'
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'<p>前のページのユーザー名リストで有効なユーザー名が見つからず、&P303_INVALID_COUNT.件の無効なユーザー名が見つかりました。戻って、指定したユーザー名リストを確認してください。</p>'
,p_plug_query_row_template=>1
,p_plug_query_num_rows=>15
...
'',
'commit;'))
,p_process_error_message=>'ユーザーの作成中に予期しないエラーが発生しました'
,p_process_success_message=>'ユーザーが作成されました'
);
end;
/
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'削除するユーザーを1つ以上選択する必要があります。'
,p_always_execute=>'N'
...
'end loop;'))
,p_process_error_message=>'ユーザーの削除に失敗しました。'
,p_process_when_button_id=>wwv_flow_api.id(805152655703739453.4759)
,p_process_success_message=>'ユーザーが削除されました。'
);
end;
/
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>このユーザー・マネージャは、これらのアカウントに格納されているユーザー名およびパスワードに対して認証を行う認証スキームで使用するためにアカウントを保持します。</p>',
'<p>ユーザーのパスワードを変更する場合は、新しいパスワードを入力します。変更しない場合は、パスワード列をNULLにすると、現行のパスワードは変更されません。</p>'))
,p_plug_query_row_template=>wwv_flow_api.id(1939532588110833.4759)
...
,p_plug_name=>'ユーザー: &F4750_P306_USER_NAME.'
,p_region_template_options=>'#DEFAULT#:a-ButtonRegion--withItems:a-ButtonRegion--noUI:a-ButtonRegion--showTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(740735067061086300.4759)
,p_plug_display_sequence=>20
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4759)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'このユーザーが属しているワークスペースを示します。'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_field_template=>wwv_flow_api.id(741376307162001773.4759)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'通常の通信およびパスワードの再設定に関する通知などに使用する電子メール・アドレスを指定します。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'EMAIL'
,p_attribute_05=>'BOTH'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>'ユーザー用のデフォルトのOracle日付書式を指定します。これにより、SQLワークショップ内のデフォルトの日付書式が制御されます。'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'このユーザーがワークスペースの管理者権限を持つ必要があるかどうかを指定します。管理者はすべてのコンポーネントへのアクセス権を付与されます。また、ユーザー・アカウントおよび開発サービスも管理できます。',
'',
'コンポーネントは、インスタンス管理者によってオフにされていると、使用できない場合があります。'))
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>ユーザーは、強調表示されているグループに属します。ユーザーをグループに追加するには、名前をクリックして強調表示させます。グループを削除するには、名前を再度クリックして、強調表示を解除します。</p>',
'<p>グループ割当てを使用すると、開発者はグループ別に特定の機能へのアクセスを制御できます。',
'このグループ機能はアプリケーション・ビルダーに組み込まれており、Cookieベースの認証との併用が最も効果的(かつ、最も便利)です。',
'ただし、このユーザー・グループ機能は異なる認証スキーマに移植できないことに注意してください。</p>',
''))
,p_attribute_01=>'Y'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4759)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'システムへのログイン時に使用するパスワード。現在のパスワードを変更しない場合は、パスワードを入力しないでください。'
,p_attribute_01=>'N'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4759)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'パスワードを再入力してください。現在のパスワードを変更しない場合は、パスワードを入力しないでください。'
,p_attribute_01=>'N'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4759)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'開発者またはワークスペース管理者のログイン用パスワードが期限切れか有効かを示します。'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4759)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'エンド・ユーザー・ログイン用のパスワードが期限切れか有効かを示します。'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'ユーザーのパスワードを期限切れにする場合に、このチェックボックスを選択します。これは、開発者/管理者ログインとエンド・ユーザーとしてのアクセスの両方に影響します。期限が切れると、このアカウントに次回アクセスするとき、ログインには古いパスワードと新しいパスワードが要求されます。'
,p_attribute_01=>'1'
);
wwv_flow_api.create_page_item(
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'自分の管理者権限は、自分では削除できません。'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(805491074986047781.4759)
...
'end loop;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'ユーザー名を更新した場合、新しいパスワードを指定する必要があります。'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(805491074986047781.4759)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'パスワードが正しく確認されませんでした。同じパスワードを正確に2回入力してください。'
,p_always_execute=>'N'
,p_validation_condition=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
'    exit;',
'end loop;'))
,p_process_error_message=>'ユーザー情報のフェッチ中にエラーが発生しました。'
);
end;
/
begin
...
'  end if;',
'end;'))
,p_process_error_message=>'ユーザーの更新中にエラーが発生しました。'
,p_process_when_button_id=>wwv_flow_api.id(805491074986047781.4759)
,p_process_success_message=>'ユーザー"&F4750_P306_USER_NAME."は更新されました。'
);
wwv_flow_api.create_page_process(
...
'wwv_flow_fnd_user_api.remove_fnd_user(',
'             p_user_id => :F4750_P306_USER_ID);'))
,p_process_error_message=>'&F4750_P306_USER_NAME.の削除中にエラーが発生しました。'
,p_process_when_button_id=>wwv_flow_api.id(805490871563047781.4759)
,p_process_success_message=>'ユーザー「&F4750_P306_USER_NAME.」は削除されました。'
);
wwv_flow_api.create_page_process(
...
,p_plug_name=>'このページに関する既存のフィードバック'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'このページに対するフィードバックは入力されていません。'
...
,p_column_display_sequence=>4
,p_column_heading=>'フィードバック・ステータス'
,p_use_as_row_header=>'N'
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4759)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'フィードバックを提供するアプリケーション。'
,p_attribute_01=>'Y'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(829721255038941612.4759)
,p_prompt=>'アプリケーション・ビルダーおよびAPEXアプリケーション開発のフィードバック'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>96
,p_cMaxlength=>4000
,p_cHeight=>4
,p_field_template=>wwv_flow_api.id(741376307162001773.4759)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'&PRODUCT_NAME.の品質を向上させるため、皆様からのご意見をお待ちしております。'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'フィードバックの種類を指定してください。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'コメントするコンポーネントまたは機能を指定してください。'
,p_attribute_01=>'3'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_validation(
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(829724817666941621.4759)
,p_validation_name=>'Feedback not null'
,p_validation_sequence=>20
,p_validation=>'P11001_FEEDBACK'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'値を指定する必要があります'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(829724329405941619.4759)
,p_associated_item=>wwv_flow_api.id(829722489187941618.4759)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
