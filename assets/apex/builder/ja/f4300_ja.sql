...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902260351207380645')
...
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'表の所有者と名前'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
...
,p_list_item_icon=>'htmldb/icons/pt_build_options.png'
,p_list_item_icon_attributes=>'width="20" height="20" title="#LIST_LABEL#" alt="#LIST_LABEL#"'
,p_list_text_01=>'カンマ区切りデータ(csv)またはタブ区切りデータのファイルなどの構造化フラット・ファイルからデータをロードします。'
...
,p_list_item_icon=>'htmldb/icons/pt_build_options.png'
,p_list_item_icon_attributes=>'width="20" height="20" title="#LIST_LABEL#" alt="#LIST_LABEL#"'
,p_list_text_01=>'標準形式のXMLからデータをロードします。'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'htmldb/icons/pt_build_options.png'
,p_list_item_icon_attributes=>'width="20" height="20" title="#LIST_LABEL#" alt="#LIST_LABEL#"'
,p_list_text_01=>'データベース・データをフラット・ファイルにエクスポートします。'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'htmldb/icons/pt_build_options.png'
,p_list_item_icon_attributes=>'width="20" height="20" title="#LIST_LABEL#" alt="#LIST_LABEL#"'
,p_list_text_01=>'データベース・データをXML文書にエクスポートします。'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list(
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718997895063143733.4309)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1490428208929471.4309)
...
,p_error_message=>'データ・ローダーは許可されていません。'
...
,p_icon_target=>'#'
,p_icon_image_alt=>'ワークスペース&COMPANY.'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747112016170067798.4309)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747112448459067799.4309)
,p_page_template_id=>wwv_flow_api.id(716604939833788366.4309)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970723723564339906.4309)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970724109087339906.4309)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4309)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970724540049339907.4309)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4309)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970724913565339907.4309)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4309)
,p_name=>'Right Side Bar'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970725381151339907.4309)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4309)
,p_name=>'After Body'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970725711831339907.4309)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4309)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970726188421339907.4309)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4309)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824989302125308447.4309)
,p_page_template_id=>wwv_flow_api.id(716609648731788373.4309)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824989797922308447.4309)
,p_page_template_id=>wwv_flow_api.id(716609648731788373.4309)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824990142859308448.4309)
,p_page_template_id=>wwv_flow_api.id(716609648731788373.4309)
,p_name=>'Wizard Title'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824990504766308448.4309)
,p_page_template_id=>wwv_flow_api.id(716609648731788373.4309)
...
,p_last_upd_yyyymmddhh24miss=>'20150428184531'
);
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'<p>このページには、スプレッドシートのインポートに関する情報が表示されます。 インポートに失敗した行がある場合は、このページにエラー・メッセージが表示されます。</p>'
,p_plug_query_row_template=>1
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>このページには、ロードされたテキスト・データのステータスが表示されます。</p> ',
'<p>ロードされたファイルにアクセスするには、そのファイル名を選択してください。</p> ',
...
,p_help_text=>'ユーザーのファイルまたはすべてのファイルを表示するように指定してください。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>このページには、インポートされたスプレッドシート・データのステータスが表示されます。</p> ',
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>' - '
,p_query_no_data_found=>'スプレッドシートのインポートが見つかりません。'
,p_query_num_rows_type=>'ROW_RANGES'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_csv_output=>'N'
...
,p_help_text=>'ご使用のスプレッドシートのインポートを表示するか、すべてのスプレッドシートのインポートを表示するかを指定してください。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>データをロードする表のデータベース・スキーマおよび名前を選択し、アップロードするXML文書を指定してください。</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_help_text=>'データをロードする表を所有するデータベース・スキーマを選択してください。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'データをロードするデータベース表を選択してください。デフォルトでは、すべての表名は大文字に変換されます。このデフォルトの動作をオーバーライドするには「<span class="fielddatabold">大/小文字区別</span>」を選択してください。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_help_text=>'「<span class="fielddatabold">参照</span>」をクリックして、アップロードするXMLファイルを検索してください。'
...
,p_error_message=>'ファイルにコンテンツが含まれていません。'
,p_always_execute=>'N'
,p_validation_condition=>'F4300_P17_FILE'
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_when_button_pressed=>wwv_flow_api.id(184013029848654860.4309)
...
wwv_flow_api.create_page(
 p_id=>18.4309
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4309)
,p_name=>'データのロード - ファイルの詳細'
,p_page_mode=>'MODAL'
,p_step_title=>'データのロード - ファイルの詳細'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_group_id=>wwv_flow_api.id(215731706086585147)
,p_step_template=>wwv_flow_api.id(716613771837788376.4309)
...
'アップロードするファイルは、テキスト・ベースである必要があります。.XLSファイルをアップロードするには、まずCSVとして保存します。<p />',
''))
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'N'
,p_help_text=>'「<span class="fielddatabold">参照</span>」をクリックして、アップロードするファイルを検索してください。'
,p_attribute_01=>'WWV_FLOW_FILES'
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>データの最初の行に列名が含まれる場合は、このボックスを選択してください。</p>',
'',
'',
'',
'<pre>',
...
,p_help_text=>'列セパレータ文字を指定してください。タブ・セパレータには<code>\t</code>を使用してください。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'ファイルを再アップロードするように指定 '
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">デリミタ文字を入力してください。この文字を使用して、データ値の開始境界および終了境界を区切ることができます。デリミタ文字を指定すると、データ・ワークショップではデータ値の開始境界および終了境界の前の空白が無視されます。また、このオプションを使用して、指定したデリミタ文字でデータ値を囲むことができます。</div>',
'<div class="htmldbInfoBodyP">1行目に列名が含まれている場合は、「<span class="fielddatabold">1行目のデータに列名が含まれる</span>」を選択してください。</div>',
''))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>データに国際通貨記号が含まれている場合は、その記号をここに入力してください。</p>',
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>グループ・セパレータは、千の位や百万の位などの整数グループを区切ります。</p>',
'<p>グループ・セパレータには、任意の文字を指定できます。指定した文字はシングルバイトで、グループ・セパレータは他の小数点文字と異なる必要があります。セパレータには、空白を指定できますが、数字および次に示す文字は指定できません。</p>',
'<ul class="noIndent">',
'<li>プラス(+)</li>',
'<li>ハイフン(-)</li> ',
'<li>小なり記号(<)</li>',
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>小数点文字は、数値の整数部分と小数部分を区切ります。</p>',
'<p>小数点文字には、任意の文字を指定できます。指定した文字はシングルバイトで、小数点文字はグループ・セパレータと異なる必要があります。小数点文字には、空白を指定できますが、数字および次に示す文字は指定できません。</p>',
'<ul class="noIndent">',
'<li>プラス(+)</li>',
'<li>ハイフン(-)</li> ',
'<li>小なり記号(<)</li>',
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'テキスト・ファイルをエンコードする文字セットを選択してください。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_computation(
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'アップロードするファイルを選択する必要があります。'
,p_always_execute=>'N'
...
wwv_flow_api.create_page(
 p_id=>19.4309
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4309)
,p_name=>'データのロード - 表のプロパティ'
,p_page_mode=>'MODAL'
,p_step_title=>'データのロード - 表のプロパティ'
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'<p>このページでは、新しい表の外観をプレビューできます。表名を入力し、列名またはデータ型を変更し、挿入する列を指定してください。</p>'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'データを作成してロードするデータベース・スキーマを選択してください。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
,p_item_comment=>'Generated 20-SEP-2002 14:00:17'
);
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>'作成する表名を指定してください。デフォルトでは、すべての表名は大文字に変換されます。このデフォルトの動作をオーバーライドするには「<span class="fielddatabold">大/小文字を保持</span>」を選択してください。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>このページを使用すると、表の主キーを指定できます。データ・セット内のいずれの列も主キーとして適切でない場合は、新しい列を主キーとして指定してください。主キーは、表の行を一意に識別するために使用されます。</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_plug_comment=>'Region generated 20-SEP-2002 14:00:17'
);
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'データをロードする表を所有するスキーマです。'
,p_attribute_01=>'Y'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
,p_item_comment=>'Generated 20-SEP-2002 14:00:17'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'表の主キーとなる列を指定してください。主キーは行を一意に識別する列です。Oracleでは表が主キーを持つ必要はありませんが、このウィザードでは主キーを指定する必要があります。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'主キーの計算方法を選択してください。または、主キー値を設定しないように選択してください。'
,p_attribute_01=>'1'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'主キー値を移入するために使用する既存のデータベース順序の名前を指定してください。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(716620116614799716.4309)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'この新しい表の主キーを移入するために作成される新しいデータベース順序の名前を指定してください。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'主キーとして既存の列を選択することも、新しい列を追加することもできます。'
,p_attribute_01=>'1'
,p_attribute_02=>'SUBMIT'
,p_attribute_03=>'Y'
);
...
,p_field_template=>wwv_flow_api.id(716620116614799716.4309)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'新しい主キー列の名前を入力してください。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(2164724759803154.4309)
,p_process_success_message=>'データがロードされました。'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>22.4309
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4309)
,p_name=>'データのロード - 表の所有者と名前'
,p_page_mode=>'MODAL'
,p_step_title=>'データのロード - 表の所有者と名前'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_group_id=>wwv_flow_api.id(215731706086585147)
,p_step_template=>wwv_flow_api.id(716613771837788376.4309)
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>データをロードする表のデータベース・スキーマおよび名前を選択してください。</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'<p>データをロードする表を所有するデータベース・スキーマを選択してください。</p>'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'<p>データをロードするデータベース表を選択してください。</p>'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
...
,p_plug_column_width=>'valign="top"'
,p_plug_header=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<label for="file-upload" class="hideMe508">ファイルのアップロード</label><p>このページでは、アップロードするファイルを検索できます。1行目に列名が含まれる場合は、「<b>1行目のデータに列名が含まれる</b>」を選択してください。</p>',
''))
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_plug_comment=>'Region generated 20-SEP-2002 14:00:17'
...
,p_field_template=>wwv_flow_api.id(716620116614799716.4309)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'<p>「<strong>参照</strong>」をクリックして、アップロードするファイルを検索してください。</p>'
,p_attribute_01=>'WWV_FLOW_FILES'
,p_item_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>データの最初の行に列名が含まれる場合は、このオプションを選択してください。次の例を参照してください。</p>',
'<pre>',
'名前     給与     コミッション',
'Clark    1000       10',
'Scott    2000       20',
...
,p_field_template=>wwv_flow_api.id(716620116614799716.4309)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'<p>列のセパレータ文字を指定してください。タブ区切りには、<strong>\t</strong>を使用します。</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(716619902812799716.4309)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'<p>オプションで囲み文字を指定してください。</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page(
 p_id=>25.4309
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4309)
,p_name=>'データのロード - 列のマッピング'
,p_page_mode=>'MODAL'
,p_step_title=>'データのロード - 列のマッピング'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_group_id=>wwv_flow_api.id(215731706086585147)
,p_step_template=>wwv_flow_api.id(716613771837788376.4309)
...
,p_plug_query_row_template=>1
,p_plug_header=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>このページでは、データのロード方法をプレビューできます。データベース列名と、データ内の列を一致させます。列をアップロードするには「<b>はい</b>」を、しない場合は「<b>いいえ</b>」を選択します。アスタリスク(*)は、必須の列を示します。選択した表にデータをアップロードするには、「<b>データのロード</b>」をクリックしてください。</p>',
...
,p_plug_header=>'<p>表のコンテンツをXML文書にエクスポートできます。XML文書にエクスポートするデータベースのスキーマ、表および関連付けられた列を選択してください。</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'XML文書にエクスポートするデータベース・オブジェクト列を選択してください。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'YES'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'SQL WHERE句を入力して、選択される行を制限します。例:',
'<pre>',
'DEPTNO = 10',
'</pre>'))
,p_attribute_01=>'Y'
...
,p_lov_display_extra=>'NO'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'エクスポートするオブジェクトを所有するデータベース・スキーマを選択してください。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_input=>'Y'
,p_help_text=>'XMLファイル形式にエクスポートするデータベース・オブジェクト名を選択してください。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_computation(
...
wwv_flow_api.create_page(
 p_id=>150.4309
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4309)
,p_name=>'テキストへのアンロード - 列'
,p_page_mode=>'MODAL'
,p_step_title=>'テキストへのアンロード - 列'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_group_id=>wwv_flow_api.id(215731706086585147)
,p_step_template=>wwv_flow_api.id(716613771837788376.4309)
...
,p_cache_timeout_seconds=>21600
,p_help_text=>'AEUTL/sql_utl_exprt.htm'
,p_last_upd_yyyymmddhh24miss=>'20150428184532'
);
wwv_flow_api.create_page_plug(
...
,p_plug_query_number_formats=>'::::::'
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_plug_header=>'<p>表のコンテンツを構造化されたテキスト・ファイルにアンロードできます。たとえば、表全体をカンマ区切りファイル(.CSV)にエクスポートできます。テキストにアンロードする表を所有するデータベース・スキーマを選択してください。</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'プレーン・テキスト形式でエクスポートするデータベース表を選択してください。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'このプレーン・テキスト・ファイルに含める列を選択してください。アンロードがサポートされているのは、BLOBおよびBFILEを除くOracle組込みデータ型のみです。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
wwv_flow_api.create_page(
 p_id=>180.4309
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4309)
,p_name=>'テキストへのアンロード - オプション'
,p_page_mode=>'MODAL'
,p_step_title=>'テキストへのアンロード - オプション'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_group_id=>wwv_flow_api.id(215731706086585147)
,p_step_template=>wwv_flow_api.id(716613771837788376.4309)
...
,p_plug_query_number_formats=>'::::::'
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_plug_header=>'<p>各行で列の値を区切るためのセパレータの種類と、列のテキスト文字列の指定方法を指定してください。</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'列名も含めてデータをエクスポートする場合は、このアイテムを選択してください。'
,p_attribute_01=>'1'
,p_attribute_02=>'VERTICAL'
);
wwv_flow_api.create_page_item(
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">各行の列値を区切るために使用するセパレータ・タイプを指定してください。</div> ',
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'エクスポート・ファイルをエンコードする文字セットを選択してください。',
''))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'結果ファイルの行をキャリッジ・リターンおよび改行で終了させるには、DOSを選択してください。  結果ファイルの行を改行で終了させるには、UNIXを選択してください。  '
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(716619902812799716.4309)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'列内のテキスト文字列を識別する方法を指定するには、このオプションを使用してください。一重引用符または二重引用符を指定できます。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>Microsoft Excelなどのスプレッドシート・プログラムからロードするデータをコピーし、「データ」フィールドにペーストしてください。</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_help_text=>'スプレッドシート・プログラムからロードするデータをコピーし、ペーストしてください。'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>このページでは、表の定義方法をプレビューできます。表名を入力し、列名、データ型および列長を確認してください。列を更新するには、<b>「はい」</b>または<b>「いいえ」</b>を選択してください。</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_lov_display_extra=>'YES'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'<div class="htmldbInfoBodyP">作成する表名を指定してください。デフォルトでは、すべての表名は大文字に変換されます。このデフォルトの動作をオーバーライドするには「<span class="fielddatabold">大/小文字を保持</span>」を選択してください。</div>'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'return TRUE;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'1つ以上の重複する列名があります。'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(116940415820894908.4309)
,p_associated_item=>wwv_flow_api.id(.4309)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'表の行を識別するために、新しい列の名前の入力'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page(
 p_id=>230.4309
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4309)
,p_name=>'データのロード - ターゲットとメソッド'
,p_page_mode=>'MODAL'
,p_step_title=>'データのロード - ターゲットとメソッド'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_group_id=>wwv_flow_api.id(215729525348581243)
,p_step_template=>wwv_flow_api.id(716613771837788376.4309)
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'データをロードする対象を選択してください。データベース表が存在する場合は、「既存の表」を選択してください。新しい表を作成する場合は、「新しい表」を選択してください。'
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'データを、ファイルからアップロードするか、またはスプレッドシートからコピー・アンド・ペーストするかを指定します。'
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_computation(
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'Excelデータをロードする表を所有するデータベース・スキーマを選択してください。'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>このページでは、データのロード方法をプレビューできます。データベース列名をデータ内の列と照合してください。選択した表にデータをアップロードするには、「<b>データのロード</b>」をクリックしてください。</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_plug_query_number_formats=>'::::::'
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_plug_header=>'<p>列をアップロードするには「<b>はい</b>」を、しない場合は「<b>いいえ</b>」を選択します。アスタリスク(*)は、必須の列を示します。SQLワークショップを使用して、列長の変更、NOT NULL列の作成、列のデータ型の変更など、表属性を変更できます。</p>'
);
wwv_flow_api.create_page_plug(
...
,p_plug_query_row_template=>1
,p_plug_column_width=>'valign="top"'
,p_plug_header=>'<p>Microsoft Excelなどのスプレッドシート・プログラムからインポートするデータをコピーし、「データ」フィールドにペーストしてください。</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_field_template=>wwv_flow_api.id(716620262276799717.4309)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch'
,p_help_text=>'このフィールドには、最大30KBのデータを貼り付けることができます。'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
