...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902292531371406046')
...
,p_substitution_value_08=>'アプリケーションに戻る'
,p_substitution_string_09=>'MSG_LANGUAGE'
,p_substitution_value_09=>'言語'
,p_substitution_string_10=>'MSG_COMPANY'
,p_substitution_value_10=>'ワークスペース: &COMPANY.'
,p_substitution_string_11=>'MSG_COPYRIGHT'
,p_substitution_value_11=>'Copyright &copy; 1999, 2015, Oracle. All rights reserved.'
,p_substitution_string_12=>'VIEW'
,p_substitution_value_12=>'表示'
...
,p_list_text_01=>'最新バージョンのダウンロードやドキュメントの確認を行ったり、各種関連資料にアクセスできるOracle Application Expressのホームページ。'
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>' alt=""'
,p_list_text_01=>'OTNディスカッション・フォーラムでApplication Expressに関する疑問に対してコミュニティ主導の無償サポートを受けます。'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_link_text=>'Application Expressコミュニティ'
,p_list_item_link_target=>'https://apex.oracle.com/pls/apex/f?p=56861:1'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'リファレンス、アプリケーション、コンサルティング会社、ホスト企業などを確認します。'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list(
...
,p_list_text_01=>'Oracle Application Expressに習熟していないユーザー専用の情報と様々なリンクを含むページ。'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Application Expressの最新バージョンを試用できるホスティングされたデモ専用の無償のサービス。'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Oracle by Example (OBE)には、あらかじめ必要なファイルや、様々なアプリケーション・コンポーネントの作成を段階的に示す画面ショット付きのステップバイステップの手順が用意されています。'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list(
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'パスワードの再設定'
,p_list_item_link_target=>'f?p=&APP_ID.:7:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'ワークスペースにサインインできませんか。ここでパスワードを再設定してみてください。'
,p_translate_list_text_y_n=>'Y'
...
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'ワークスペースの検索'
,p_list_item_link_target=>'f?p=&APP_ID.:4:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'関連付けられているワークスペースを忘れましたか。ここで検索できます。'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>'!'||wwv_flow_api.id(6153929631135099)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
...
,p_list_text_01=>'インスタンス管理にサインインします。'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>'!'||wwv_flow_api.id(6153929631135099)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(333182002517862192.4559)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'管理'
,p_list_item_link_target=>'f?p=4050:3:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'インスタンス管理に移動します。'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>wwv_flow_api.id(6153929631135099)
...
,p_list_item_link_text=>'ワークスペースのリクエスト'
...
,p_list_text_01=>'独自のワークスペースをリクエストするには、このウィザードを完了してください。'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1349046415926832.4559)
...
,p_computation_error_message=>'F4550_SERVICE_REQUEST_URLの計算中にエラーが発生しました: #SQLERRM#'
);
end;
/
...
,p_lov_disp_value=>'HRサンプル・ユーザー・アカウントのロック解除'
,p_lov_return_value=>'HR'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(20204016953961621.4559)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'新規ユーザー・アカウントの作成'
...
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'データベース開発(RESOURCE)'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983000163308436.4559)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4559)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983424337308436.4559)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4559)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983847896308436.4559)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4559)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824984287203308437.4559)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4559)
...
,p_shortcut_type=>'HTML_TEXT'
,p_shortcut=>'統合されたオンライン・アプリケーション開発環境を今すぐお試しください。 &PRODUCT_NAME.を使用すると、強力な動的Webアプリケーションを構築でき、ご使用のブラウザからOracleデータベースの完全な機能を使用できます。'
);
end;
/
...
,p_last_upd_yyyymmddhh24miss=>'20150428184611'
);
...
wwv_flow_api.create_page(
 p_id=>1.4559
,p_user_interface_id=>wwv_flow_api.id(4972214035302345.4559)
,p_name=>'Oracle Application Express - サインイン'
,p_page_mode=>'NORMAL'
,p_step_title=>'&PRODUCT_NAME. - サインイン'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
...
,p_button_image_alt=>'ワークスペースのリクエスト'
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">ワークスペースを入力してください。ワークスペース名は大/小文字が区別されません。</div>',
'<div class="htmldbInfoBodyP">これは、仮想プライベート・データベースにアクセスできるオンライン開発サービスです。要求された複数のワークスペースに同一のユーザー名が存在する可能性があるため、このサービスを使用する場合はワークスペースを入力してください。</div>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">ユーザー名を入力してください。ユーザー名は大/小文字が区別されません。</div>',
'<div class="htmldbInfoBodyP">認証され、適切な証明書を持っているとみなされた場合は、追加のユーザーを作成できます。</div>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">パスワードを入力してください。パスワードは大/小文字が区別されます。このパスワードは、このサービスに固有です。各ワークスペースには、複数のユーザーが存在する可能性があることに注意してください。</div>',
'<div class="htmldbInfoBodyP">パスワードを忘れた場合は、「<span class="fielddatabold">パスワードの再設定</span>」を選択してください。</div>'))
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_error_message=>'ワークスペース名を入力してください'
,p_always_execute=>'N'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'ユーザー名を入力してください'
,p_always_execute=>'N'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'パスワードを入力してください'
,p_always_execute=>'N'
...
,p_item_css_classes=>'icon-login-username'
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'ワークスペースに関連付けられている電子メール・アドレスを入力してください。ワークスペース名はこの電子メールに送信されます。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
,p_process_error_message=>'エラー'
,p_process_when_button_id=>wwv_flow_api.id(26487014153670357.4559)
,p_process_success_message=>'&F4550_P4_EMAIL.がレコードに存在する場合、 この電子メール・アドレスに関連付けられたワークスペース名を送信します。ワークスペース名の受信に問題がある場合は管理者に問い合せてください。'
);
end;
/
...
,p_prompt=>'<span class="instructiontext">ワークスペースと電子メール・アドレスの有効な組合せが指定されていません。</span>'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'N'
,p_help_text=>'ワークスペースを入力してください。ワークスペースがわからない場合は、「ワークスペースの検索」リンクを使用します。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'パスワードの送信先に使用できる電子メール・アドレスを入力してください。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'EMAIL'
,p_attribute_05=>'BOTH'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'電子メールは空白にできません'
,p_always_execute=>'N'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'ワークスペースは空白にできません'
,p_always_execute=>'N'
...
,p_error_message=>'パスワードのリセット操作は、INTERNALワークスペースではサポートされていません。'
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(47286220449334625.4559)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
...
,p_process_error_message=>'パスワードをリセットできません。'
,p_process_when_button_id=>wwv_flow_api.id(47286811980358498.4559)
,p_process_success_message=>'パスワードのリセット・リクエストは処理に送信されました。'
);
end;
/
...
,p_button_template_id=>wwv_flow_api.id(781653829819356486.4559)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'サインイン・ページに戻る'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
,p_name=>'内部管理ログイン'
,p_page_mode=>'NORMAL'
,p_step_title=>'&PRODUCT_NAME.管理サービス'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_api.id(222575208632450607)
...
,p_item_css_classes=>'icon-login-username'
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'ユーザー名を入力してください。ユーザー名は大/小文字が区別されません。認証され、適切な証明書を持っているとみなされた場合は、別のユーザー名を作成できます。'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'パスワードを入力してください。パスワードは大/小文字が区別されます。パスワードを忘れた場合は、「パスワードを忘れた場合」リンクをクリックしてください。各ワークスペースは複数のユーザーを持つことに注意してください。'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_computation(
...
wwv_flow_api.create_page(
 p_id=>20.4559
,p_user_interface_id=>wwv_flow_api.id(4972214035302345.4559)
,p_name=>'Oracle Application Expressログイン'
,p_page_mode=>'NORMAL'
,p_step_title=>'&PRODUCT_NAME.ログイン'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_javascript_code=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
,p_button_template_id=>wwv_flow_api.id(781653829819356486.4559)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'新しいワークスペースのリクエスト'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_button_redirect_url=>'f?p=4700:1:&SESSION.::&DEBUG.:RP:::'
,p_button_condition=>'wwv_flow_platform.get_preference( p_preference_name => ''SERVICE_REQUEST_FLOW'' ) <> ''MANUAL'''
,p_button_condition_type=>'PLSQL_EXPRESSION'
