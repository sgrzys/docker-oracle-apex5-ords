...
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Packaged Apps Only'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824976787312308427)
,p_page_template_id=>wwv_flow_api.id(728299018883563592)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977164944308427)
,p_page_template_id=>wwv_flow_api.id(728299018883563592)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977534964308429)
,p_page_template_id=>wwv_flow_api.id(728299018883563592)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977932305308429)
,p_page_template_id=>wwv_flow_api.id(728299018883563592)
...
,p_page_is_public_y_n=>'N'
,p_cache_mode=>'NOCACHE'
,p_last_upd_yyyymmddhh24miss=>'20150313123309'
);
wwv_flow_api.create_page_plug(
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Request Workspace - Second Page'
...
,p_page_is_public_y_n=>'N'
,p_cache_mode=>'NOCACHE'
,p_last_upd_yyyymmddhh24miss=>'20150313123342'
);
wwv_flow_api.create_page_plug(
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Your account information will be sent to this email address.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
,p_field_template=>wwv_flow_api.id(481972771960821314)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Enter the workspace name you would like to have.  When your workspace is provisioned, you will login using a workspace / username / password combination.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'BOTH'
...
,p_last_upd_yyyymmddhh24miss=>'20150313123418'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18348331817861713)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18348522944868646)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18348331817861713)
...
,p_page_is_public_y_n=>'N'
,p_cache_mode=>'NOCACHE'
,p_last_upd_yyyymmddhh24miss=>'20150313123237'
);
wwv_flow_api.create_page_plug(
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Request Workspace - Identify Schema'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586)
,p_page_template_options=>'#DEFAULT#'
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Request Workspace - Schema Warnings'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586)
,p_page_template_options=>'#DEFAULT#'
...
,p_cache_mode=>'NOCACHE'
,p_cache_timeout_seconds=>21600
,p_last_upd_yyyymmddhh24miss=>'20150313123526'
);
wwv_flow_api.create_page_plug(
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Request Workspace - Project Description'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586)
,p_page_template_options=>'#DEFAULT#'
...
,p_page_is_public_y_n=>'N'
,p_cache_mode=>'NOCACHE'
,p_last_upd_yyyymmddhh24miss=>'20150313123552'
);
wwv_flow_api.create_page_plug(
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Service Agreement'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586)
,p_page_template_options=>'#DEFAULT#'
...
,p_page_is_public_y_n=>'N'
,p_cache_mode=>'NOCACHE'
,p_last_upd_yyyymmddhh24miss=>'20150313123637'
);
wwv_flow_api.create_page_plug(
...
,p_name=>'Request Workspace - Confirmation'
,p_page_mode=>'NORMAL'
,p_step_title=>'Request Workspace - Confirmation'
...
,p_cache_mode=>'NOCACHE'
,p_cache_timeout_seconds=>21600
,p_last_upd_yyyymmddhh24miss=>'20150313123704'
);
wwv_flow_api.create_page_plug(
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'<p class="a-Wizard-text">Please verify your workspace request.</p>'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
...
,p_page_mode=>'NORMAL'
,p_step_title=>'&PRODUCT_NAME. Workspace Creation'
,p_allow_duplicate_submissions=>'N'
...
,p_last_upd_yyyymmddhh24miss=>'20150223095208'
);
wwv_flow_api.create_page_plug(
