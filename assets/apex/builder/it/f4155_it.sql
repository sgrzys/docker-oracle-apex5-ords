...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902240779847377956')
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(131180169902861.4159)
...
'</div>'))
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>702684260095026477.4159
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780089694684785.4159)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4159)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780455120684785.4159)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4159)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780833657684786.4159)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4159)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146781259067684786.4159)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4159)
...
,p_last_upd_yyyymmddhh24miss=>'20150428184243'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7642519848874484.4159)
,p_plug_name=>'È stato eseguito il logout.'
...
'Si è stati reindirizzati qui dopo aver utilizzato un collegamento di logout fornito da uno schema di autenticazione. Per eseguire il reindirizzamento a una pagina dell''applicazione, procedere come indicato di seguito.',
'<ul>',
'<li>Creare una pagina nell''applicazione e assegnarle un alias PUBLIC_PAGE.',
'<li>Nella pagina relativa agli attributi pagina di Builder, selezionare l''attributo di pagina pubblica "Sì, questa pagina è pubblica".',
...
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Facendo clic sul pulsante <b>Non rimuovere l''area di lavoro</b> riportato di seguito si indica che l''area di lavoro &P99_WORKSPACE_NAME. non deve essere eliminata.  <b>L''esecuzione di questa azione è necessaria per evitare che l''area di lavoro &P99_W'
...
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'&P99_LAST_UPDATED_BY., un amministratore dell''area di lavoro &P99_WORKSPACE_NAME., ha già specificato che questa area di lavoro non deve essere rimossa. L''ultimo aggiornamento è stato eseguito da &P99_LAST_UPDATED_BY. il &P99_LAST_UPDATED..',
'<p>',
'Se l''area di lavoro non è più necessaria, fare clic sul pulsante <b>Ho cambiato idea - Rimuovi area di lavoro</b>: l''area di lavoro verrà rimossa in modo automatico il o dopo il <span style="font-weight:bold;color:#ff0033;">&P99_DATE_TO_BE_PURGED.</s'
||'pan>.',
''))
,p_translate_title=>'N'
,p_plug_query_row_template=>1
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'Questa applicazione viene usata per confermare l''uso di un''area di lavoro su &P99_APEX_URL.. L''accesso a questa pagina è stato eseguito con un URL non valido. Per porre domande su questa applicazione o sul processo di rimozione, inviare un messaggio '
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'L''area di lavoro inattiva &P99_WORKSPACE_NAME. verrà eliminata in data &P99_DATE_TO_BE_PURGED..',
'<br/><br/>'))
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'L''area di lavoro <strong>&P99_WORKSPACE_NAME.</strong> è stata rimossa il <strong>&P99_DATE_PURGED.</strong>.',
'<p>',
...
,p_process_success_message=>'L''area di lavoro &P99_WORKSPACE_NAME. non verrà rimossa. Grazie.'
);
wwv_flow_api.create_page_process(
...
,p_process_success_message=>'L''area di lavoro &P99_WORKSPACE_NAME. verrà rimossa il o dopo il &P99_DATE_TO_BE_PURGED.. Grazie.'
);
wwv_flow_api.create_page_process(
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'La sottoscrizione corrente al report indica <strong>&P200_EMAIL.</strong>. Se non si desidera ricevere più i messaggi all''indirizzo di posta elettronica, fare clic su <strong>Annulla sottoscrizione</strong> di seguito:'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Grazie. La sottoscrizione per i messaggi di posta elettronica di sottoscrizione al report è stata annullata.  '
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_display_column=>1
,p_plug_display_point=>'BODY_3'
,p_plug_source=>'Questa applicazione viene usata per annullare le sottoscrizioni ai report. L''accesso a questa pagina è stato eseguito con un URL non valido.'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
