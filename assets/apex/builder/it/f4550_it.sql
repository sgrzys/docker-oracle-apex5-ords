...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902292393154405839')
...
,p_substitution_value_11=>'Copyright © 1999-2015, Oracle e/o relative consociate. Tutti i diritti riservati.'
...
,p_list_text_01=>'Scaricare la versione più recente del programma, consultare la documentazione e accedere ad altri componenti correlati mediante la home page di Oracle Application.'
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Riesaminare riferimenti, applicazioni, società di consulenza e di hosting e altro ancora.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list(
...
,p_list_text_01=>'Utilizzare una pagina dedicata agli utenti che iniziano a usare Oracle Application Express con informazioni e numerosi collegamenti.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Servizio di "sola demo" gratuito che consente di valutare le caratteristiche della versione più recente di Application Express.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Se non si è in grado di collegarsi alla propria area di lavoro, provare a reimpostare la password qui.'
,p_translate_list_text_y_n=>'Y'
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Se non si ricordano più le aree di lavoro alle quali si è associati, è possibile scoprirlo qui.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>'!'||wwv_flow_api.id(6153929631135099)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(333182002517862192.4554)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'Amministrazione'
,p_list_item_link_target=>'f?p=4050:3:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Andare ad Amministrazione istanza.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>wwv_flow_api.id(6153929631135099)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1349046415926832.4554)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983000163308436.4554)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4554)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983424337308436.4554)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4554)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983847896308436.4554)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4554)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824984287203308437.4554)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4554)
...
,p_last_upd_yyyymmddhh24miss=>'20150428184324'
);
...
'<div class="htmldbInfoBodyP">Questo è un servizio di sviluppo in linea che fornisce accesso a un database privato virtuale. Poiché è possibile che lo stesso nome utente esista in più aree di lavoro, è necessario immettere la propria area di lavoro pe'
...
'<div class="htmldbInfoBodyP">Una volta effettuata l''autenticazione, se si dispone delle credenziali appropriate è possibile creare utenti aggiuntivi.</div>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">Immettere la password. Le password fanno distinzione tra maiuscole e minuscole. Questa password è specifica per questo servizio. Ciascuna area di lavoro può avere più utenti.</div>',
...
,p_item_css_classes=>'icon-login-username'
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Immettere l''indirizzo di posta elettronica associato all''area di lavoro. Il nome dell''area di lavoro verrà inviato a questo indirizzo.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
,p_process_success_message=>'Se &F4550_P4_EMAIL. è stato registrato, si riceveranno i nomi delle aree di lavoro associate a questo indirizzo di posta elettronica. In caso di problemi relativi alla ricezione dei nomi delle aree di lavoro, contattare l''amministratore.'
);
end;
/
...
,p_prompt=>'<span class="instructiontext">La combinazione fornita di nome di area di lavoro e indirizzo di posta elettronica non è valida.</span>'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Il campo Posta elettronica non può essere vuoto'
,p_always_execute=>'N'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Il campo Area di lavoro non può essere vuoto'
,p_always_execute=>'N'
...
,p_process_success_message=>'La richiesta di reimpostazione della password è stata inviata per essere elaborata.'
);
end;
/
...
,p_item_css_classes=>'icon-login-username'
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Immettere il nome utente. Il nome utente non fa distinzione tra maiuscole e minuscole. Una volta effettuata l''autenticazione, se si dispone delle credenziali appropriate è possibile creare nomi utente aggiuntivi.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'Immettere la password. Le password fanno distinzione tra maiuscole e minuscole. Se si dimentica la propria, fare clic sul collegamento "Password dimenticata". Ciascuna area di lavoro può avere più utenti.'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_computation(
