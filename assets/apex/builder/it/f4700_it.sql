...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902294138668408032')
...
,p_substitution_value_12=>'Copyright © 1999-2015, Oracle e/o relative consociate. Tutti i diritti riservati.'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1352228430926978.4704)
...
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Solo applicazioni preparate'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824976787312308427.4704)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4704)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977164944308427.4704)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4704)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977534964308429.4704)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4704)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977932305308429.4704)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4704)
...
,p_last_upd_yyyymmddhh24miss=>'20150428184325'
);
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Richiesta servizio'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Richiesta area di lavoro - Seconda pagina'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Le informazioni dell''account dell''utente verranno inviate a questo indirizzo di posta elettronica.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
,p_field_template=>wwv_flow_api.id(481972771960821314.4704)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Immettere il nome dell''area di lavoro desiderata. Dopo il provisioning dell''area di lavoro, si eseguirà il login utilizzando una combinazione di area di lavoro, nome utente e password.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'BOTH'
...
,p_plug_name=>'È richiesta di area di lavoro.'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(481970015003751305.4704)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18348331817861713.4704)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18348522944868646.4704)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18348331817861713.4704)
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Richiesta area di lavoro - Identifica schema'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4704)
,p_page_template_options=>'#DEFAULT#'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Selezionare la quantità di spazio su disco necessaria. Una volta creato lo schema, è possibile richiedere ulteriore spazio.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
'Il nome dello schema è l''utente del database Oracle che sarà il proprietario degli oggetti di database. Scegliere tale nome con attenzione, poiché la modifica degli schemi può comportare task complessi. Una volta fornito il servizio, si riceverà la p'
||'assword dello schema e la password di login. Una volta creata l''area di lavoro, è possibile aggiungervi altri schemi.',
'',
'',
'',
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Immettere il nome dello schema che si desidera rendere accessibile per la nuova area di lavoro di &PRODUCT_NAME.. Una volta creata l''area di lavoro, è possibile aggiungervi altri schemi.',
''))
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Il nome dello schema (&SCHEMA_NAME.) è un nome riservato o limitato. Immettere uno schema diverso.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4704)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Il nome di schema non è valido, specificarne un altro.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4704)
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Richiesta area di lavoro - Avvertenze schema'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4704)
,p_page_template_options=>'#DEFAULT#'
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Richiesta area di lavoro - Descrizione progetto'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4704)
,p_page_template_options=>'#DEFAULT#'
...
,p_prompt=>'Perché si sta richiedendo questo servizio?'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'Se l''accordo con la società o per il servizio richiede che la richiesta venga giustificata, fornire una giustificazione.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Accordo di servizio'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4704)
,p_page_template_options=>'#DEFAULT#'
...
,p_error_message=>'Per proseguire è necessario accettare i termini.'
,p_always_execute=>'N'
...
,p_name=>'Richiesta area di lavoro - Conferma'
,p_page_mode=>'NORMAL'
,p_step_title=>'Richiesta area di lavoro - Conferma'
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'<p class="a-Wizard-text">Verificare la richiesta di area di lavoro.</p>'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
...
'Fare attenzione nell''immettere le lettere poiché vi è <b>distinzione tra maiuscole e minuscole</b>.'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_page_mode=>'NORMAL'
,p_step_title=>'&PRODUCT_NAME. Creazione dell''area di lavoro'
,p_allow_duplicate_submissions=>'N'
