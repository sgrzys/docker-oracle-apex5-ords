...
prompt APPLICATION 4757 - Oracle APEX Packaged Applications
--
-- Application Export:
--   Application:     4757
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902296957958412419')
...
,p_substitution_value_04=>'語言'
,p_substitution_string_05=>'MSG_COPYRIGHT'
,p_substitution_value_05=>'版權所有 &copy; 1999, 2015, Oracle. 保留一切權利.'
,p_substitution_string_06=>'MSG_USER'
,p_substitution_value_06=>'使用者'
,p_substitution_string_07=>'MSG_JSCRIPT'
,p_substitution_value_07=>'您必須啟用 JavaScript, 才能執行本產品.'
,p_substitution_string_08=>'MSG_TBL_SUMMARY'
,p_substitution_value_08=>'頁面版面配置表格'
...
,p_substitution_value_18=>'返回應用程式'
,p_substitution_string_19=>'DELETE_MSG'
,p_substitution_value_19=>'要執行此刪除動作嗎?'
,p_substitution_string_20=>'PAGE'
,p_substitution_value_20=>'頁面'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719115788931175389.4757)
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'套裝應用程式管理'
...
,p_list_item_disp_cond_type=>'PLSQL_EXPRESSION'
,p_list_item_disp_condition=>'wwv_flow_platform.get_preference(''SERVICE_REQUESTS_ENABLED'') = ''Y'''
,p_list_text_01=>'要求存取額外的儲存體或終止工作區.'
...
,p_list_text_01=>'設定控制工作區之功能的偏好設定.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>wwv_flow_api.id(404682514053862570)
,p_list_item_current_type=>'TARGET_PAGE'
);
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'管理使用者'
,p_list_item_link_target=>'f?p=&APP_ID.:300:&SESSION.::&DEBUG.:300:::'
,p_list_item_icon=>'icon-apex-user'
,p_list_text_01=>'控制 Application Express 工作區管理員、應用程式開發人員以及一般使用者的存取權.'
,p_translate_list_text_y_n=>'Y'
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'訂閱'
,p_list_item_link_target=>'f?p=&APP_ID.:17:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'icon-report-subscriptions'
,p_list_text_01=>'檢視及管理套裝應用程式使用者所建立的互動式報表訂閱項目.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list(
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'詳細的表格空間使用狀況報表 (可能需要幾秒鐘時間)'
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'應用程式活動'
,p_list_item_link_target=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'icon-utilities-activity'
,p_list_text_01=>'應用程式活動的月行事曆會按日期報告不同的使用者和頁面檢視總計.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'最常使用的使用者'
,p_list_item_link_target=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.:RP,30:::'
,p_list_item_icon=>'icon-apex-user'
,p_list_text_01=>'按使用者聚總的頁面檢視報表.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list(
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1355859641927129.4757)
...
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
,p_attribute_01=>'SQL'
,p_error_message=>'您沒有使用「SQL 工作室」的授權'
...
,p_error_message=>'「開發環境」正在使用外部「認證」'
...
,p_error_message=>'您沒有安裝「套裝應用程式」的授權'
...
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'設定完整電子郵件地址的使用者名稱'
,p_lov_return_value=>'N'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805346868716446830.4757)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'排除使用者名稱的 @ 網域部分'
,p_lov_return_value=>'Y'
);
wwv_flow_api.create_list_of_values(
...
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'建立 Application Express 使用者'
,p_lov_return_value=>'Y'
);
wwv_flow_api.create_list_of_values(
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(805102768336534835.4757)
,p_lov_name=>'REQUEST SERVICE'
,p_lov_query=>'.'||wwv_flow_api.id(805102768336534835)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103010621534839.4757)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'要求新的綱要'
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103339867534842.4757)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'要求更多儲存體'
,p_lov_return_value=>'STORAGE'
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103624199534842.4757)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'要求終止'
,p_lov_return_value=>'TERMINATION'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4757)
,p_short_name=>'移除套裝應用程式'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4757)
,p_short_name=>'安裝套裝應用程式'
,p_link=>'f?p=&APP_ID.:83:&SESSION.::&DEBUG.:::'
,p_page_id=>83
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(492872210530717222.4757)
,p_parent_id=>wwv_flow_api.id(806264496767109365.4757)
,p_short_name=>'安裝套裝應用程式'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(750897172696068128.4757)
,p_parent_id=>wwv_flow_api.id(.4757)
,p_short_name=>'<span class="u-VisuallyHidden">應用程式</span><span class="a-Icon icon-breadcrumb-previous"></span>'
,p_link=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::'
,p_page_id=>1
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(788162743515607361.4757)
,p_parent_id=>wwv_flow_api.id(750897172696068128.4757)
,p_short_name=>'套裝應用程式儀表板'
...
,p_parent_id=>wwv_flow_api.id(798343358044477984.4757)
,p_short_name=>'最常使用的使用者'
,p_link=>'f?p=&APP_ID.:30:&SESSION.'
,p_page_id=>30
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(1224179617523676528.4757)
,p_parent_id=>wwv_flow_api.id(788162743515607361.4757)
,p_short_name=>'套裝應用程式'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747469399730136676.4757)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747469775365136676.4757)
,p_page_template_id=>wwv_flow_api.id(741366253443994295.4757)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970712970659339897.4757)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970713375545339897.4757)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4757)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970713743513339897.4757)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4757)
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714187781339897.4757)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4757)
,p_name=>'Right Side Bar'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714515296339897.4757)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4757)
,p_name=>'After Body'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714940759339898.4757)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4757)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970715378375339898.4757)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4757)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824980978803308434.4757)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4757)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824981311553308434.4757)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4757)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824981767148308434.4757)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4757)
,p_name=>'Wizard Title'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824982170342308434.4757)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4757)
...
,p_display_name=>'INTERNAL Application Express 帳戶'
,p_supported_ui_types=>'DESKTOP'
...
,p_subscribe_plugin_settings=>true
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>「新增全部勾選核取方塊」動態動作會將含有 #CHECK_ALL_CHECKBOX# 字串的資料欄標題轉換為可存取的全部勾選樣式核取方塊, 而此核取方塊會勾選和取消勾選其對應資料欄中的所有核取方塊.<p>',
'<p>',
'若要使用此 Plug-in, 請確定已設定下列屬性:',
'<ol>',
'<li>在報表資料欄中, 將 ''#CHECK_ALL_CHECKBOX#'' 定義為「標題」值.</li>',
'<li>在「動態動作 - 時機」屬性中, 選取含有資料欄的報表區域.</li>',
'<li>定義「動態動作」以觸發「重新整理後」, 以及「載入頁面時觸發」的動作 (如果透過選取「頁面設計工具」之「轉換」區段中的區域並從這裡建立「動態動作」來建立「動態動作」, 則兩者預設都適用).</li>',
'<li>這不會處理每個資料列上轉換的核取方塊的輔助功能, 而且必須分別在區域來源中進行 (如需範例, 請參閱 4000:656「區域」區域).</li>',
'</ol>',
'</p>'))
,p_version_identifier=>'1.0'
);
...
,p_subscribe_plugin_settings=>true
,p_help_text=>'<p>此 Plugin 可繪製內含標籤、值、甚至圖示的水平長條圖</p>'
,p_version_identifier=>'1.0'
,p_files_version=>16
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006268931685907537.4757)
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006277098711907541.4757)
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006269307704907538.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4757)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006269805212907538.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4757)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006270313871907538.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4757)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006270898104907538.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006271224803907539.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006271675789907539.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272020373907539.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272490890907539.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272846289907539.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006268931685907537.4757)
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006273272857907539.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006273675862907539.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006274092256907540.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006279811153907542.4757)
,p_depending_on_condition_type=>'IN_LIST'
,p_depending_on_expression=>'CUSTOM'
,p_help_text=>'<p>A list of CSS supported colors separated by colons.</p>'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006274433061907540.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006274824808907540.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006274433061907540.4757)
,p_display_sequence=>10
,p_display_value=>'Value'
,p_return_value=>'VALUE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006275327182907540.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006274433061907540.4757)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006275868271907541.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>12
,p_display_sequence=>120
...
,p_is_required=>false
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_api.id(2006274433061907540.4757)
,p_depending_on_condition_type=>'IN_LIST'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006276251069907541.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>13
,p_display_sequence=>130
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006276652694907541.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>14
,p_display_sequence=>140
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006277098711907541.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>15
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006277474563907541.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006277098711907541.4757)
,p_display_sequence=>10
,p_display_value=>'Icon Chart'
,p_return_value=>'ICON'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006277997330907541.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006277098711907541.4757)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006278471627907542.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>16
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006278897464907542.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006278471627907542.4757)
,p_display_sequence=>10
,p_display_value=>'Absolute'
,p_return_value=>'ABSOLUTE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006279373310907542.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006278471627907542.4757)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006279811153907542.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>17
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006280226737907543.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4757)
,p_display_sequence=>5
,p_display_value=>'Default'
,p_return_value=>'DEFAULT'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006280711849907543.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4757)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006281297160907543.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4757)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006281704972907543.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4757)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006282208978907543.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4757)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006282788751907543.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4757)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006283223942907543.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4757)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006283798141907544.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>18
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006284193963907544.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006283798141907544.4757)
,p_display_sequence=>10
,p_display_value=>'Above the bar'
,p_return_value=>'ABOVE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006284698759907545.4757)
,p_plugin_attribute_id=>wwv_flow_api.id(2006283798141907544.4757)
,p_display_sequence=>20
...
begin
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006285119215907545.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>19
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006285570964907546.4757)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>20
...
,p_last_upd_yyyymmddhh24miss=>'20150428185711'
);
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750747661941502571.4757)
,p_plug_name=>'關於'
...
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>套裝應用程式是一套商業生產力應用程式, 只要按幾下滑鼠便能安裝. 這些解決方案可立即作為實際執行應用程式來增強商業處理作業, 而且 Oracle 提供完全支援.</p>',
''))
,p_plug_query_row_template=>1
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750750940971502582.4757)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750751542816502585.4757)
,p_plug_name=>'輔助功能模式'
,p_region_css_classes=>' a-Region--stacked a-Region--padded a-Region--flush a-Region--sideRegion'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750867860695912536.4757)
,p_plug_name=>'應用程式'
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(750862626609892264.4757)
,p_plug_source_type=>'NATIVE_LIST'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(787083093555047575.4757)
,p_name=>'已安裝的套裝應用程式'
...
,p_query_no_data_found=>'未安裝任何套裝應用程式.'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(656958519483052405.4757)
,p_query_column_id=>1
,p_column_alias=>'APP_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'應用程式'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448306370861802.4757)
,p_query_column_id=>2
,p_column_alias=>'RUN_APP_LINK'
,p_column_display_sequence=>4
,p_column_heading=>'執行應用程式連結'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(656958784419052407.4757)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(886493838302981514.4757)
,p_query_column_id=>4
,p_column_alias=>'APP_ID'
,p_column_display_sequence=>9
,p_column_heading=>'應用程式 ID'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(886493647565981512.4757)
,p_query_column_id=>5
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448453999861803.4757)
,p_query_column_id=>6
,p_column_alias=>'MODIFY_APP_BUTTON'
,p_column_display_sequence=>5
,p_column_heading=>'修改應用程式按鈕'
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448530210861804.4757)
,p_query_column_id=>7
,p_column_alias=>'RUN_APP_BUTTON'
,p_column_display_sequence=>6
,p_column_heading=>'執行應用程式按鈕'
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(864570195174731021.4757)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(864570463503731024.4757)
,p_query_column_id=>9
,p_column_alias=>'APP_INFO'
,p_column_display_sequence=>7
,p_column_heading=>'應用程式資訊'
,p_use_as_row_header=>'N'
,p_column_format=>'SINCE'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2310796521456520805.4757)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2310796924341520807.4757)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1494304199802239903.4757)
,p_plug_name=>'精選套裝應用程式'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1199601170102177728.4757)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(787083093555047575.4757)
,p_button_name=>'NEW_INSTALLED_APPS'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404711161197908978.4757)
,p_button_image_alt=>'建立套裝應用程式'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(787719037872821217.4757)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(750755519256502601.4757)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(750751746540502585.4757)
,p_name=>'P1_ACCESSIBILITY_MODE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(750751542816502585.4757)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(933144624364626643.4757)
,p_name=>'RENDERING: Page - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(787083093555047575.4757)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(933144967905626652.4757)
,p_event_id=>wwv_flow_api.id(933144624364626643.4757)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(750754662427502591.4757)
...
'    end if;',
'end;'))
,p_process_error_message=>'設定「輔助功能模式」時發生錯誤'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when=>'P1_ACCESSIBILITY_MODE'
,p_process_when_type=>'REQUEST_EQUALS_CONDITION'
,p_process_success_message=>'已設定輔助功能模式'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959145671052411.4757)
,p_plug_name=>'最常使用的套裝應用程式'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959251264052412.4757)
,p_plug_name=>'使用者安裝的套裝應用程式'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4757)
,p_plug_display_sequence=>50
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959463401052414.4757)
,p_plug_name=>'套裝應用程式'
...
'end loop;'))
,p_plug_source_type=>'NATIVE_PLSQL'
,p_plug_query_row_template=>wwv_flow_api.id(741378333819007312.4757)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959880777052418.4757)
,p_plug_name=>'關於'
,p_region_css_classes=>'a-Region--stacked a-Region--padded a-Region--flush a-Region--sideRegion'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4757)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'您工作區中套裝應用程式的相關測量結果.'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959992513052419.4757)
,p_plug_name=>'套裝應用程式檢視'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788159425426560907.4757)
,p_plug_name=>'已安裝'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4757)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788164282527649493.4757)
,p_plug_name=>'可升級'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4757)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788166095908674996.4757)
,p_plug_name=>'未安裝'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4757)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788982827579790091.4757)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788983890794795218.4757)
,p_plug_name=>'Hidden'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(788983363220793228.4757)
,p_name=>'P2_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(788983890794795218.4757)
...
,p_lov_display_extra=>'YES'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'設定限制此頁面中顯示之監督查詢的時間範圍.'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(789119577877826005.4757)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(789084545317643151.4757)
,p_name=>'RENDERING: Dashboard - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(788982827579790091.4757)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(789084801764643152.4757)
,p_event_id=>wwv_flow_api.id(789084545317643151.4757)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1224170433387563371.4757)
,p_plug_name=>'套裝應用程式'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(1224170516463563371.4757)
,p_name=>'Packaged Applications'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'此報表的資料列數目上限為 #MAX_ROW_COUNT# 個資料列.  請套用篩選, 以減少您查詢中的記錄數目.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224170864888563380.4757)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171279819563380.4757)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224170911190563380.4757)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171038140563380.4757)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171103374563380.4757)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171357038563381.4757)
,p_db_column_name=>'TARGET_URL'
,p_display_order=>52
,p_column_identifier=>'G'
,p_column_label=>'目標 URL'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962307327400233.4757)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1473925915428744023.4757)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962433555400234.4757)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962551146400235.4757)
,p_db_column_name=>'UPGRADE_IS_AVAILABLE'
,p_display_order=>83
,p_column_identifier=>'K'
,p_column_label=>'有升級可用'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(973962130782400231.4757)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(1224170433387563371.4757)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(973962236123400232.4757)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(1224170433387563371.4757)
,p_button_name=>'Reset'
,p_button_action=>'REDIRECT_PAGE'
...
,p_lov_display_extra=>'NO'
,p_help_text=>'設定限制儀表板中顯示之監督查詢的時間範圍.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_da_event(
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'根據您權限的不同, 您可以在「管理」中管理及監督您工作區中的套裝應用程式.'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
...
,p_max_row_count_message=>'此查詢傳回 10,000 個以上的資料列, 請篩選資料, 確保取得完整的結果.'
,p_no_data_found_message=>'套裝應用程式沒有任何使用者預存報表.'
,p_allow_report_categories=>'N'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
...
,p_max_row_count=>'10000'
,p_max_row_count_message=>'此查詢傳回 10,000 個以上的資料列, 請篩選資料, 確保取得完整的結果.'
,p_no_data_found_message=>'套裝應用程式沒有任何訂閱項目.'
,p_allow_report_categories=>'N'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'選擇一個選項, 決定是可讓 &PRODUCT_NAME. 一般使用者帳戶失效, 或可將它們鎖定. 這項功能只適用於',
'使用 &PRODUCT_NAME. 使用者管理介面建立的一般使用者帳戶.',
' 可用的選項包括:',
'<ul>',
'<li>啟用</li>',
'<li>停用</li>',
'</ul>',
'這項功能提供額外的認證安全性給應用程式.',
'如果選取<b>啟用</b>, 使用者帳戶密碼將在設定的期間後失效,',
'帳戶將在超過設定的認證失敗次數之後被鎖定, 而且可將帳戶密碼設成在第一次使用後失效.',
'<p>',
'如果此安裝的 &PRODUCT_NAME. 管理員將<b>要求讓使用者帳戶失效與鎖定功能</b>環境設定設成「是」, 表示必須為所有工作區啟用這項功能, 而該項目將顯示<b>啟用</b>, 並且無法由工作區管理員加以變更.'))
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4757)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'輸入一個正整數, 作為將一般使用者帳戶鎖定前, 允許的連續失敗認證嘗試次數上限. 如果將此欄位留白, 將使用網站層次的<b>允許的登入失敗次數上限</b>環境設定.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'輸入一個正整數, 作為一般使用者帳戶密碼過期前, 還能夠使用的天數上限. 如果將此欄位留白, 將使用網站層次的<b>帳戶密碼期限</b>環境設定.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'end if;'))
,p_process_error_message=>'無法套用工作區偏好設定.'
,p_process_when_button_id=>wwv_flow_api.id(805414831280857790.4757)
,p_process_success_message=>'已套用工作區偏好設定.'
);
wwv_flow_api.create_page_process(
...
,p_error_message=>'未正確設定使用者名稱. 請完全關閉您的瀏覽器, 然後嘗試重新變更您的密碼.'
,p_always_execute=>'N'
...
'end;'))
,p_process_error_message=>'變更密碼時發生錯誤.'
,p_process_when=>':F4750_P24_PASSWORD = :F4750_P24_CONFIRM_PASSWORD'
,p_process_when_type=>'PLSQL_EXPRESSION'
,p_process_success_message=>'已變更密碼.'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(818291832742192134.4757)
...
'        commit;',
' end;'))
,p_process_error_message=>'未順利更新應用程式.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492892500116858121.4757)
,p_process_success_message=>'已順利更新應用程式認證配置.'
);
wwv_flow_api.create_page_process(
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492892500116858121.4757)
,p_process_success_message=>'已變更應用程式認證.'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1119586009828190520.4757)
,p_plug_name=>'應用程式 JSON'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(404672496027804677.4757)
,p_plug_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1212073820889771903.4757)
,p_plug_name=>'搜尋容器'
,p_region_template_options=>'#DEFAULT#'
...
,p_cache_mode=>'NOCACHE'
,p_cache_timeout_seconds=>21600
,p_last_upd_yyyymmddhh24miss=>'20150428185712'
);
wwv_flow_api.create_page_plug(
...
,p_button_template_id=>wwv_flow_api.id(758581488338548971.4757)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'管理 Web 試算表資料庫物件'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(1164736283212438414.4757)
...
,p_process_error_message=>'未順利安裝應用程式.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'已安裝應用程式.'
);
wwv_flow_api.create_page_process(
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'選取一個服務變更要求, 然後按一下<b>下一步</b>.'
,p_attribute_01=>'3'
,p_attribute_02=>'NONE'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'找不到任何「資料庫應用程式」.'
,p_query_num_rows_type=>'ROW_RANGES_WITH_LINKS'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_csv_output=>'N'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'找不到任何「Web 試算表應用程式」.'
,p_query_num_rows_type=>'ROW_RANGES_WITH_LINKS'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_csv_output=>'N'
...
,p_column_display_sequence=>2
,p_column_heading=>'預設表格空間'
,p_use_as_row_header=>'N'
,p_lov_show_nulls=>'NO'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(805274418118000233.4757)
,p_name=>'應用程式開發人員'
,p_template=>wwv_flow_api.id(662132465401686364.4757)
,p_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(805274700563000235.4757)
,p_query_column_id=>1
,p_column_alias=>'THE_NAME'
,p_column_display_sequence=>1
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(805274820294000235.4757)
,p_query_column_id=>2
,p_column_alias=>'THE_NAME'
,p_column_display_sequence=>2
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_page(
 p_id=>103.4757
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4757)
,p_name=>'詳細的表格空間使用狀況報表'
,p_page_mode=>'MODAL'
,p_step_title=>'詳細的表格空間使用狀況報表'
...
'end;'))
,p_process_error_message=>'要求額外儲存體時發生錯誤.'
,p_process_when_button_id=>wwv_flow_api.id(805366770901561427.4757)
,p_process_success_message=>'您要求 &P101_STORAGE. MB 的額外儲存體.'
...
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>工作區管理員可以使用此頁面來要求終止他們目前連線的服務.<br/><br/>',
'',
'<b>重要事項!</b>: 當您的服務終止後, 所有的資料、資料庫物件、資料庫綱要、表格空間、應用程式、命令檔、檔案等都會被移除.</p>',
'',
'<p>請確認要終止您的服務.</p>'))
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
...
,p_error_message=>'此工作區的服務終止要求已經存在.'
,p_always_execute=>'N'
...
'    p_service_attribute_2  => wwv_flow_user_api.get_email(p_username => upper(wwv_flow.g_user)));',
'end;'))
,p_process_error_message=>'送出終止服務要求時發生錯誤.'
,p_process_when_button_id=>wwv_flow_api.id(805380789015646517.4757)
,p_process_success_message=>'已送出服務終止要求.'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>209.4757
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4757)
,p_name=>'Application Express 帳戶設定'
,p_page_mode=>'MODAL'
,p_step_title=>'Application Express 帳戶設定'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(492818829813527218.4757)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#:a-ButtonRegion--noUI'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(492819635063527220.4757)
,p_plug_name=>'設定帳戶'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(770118466855390796.4757)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(492818829813527218.4757)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4757)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(492819215638527220.4757)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(492818829813527218.4757)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492819882805527221.4757)
,p_name=>'P209_APP_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4757)
,p_prompt=>'應用程式名稱:'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
,p_field_template=>wwv_flow_api.id(741376158824001765.4757)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820018143527222.4757)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820296100527225.4757)
,p_name=>'P209_SCHEMA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4757)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820409273527225.4757)
,p_name=>'P209_METHOD'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4757)
,p_item_default=>'E'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820697304527226.4757)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820844713527226.4757)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492821075748527226.4757)
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'指定用來登入套裝應用程式的使用者名稱. 使用者名稱有下列限制: <p/><ul><li>',
'長度上限為 100 個字元</li><li>',
'不可有空格</li>',
'<li>只允許以下特殊字元: @ 和句號 (.)</li></ul>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492821585156527227.4757)
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4757)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'指定密碼. 密碼有大小寫之分.'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492822027856527228.4757)
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4757)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'請再輸入一次密碼.'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492822594676527228.4757)
,p_name=>'P209_EMAIL'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4757)
,p_prompt=>'電子郵件'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4757)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'指定一般項目, 重設密碼通知等使用的電子郵件地址.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(656958442251052404.4757)
...
,p_cSize=>30
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(750871254241940005.4757)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch:a-Form-fieldContainer--autoLabelWidth'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(777061579764817791.4757)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823118333527228.4757)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823384065527229.4757)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823728079527229.4757)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492823955896527229.4757)
...
,p_associated_item=>wwv_flow_api.id(492821075748527226.4757)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824175298527231.4757)
...
,p_associated_item=>wwv_flow_api.id(492822594676527228.4757)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824349197527231.4757)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824530875527231.4757)
...
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_api.id(492821585156527227.4757)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824717510527231.4757)
...
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_api.id(492822027856527228.4757)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824939547527231.4757)
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'確認密碼與輸入的密碼不符.'
,p_always_execute=>'N'
,p_validation_condition=>'P209_CREATE_USER'
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(492819215638527220.4757)
,p_associated_item=>wwv_flow_api.id(.4757)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825193741527232.4757)
,p_validation_name=>'strong password'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825374747527232.4757)
...
,p_when_button_pressed=>wwv_flow_api.id(492819215638527220.4757)
,p_only_for_changed_rows=>'Y'
,p_associated_item=>wwv_flow_api.id(492820844713527226.4757)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(492826451491527234.4757)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492826790590527234.4757)
,p_event_id=>wwv_flow_api.id(492826451491527234.4757)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492826968456527234.4757)
,p_event_id=>wwv_flow_api.id(492826451491527234.4757)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827153196527234.4757)
,p_event_id=>wwv_flow_api.id(492826451491527234.4757)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(492827265876527234.4757)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827513295527235.4757)
,p_event_id=>wwv_flow_api.id(492827265876527234.4757)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827728196527235.4757)
,p_event_id=>wwv_flow_api.id(492827265876527234.4757)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827960709527235.4757)
,p_event_id=>wwv_flow_api.id(492827265876527234.4757)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492828182378527235.4757)
,p_event_id=>wwv_flow_api.id(492827265876527234.4757)
,p_event_result=>'FALSE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(770119774478414886.4757)
,p_name=>'Close Dialog'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(770118466855390796.4757)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(770120016874414887.4757)
,p_event_id=>wwv_flow_api.id(770119774478414886.4757)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(492825632290527232.4757)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4757)
,p_process_when=>'wwv_flow_global.g_cloud and :P83_AUTH = ''NATIVE_APEX_ACCOUNTS'' and :P81_APP_TYPE = ''DATABASE'''
,p_process_when_type=>'PLSQL_EXPRESSION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(492825893428527233.4757)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'    ); ',
'end;'))
,p_process_error_message=>'無法定義 Web 試算表管理員.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4757)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(770120150142419290.4757)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4757)
,p_process_success_message=>'已設定執行應用程式的帳戶.'
);
end;
/
...
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_plug_header=>'已安裝此套裝應用程式.  但是安裝資料庫物件和種籽資料失敗.'
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
);
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'找不到任何安裝結果'
...
'解除鎖定套裝應用程式會讓應用程式<strong>日後無法升級</strong>,',
'且 Oracle Support 將<strong>不再支援</strong>.'))
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
'  end loop;',
'end;'))
,p_process_error_message=>'解除鎖定應用程式時發生錯誤'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'已解除鎖定應用程式'
);
wwv_flow_api.create_page_process(
...
'  end if;',
'end;'))
,p_process_error_message=>'移除應用程式時發生錯誤'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'已移除應用程式'
);
wwv_flow_api.create_page_process(
...
,p_process_error_message=>'未順利更新應用程式.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'已順利更新應用程式.'
);
wwv_flow_api.create_page_process(
...
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'已更新應用程式.'
);
end;
/
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'指定用於瀏覽資料, 建立應用程式, 以及執行 SQL 命令檔的預設綱要. 使用有一個以上綱要的工作區時, 此綱要為建立應用程式, 執行 SQL 查詢等時所使用的預設綱要. 這項功能不控制安全性, 僅僅是使用者的偏好設定.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
...
,p_help_text=>'輸入此開發人員在使用「SQL 工作室」時, 有權存取的綱要清單 (使用冒號區隔). 您在此處輸入的綱要清單決定了使用者所能存取的綱要 (亦即, 為工作區啟動設定之一組完整綱要的部分綱要), 並且決定使用者在「SQL 工作室」所見的綱要名稱.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'指定此使用者是否應有工作區管理員權限. 管理員可以存取所有元件. 此外, 他們還可以管理使用者帳戶、群組以及開發服務.',
'',
'若「執行處理管理員」將元件關閉, 就無法使用這些元件.'))
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'指定此使用者是否應該具備開發人員權限. 開發人員可以安裝、移除或升級套裝應用程式.'
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
,p_attribute_04=>'VERTICAL'
);
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'決定開發人員是否具備「應用程式產生器」的存取權.<br>',
'<br>',
'「管理員」一律可以存取「應用程式產生器」.<br>',
'「開發人員」必須具備「應用程式產生器」、「SQL 工作室」或二者的存取權.<br>',
'<br>',
'「管理員」停用工作區的「應用程式產生器存取權」時, 一律會停用此屬性.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'決定開發人員是否具備「Web 試算表開發」的存取權.<br>',
'<br>',
'「管理員」一律可以存取「Web 試算表開發」.<br>',
'<br>',
'「管理員」停用工作區的「Web 試算表開發存取權」時, 一律會停用此屬性.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'決定開發人員是否具備「SQL 工作室」的存取權.<br>',
'<br>',
'「管理員」一律可以存取「SQL 工作室」.<br>',
'「開發人員」必須具備「應用程式產生器」、「SQL 工作室」或二者的存取權.<br>',
'<br>',
'「管理員」停用工作區的「SQL 工作室存取權」時, 一律會停用此屬性.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'決定使用者是否具備「團隊開發」的存取權.<br>',
'<br>',
'「管理員」一律可以存取「團隊開發」.<br>',
'<br>',
'「管理員」停用工作區的「團隊開發存取權」時, 一律會停用此屬性.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>'選取<b>鎖定</b>可防止帳戶被使用. 選取<b>解除鎖定</b>以允許使用帳戶.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'指定登入系統所使用的使用者名稱. 使用者名稱有下列限制: <ul><li>',
'長度上限為 100 個字元</li><li>',
'不可有空格</li>',
'<li>只允許以下特殊字元: @ 和句號 (.)</li></ul>',
'<p>您也可以使用使用者名稱參照使用監督器應用程式的使用者活動. 組建應用程式時, 連結變數 <code>:app_user</code> 會傳回目前使用者的值.</p>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4757)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'指定使用者的名字以進一步識別使用者. 此選擇性欄位僅供資訊目的之用.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4757)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'指定使用者的姓氏以進一步識別使用者. 此選擇性欄位僅供資訊目的之用.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4757)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'請在此欄位中輸入有關使用者的註解 (僅供資訊目的之用).'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'Y'
,p_attribute_04=>'NONE'
...
,p_use_cache_before_default=>'NO'
,p_prompt=>'密碼'
,p_post_element_text=>' <span class="instructiontext">密碼有大小寫之分</span>'
,p_display_as=>'NATIVE_PASSWORD'
,p_cSize=>30
,p_cMaxlength=>255
,p_field_template=>wwv_flow_api.id(741376307162001773.4757)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'指定密碼. 密碼有大小寫之分. 開發人員可以變更他們自己的密碼. 具有「管理員」權限的開發人員可以變更同一工作區內之使用者的密碼.'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'選取<b>是</b>, 要求此帳戶的使用者在第一次使用目前的密碼登入之後立即變更密碼. 此規則適用於使用此帳戶進行工作區管理或開發, 以及使用此帳戶登入已開發之應用程式等情況.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
...
,p_validation_type=>'NOT_EXISTS'
,p_error_message=>'使用者 &F4750_P301_USER_NAME. 已經存在.'
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
,p_associated_item=>wwv_flow_api.id(801875696425261961.4757)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'「預設綱要」必須在「可存取綱要」之內.'
,p_always_execute=>'N'
...
'END;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'「開發人員」必須具備「應用程式產生器」、「SQL 工作室」或二者的存取權.'
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
...
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'使用者名稱與替執行處理定義的表示式不符.'
,p_always_execute=>'N'
,p_validation_condition=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
'end;',
'commit;'))
,p_process_error_message=>'錯誤: #SQLERRM#'
,p_process_when=>'SUBMIT,CREATE_ANOTHER'
,p_process_when_type=>'REQUEST_IN_CONDITION'
,p_process_success_message=>'已建立使用者.'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>輸入或複製並貼上電子郵件地址 (使用逗號、分號或新行區隔). 請注意, 如果您從電子郵件訊息複製並貼上電子郵件地址, 額外的文字將會被篩除. 系統將以選取的角色增加所有提供的電子郵件使用者. 將忽略現有或重複的電子郵件地址.',
'',
'<p>請注意, 系統會將您指定的密碼指派給每位使用者, 使用者必須在登入後變更其密碼.</p>'))
,p_plug_query_row_template=>1
,p_plug_column_width=>'valign=top'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'輸入或複製並貼上電子郵件地址 (使用逗號、分號或新行區隔). 注意, 如果您從電子郵件訊息複製並貼上電子郵件地址, 將會篩選掉額外的文字.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'指定要包括完整的電子郵件地址, 或是要排除網域名稱. 選項包括:',
'<ul>',
'<li>將使用者名稱設為完整的電子郵件地址 - 包括完整的電子郵件地址.</li>',
'<li>排除使用者名稱的 @ 網域部分 - 移除 @ 符號後的所有文字 (例如, <code>user1@xyz.com</code> 將變成 <code>user1</code>).</li>',
'</ul>'))
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'指定這些使用者是否應有工作區管理員權限. 就像開發人員, 工作區管理員可以建立及修改應用程式和資料庫物件. 此外, 他們還可以管理使用者帳戶、群組以及開發服務.'
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'指定這些使用者是否應有開發人員權限. 開發人員可以建立及修改應用程式和資料庫物件.'
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_cache_timeout_seconds=>21600
,p_help_text=>'AEADM/aadm_users.htm'
,p_last_upd_yyyymmddhh24miss=>'20150428185713'
);
wwv_flow_api.create_page_plug(
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'找不到有效的電子郵件地址.'
,p_query_num_rows_type=>'0'
,p_query_row_count_max=>5000
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_break_type_flag=>'DEFAULT_BREAK_FORMATTING'
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'找不到任何無效的新使用者'
,p_query_num_rows_type=>'0'
,p_query_row_count_max=>5000
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_break_type_flag=>'DEFAULT_BREAK_FORMATTING'
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'<p>上一頁的使用者名稱清單中沒有任何有效的使用者名稱, 共有 &P303_INVALID_COUNT. 個無效的使用者名稱. 請回到該頁檢查您所提供的使用者名稱清單.</p>'
,p_plug_query_row_template=>1
,p_plug_query_num_rows=>15
...
'',
'commit;'))
,p_process_error_message=>'建立使用者時發生未預期的錯誤'
,p_process_success_message=>'已建立使用者'
);
end;
/
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'至少必須選取一位要刪除的使用者.'
,p_always_execute=>'N'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>此使用者管理程式會維護認證配置所使用的帳戶, 這些認證配置會認證儲存在這些帳戶中的使用者名稱和密碼.</p>',
'<p>如果您想變更使用者的密碼, 請輸入新密碼. 否則, 請將密碼欄位留白, 不變更目前的密碼.</p>'))
,p_plug_query_row_template=>wwv_flow_api.id(1939532588110833.4757)
...
,p_plug_name=>'使用者: &F4750_P306_USER_NAME.'
,p_region_template_options=>'#DEFAULT#:a-ButtonRegion--withItems:a-ButtonRegion--noUI:a-ButtonRegion--showTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(740735067061086300.4757)
,p_plug_display_sequence=>20
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>'指定使用者的預設 Oracle 日期格式.  此格式將控制「SQL 工作室」內的預設日期格式.'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'指定此使用者是否應該具備工作區管理員權限. 管理員可以存取所有元件. 此外, 他們還可以管理使用者帳戶和開發服務.',
'',
'如果「執行處理管理員」將元件關閉, 就無法使用這些元件.'))
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
,p_attribute_04=>'VERTICAL'
);
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>使用者屬於標示的群組. 若要新增使用者至群組, 請按一下名稱使其反白顯示. 若要移除某個群組, 請再按一下該群組以取消其反白顯示. </p> ',
'<p>開發人員可以利用群組指派功能, 依據群組控制對特定特性和功能的存取. ',
'此群組功能內建於「應用程式產生器」, 最適合搭配 (也最方便) 應用 Cookie 的認證使用. ',
'不過, 此使用者群組功能不能在不同的認證配置之間運作.</p>',
''))
,p_attribute_01=>'Y'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4757)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'登入系統所使用的密碼. 除非您要變更目前的密碼, 否則請勿輸入密碼.'
,p_attribute_01=>'N'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4757)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'再輸入一次密碼. 除非您想變更目前的密碼, 否則請勿輸入密碼.'
,p_attribute_01=>'N'
,p_attribute_02=>'Y'
);
end;
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4757)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'代表密碼對於開發人員或工作區管理員登入是否有效.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4757)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'指示密碼對於「一般使用者」登入是否有效.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'勾選此方塊即可讓使用者的密碼失效.  這會同時影響使用者的開發人員/管理員登入, 以及以一般使用者身分所進行的存取.  如果失效, 使用者在下次存取此帳戶時, 就必須輸入其舊密碼和新密碼才能登入.'
,p_attribute_01=>'1'
);
wwv_flow_api.create_page_item(
...
'end loop;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'若您更新「使用者名稱」, 則必須提供新的密碼.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(805491074986047781.4757)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'未正確確認密碼, 請輸入相同的密碼兩次.'
,p_always_execute=>'N'
,p_validation_condition=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
'    exit;',
'end loop;'))
,p_process_error_message=>'擷取使用者資訊時發生錯誤.'
);
wwv_flow_api.create_page_process(
...
'  end if;',
'end;'))
,p_process_error_message=>'更新使用者時發生錯誤.'
,p_process_when_button_id=>wwv_flow_api.id(805491074986047781.4757)
,p_process_success_message=>'已更新使用者 "&F4750_P306_USER_NAME.".'
);
end;
/
begin
...
'wwv_flow_fnd_user_api.remove_fnd_user(',
'             p_user_id => :F4750_P306_USER_ID);'))
,p_process_error_message=>'刪除 &F4750_P306_USER_NAME. 時發生錯誤.'
,p_process_when_button_id=>wwv_flow_api.id(805490871563047781.4757)
,p_process_success_message=>'已刪除使用者 &F4750_P306_USER_NAME..'
);
wwv_flow_api.create_page_process(
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'沒有任何針對此頁面輸入的回應.'
...
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(829721255038941612.4757)
,p_prompt=>'應用程式產生器和 APEX 應用程式開發回應'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>96
,p_cMaxlength=>4000
,p_cHeight=>4
,p_field_template=>wwv_flow_api.id(741376307162001773.4757)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'請提供您的意見, 協助我們改進 &PRODUCT_NAME..'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'請指定主要針對哪個元件或功能提供意見.'
,p_attribute_01=>'3'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_validation(
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(829724817666941621.4757)
,p_validation_name=>'Feedback not null'
,p_validation_sequence=>20
,p_validation=>'P11001_FEEDBACK'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'必須指定值'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(829724329405941619.4757)
,p_associated_item=>wwv_flow_api.id(829722489187941618.4757)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
