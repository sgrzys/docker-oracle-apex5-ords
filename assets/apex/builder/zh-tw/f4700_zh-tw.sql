...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902295144932409142')
...
,p_substitution_value_09=>'返回應用程式'
,p_substitution_string_10=>'MSG_LANGUAGE'
,p_substitution_value_10=>'語言'
,p_substitution_string_11=>'PRODUCT_TYPE'
,p_substitution_value_11=>'要求工作區'
,p_substitution_string_12=>'MSG_COPYRIGHT'
,p_substitution_value_12=>'版權所有 &copy; 1999, 2015, Oracle. 保留一切權利.'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1352228430926978.4707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824976787312308427.4707)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4707)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977164944308427.4707)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977534964308429.4707)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4707)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977932305308429.4707)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4707)
...
,p_shortcut=>'<a href="javascript:popupFieldHelp(''#CURRENT_ITEM_ID#'',''&SESSION.'')" tabindex="999" title="此項目的說明."><img src="#IMAGE_PREFIX#infoicon_status_gray.gif" width="16" height="16" /></a>'
);
end;
/
...
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_header=>'<p class="a-Wizard-subHeading">您想要求什麼類型的工作區?</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_field_template=>wwv_flow_api.id(481972771960821314.4707)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'請輸入您想使用的工作區名稱.  當您的工作區啟動設定後, 您可以使用工作區 / 使用者名稱 / 密碼組合來登入.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'BOTH'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18348331817861713.4707)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18348522944868646.4707)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18348331817861713.4707)
,p_button_name=>'FINISH'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(481975658518888812.4707)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'繼續登入畫面'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'選取您將要求的磁碟空間量.  建立您的綱要之後, 如有需要還可要求額外的空間.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
'綱要是將會擁有您的資料庫物件的 Oracle 資料庫使用者.  由於變更綱要是件複雜的工作, 因此請花點時間選擇此名稱.  您的服務啟動設定後, 您將會收到您綱要的密碼和您的登入密碼.  您的工作區建立之後, 就可以新增其他綱要到工作區.',
'',
'',
'',
'有效的綱要名稱必須遵守下列規則:',
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'輸入可存取您的新 &PRODUCT_NAME. 工作區之綱要的名稱.  您的工作區建立之後, 可以新增其他綱要到工作區.',
''))
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'選取要替新工作區建立新的資料庫綱要或設定現有資料庫綱要.'
,p_attribute_01=>'1'
...
,p_error_message=>'綱要 &EXISTING_SCHEMA_NAME. 不存在.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''NO'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(11472001772984287.4707)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'綱要名稱 (&SCHEMA_NAME.) 為保留或限制項目.  請輸入其他綱要.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4707)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'綱要名稱無效.  請指定其他名稱.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4707)
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p class="a-Wizard-text">這項資訊可協助 &PRODUCT_NAME. 管理員瞭解您想使用這項服務的目的.</p>',
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'輸入要求服務的用途.  &PRODUCT_NAME. 管理員會使用此資訊.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'如果您公司或服務合約要求您說明要求的理由, 請輸入理由.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'您必須說明要求這項服務的原因.'
,p_always_execute=>'N'
...
,p_page_is_public_y_n=>'N'
,p_cache_mode=>'NOCACHE'
,p_last_upd_yyyymmddhh24miss=>'20150428185710'
);
wwv_flow_api.create_page_plug(
...
,p_error_message=>'您必須接受條款, 才能繼續進行作業.'
,p_always_execute=>'N'
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'<p class="a-Wizard-text">請驗證您的工作區要求.</p>'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'未正確設定所有值, 請重新啟動工作區要求處理.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(318141939408.4707)
,p_associated_item=>wwv_flow_api.id(.4707)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
...
'end;'))
,p_process_error_message=>'要求 &MSG_COMPANY. 時發生錯誤.'
...
wwv_flow_api.create_page(
 p_id=>73.4707
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4707)
,p_name=>'建立 &PRODUCT_NAME. 工作區'
,p_page_mode=>'NORMAL'
,p_step_title=>'建立 &PRODUCT_NAME. 工作區'
,p_allow_duplicate_submissions=>'N'
...
'<h2 class="a-Wizard-subTitle">已順利建立工作區</h2>'))
);
wwv_flow_api.create_page_plug(
