...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902241747955379070')
...
,p_substitution_value_14=>'返回應用程式'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(131180169902861.4162)
...
'</div>'))
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>702684260095026477.4162
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780089694684785.4162)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4162)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780455120684785.4162)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4162)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780833657684786.4162)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4162)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146781259067684786.4162)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4162)
...
,p_last_upd_yyyymmddhh24miss=>'20150428185630'
);
...
'系統使用認證配置提供的登出連結將您重導至此處. 若要改為重導至您應用程式中的某個頁面, 請執行下列動作:',
'<ul>',
'<li>在您的應用程式中建立一個頁面, 並將它的別名命名為 PUBLIC_PAGE.',
'<li>在「產生器」頁面屬性頁面中, 選取「是 - 此為公用頁面」公用頁面屬性.',
'<li>將您認證配置中的登出 URL 變更為在執行登出程序後重導至這個新頁面. 例如, 使用下面的登出 URL:<p>',
...
wwv_flow_api.create_page(
 p_id=>99.4162
,p_user_interface_id=>wwv_flow_api.id(4973000124302346.4162)
,p_name=>'&PRODUCT_NAME. 非作用中工作區'
,p_page_mode=>'NORMAL'
,p_step_title=>'&PRODUCT_NAME. 非作用中工作區'
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'若按下方的<b>不要將工作區永久清除</b>按鈕, 代表您要求不要將工作區 &P99_WORKSPACE_NAME. 刪除.  <b>您必須執行此動作, 避免將工作區 &P99_WORKSPACE_NAME. 刪除.</b>  '
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
...
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'&P99_WORKSPACE_NAME. 工作區的管理員 &P99_LAST_UPDATED_BY. 已經指定不要將此工作區永久清除.  這由 &P99_LAST_UPDATED_BY. 於 &P99_LAST_UPDATED. 更新.',
'<p>',
'如果不需要再使用此工作區, 請按一下<b>我改變主意 - 請將工作區永久清除</b>按鈕, 系統就會在 <span style="font-weight:bold;color:#ff0033;">&P99_DATE_TO_BE_PURGED.</span> 或之後, 自動將該工作區永久清除.',
''))
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'此應用程式主要用來確認 &P99_APEX_URL. 之工作區的使用狀況.  您使用無效的 URL 存取此頁面.  如果您有關於此應用程式或永久清除處理作業方面的問題, 請隨時利用 <a href="mailto:&P99_PURGE_ADMIN_EMAIL.">&P99_PURGE_ADMIN_EMAIL.</a> 提出您的問題.'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
,p_plug_name=>'&PRODUCT_NAME. 工作區永久清除'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146873381156733851.4162)
...
,p_plug_name=>'感謝您使用 &PRODUCT_NAME. - 已將工作區永久清除'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146873381156733851.4162)
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'系統已排定於 &P99_DATE_TO_BE_PURGED. 刪除非作用中工作區 &P99_WORKSPACE_NAME..',
'<br/><br/>'))
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'系統已在 <strong>&P99_DATE_PURGED.</strong> 將工作區 <strong>&P99_WORKSPACE_NAME.</strong> 永久清除.',
'<p>',
'感謝您使用 &P99_APEX_URL. 的 &PRODUCT_NAME..  ',
''))
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1146918375616882531.4162)
,p_button_image_alt=>'我改變主意 - 請將工作區永久清除'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_button_condition=>'P99_OK_TO_DELETE'
...
,p_process_success_message=>'不會將工作區 &P99_WORKSPACE_NAME. 永久清除.  感謝您.'
);
wwv_flow_api.create_page_process(
...
,p_process_success_message=>'系統將於 &P99_DATE_TO_BE_PURGED. 或之後, 將工作區 &P99_WORKSPACE_NAME. 永久清除.  感謝您.'
);
wwv_flow_api.create_page_process(
...
'    end if;',
'end;'))
,p_process_error_message=>'無效的工作區和要求 ID.'
);
end;
/
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'您目前以 <strong>&P200_EMAIL.</strong> 訂閱下列報表.  若不想再於此電子郵件地址收到電子郵件, 請按一下下方的<strong>取消訂閱</strong>:'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'謝謝.  您現在已經取消訂閱報表訂閱電子郵件.  '
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_display_column=>1
,p_plug_display_point=>'BODY_3'
,p_plug_source=>'此應用程式是用來取消訂閱報表訂閱.  您使用無效的 URL 來存取此頁面.'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
...
,p_process_success_message=>'已取消訂閱. 謝謝.'
);
wwv_flow_api.create_page_process(
...
'    end if;',
'end;'))
,p_process_error_message=>'無效的訂閱和要求 ID.'
);
end;
/
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'在此表單中輸入您的證明資料, 以在此 &PRODUCT_NAME. 應用程式中開始新的階段作業.'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_plug_name=>'登入應用程式 &F4155_P1000_APP_ID.'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146873381156733851.4162)
,p_plug_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'Y'
