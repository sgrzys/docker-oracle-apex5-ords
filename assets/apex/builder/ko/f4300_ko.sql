...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902260576909380981')
...
,p_substitution_value_16=>'응용 프로그램으로 돌아가기'
,p_substitution_string_17=>'DELETE_MSG'
,p_substitution_value_17=>'이 삭제 작업을 수행하겠습니까?'
,p_substitution_string_18=>'FIND'
,p_substitution_value_18=>'찾기'
,p_substitution_string_19=>'HELP'
,p_substitution_value_19=>'도움말'
...
,p_list_item_link_text=>'스프레드시트 임포트'
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'스프레드시트 임포트 저장소'
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'텍스트 데이터 임포트 저장소'
...
,p_list_item_link_text=>'파일 세부 정보'
...
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'테이블 소유자 및 이름'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'텍스트 데이터'
,p_list_item_link_target=>'f?p=&APP_ID.:230:&SESSION.::&DEBUG.:18,19,21,22,24,25:F4300_P230_LOAD_FROM:UPLOAD:'
,p_list_item_icon=>'htmldb/icons/pt_build_options.png'
,p_list_item_icon_attributes=>'width="20" height="20" title="#LIST_LABEL#" alt="#LIST_LABEL#"'
,p_list_text_01=>'구조화된 플랫 파일(예: 콤마로 구분된 데이터(csv) 또는 탭으로 구분된 데이터 파일)에서 데이터를 로드합니다.'
...
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'XML 데이터'
,p_list_item_link_target=>'f?p=&APP_ID.:14:&SESSION.::&DEBUG.:14:::'
,p_list_item_icon=>'htmldb/icons/pt_build_options.png'
,p_list_item_icon_attributes=>'width="20" height="20" title="#LIST_LABEL#" alt="#LIST_LABEL#"'
,p_list_text_01=>'표준 형식의 XML에서 데이터를 로드합니다.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'스프레드시트 데이터'
...
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'텍스트로'
,p_list_item_link_target=>'f?p=&APP_ID.:150:&SESSION.::&DEBUG.:150,180:::'
,p_list_item_icon=>'htmldb/icons/pt_build_options.png'
,p_list_item_icon_attributes=>'width="20" height="20" title="#LIST_LABEL#" alt="#LIST_LABEL#"'
,p_list_text_01=>'데이터베이스 데이터를 플랫 파일로 익스포트합니다.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'XML로'
,p_list_item_link_target=>'f?p=&APP_ID.:90:&SESSION.::&DEBUG.:90:::'
,p_list_item_icon=>'htmldb/icons/pt_build_options.png'
,p_list_item_icon_attributes=>'width="20" height="20" title="#LIST_LABEL#" alt="#LIST_LABEL#"'
,p_list_text_01=>'데이터베이스 데이터를 XML 문서로 익스포트합니다.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list(
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(718997895063143733.4308)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1490428208929471.4308)
...
,p_error_message=>'데이터 로더에 대한 권한이 없습니다.'
...
,p_icon_target=>'#'
,p_icon_image_alt=>'작업 영역 &COMPANY.'
...
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'내 임포트 파일'
,p_lov_return_value=>'MY'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(87919109206509212.4308)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'모든 임포트 파일'
,p_lov_return_value=>'ALL'
);
wwv_flow_api.create_list_of_values(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747112016170067798.4308)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747112448459067799.4308)
,p_page_template_id=>wwv_flow_api.id(716604939833788366.4308)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970723723564339906.4308)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970724109087339906.4308)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4308)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970724540049339907.4308)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4308)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970724913565339907.4308)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4308)
,p_name=>'Right Side Bar'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970725381151339907.4308)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4308)
,p_name=>'After Body'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970725711831339907.4308)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4308)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970726188421339907.4308)
,p_page_template_id=>wwv_flow_api.id(716607780903788372.4308)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824989302125308447.4308)
,p_page_template_id=>wwv_flow_api.id(716609648731788373.4308)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824989797922308447.4308)
,p_page_template_id=>wwv_flow_api.id(716609648731788373.4308)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824990142859308448.4308)
,p_page_template_id=>wwv_flow_api.id(716609648731788373.4308)
,p_name=>'Wizard Title'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824990504766308448.4308)
,p_page_template_id=>wwv_flow_api.id(716609648731788373.4308)
...
,p_last_upd_yyyymmddhh24miss=>'20150428184820'
);
...
wwv_flow_api.create_page(
 p_id=>2.4308
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4308)
,p_name=>'스프레드시트 로드 세부 정보'
,p_page_mode=>'NORMAL'
,p_step_title=>'스프레드시트 로드 세부 정보'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'<p>이 페이지에는 스프레드시트 임포트에 대한 정보가 표시됩니다. 임포트를 실패한 행이 있으면 이 페이지에 오류 메시지가 표시됩니다.</p>'
,p_plug_query_row_template=>1
,p_plug_column_width=>'valign="top"'
,p_plug_query_no_data_found=>'실패한 행을 찾을 수 없습니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
...
,p_query_no_data_found=>'실패한 행을 찾을 수 없습니다.'
...
wwv_flow_api.create_page(
 p_id=>7.4308
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4308)
,p_name=>'텍스트 데이터 로드 세부 정보'
,p_page_mode=>'NORMAL'
,p_step_title=>'텍스트 데이터 로드 세부 정보'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
,p_source_type=>'NATIVE_SQL_REPORT'
,p_header=>'<p>이 페이지에는 텍스트 데이터 파일 임포트에 대한 정보가 표시됩니다. 임포트를 실패한 행이 있으면 이 페이지에 오류 메시지가 표시됩니다.</p>'
,p_fixed_header=>'NONE'
,p_query_row_template=>2
,p_query_num_rows=>15
,p_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_page(
 p_id=>8.4308
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4308)
,p_name=>'텍스트 데이터 로드 저장소'
,p_page_mode=>'NORMAL'
,p_step_title=>'텍스트 데이터 로드 저장소'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_group_id=>wwv_flow_api.id(215731706086585147)
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>이 페이지에는 로드된 텍스트 데이터의 상태가 표시됩니다.</p> ',
'<p>로드된 파일에 액세스하려면 파일 이름을 선택하십시오.</p> ',
'<p>상태 항목을 제거하려면 해당 항목을 선택하고 <b>선택된 항목 삭제</b>를 누르십시오.</p>'))
,p_plug_query_row_template=>1
,p_plug_column_width=>'valign="top"'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'파일을 찾을 수 없습니다.'
,p_query_num_rows_type=>'ROW_RANGES'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_break_type_flag=>'DEFAULT_BREAK_FORMATTING'
...
,p_help_text=>'사용자 파일 또는 모든 파일 표시 지정'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
...
,p_error_message=>'삭제할 파일을 한 개 이상 선택해야 합니다.'
,p_always_execute=>'N'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>이 페이지에는 임포트된 스프레드시트 데이터의 상태가 표시됩니다.</p> ',
'<p>상태 항목을 제거하려면 해당 항목을 선택하고 <b>선택된 항목 삭제</b>를 누르십시오.</p>'))
,p_plug_query_row_template=>1
,p_plug_column_width=>'valign="top"'
,p_attribute_01=>'N'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>' - '
,p_query_no_data_found=>'스프레드시트 임포트를 찾을 수 없습니다.'
,p_query_num_rows_type=>'ROW_RANGES'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_csv_output=>'N'
...
,p_help_text=>'사용자 스프레드시트 임포트 또는 모든 스프레드시트 임포트를 표시하도록 지정하십시오.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
...
'     and security_group_id = :flow_security_group_id;',
'commit;'))
,p_process_error_message=>'삭제하는 중 오류가 발생했습니다.'
,p_process_when_button_id=>wwv_flow_api.id(192155317097767347.4308)
,p_process_success_message=>'스프레드시트 데이터 로드 세부 정보가 삭제되었습니다.'
);
wwv_flow_api.create_page_process(
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>데이터를 로드할 테이블의 데이터베이스 스키마 및 이름을 선택한 다음 업로드할 XML 문서를 찾으십시오.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_help_text=>'데이터를 로드하려는 테이블을 소유하는 데이터베이스 스키마를 선택하십시오.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'데이터를 로드하려는 데이터베이스 테이블을 선택하십시오. 기본적으로 모든 테이블 이름은 대문자로 변환됩니다. 이 기본 동작을 무효화하려면 <span class="fielddatabold">대소문자 유지</span>를 선택하십시오.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_help_text=>'업로드하려는 XML 파일을 찾으려면 <span class="fielddatabold">찾아보기</span>를 누르십시오.'
...
'',
'end;'))
,p_process_error_message=>'XML을 로드하는 중 오류가 발생했습니다.'
,p_process_when_button_id=>wwv_flow_api.id(184013029848654860.4308)
,p_process_success_message=>'XML이 로드되었습니다.'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>18.4308
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4308)
,p_name=>'데이터 로드 - 파일 세부 정보'
,p_page_mode=>'MODAL'
,p_step_title=>'데이터 로드 - 파일 세부 정보'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_group_id=>wwv_flow_api.id(215731706086585147)
,p_step_template=>wwv_flow_api.id(716613771837788376.4308)
...
'업로드할 파일은 텍스트 기반이어야 합니다. .XLS 파일을 업로드하려면 먼저 CSV 형식으로 저장하십시오. <p />',
''))
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'N'
,p_help_text=>'업로드할 파일을 찾으려면 <span class="fielddatabold">찾아보기</span>를 누르십시오.'
,p_attribute_01=>'WWV_FLOW_FILES'
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>데이터의 첫번째 행에 열 이름이 포함되어 있으면 이 체크 박스를 선택하십시오.</p>',
'',
'',
'',
'<pre>',
...
,p_help_text=>'열 구분 기호를 지정하십시오. 탭 구분 기호로는 <code>\t</code>를 사용하십시오.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">구분자를 입력하십시오. 이 문자를 사용하여 데이터 값의 시작 경계와 끝 경계를 구분할 수 있습니다. 구분자를 지정할 경우 데이터 워크숍은 데이터 값의 시작 경계와 끝 경계 앞에 있는 공백을 무시합니다. 이 옵션을 사용하여 데이터 값을 지정된 구분자로 묶을 수도 있습니다.</div>',
'<div class="htmldbInfoBodyP">첫번째 행에 열 이름이 포함된 경우 <span class="fielddatabold">첫번째 행은 열 이름 포함</span>을 선택하십시오.</div>',
''))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>데이터가 국제 통화 기호를 포함하는 경우 여기에 해당 기호를 입력하십시오.</p>',
'<p>예를 들어, 데이터가 "&euro;1,234.56" 또는 "&yen;1,234.56"을 포함하는 경우 "&euro;" 또는 "&yen;"을 입력하십시오. 그렇지 않으면 데이터가 제대로 로드되지 않습니다.</p>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>그룹 구분 기호는 정수 그룹을 구분하는 문자입니다. 예를 들면, 천 단위 및 백만 단위를 표시하는 문자입니다.</p>',
'<p>그룹 구분 기호로 어떤 문자든 사용할 수 있습니다. 그룹 구분 기호는 단일 바이트로 지정해야 하고 소수점 문자와 달라야 합니다. 공백은 문자로 간주하지만 숫자나 다음 문자는 사용할 수 없습니다.</p>',
'<ul class="noIndent">',
'<li>플러스 기호(+)</li>',
'<li>하이픈(-)</li> ',
'<li>여는 꺾쇠 기호(<)</li>',
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>소수점 문자는 숫자의 정수 부분과 소수 부분을 구분합니다.</p>',
'<p> 소수점 문자로 어떤 문자든 사용할 수 있습니다. 소수점 문자는 단일 바이트로 지정해야 하고 그룹 구분 기호와 달라야 합니다. 공백은 문자로 간주하지만 숫자나 다음 문자는 사용할 수 없습니다.</p>',
'<ul class="noIndent">',
'<li>플러스 기호(+)</li>',
'<li>하이픈(-)</li> ',
'<li>여는 꺾쇠 기호(<)</li>',
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'텍스트 파일이 인코딩된 문자 집합을 선택하십시오.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_computation(
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'업로드할 파일을 선택해야 합니다.'
,p_always_execute=>'N'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'구분 기호를 지정해야 합니다.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(2158311458803135.4308)
...
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'파일에 부적합한 파일 확장자가 포함되어 있습니다. 지원되는 바이너리 파일 유형이 없습니다.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(2158311458803135.4308)
...
'  end if;',
'end;'))
,p_process_error_message=>'로드된 데이터를 사용하여 모음을 생성하는 중 오류가 발생했습니다.'
...
'',
':F4300_P13_FILE := null;'))
,p_process_error_message=>'파일을 삭제할 수 없습니다.'
...
wwv_flow_api.create_page(
 p_id=>19.4308
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4308)
,p_name=>'데이터 로드 - 테이블 속성'
,p_page_mode=>'MODAL'
,p_step_title=>'데이터 로드 - 테이블 속성'
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'<p>이 페이지에서는 새 테이블의 모양을 미리 볼 수 있습니다. 테이블 이름을 입력하고 열 이름 또는 데이터 유형을 변경하며 포함시킬 열을 지정하십시오.</p>'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'데이터를 생성하여 로드할 데이터베이스 스키마를 선택하십시오.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
,p_item_comment=>'Generated 20-SEP-2002 14:00:17'
);
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>'생성하려는 테이블 이름을 지정하십시오. 기본적으로 모든 테이블 이름은 대문자로 변환됩니다. 이 기본 동작을 무효화하려면 <span class="fielddatabold">대소문자 유지</span>를 선택하십시오.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_error_message=>'테이블 이름이 너무 깁니다.'
,p_always_execute=>'N'
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'새 테이블에 포함될 열을 한 개 이상 지정해야 합니다. '
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(.4308)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_error_message=>'기존 객체에서 이미 사용하는 이름입니다.'
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(2267110534176923.4308)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'테이블 이름을 지정해야 합니다.'
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(2267110534176923.4308)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_error_message=>'열 길이에 오류가 있습니다.'
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(.4308)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'지정된 테이블 이름은 Oracle 예약어입니다. 다른 이름을 선택하십시오.'
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(.4308)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_error_message=>'지정된 열 이름은 Oracle 예약어입니다. 다른 이름을 선택하십시오.'
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(.4308)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
...
,p_cache_timeout_seconds=>21600
,p_help_text=>'AEUTL/sql_utl_imprt.htm'
,p_last_upd_yyyymmddhh24miss=>'20150428184821'
);
wwv_flow_api.create_page_plug(
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>이 페이지에서 테이블의 기본 키를 지정하십시오. 데이터 집합에 기본 키로 적합한 열이 없을 경우 새 열을 기본 키로 지정하십시오. 기본 키는 테이블의 행을 고유하게 식별하는 데 사용됩니다.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_plug_comment=>'Region generated 20-SEP-2002 14:00:17'
);
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'데이터를 로드할 테이블을 소유하는 스키마입니다.'
,p_attribute_01=>'Y'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
,p_item_comment=>'Generated 20-SEP-2002 14:00:17'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'테이블의 기본 키 열을 지정하십시오. 기본 키란 행을 고유하게 식별하는 열입니다. Oracle에서는 테이블 기본 키가 없어도 되지만 이 마법사에서는 기본 키를 지정해야 합니다.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(716620116614799716.4308)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'기본 키 제약 조건 이름을 지정하십시오.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'기본 키의 계산 방식을 선택하거나, 기본 키의 값 집합을 가지지 않도록 선택하십시오.'
,p_attribute_01=>'1'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'기본 키 값을 채우는 데 사용될 기존 데이터베이스 시퀀스의 이름을 지정하십시오.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(716620116614799716.4308)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'이 새 테이블의 기본 키를 채우기 위해 생성될 새 데이터베이스 시퀀스의 이름을 지정하십시오.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'기본 키로 기존 열을 선택하거나 새 열을 추가할 수 있습니다.'
,p_attribute_01=>'1'
,p_attribute_02=>'SUBMIT'
,p_attribute_03=>'Y'
);
...
,p_field_template=>wwv_flow_api.id(716620116614799716.4308)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'새 기본 키 열의 이름을 입력하십시오.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_validation_type=>'ITEM_NOT_NULL_OR_ZERO'
,p_error_message=>'기본 키를 지정해야 합니다.'
,p_always_execute=>'N'
...
'return true;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'기본 키 열 이름은 30자를 초과할 수 없습니다.'
,p_always_execute=>'N'
,p_validation_condition=>'P13_PK1_OPTION'
,p_validation_condition2=>'NEW_KEY'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
...
'return true;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'새 기본 키를 생성할 때 기본 키는 시퀀스에서 생성되어야 합니다.'
,p_always_execute=>'N'
,p_validation_condition=>'P13_PK1_OPTION'
,p_validation_condition2=>'NEW_KEY'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
...
,p_validation_type=>'ITEM_NOT_NULL_OR_ZERO'
,p_error_message=>'기본 키 이름을 지정해야 합니다.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(2164724759803154.4308)
,p_associated_item=>wwv_flow_api.id(29868930193545840.4308)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(2164724759803154.4308)
,p_process_success_message=>'데이터가 로드되었습니다.'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>22.4308
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4308)
,p_name=>'데이터 로드 - 테이블 소유자 및 이름'
,p_page_mode=>'MODAL'
,p_step_title=>'데이터 로드 - 테이블 소유자 및 이름'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_group_id=>wwv_flow_api.id(215731706086585147)
,p_step_template=>wwv_flow_api.id(716613771837788376.4308)
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>데이터를 로드할 테이블의 데이터베이스 스키마 및 이름을 선택하십시오.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'<p>데이터를 로드하려는 테이블을 소유하는 데이터베이스 스키마를 선택하십시오.</p>'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'<p>데이터를 로드하려는 데이터베이스 테이블을 선택하십시오.</p>'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
...
,p_plug_column_width=>'valign="top"'
,p_plug_header=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<label for="file-upload" class="hideMe508">파일 업로드</label><p>이 페이지에서 업로드할 파일을 찾으십시오. 첫번째 행에 열 이름이 포함된 경우 <b>첫번째 행은 열 이름 포함</b>을 선택하십시오.</p>',
''))
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_plug_comment=>'Region generated 20-SEP-2002 14:00:17'
...
,p_field_template=>wwv_flow_api.id(716620116614799716.4308)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'<p>업로드할 파일을 찾으려면 <strong>찾아보기</strong>를 누르십시오.</p>'
,p_attribute_01=>'WWV_FLOW_FILES'
,p_item_comment=>'Generated 20-SEP-2002 14:00:17'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>데이터의 첫번째 행에 열 이름이 포함되어 있으면 이 옵션을 선택하십시오. 다음 예제를 살펴보십시오.</p>',
'<pre>',
'Name     Salary     Commission',
'Clark    1000       10',
'Scott    2000       20',
...
,p_field_template=>wwv_flow_api.id(716620116614799716.4308)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'<p>열 구분 기호를 지정하십시오. 탭 구분 기호로는 <strong>\t</strong>를 사용하십시오.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(716619902812799716.4308)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'<p>선택적 둘러싸기 문자를 지정하십시오.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'텍스트 파일을 인코딩할 문자 집합을 선택하십시오.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_computation(
...
,p_plug_query_row_template=>1
,p_plug_header=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>이 페이지에서는 데이터가 로드되는 방식을 미리 볼 수 있습니다. 데이터베이스 열 이름을 데이터의 열에 대응시키십시오. 열을 업로드하려면 <b>예</b> 또는 <b>아니오</b>를 선택하십시오. 별표(*)는 필수 열을 나타냅니다. 선택한 테이블에 데이터를 업로드하려면 <b>데이터 로드</b>를 누르십시오.</p> ',
'<p>SQL 워크숍을 사용하여 열 길이 변경, NOT NULL 열 설정 또는 열 유형 변경 등과 같은 테이블 속성을 수정하십시오.</p> ',
''))
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'열 이름은 널일 수 없습니다.'
,p_always_execute=>'N'
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'데이터를 업로드하려면 열을 한 개 이상 지정해야 합니다.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(3749803794082687.4308)
,p_associated_item=>wwv_flow_api.id(.4308)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'&F4300_P22_TABLE_OWNER..&F4300_P22_TABLE_NAME.에 NOT NULL 열이 있습니다. 오류 없이 데이터를 업로드하려면 선택하십시오.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(3749803794082687.4308)
,p_associated_item=>wwv_flow_api.id(.4308)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'중복된 열 이름이 선택되었습니다.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(3749803794082687.4308)
,p_associated_item=>wwv_flow_api.id(.4308)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
...
'   );',
'end;'))
,p_process_error_message=>'데이터를 삽입하는 중 오류가 발생했습니다.'
...
,p_plug_header=>'<p>테이블의 내용은 XML 문서로 익스포트할 수 있습니다. XML 문서로 익스포트할 데이터베이스 스키마, 테이블 및 연관된 열을 선택하십시오.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'XML 문서로 익스포트하려는 데이터베이스 객체 열을 선택하십시오.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'YES'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'선택된 행을 제한할 SQL WHERE 절을 입력하십시오. 예제:',
'<pre>',
'DEPTNO = 10',
'</pre>'))
,p_attribute_01=>'Y'
...
,p_lov_display_extra=>'NO'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'익스포트하려는 객체를 소유하는 데이터베이스 스키마를 선택하십시오.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_input=>'Y'
,p_help_text=>'XML 파일 형식으로 익스포트하려는 데이터베이스 객체 이름을 선택하십시오.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_computation(
...
,p_validation_type=>'ITEM_NOT_NULL_OR_ZERO'
,p_error_message=>'익스포트 테이블을 지정해야 합니다.'
,p_always_execute=>'N'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'익스포트 열을 지정해야 합니다.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(242954438477.4308)
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'선택된 테이블에 익스포트할 레코드가 없습니다. 익스포트하기 전에 테이블에 데이터를 입력하십시오.'
,p_always_execute=>'N'
,p_validation_condition=>'F4300_P80_XML_EXPORT_TABLE'
...
,p_plug_query_number_formats=>'::::::'
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_plug_header=>'<p>테이블의 내용을 구조화된 텍스트 파일로 언로드할 수 있습니다. 예를 들어, 전체 테이블을 콤마 구분 파일(.CSV)로 익스포트할 수 있습니다. 텍스트로 언로드하려는 테이블을 소유하는 데이터베이스 스키마를 선택하십시오.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'일반 텍스트 형식으로 익스포트하려는 데이터베이스 테이블을 선택하십시오.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'이 일반 텍스트 파일에 포함시키려는 열을 선택하십시오. BLOB 및 BFILE을 제외한 Oracle 내장 데이터 유형만 로드 취소가 지원됩니다.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
wwv_flow_api.create_page(
 p_id=>180.4308
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4308)
,p_name=>'텍스트로 로드 취소 - 옵션'
,p_page_mode=>'MODAL'
,p_step_title=>'텍스트로 로드 취소 - 옵션'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_group_id=>wwv_flow_api.id(215731706086585147)
,p_step_template=>wwv_flow_api.id(716613771837788376.4308)
...
,p_plug_query_number_formats=>'::::::'
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_plug_header=>'<p>각 행의 열 값을 구분하는 데 사용할 구분 기호 유형과 열에서 텍스트 문자열을 식별하는 방식을 지정하십시오.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'열 이름을 사용하여 데이터를 익스포트하려면 이 항목을 선택 표시하십시오.'
,p_attribute_01=>'1'
,p_attribute_02=>'VERTICAL'
);
wwv_flow_api.create_page_item(
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">각 행에서 열 값을 구분하는 데 사용되는 구분 기호의 유형을 지정하십시오.</div> ',
'<div class="htmldbInfoBodyP">기본값은 콤마(<code>,</code>)입니다. 탭을 열 구분 기호로 사용하려면 "t"(<code>	</code>)를 입력하십시오.</div>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'DOS를 선택하면 결과 파일의 행 끝이 캐리지 리턴과 줄 바꿈으로 처리되고, UNIX를 선택하면 결과 파일의 행 끝이 줄 바꿈으로 처리됩니다.  '
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(716619902812799716.4308)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'이 옵션을 사용하여 열에서 텍스트 문자열을 식별하는 방식을 지정하십시오. 작은 따옴표 또는 큰 따옴표를 지정할 수 있습니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'end;'))
,p_process_error_message=>'데이터를 익스포트할 수 없습니다.'
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>Microsoft Excel과 같은 스프레드시트 프로그램에서 로드할 데이터를 복사하여 <b>데이터</b> 필드에 붙여 넣으십시오.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_help_text=>'스프레드시트 프로그램에서 로드할 데이터를 복사하고 붙여 넣으십시오.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
'   );',
'end;'))
,p_process_error_message=>'Excel 데이터를 로드하는 중 오류가 발생했습니다.'
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>이 페이지에는 테이블 정의 방법이 미리 보기로 표시됩니다. 테이블 이름을 입력한 후 열 이름, 데이터 유형 및 열 길이를 검토합니다. 열을 업로드하려면 <b>예</b> 또는 <b>아니오</b>를 선택합니다.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'데이터를 생성하여 로드하려는 데이터베이스 스키마를 선택하십시오.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'YES'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'<div class="htmldbInfoBodyP">생성하려는 테이블 이름을 지정하십시오. 기본적으로 모든 테이블 이름은 대문자로 변환됩니다. 이 기본 동작을 무효화하려면 <span class="fielddatabold">대소문자 유지</span>를 선택하십시오.</div>'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'return TRUE;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'하나 이상의 열 이름이 중복됩니다.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(116940415820894908.4308)
,p_associated_item=>wwv_flow_api.id(.4308)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'새 열의 이름을 입력하여 테이블에서 행을 지정하십시오.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'  );',
'end;'))
,p_process_error_message=>'테이블을 생성하는 중 오류가 발생했습니다.'
...
wwv_flow_api.create_page(
 p_id=>230.4308
,p_user_interface_id=>wwv_flow_api.id(4969527595302343.4308)
,p_name=>'데이터 로드 - 대상 및 방식'
,p_page_mode=>'MODAL'
,p_step_title=>'데이터 로드 - 대상 및 방식'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_group_id=>wwv_flow_api.id(215729525348581243)
,p_step_template=>wwv_flow_api.id(716613771837788376.4308)
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'데이터를 로드할 항목을 선택하십시오. 데이터베이스 테이블이 존재하면 "기존 테이블"을 선택하십시오. 새 테이블을 생성하려면 "새 테이블"을 선택하십시오.'
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'스프레드시트에서 복사하여 붙여 넣기 위해 데이터를 파일에서 업로드할지 여부를 지정하십시오.'
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_computation(
...
,p_escape_on_http_input=>'Y'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'Excel 데이터를 로드할 테이블을 소유하는 데이터베이스 스키마를 선택하십시오.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'테이블 소유자를 지정해야 합니다.'
,p_always_execute=>'N'
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>이 페이지에서는 데이터가 로드되는 방식을 미리 볼 수 있습니다. 데이터베이스 열 이름을 데이터의 열에 대응시키십시오. 선택한 테이블에 데이터를 업로드하려면 <b>데이터 로드</b>를 누르십시오.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_plug_query_number_formats=>'::::::'
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_plug_header=>'<p>열을 업로드하려면 <b>예</b> 또는 <b>아니오</b>를 선택하십시오. 별표(*)는 필수 열을 나타냅니다. SQL 워크숍을 사용하여 열 길이 변경, NOT NULL 열 설정 또는 열 유형 변경 등과 같은 테이블 속성을 수정하십시오.</p>'
);
wwv_flow_api.create_page_plug(
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'데이터 업로드를 위해 포함될 열을 한 개 이상 지정해야 합니다.'
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(.4308)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'&F4300_P240_TABLE_OWNER..&F4300_P250_TABLE_NAME.에 NOT NULL 열이 있습니다. 오류 없이 데이터를 업로드하려면 선택하십시오.'
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(.4308)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
...
,p_plug_query_row_template=>1
,p_plug_column_width=>'valign="top"'
,p_plug_header=>'<p>Microsoft Excel과 같은 스프레드시트 프로그램에서 임포트하려는 데이터를 복사하여 <b>데이터</b> 필드에 붙여 넣으십시오.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_field_template=>wwv_flow_api.id(716620262276799717.4308)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch'
,p_help_text=>'이 필드에 최대 30KB의 데이터를 붙여 넣을 수 있습니다.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'붙여 넣은 데이터가 30KB를 초과합니다. 콤마로 구분된 형식(csv)이나 탭으로 구분된 형식으로 파일을 저장한 다음 파일을 업로드하여 데이터를 로드하십시오.'
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(.4308)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
