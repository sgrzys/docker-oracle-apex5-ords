...
prompt APPLICATION 4758 - Oracle APEX Packaged Applications
--
-- Application Export:
--   Application:     4758
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902296364554411262')
...
,p_substitution_value_05=>'Copyright &copy; 1999, 2015, Oracle and/or its affiliates. All rights reserved.'
...
,p_substitution_value_15=>'fmDay yyyy"년"mm"월"dd"일"'
...
,p_substitution_value_18=>'응용 프로그램으로 돌아가기'
,p_substitution_string_19=>'DELETE_MSG'
,p_substitution_value_19=>'이 삭제 작업을 수행하겠습니까?'
,p_substitution_string_20=>'PAGE'
,p_substitution_value_20=>'페이지'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719115788931175389.4758)
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'패키지된 응용 프로그램 갤러리'
,p_list_item_link_target=>'f?p=&APP_ID.:50:&SESSION.::&DEBUG.:50:::'
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'패키지된 응용 프로그램 관리'
...
,p_list_item_disp_cond_type=>'PLSQL_EXPRESSION'
,p_list_item_disp_condition=>'wwv_flow_platform.get_preference(''SERVICE_REQUESTS_ENABLED'') = ''Y'''
,p_list_text_01=>'추가 저장 영역에 대한 액세스를 요청하거나 작업 영역을 종료합니다.'
...
,p_list_text_01=>'작업 영역의 기능을 제어하는 환경설정을 구성합니다.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>wwv_flow_api.id(404682514053862570)
,p_list_item_current_type=>'TARGET_PAGE'
);
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'사용자 관리'
,p_list_item_link_target=>'f?p=&APP_ID.:300:&SESSION.::&DEBUG.:300:::'
,p_list_item_icon=>'icon-apex-user'
,p_list_text_01=>'Application Express 작업 영역 관리자, 응용 프로그램 개발자 및 일반 사용자의 액세스를 제어합니다.'
,p_translate_list_text_y_n=>'Y'
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'적용'
,p_list_item_link_target=>'f?p=&APP_ID.:17:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'icon-report-subscriptions'
,p_list_text_01=>'패키지된 응용 프로그램의 사용자가 생성한 대화식 보고서 적용을 보고 관리합니다.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list(
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'자세한 테이블스페이스 활용도 보고서(약간의 시간이 소요될 수 있음)'
...
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'복수 사용자 삭제'
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'응용 프로그램 작업'
,p_list_item_link_target=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'icon-utilities-activity'
,p_list_text_01=>'일별 총 페이지 뷰 및 개별 사용자를 보고하는 응용 프로그램 작업의 월별 달력입니다.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'최상위 사용자'
,p_list_item_link_target=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.:RP,30:::'
,p_list_item_icon=>'icon-apex-user'
,p_list_text_01=>'사용자별로 집계된 페이지 뷰 보고서입니다.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list(
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1355859641927129.4758)
...
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
,p_attribute_01=>'SQL'
,p_error_message=>'SQL 워크숍을 사용할 수 있는 권한이 없습니다.'
...
,p_error_message=>'개발 환경이 외부 인증을 사용하고 있습니다.'
...
,p_error_message=>'패키지된 응용 프로그램을 설치할 수 있는 권한이 없습니다.'
...
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'사용자 이름을 전체 전자 메일 주소로 설정'
,p_lov_return_value=>'N'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805346868716446830.4758)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'사용자 이름의 일부로 @ 도메인 제외'
,p_lov_return_value=>'Y'
);
wwv_flow_api.create_list_of_values(
...
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Application Express 사용자 생성'
,p_lov_return_value=>'Y'
);
wwv_flow_api.create_list_of_values(
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(805102768336534835.4758)
,p_lov_name=>'REQUEST SERVICE'
,p_lov_query=>'.'||wwv_flow_api.id(805102768336534835)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103010621534839.4758)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'스키마 요청'
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103339867534842.4758)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'저장 영역 요청'
,p_lov_return_value=>'STORAGE'
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103624199534842.4758)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'종료 요청'
,p_lov_return_value=>'TERMINATION'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4758)
,p_short_name=>'패키지된 응용 프로그램 제거'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4758)
,p_short_name=>'패키지된 응용 프로그램 설치'
,p_link=>'f?p=&APP_ID.:83:&SESSION.::&DEBUG.:::'
,p_page_id=>83
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(492872210530717222.4758)
,p_parent_id=>wwv_flow_api.id(806264496767109365.4758)
,p_short_name=>'패키지된 응용 프로그램 설치'
...
,p_short_name=>'패키지된 응용 프로그램 잠금 해제'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4758)
,p_short_name=>'패키지된 응용 프로그램 업데이트'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(750897172696068128.4758)
,p_parent_id=>wwv_flow_api.id(.4758)
,p_short_name=>'<span class="u-VisuallyHidden">응용 프로그램</span><span class="a-Icon icon-breadcrumb-previous"></span>'
,p_link=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::'
,p_page_id=>1
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(788162743515607361.4758)
,p_parent_id=>wwv_flow_api.id(750897172696068128.4758)
,p_short_name=>'패키지된 응용 프로그램 대시보드'
...
,p_short_name=>'패키지된 응용 프로그램 세부 정보'
...
,p_parent_id=>wwv_flow_api.id(798343358044477984.4758)
,p_short_name=>'최상위 사용자'
,p_link=>'f?p=&APP_ID.:30:&SESSION.'
,p_page_id=>30
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(1224179617523676528.4758)
,p_parent_id=>wwv_flow_api.id(788162743515607361.4758)
,p_short_name=>'패키지된 응용 프로그램'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747469399730136676.4758)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747469775365136676.4758)
,p_page_template_id=>wwv_flow_api.id(741366253443994295.4758)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970712970659339897.4758)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970713375545339897.4758)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4758)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970713743513339897.4758)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4758)
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714187781339897.4758)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4758)
,p_name=>'Right Side Bar'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714515296339897.4758)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4758)
,p_name=>'After Body'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714940759339898.4758)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4758)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970715378375339898.4758)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4758)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824980978803308434.4758)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4758)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824981311553308434.4758)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4758)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824981767148308434.4758)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4758)
,p_name=>'Wizard Title'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824982170342308434.4758)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4758)
...
,p_display_name=>'INTERNAL Application Express 계정'
,p_supported_ui_types=>'DESKTOP'
...
,p_subscribe_plugin_settings=>true
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>"모두 선택 체크 박스 추가" 동적 작업은#CHECK_ALL_CHECKBOX# 문자열이 포함된 열 제목을 액세스 가능한 모든 스타일 선택 체크 박스로 변환합니다. 이 체크 박스를 사용하면 해당 열에 있는 모든 체크 박스를 선택 및 선택 취소할 수 있습니다.<p>',
'<p>',
'이 플러그인을 사용하려면 다음 속성이 설정되었는지 확인하십시오.',
'<ol>',
'<li>보고서 열에서 ''#CHECK_ALL_CHECKBOX#''를 제목 값으로 정의합니다.</li>',
'<li>동적 작업 시간 속성의 경우 해당 열이 포함된 보고서 영역을 선택합니다.</li>',
'<li>''새로 고침 이후''에 실행되는 동적 작업 및 ''페이지 로드 시 실행'' 작업을 정의합니다. 페이지 디자이너의 ''렌더링'' 섹션에서 영역을 선택하고 여기에서 동적 작업을 생성하는 방식으로 동적 작업이 생성된 경우 두 작업 모두 기본값으로 올바르게 지정될 수 있습니다.</li>',
'<li>이 작업은 각 행에서 렌더링되는 체크 박스의 접근성을 처리하지 않으며, 영역 소스에서 개별적으로 수행되어야 합니다. (예를 들어, 4000:656 ''Regions'' 영역을 참조하십시오).</li>',
'</ol>',
'</p>'))
,p_version_identifier=>'1.0'
);
...
,p_subscribe_plugin_settings=>true
,p_help_text=>'<p>이 플러그인은 레이블, 값 및 아이콘을 포함하는 가로 막대 차트를 그립니다.</p>'
,p_version_identifier=>'1.0'
,p_files_version=>16
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006268931685907537.4758)
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006277098711907541.4758)
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006269307704907538.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4758)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006269805212907538.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4758)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006270313871907538.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4758)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006270898104907538.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006271224803907539.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006271675789907539.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272020373907539.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272490890907539.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272846289907539.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006268931685907537.4758)
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006273272857907539.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006273675862907539.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006274092256907540.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006279811153907542.4758)
,p_depending_on_condition_type=>'IN_LIST'
,p_depending_on_expression=>'CUSTOM'
,p_help_text=>'<p>A list of CSS supported colors separated by colons.</p>'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006274433061907540.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006274824808907540.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006274433061907540.4758)
,p_display_sequence=>10
,p_display_value=>'Value'
,p_return_value=>'VALUE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006275327182907540.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006274433061907540.4758)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006275868271907541.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>12
,p_display_sequence=>120
...
,p_is_required=>false
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_api.id(2006274433061907540.4758)
,p_depending_on_condition_type=>'IN_LIST'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006276251069907541.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>13
,p_display_sequence=>130
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006276652694907541.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>14
,p_display_sequence=>140
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006277098711907541.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>15
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006277474563907541.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006277098711907541.4758)
,p_display_sequence=>10
,p_display_value=>'Icon Chart'
,p_return_value=>'ICON'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006277997330907541.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006277098711907541.4758)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006278471627907542.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>16
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006278897464907542.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006278471627907542.4758)
,p_display_sequence=>10
,p_display_value=>'Absolute'
,p_return_value=>'ABSOLUTE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006279373310907542.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006278471627907542.4758)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006279811153907542.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>17
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006280226737907543.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4758)
,p_display_sequence=>5
,p_display_value=>'Default'
,p_return_value=>'DEFAULT'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006280711849907543.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4758)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006281297160907543.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4758)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006281704972907543.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4758)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006282208978907543.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4758)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006282788751907543.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4758)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006283223942907543.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4758)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006283798141907544.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>18
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006284193963907544.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006283798141907544.4758)
,p_display_sequence=>10
,p_display_value=>'Above the bar'
,p_return_value=>'ABOVE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006284698759907545.4758)
,p_plugin_attribute_id=>wwv_flow_api.id(2006283798141907544.4758)
,p_display_sequence=>20
...
begin
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006285119215907545.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>19
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006285570964907546.4758)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4758)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>20
...
,p_display_name=>'Flot 꺾은선형 차트 v2 ***'
,p_supported_ui_types=>'DESKTOP'
...
,p_last_upd_yyyymmddhh24miss=>'20150428184902'
);
...
wwv_flow_api.create_page(
 p_id=>1.4758
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4758)
,p_name=>'패키지된 응용 프로그램 홈'
,p_page_mode=>'NORMAL'
,p_step_title=>'패키지된 응용 프로그램 홈'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750747661941502571.4758)
,p_plug_name=>'정보'
...
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>패키지된 응용 프로그램은 간단한 조작으로 설치할 수 있는 일련의 비즈니스 생산성 응용 프로그램입니다. 프로덕션 응용 프로그램으로 사용할 수 있도록 준비된 이 솔루션을 통해 비즈니스 프로세스를 향상시킬 수 있습니다. 오라클에서는 이 솔루션을 전면적으로 지원합니다.</p>',
''))
,p_plug_query_row_template=>1
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750750940971502582.4758)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750751542816502585.4758)
,p_plug_name=>'접근성 모드'
,p_region_css_classes=>' a-Region--stacked a-Region--padded a-Region--flush a-Region--sideRegion'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750867860695912536.4758)
,p_plug_name=>'응용 프로그램'
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(750862626609892264.4758)
,p_plug_source_type=>'NATIVE_LIST'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(787083093555047575.4758)
,p_name=>'설치된 패키지된 응용 프로그램'
...
,p_query_no_data_found=>'패키지된 응용 프로그램이 설치되지 않았습니다.'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(656958519483052405.4758)
,p_query_column_id=>1
,p_column_alias=>'APP_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'응용 프로그램'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448306370861802.4758)
,p_query_column_id=>2
,p_column_alias=>'RUN_APP_LINK'
,p_column_display_sequence=>4
,p_column_heading=>'응용 프로그램 실행 링크'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(656958784419052407.4758)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(886493838302981514.4758)
,p_query_column_id=>4
,p_column_alias=>'APP_ID'
,p_column_display_sequence=>9
,p_column_heading=>'응용 프로그램 ID'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(886493647565981512.4758)
,p_query_column_id=>5
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448453999861803.4758)
,p_query_column_id=>6
,p_column_alias=>'MODIFY_APP_BUTTON'
,p_column_display_sequence=>5
,p_column_heading=>'응용 프로그램 수정 단추'
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448530210861804.4758)
,p_query_column_id=>7
,p_column_alias=>'RUN_APP_BUTTON'
,p_column_display_sequence=>6
,p_column_heading=>'응용 프로그램 실행 단추'
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(864570195174731021.4758)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(864570463503731024.4758)
,p_query_column_id=>9
,p_column_alias=>'APP_INFO'
,p_column_display_sequence=>7
,p_column_heading=>'응용 프로그램 정보'
,p_use_as_row_header=>'N'
,p_column_format=>'SINCE'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2310796521456520805.4758)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2310796924341520807.4758)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1494304199802239903.4758)
,p_plug_name=>'제공된 패키지된 응용 프로그램'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1199601170102177728.4758)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(787083093555047575.4758)
,p_button_name=>'NEW_INSTALLED_APPS'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404711161197908978.4758)
,p_button_image_alt=>'패키지된 응용 프로그램 생성'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(787719037872821217.4758)
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404711161197908978.4758)
,p_button_image_alt=>'설치된 응용 프로그램 보기'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(750755519256502601.4758)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(750751746540502585.4758)
,p_name=>'P1_ACCESSIBILITY_MODE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(750751542816502585.4758)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(933144624364626643.4758)
,p_name=>'RENDERING: Page - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(787083093555047575.4758)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(933144967905626652.4758)
,p_event_id=>wwv_flow_api.id(933144624364626643.4758)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(750754662427502591.4758)
...
'    end if;',
'end;'))
,p_process_error_message=>'접근성 모드를 설정하는 중 오류가 발생했습니다.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when=>'P1_ACCESSIBILITY_MODE'
,p_process_when_type=>'REQUEST_EQUALS_CONDITION'
,p_process_success_message=>'접근성 모드 설정'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959145671052411.4758)
,p_plug_name=>'최상위 패키지된 응용 프로그램'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959251264052412.4758)
,p_plug_name=>'사용자가 설치한 패키지된 응용 프로그램'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4758)
,p_plug_display_sequence=>50
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959463401052414.4758)
,p_plug_name=>'패키지된 응용 프로그램'
...
'end loop;'))
,p_plug_source_type=>'NATIVE_PLSQL'
,p_plug_query_row_template=>wwv_flow_api.id(741378333819007312.4758)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959880777052418.4758)
,p_plug_name=>'정보'
,p_region_css_classes=>'a-Region--stacked a-Region--padded a-Region--flush a-Region--sideRegion'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4758)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'작업 영역의 패키지된 응용 프로그램에 대한 측정 단위입니다.'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959992513052419.4758)
,p_plug_name=>'패키지된 응용 프로그램 뷰'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788159425426560907.4758)
,p_plug_name=>'설치됨'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4758)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788164282527649493.4758)
,p_plug_name=>'업그레이드할 수 있음'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4758)
,p_plug_display_sequence=>40
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788166095908674996.4758)
,p_plug_name=>'설치되지 않음'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4758)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788982827579790091.4758)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788983890794795218.4758)
,p_plug_name=>'Hidden'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(788983363220793228.4758)
,p_name=>'P2_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(788983890794795218.4758)
...
,p_lov_display_extra=>'YES'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'이 페이지에 표시된 모니터 질의를 제약할 시간 프레임을 설정합니다.'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(789119577877826005.4758)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(789084545317643151.4758)
,p_name=>'RENDERING: Dashboard - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(788982827579790091.4758)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(789084801764643152.4758)
,p_event_id=>wwv_flow_api.id(789084545317643151.4758)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1224170433387563371.4758)
,p_plug_name=>'패키지된 응용 프로그램'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(1224170516463563371.4758)
,p_name=>'Packaged Applications'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'이 보고서의 최대 행 수는 #MAX_ROW_COUNT#개 행입니다. 질의 레코드 수를 줄이려면 필터를 적용하십시오.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224170864888563380.4758)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171279819563380.4758)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224170911190563380.4758)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171038140563380.4758)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171103374563380.4758)
,p_db_column_name=>'UPGRADE_AVAILABLE'
,p_display_order=>42
,p_column_identifier=>'E'
,p_column_label=>'업그레이드 사용 가능'
,p_column_type=>'STRING'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_api.id(801893675976261985)
,p_rpt_show_filter_lov=>'1'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171357038563381.4758)
,p_db_column_name=>'TARGET_URL'
,p_display_order=>52
,p_column_identifier=>'G'
,p_column_label=>'대상 URL'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962307327400233.4758)
,p_db_column_name=>'CATEGORY_NAME'
,p_display_order=>62
,p_column_identifier=>'H'
,p_column_label=>'범주 이름'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1473925915428744023.4758)
,p_db_column_name=>'IS_INSTALLED'
,p_display_order=>63
,p_column_identifier=>'I'
,p_column_label=>'설치 여부'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962433555400234.4758)
,p_db_column_name=>'IS_NOT_INSTALLED'
,p_display_order=>73
,p_column_identifier=>'J'
,p_column_label=>'설치 안됨'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962551146400235.4758)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(973962130782400231.4758)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(1224170433387563371.4758)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(973962236123400232.4758)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(1224170433387563371.4758)
,p_button_name=>'Reset'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page(
 p_id=>5.4758
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4758)
,p_name=>'대시보드 보고 시간 프레임 설정'
,p_page_mode=>'MODAL'
,p_step_title=>'대시보드 보고 시간 프레임 설정'
...
,p_plug_name=>'홈 페이지 보고 시간 프레임 설정'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
,p_lov_display_extra=>'NO'
,p_help_text=>'대시보드에 표시된 모니터 질의를 제약하기 위한 시간 프레임을 설정합니다.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_da_event(
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'관리에서는 권한에 따라 작업 영역의 패키지된 응용 프로그램을 관리 및 모니터할 수 있습니다.'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
...
,p_plug_name=>'패키지된 응용 프로그램 세부 정보'
...
,p_plug_name=>'패키지된 응용 프로그램 저장된 보고서'
...
,p_max_row_count_message=>'이 질의는 10,000개 이상의 행을 반환합니다. 보다 정확한 결과를 얻으려면 데이터를 필터링하십시오.'
,p_no_data_found_message=>'패키지된 응용 프로그램에 사용자 저장 보고서가 포함되어 있지 않습니다.'
,p_allow_report_categories=>'N'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
...
,p_error_message=>'삭제할 보고서를 선택해야 합니다.'
,p_always_execute=>'N'
...
'    end loop;',
'end loop;'))
,p_process_error_message=>'보고서를 제거할 수 없습니다.'
,p_process_when_button_id=>wwv_flow_api.id(802126337999115511.4758)
,p_process_success_message=>'보고서가 삭제되었습니다.'
);
end;
/
...
,p_max_row_count=>'10000'
,p_max_row_count_message=>'이 질의는 10,000개 이상의 행을 반환합니다. 보다 정확한 결과를 얻으려면 데이터를 필터링하십시오.'
,p_no_data_found_message=>'패키지된 응용 프로그램에 적용이 포함되어 있지 않습니다.'
,p_allow_report_categories=>'N'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
'return true;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'삭제할 가입을 선택해야 합니다.'
,p_always_execute=>'N'
...
'    end loop;',
'end loop;'))
,p_process_error_message=>'가입을 제거할 수 없습니다.'
,p_process_when_button_id=>wwv_flow_api.id(805213568160829552.4758)
,p_process_success_message=>'가입이 제거되었습니다.'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>22.4758
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4758)
,p_name=>'작업 영역 환경설정 설정'
,p_page_mode=>'NORMAL'
,p_step_title=>'작업 영역 환경설정 설정'
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'작업 영역에 대한 환경설정 제어 기능입니다.'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'&PRODUCT_NAME. 일반 사용자 계정이 만기되거나 잠길 수 있는지 여부를 결정하십시오. 이 기능은 &PRODUCT_NAME. 사용자 관리 인터페이스를 사용하여 생성된 일반 사용자 계정에만 적용됩니다.',
' 사용 가능한 옵션은 다음과 같습니다.',
'<ul>',
'<li>사용으로 설정</li>',
'<li>사용 안함으로 설정</li>',
'</ul>',
'이 기능은 애플리케이션에 추가 인증 보안을 제공합니다.',
'<b>사용으로 설정</b>을 선택하면 구성 가능한 기간 후 사용자 계정 비밀번호가 만기되고,',
'구성 가능한 인증 실패 횟수 후 계정이 잠기며, 최초 사용 후 계정 비밀번호가 만기되도록 설정할 수 있습니다.',
'<p>',
'이 설치에 대한 &PRODUCT_NAME. 관리자가 환경 설정 <b>사용자 계정 만기 및 잠금 필요</b>를 <b>예</b>로 설정한 경우 이것은 기능이 모든 작업 영역에 대해 사용으로 설정되어야 하고 항목이 <b>사용으로 설정</b>을 표시하며 작업 영역 관리자에 의해 변경될 수 없음을 의미합니다.'))
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'일반 사용자 계정이 잠기기 전에 허용된 최대 연속 실패 인증 시도 횟수로 사용할 양의 정수를 입력하십시오. 이 필드에서 값을 지정하지 않으면 사이트 레벨의 <b>허용된 최대 로그인 실패</b> 환경 설정이 사용됩니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'계정이 만기되기 전에 일반 사용자 계정 비밀번호가 사용될 수 있는 최대 기간(일)으로 사용할 양의 정수를 입력하십시오. 이 필드에서 값을 지정하지 않으면 사이트 레벨의 <b>계정 비밀번호 사용 기간</b> 환경 설정이 사용됩니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'값은 양의 정수여야 합니다.'
,p_always_execute=>'N'
...
'end if;'))
,p_process_error_message=>'작업 영역 환경설정을 적용할 수 없습니다.'
,p_process_when_button_id=>wwv_flow_api.id(805414831280857790.4758)
,p_process_success_message=>'작업 영역 환경설정이 적용되었습니다.'
);
wwv_flow_api.create_page_process(
...
,p_cache_mode=>'NOCACHE'
,p_cache_timeout_seconds=>21600
,p_last_upd_yyyymmddhh24miss=>'20150428184903'
);
wwv_flow_api.create_page_plug(
...
,p_error_message=>'사용자 이름이 정확하게 설정되지 않았습니다. 브라우저를 완전히 닫고 비밀번호를 다시 변경해보십시오.'
,p_always_execute=>'N'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'비밀번호를 지정해야 합니다.'
,p_always_execute=>'N'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'확인용 비밀번호를 지정해야 합니다.'
,p_always_execute=>'N'
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'비밀번호와 확인용 비밀번호가 일치하지 않습니다.'
,p_always_execute=>'N'
...
'end;'))
,p_process_error_message=>'비밀번호를 변경하는 중 오류가 발생했습니다.'
,p_process_when=>':F4750_P24_PASSWORD = :F4750_P24_CONFIRM_PASSWORD'
,p_process_when_type=>'PLSQL_EXPRESSION'
,p_process_success_message=>'비밀번호가 변경되었습니다.'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(818291832742192134.4758)
...
'<script type="text/javascript">',
'// 렌더링 직후에 동적 속성을 숨깁니다, ',
'// jQuery.ready는 시간이 너무 오래 걸릴 수 있습니다. ',
...
'        commit;',
' end;'))
,p_process_error_message=>'응용 프로그램이 성공적으로 업데이트되지 않았습니다.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492892500116858121.4758)
,p_process_success_message=>'응용 프로그램 인증 체계가 성공적으로 업데이트되었습니다.'
);
wwv_flow_api.create_page_process(
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492892500116858121.4758)
,p_process_success_message=>'응용 프로그램 인증이 변경되었습니다.'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1119586009828190520.4758)
,p_plug_name=>'응용 프로그램 JSON'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(404672496027804677.4758)
,p_plug_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1212073820889771903.4758)
,p_plug_name=>'검색 컨테이너'
,p_region_template_options=>'#DEFAULT#'
...
,p_name=>'패키지된 응용 프로그램 세부 정보'
,p_page_mode=>'NORMAL'
,p_step_title=>'패키지된 응용 프로그램 세부 정보'
...
wwv_flow_api.create_page(
 p_id=>83.4758
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4758)
,p_name=>'패키지된 응용 프로그램 설치'
,p_page_mode=>'MODAL'
,p_step_title=>'패키지된 응용 프로그램 설치'
...
,p_button_template_id=>wwv_flow_api.id(758581488338548971.4758)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Websheet 데이터베이스 객체 관리'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(1164736283212438414.4758)
...
,p_process_error_message=>'응용 프로그램이 성공적으로 설치되지 않았습니다.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'응용 프로그램이 설치되었습니다.'
);
wwv_flow_api.create_page_process(
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'서비스 변경 요청을 선택하고 <b>다음</b>을 누르십시오.'
,p_attribute_01=>'3'
,p_attribute_02=>'NONE'
...
,p_error_message=>'부적합한 저장 영역 양이 요청되었습니다.'
,p_always_execute=>'N'
...
wwv_flow_api.create_page(
 p_id=>101.4758
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4758)
,p_name=>'저장 영역 요청 - 요청 정의'
,p_page_mode=>'NORMAL'
,p_step_title=>'저장 영역 요청 - 요청 정의'
...
wwv_flow_api.create_page(
 p_id=>102.4758
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4758)
,p_name=>'서비스 해지 요청 - 요청 정의'
,p_page_mode=>'NORMAL'
,p_step_title=>'서비스 해지 요청 - 요청 정의'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'데이터베이스 응용 프로그램을 찾을 수 없습니다.'
,p_query_num_rows_type=>'ROW_RANGES_WITH_LINKS'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_csv_output=>'N'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'웹 시트 응용 프로그램을 찾을 수 없습니다.'
,p_query_num_rows_type=>'ROW_RANGES_WITH_LINKS'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_csv_output=>'N'
...
'<p>작업 영역 관리자는 이 페이지에서 서비스 해지를 요청할 수 있습니다.</p>'))
...
,p_column_display_sequence=>2
,p_column_heading=>'기본 테이블스페이스'
,p_use_as_row_header=>'N'
,p_lov_show_nulls=>'NO'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(805274418118000233.4758)
,p_name=>'응용 프로그램 개발자'
,p_template=>wwv_flow_api.id(662132465401686364.4758)
,p_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(805274700563000235.4758)
,p_query_column_id=>1
,p_column_alias=>'THE_NAME'
,p_column_display_sequence=>1
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(805274820294000235.4758)
,p_query_column_id=>2
,p_column_alias=>'THE_NAME'
,p_column_display_sequence=>2
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_page(
 p_id=>103.4758
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4758)
,p_name=>'자세한 테이블스페이스 활용도 보고서'
,p_page_mode=>'MODAL'
,p_step_title=>'자세한 테이블스페이스 활용도 보고서'
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>요청 내용을 확인하십시오.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
'end;'))
,p_process_error_message=>'추가 저장 영역을 요청하는 중 오류가 발생했습니다.'
,p_process_when_button_id=>wwv_flow_api.id(805366770901561427.4758)
,p_process_success_message=>'&P101_STORAGE.MB의 추가 저장 영역을 요청했습니다.'
...
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>이 페이지에서는 작업 영역 관리자가 현재 접속되어 있는 서비스의 해지를 요청할 수 있습니다.<br/><br/>',
'',
'<b>중요!</b>: 서비스가 해지되면 데이터, 데이터베이스 객체, 데이터베이스 스키마, 테이블스페이스, 응용 프로그램, 스크립트, 파일 등이 모두 제거됩니다.</p>',
'',
'<p>서비스를 해지할 것인지 확인하십시오.</p>'))
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
...
,p_error_message=>'이 작업 영역에 대한 서비스 해지 요청이 존재합니다.'
,p_always_execute=>'N'
...
'    p_service_attribute_2  => wwv_flow_user_api.get_email(p_username => upper(wwv_flow.g_user)));',
'end;'))
,p_process_error_message=>'서비스 해지 요청을 제출하는 중 오류가 발생했습니다.'
,p_process_when_button_id=>wwv_flow_api.id(805380789015646517.4758)
,p_process_success_message=>'서비스 해지 요청이 제출되었습니다.'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>209.4758
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4758)
,p_name=>'Application Express 계정 설정'
,p_page_mode=>'MODAL'
,p_step_title=>'Application Express 계정 설정'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(492818829813527218.4758)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#:a-ButtonRegion--noUI'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(492819635063527220.4758)
,p_plug_name=>'계정 설정'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(770118466855390796.4758)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(492818829813527218.4758)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4758)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(492819215638527220.4758)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(492818829813527218.4758)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492819882805527221.4758)
,p_name=>'P209_APP_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4758)
,p_prompt=>'응용 프로그램 이름:'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
,p_field_template=>wwv_flow_api.id(741376158824001765.4758)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820018143527222.4758)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820296100527225.4758)
,p_name=>'P209_SCHEMA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4758)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820409273527225.4758)
,p_name=>'P209_METHOD'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4758)
,p_item_default=>'E'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820697304527226.4758)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820844713527226.4758)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492821075748527226.4758)
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'패키지된 응용 프로그램에 로그인하는 데 사용할 사용자 이름을 지정하십시오. 사용자 이름에는 다음과 같은 제한이 있습니다. <p/><ul><li>',
'최대 길이는 100자입니다.</li><li>',
'공백이 없어야 합니다.</li>',
'<li>특수 문자는 @ 및 마침표(.)만 허용됩니다.</li></ul>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492821585156527227.4758)
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'비밀번호를 지정하십시오. 비밀번호는 대소문자를 구분합니다.'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492822027856527228.4758)
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'비밀번호를 다시 입력하십시오.'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492822594676527228.4758)
,p_name=>'P209_EMAIL'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4758)
,p_prompt=>'전자 메일'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'일반 통신, 비밀번호 재설정 알림 등에 사용할 전자 메일 주소를 지정합니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(656958442251052404.4758)
...
,p_cSize=>30
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(750871254241940005.4758)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch:a-Form-fieldContainer--autoLabelWidth'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(777061579764817791.4758)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823118333527228.4758)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823384065527229.4758)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823728079527229.4758)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492823955896527229.4758)
...
,p_associated_item=>wwv_flow_api.id(492821075748527226.4758)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824175298527231.4758)
...
,p_associated_item=>wwv_flow_api.id(492822594676527228.4758)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824349197527231.4758)
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'부적합한 전자 메일 주소입니다.'
,p_always_execute=>'N'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824530875527231.4758)
...
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_api.id(492821585156527227.4758)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824717510527231.4758)
...
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_api.id(492822027856527228.4758)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824939547527231.4758)
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'확인 비밀번호가 입력된 비밀번호와 일치하지 않습니다.'
,p_always_execute=>'N'
,p_validation_condition=>'P209_CREATE_USER'
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(492819215638527220.4758)
,p_associated_item=>wwv_flow_api.id(.4758)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825193741527232.4758)
,p_validation_name=>'strong password'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825374747527232.4758)
...
,p_when_button_pressed=>wwv_flow_api.id(492819215638527220.4758)
,p_only_for_changed_rows=>'Y'
,p_associated_item=>wwv_flow_api.id(492820844713527226.4758)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(492826451491527234.4758)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492826790590527234.4758)
,p_event_id=>wwv_flow_api.id(492826451491527234.4758)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492826968456527234.4758)
,p_event_id=>wwv_flow_api.id(492826451491527234.4758)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827153196527234.4758)
,p_event_id=>wwv_flow_api.id(492826451491527234.4758)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(492827265876527234.4758)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827513295527235.4758)
,p_event_id=>wwv_flow_api.id(492827265876527234.4758)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827728196527235.4758)
,p_event_id=>wwv_flow_api.id(492827265876527234.4758)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827960709527235.4758)
,p_event_id=>wwv_flow_api.id(492827265876527234.4758)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492828182378527235.4758)
,p_event_id=>wwv_flow_api.id(492827265876527234.4758)
,p_event_result=>'FALSE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(770119774478414886.4758)
,p_name=>'Close Dialog'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(770118466855390796.4758)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(770120016874414887.4758)
,p_event_id=>wwv_flow_api.id(770119774478414886.4758)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(492825632290527232.4758)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4758)
,p_process_when=>'wwv_flow_global.g_cloud and :P83_AUTH = ''NATIVE_APEX_ACCOUNTS'' and :P81_APP_TYPE = ''DATABASE'''
,p_process_when_type=>'PLSQL_EXPRESSION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(492825893428527233.4758)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'    ); ',
'end;'))
,p_process_error_message=>'웹 시트 관리자를 정의할 수 없습니다.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4758)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(770120150142419290.4758)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4758)
,p_process_success_message=>'응용 프로그램을 실행할 수 있도록 계정이 설정되었습니다.'
);
end;
/
...
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_plug_header=>'패키지된 응용 프로그램이 설치되었지만 데이터베이스 객체 및 시드 데이터 설치를 실패했습니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
);
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'설치 결과를 찾을 수 없습니다.'
...
wwv_flow_api.create_page(
 p_id=>234.4758
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4758)
,p_name=>'패키지된 응용 프로그램 잠금 해제'
,p_page_mode=>'MODAL'
,p_step_title=>'패키지된 응용 프로그램 잠금 해제'
...
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_header=>'패키지화된 응용 프로그램을 잠금 해제하면 응용 프로그램이 <strong>향후 업그레이드를 받을 수 없게 되며</strong> 오라클 고객 지원 센터에서 <strong>더 이상 지원되지 않습니다</strong>.'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4758)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'응용 프로그램 잠금 해제'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
...
'  end loop;',
'end;'))
,p_process_error_message=>'응용 프로그램의 잠금을 해제하는 중 오류가 발생했습니다.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'응용 프로그램이 잠금 해제되었습니다.'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>237.4758
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4758)
,p_name=>'패키지된 응용 프로그램 제거'
,p_page_mode=>'MODAL'
,p_step_title=>'패키지된 응용 프로그램 제거'
...
'  end if;',
'end;'))
,p_process_error_message=>'응용 프로그램을 제거하는 중 오류가 발생했습니다.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'응용 프로그램이 제거되었습니다.'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>262.4758
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4758)
,p_name=>'패키지된 응용 프로그램 업데이트'
,p_page_mode=>'MODAL'
,p_step_title=>'패키지된 응용 프로그램 업데이트'
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4758)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'응용 프로그램 업데이트'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
...
,p_process_error_message=>'응용 프로그램이 성공적으로 업데이트되지 않았습니다.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'응용 프로그램이 성공적으로 업데이트되었습니다.'
);
wwv_flow_api.create_page_process(
...
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'응용 프로그램이 업데이트되었습니다.'
);
end;
/
...
,p_last_upd_yyyymmddhh24miss=>'20150428184904'
);
wwv_flow_api.create_page_plug(
...
,p_display_order=>26
,p_column_identifier=>'Z'
,p_column_label=>'처음 사용할 때 비밀번호 변경'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4758)
,p_button_image_alt=>'생성 후 다른 항목 생성'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'데이터 찾아보기, 응용 프로그램 생성 및 SQL 스크립트 실행에 사용되는 기본 스키마를 지정합니다. 사용 가능한 스키마가 둘 이상인 작업 영역을 사용하는 경우 이 스키마가 응용 프로그램 생성 및 SQL 질의 수행 등을 위한 기본 스키마입니다. 이 기능은 사용자의 환경설정만 제어하고 보안은 제어하지 않습니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
...
,p_help_text=>'SQL 워크숍을 사용하는 경우 이 개발자가 권한을 가진 스키마에 대해 콜론으로 구분된 스키마 목록을 입력하십시오. 여기에서 입력하는 스키마 목록은 사용자를 작업 영역에 대해 등록된 전체 스키마 집합의 부분 집합으로 제한하고 SQL 워크숍에 표시되는 스키마 이름을 결정합니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'이 사용자에게 작업 영역 관리자 권한이 필요한지 여부를 지정하십시오. 관리자에게는 모든 구성 요소에 대한 액세스 권한이 부여됩니다. 또한 사용자 계정, 그룹 및 개발 서비스도 관리할 수 있습니다.',
'',
'인스턴스 관리자에 의해 해제된 경우 구성 요소를 사용하지 못할 수 있습니다.'))
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'이 사용자에게 개발자 권한을 부여할지 여부를 지정하십시오. 개발자는 패키지된 응용 프로그램을 설치, 제거 또는 업그레이드할 수 있습니다.'
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
,p_attribute_04=>'VERTICAL'
);
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'개발자에게 응용 프로그램 생성기에 대한 액세스 권한이 있는지 여부를 결정합니다.<br>',
'<br>',
'관리자는 항상 응용 프로그램 생성기에 대한 액세스 권한을 갖습니다.<br>',
'개발자는 응용 프로그램 생성기나 SQL Workshop 또는 둘 다에 대한 액세스 권한이 있어야 합니다.<br>',
'<br>',
'관리자에 의해 응용 프로그램 생성기 액세스가 작업 영역에 대해 사용 안함으로 설정된 경우에는 이 속성이 항상 사용 안함으로 설정됩니다.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'개발자에게 웹 시트 개발에 대한 액세스 권한이 있는지 여부를 결정합니다.<br>',
'<br>',
'관리자는 항상 웹 시트 개발에 대한 액세스 권한을 갖습니다.<br>',
'<br>',
'관리자에 의해 웹 시트 개발 액세스가 작업 영역에 대해 사용 안함으로 설정된 경우에는 이 속성이 항상 사용 안함으로 설정됩니다.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'개발자에게 SQL Workshop에 대한 액세스 권한이 있는지 여부를 결정합니다.<br>',
'<br>',
'관리자는 항상 SQL Workshop에 대한 액세스 권한을 갖습니다.<br>',
'개발자는 응용 프로그램 생성기나 SQL Workshop 또는 둘 다에 대한 액세스 권한이 있어야 합니다.<br>',
'<br>',
'관리자에 의해 SQL Workshop 액세스가 작업 영역에 대해 사용 안함으로 설정된 경우에는 이 속성이 항상 사용 안함으로 설정됩니다.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'개발자에게 팀 개발에 대한 액세스 권한이 있는지 여부를 결정합니다.<br>',
'<br>',
'관리자는 항상 팀 개발에 대한 액세스 권한을 갖습니다.<br>',
'<br>',
'관리자에 의해 팀 개발 액세스가 작업 영역에 대해 사용 안함으로 설정된 경우에는 이 속성이 항상 사용 안함으로 설정됩니다.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>'계정이 사용되지 않도록 하려면 <b>잠김</b>을 선택하십시오. 계정이 사용되도록 허용하려면 <b>잠금 해제됨</b>을 선택하십시오.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'시스템 로그인에 사용될 사용자 이름을 지정하십시오. 사용자 이름에는 다음과 같은 제한이 있습니다. <ul><li>',
'최대 길이는 100자입니다.</li><li>',
'공백이 없어야 합니다.</li>',
'<li>특수 문자로는 @ 및 마침표(.)만 허용됩니다.</li></ul>',
'<p>사용자 이름은 모니터 응용 프로그램을 사용하는 사용자 작업을 참조하는 데도 사용됩니다. 바인드 변수 <code>:app_user</code>는 응용 프로그램을 생성할 때 현재 사용자의 값을 반환합니다.</p>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'사용자를 더 자세히 식별하려면 이름을 지정하십시오. 이 필드는 선택 필드로서 참고용으로만 사용됩니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'사용자를 더 자세히 식별하려면 성을 지정하십시오. 이 필드는 선택 필드로서 참고용으로만 사용됩니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'이 필드는 참고용으로 사용자에 대한 설명을 기록하기 위해 사용됩니다.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'Y'
,p_attribute_04=>'NONE'
...
,p_use_cache_before_default=>'NO'
,p_prompt=>'비밀번호'
,p_post_element_text=>' <span class="instructiontext">비밀번호는 대소문자를 구분합니다.</span>'
,p_display_as=>'NATIVE_PASSWORD'
,p_cSize=>30
,p_cMaxlength=>255
,p_field_template=>wwv_flow_api.id(741376307162001773.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'비밀번호를 지정하십시오. 비밀번호는 대소문자를 구분합니다. 개발자는 자신의 비밀번호를 변경할 수 있고, 관리자 권한이 있는 경우 동일한 작업 영역 내에서 사용자의 비밀번호를 변경할 수 있습니다.'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'이 계정의 사용자가 현재 비밀번호를 사용하여 처음으로 로그인한 후 즉시 비밀번호를 변경하도록 하려면 <b>예</b>를 선택하십시오. 이 규칙은 작업 영역 관리 또는 개발을 위해 해당 계정을 사용하는 경우 및 개발된 애플리케이션에 로그인하기 위해 해당 계정을 사용하는 경우 적용됩니다.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
...
,p_error_message=>'부적합한 사용자 이름입니다.'
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
,p_associated_item=>wwv_flow_api.id(801875696425261961.4758)
...
,p_validation_type=>'NOT_EXISTS'
,p_error_message=>'사용자 &F4750_P301_USER_NAME.이(가) 존재합니다.'
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
,p_associated_item=>wwv_flow_api.id(801875696425261961.4758)
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'전자 메일 주소를 지정해야 합니다.'
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'기본 스키마는 액세스 가능한 스키마 내에 있어야 합니다.'
,p_always_execute=>'N'
...
'END;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'개발자는 응용 프로그램 생성기나 SQL Workshop 또는 둘 다에 대한 액세스 권한이 있어야 합니다.'
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'비밀번호가 일치하지 않습니다.  '
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
...
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'사용자 이름이 인스턴스에 대해 정의된 표현식과 일치하지 않습니다.'
,p_always_execute=>'N'
,p_validation_condition=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
'end;',
'commit;'))
,p_process_error_message=>'오류: #SQLERRM#'
,p_process_when=>'SUBMIT,CREATE_ANOTHER'
,p_process_when_type=>'REQUEST_IN_CONDITION'
,p_process_success_message=>'사용자가 생성되었습니다.'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>콤마, 세미콜론 또는 새 행으로 구분하여 전자 메일 주소를 입력하거나 복사 후 붙여 넣으십시오. 전자 메일 주소를 전자 메일 메시지에서 복사한 후 붙여 넣는 경우 관계없는 텍스트가 필터링되어 제거됩니다. 제공된 모든 전자 메일 사용자는 선택된 롤로 추가됩니다. 기존 전자 메일 주소 및 중복된 전자 메일 주소는 무시됩니다.',
'',
'<p>지정한 비밀번호는 각 사용자에게 지정되며 사용자는 로그인 후 해당 비밀번호를 변경해야 합니다.</p>'))
,p_plug_query_row_template=>1
,p_plug_column_width=>'valign=top'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'콤마, 세미콜론 또는 새 행으로 구분하여 전자 메일 주소를 입력하거나 복사 후 붙여 넣으십시오. 전자 메일 주소를 전자 메일 메시지에서 복사한 후 붙여 넣는 경우 관계없는 텍스트가 필터링되어 제거됩니다.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'전체 전자 메일 주소를 포함할지 아니면 도메인 이름을 제외할지를 지정하십시오. 다음과 같은 옵션이 있습니다.',
'<ul>',
'<li>사용자 이름을 전체 전자 메일 주소로 설정 - 전체 전자 메일 주소가 포함됩니다.</li>',
'<li>사용자 이름의 일부로 @ 도메인 제외 - @ 기호 뒤에 오는 모든 텍스트를 제거합니다. 예를 들어, <code>user1@xyz.com</code>은 <code>user1</code>이 됩니다.</li>',
'</ul>'))
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'이러한 사용자에게 작업 영역 관리자 권한을 부여할지 여부를 지정하십시오. 개발자와 마찬가지로 작업 영역 관리자는 응용 프로그램 및 데이터베이스 객체를 생성 및 수정할 수 있으며 또한 사용자 계정, 그룹 및 개발 서비스를 관리할 수 있습니다.'
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'이러한 사용자에게 개발자 권한을 부여할지 여부를 지정하십시오. 개발자는 응용 프로그램 및 데이터베이스 객체를 생성 및 수정할 수 있습니다.'
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'적합한 전자 메일 주소를 찾을 수 없습니다.'
,p_query_num_rows_type=>'0'
,p_query_row_count_max=>5000
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_break_type_flag=>'DEFAULT_BREAK_FORMATTING'
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'부적합한 새 사용자를 찾을 수 없습니다.'
,p_query_num_rows_type=>'0'
,p_query_row_count_max=>5000
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_break_type_flag=>'DEFAULT_BREAK_FORMATTING'
...
,p_column_display_sequence=>2
,p_column_heading=>'부적합한 이유는 무엇입니까?'
);
wwv_flow_api.create_page_plug(
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'<p>이전 페이지의 사용자 이름 목록에 적합한 사용자 이름이 없고 &P303_INVALID_COUNT.개의 부적합한 사용자 이름이 있습니다. 다시 돌아가서 제공한 사용자 이름 목록을 확인하십시오.</p>'
,p_plug_query_row_template=>1
,p_plug_query_num_rows=>15
...
'',
'commit;'))
,p_process_error_message=>'사용자를 생성하는 중 예상치 않은 오류가 발생했습니다.'
,p_process_success_message=>'사용자가 생성됨'
);
end;
/
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'삭제할 사용자를 하나 이상 선택해야 합니다.'
,p_always_execute=>'N'
...
'end loop;'))
,p_process_error_message=>'사용자 삭제를 실패했습니다.'
,p_process_when_button_id=>wwv_flow_api.id(805152655703739453.4758)
,p_process_success_message=>'사용자가 삭제되었습니다.'
);
end;
/
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>이 사용자 관리자는 인증 체계에 사용할 계정을 유지 관리하여 해당 계정에 저장된 사용자 이름과 비밀번호에 따라 인증을 수행합니다.</p>',
'<p>사용자 비밀번호를 변경하려면 새 비밀번호를 입력하십시오. 그렇지 않고 비밀번호 열을 널로 남겨 두면 현재 비밀번호가 변경되지 않습니다.</p>'))
,p_plug_query_row_template=>wwv_flow_api.id(1939532588110833.4758)
...
,p_plug_name=>'사용자: &F4750_P306_USER_NAME.'
,p_region_template_options=>'#DEFAULT#:a-ButtonRegion--withItems:a-ButtonRegion--noUI:a-ButtonRegion--showTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(740735067061086300.4758)
,p_plug_display_sequence=>20
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'이 사용자가 속한 작업 영역을 식별합니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'시스템 로그인에 사용될 사용자 이름을 지정합니다. 사용자 이름에는 다음과 같은 제한이 있습니다. <ul><li>',
'최대 길이는 100자입니다.</li><li>',
'공백이 없어야 합니다.</li>',
'<li>특수 문자로는 @ 및 마침표(.)만 허용됩니다.</li></ul>',
'<p>사용자 이름은 모니터 응용 프로그램을 사용하는 사용자 작업을 참조하는 데도 사용됩니다. 바인드 변수 <code>:app_user</code>는 응용 프로그램을 생성할 때 현재 사용자의 값을 반환합니다.</p>'))
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>'사용자에 대한 기본 Oracle 날짜 형식을 지정하십시오. 이렇게 하면 SQL Workshop 내의 기본 날짜 형식이 제어됩니다.'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'이 사용자에게 작업 영역 관리자 권한을 부여할지 여부를 지정하십시오. 관리자에게는 모든 구성 요소에 대한 액세스 권한이 부여됩니다. 또한 사용자 계정 및 개발 서비스도 관리할 수 있습니다.',
'',
'인스턴스 관리자에 의해 해제된 경우 구성 요소를 사용하지 못할 수 있습니다.'))
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>사용자는 강조 표시된 그룹에 속합니다. 사용자를 그룹에 추가하려면 해당 이름을 눌러 강조 표시합니다. 그룹을 제거하려면 다시 눌러 강조 표시를 해제합니다.</p>',
'<p>개발자는 그룹 지정을 사용하여 특정 기능에 대한 액세스를 그룹별로 제어할 수 있습니다.',
'이 그룹 기능은 응용 프로그램 생성기에 내장되어 있으며 쿠키 기반 인증과 함께 사용할 때 가장 편리하며 가장 잘 작동합니다.',
'그러나 이 사용자 그룹 기능은 다른 인증 체계로 이식할 수 없습니다.</p>'))
,p_attribute_01=>'Y'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'시스템 로그인에 사용할 비밀번호입니다. 현재 비밀번호를 변경하지 않으려면 비밀번호를 입력하지 마십시오.'
,p_attribute_01=>'N'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'비밀번호를 다시 입력하십시오. 현재 비밀번호를 변경하지 않으려면 비밀번호를 입력하지 마십시오.'
,p_attribute_01=>'N'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'개발자 또는 작업 영역 관리자 로그인에 대한 비밀번호가 만기되었는지 또는 적합한지 여부를 나타냅니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'일반 사용자 로그인에 대한 비밀번호가 만기되었는지 또는 적합한지 여부를 나타냅니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'사용자의 비밀번호를 만기시키려면 이 체크 박스를 선택하십시오. 이는 개발자/관리자 로그인 및 일반 사용자 액세스 모두에 적용됩니다. 비밀번호가 만기된 경우 다음에 이 계정이 액세스될 때 사용자가 로그인하기 위해서는 이전 비밀번호와 함께 새 비밀번호를 제공해야 합니다.'
,p_attribute_01=>'1'
);
wwv_flow_api.create_page_item(
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'사용자 이름을 제공해야 합니다.'
,p_always_execute=>'N'
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'스스로 관리자 권한을 제거할 수 없습니다.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(805491074986047781.4758)
...
'end loop;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'사용자 이름을 업데이트하는 경우 새 비밀번호를 제공해야 합니다.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(805491074986047781.4758)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'비밀번호가 제대로 확인되지 않았습니다. 비밀번호를 정확히 동일하게 두 번 입력하십시오.'
,p_always_execute=>'N'
,p_validation_condition=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
'    exit;',
'end loop;'))
,p_process_error_message=>'사용자 정보를 인출하는 중 오류가 발생했습니다.'
);
wwv_flow_api.create_page_process(
...
'  end if;',
'end;'))
,p_process_error_message=>'사용자를 업데이트하는 중 오류가 발생했습니다.'
,p_process_when_button_id=>wwv_flow_api.id(805491074986047781.4758)
,p_process_success_message=>'사용자 "&F4750_P306_USER_NAME."이(가) 업데이트되었습니다.'
);
wwv_flow_api.create_page_process(
...
'wwv_flow_fnd_user_api.remove_fnd_user(',
'             p_user_id => :F4750_P306_USER_ID);'))
,p_process_error_message=>'&F4750_P306_USER_NAME.을(를) 삭제하는 중 오류가 발생했습니다.'
,p_process_when_button_id=>wwv_flow_api.id(805490871563047781.4758)
,p_process_success_message=>'사용자 &F4750_P306_USER_NAME.이(가) 삭제되었습니다.'
);
wwv_flow_api.create_page_process(
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'이 페이지에 입력된 피드백이 없습니다.'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'제공 중인 피드백에 해당하는 응용 프로그램입니다.'
,p_attribute_01=>'Y'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'제공 중인 피드백에 해당하는 페이지입니다.'
,p_attribute_01=>'Y'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(829721255038941612.4758)
,p_prompt=>'응용 프로그램 생성기 및 APEX 응용 프로그램 개발에 대한 피드백'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>96
,p_cMaxlength=>4000
,p_cHeight=>4
,p_field_template=>wwv_flow_api.id(741376307162001773.4758)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'사용자 의견을 제공하여 &PRODUCT_NAME.의 품질 향상에 도움을 주시기 바랍니다.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'설명하려는 대상 구성 요소 또는 기능이 무엇인지 식별하십시오.'
,p_attribute_01=>'3'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_validation(
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(829724817666941621.4758)
,p_validation_name=>'Feedback not null'
,p_validation_sequence=>20
,p_validation=>'P11001_FEEDBACK'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'값을 지정해야 합니다.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(829724329405941619.4758)
,p_associated_item=>wwv_flow_api.id(829722489187941618.4758)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
