...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902241102487378404')
...
,p_substitution_value_14=>'응용 프로그램으로 돌아가기'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(131180169902861.4163)
...
'</div>'))
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>702684260095026477.4163
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780089694684785.4163)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4163)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780455120684785.4163)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4163)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780833657684786.4163)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4163)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146781259067684786.4163)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4163)
...
,p_last_upd_yyyymmddhh24miss=>'20150428184819'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7642519848874484.4163)
,p_plug_name=>'성공적으로 로그아웃되었습니다.'
...
'인증 체계에서 제공한 로그아웃 링크를 사용한 후 여기로 재지정되었습니다. 응용 프로그램의 페이지로 대신 재지정하려면 다음과 같이 하십시오.',
'<ul>',
'<li>응용 프로그램에 페이지를 생성하고 PUBLIC_PAGE라는 별칭을 지정합니다.',
'<li>생성기 페이지의 속성 페이지에서 "예 - 공용 페이지" 공용 페이지 속성을 선택합니다.',
'<li>인증 템플리트에서 로그아웃 URL을 변경하여 로그아웃 프로시저 실행 후 이 새 페이지로 재지정합니다. 예를 들어, 다음 로그아웃 URL을 사용합니다.<p>',
...
wwv_flow_api.create_page(
 p_id=>50.4163
,p_user_interface_id=>wwv_flow_api.id(4973000124302346.4163)
,p_name=>'일반 사용자 비밀번호 변경'
,p_page_mode=>'NORMAL'
,p_step_title=>'일반 사용자 비밀번호 변경'
...
wwv_flow_api.create_page(
 p_id=>99.4163
,p_user_interface_id=>wwv_flow_api.id(4973000124302346.4163)
,p_name=>'&PRODUCT_NAME. 비활성 작업 영역'
,p_page_mode=>'NORMAL'
,p_step_title=>'&PRODUCT_NAME. 비활성 작업 영역'
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'아래의 <b>작업 영역 비우기 사용 안함</b>을 누르면 &P99_WORKSPACE_NAME. 작업 영역을 비우지 않도록 요청됩니다.  <b>&P99_WORKSPACE_NAME. 작업 영역을 삭제하지 않으려면 이 작업을 수행해야 합니다.</b>  '
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
...
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'&P99_WORKSPACE_NAME. 작업 영역의 관리자인 &P99_LAST_UPDATED_BY. 이(가) 이미 이 작업 영역을 비우지 않도록 지정했으며, 이 사항은 &P99_LAST_UPDATED. 에 &P99_LAST_UPDATED_BY. 에 의해 갱신되었습니다.',
'<p>',
'이 작업 영역이 더 이상 필요하지 않은 경우 <b>작업 영역 비우기 사용</b> 단추를 누르십시오. 그러면 <span style="font-weight:bold;color:#ff0033;">&P99_DATE_TO_BE_PURGED.</span> 또는 이 날짜 이후에 자동으로 비워집니다.',
''))
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'이 응용 프로그램은 &P99_APEX_URL.에서 작업 영역 사용을 확인하는 데 사용됩니다. 부적합한 URL을 사용하여 이 페이지에 액세스했습니다. 이 응용 프로그램이나 비우기 프로세스에 대한 문의 사항이 있는 경우, 전자 메일을 통해 <a href="mailto:&P99_PURGE_ADMIN_EMAIL.">&P99_PURGE_ADMIN_EMAIL.</a>(으)로 문의하십시오.'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
,p_plug_name=>'&PRODUCT_NAME. 작업 영역 비우기'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146873381156733851.4163)
...
,p_plug_name=>'&PRODUCT_NAME. 을(를) 사용해 주셔서 감사합니다. - 비워진 작업 영역'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146873381156733851.4163)
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'비활성 작업 영역 &P99_WORKSPACE_NAME.은(는) &P99_DATE_TO_BE_PURGED.에 삭제되도록 일정이 잡혔습니다.',
'<br/><br/>'))
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<strong>&P99_DATE_PURGED.</strong>에 <strong>&P99_WORKSPACE_NAME.</strong> 작업 영역이 비워졌습니다.',
'<p>',
'&PRODUCT_NAME.(&P99_APEX_URL.)을(를) 사용해 주셔서 감사합니다.  ',
''))
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1146918375616882531.4163)
,p_button_image_alt=>'작업 영역 비우기 사용 안함'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1146918375616882531.4163)
,p_button_image_alt=>'작업 영역 비우기 사용'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_button_condition=>'P99_OK_TO_DELETE'
...
,p_process_success_message=>'&P99_WORKSPACE_NAME. 작업 영역은 비우지 않습니다.'
);
wwv_flow_api.create_page_process(
...
,p_process_success_message=>'&P99_DATE_TO_BE_PURGED. 또는 이 날짜 이후에 &P99_WORKSPACE_NAME. 작업 영역을 비울 예정입니다.'
);
wwv_flow_api.create_page_process(
...
'    end if;',
'end;'))
,p_process_error_message=>'작업 영역 및 요청 식별자가 부적합합니다.'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>200.4163
,p_user_interface_id=>wwv_flow_api.id(4973000124302346.4163)
,p_name=>'대화식 보고서 적용 해제'
,p_page_mode=>'NORMAL'
,p_step_title=>'대화식 보고서 적용 해제'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(1146777630795684705.4163)
,p_page_template_options=>'#DEFAULT#'
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'현재 <strong>&P200_EMAIL.</strong>(으)로 아래 보고서에 적용되어 있습니다. 전자 메일 주소로 더 이상 전자 메일을 받지 않으려면 아래에서 <strong>적용 해제</strong>를 누르십시오.'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'감사합니다. 이제부터는 보고서 적용 전자 메일의 적용이 해제되었습니다.  '
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_display_column=>1
,p_plug_display_point=>'BODY_3'
,p_plug_source=>'이 응용 프로그램은 보고서 적용을 해제하는 데 사용됩니다. 부적합한 URL을 사용하여 이 페이지에 액세스했습니다.'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
...
,p_field_template=>wwv_flow_api.id(1146837484282708152.4163)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'적용되어 있는 보고서의 이름입니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
...
,p_process_success_message=>'적용 해제되었습니다. 감사합니다.'
);
wwv_flow_api.create_page_process(
...
'    end if;',
'end;'))
,p_process_error_message=>'부적합한 적용 및 요청 식별자입니다.'
);
end;
/
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'이 &PRODUCT_NAME. 응용 프로그램에서 새 세션을 시작하려면 이 폼에 인증서를 입력합니다.'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_plug_name=>'응용 프로그램 &F4155_P1000_APP_ID.에 로그인합니다.'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146873381156733851.4163)
,p_plug_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'Y'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'비밀번호를 입력해야 합니다.'
,p_always_execute=>'N'
