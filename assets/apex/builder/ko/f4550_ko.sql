...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902292727687406266')
...
,p_substitution_value_08=>'응용 프로그램으로 돌아가기'
,p_substitution_string_09=>'MSG_LANGUAGE'
,p_substitution_value_09=>'언어'
,p_substitution_string_10=>'MSG_COMPANY'
,p_substitution_value_10=>'작업 영역: &COMPANY.'
,p_substitution_string_11=>'MSG_COPYRIGHT'
,p_substitution_value_11=>'Copyright &copy; 1999, 2015, Oracle and/or its affiliates. All rights reserved.'
,p_substitution_string_12=>'VIEW'
,p_substitution_value_12=>'보기'
...
,p_list_text_01=>'최신 버전을 다운로드하고, 설명서를 검토하고, 다양한 부수 자료에 액세스할 수 있는 Oracle Application Express 홈 페이지입니다.'
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>' alt=""'
,p_list_text_01=>'OTN 토론 포럼에서 Application Express 질문에 대한 무료 커뮤니티 제공 지원을 받으십시오. '
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_link_text=>'Application Express 커뮤니티'
,p_list_item_link_target=>'https://apex.oracle.com/pls/apex/f?p=56861:1'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'참조 자료, 응용 프로그램, 컨설팅 회사, 호스팅 회사 등을 검토하십시오.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list(
...
,p_list_text_01=>'Oracle Application Express를 처음 접하는 사용자를 위한 페이지로, 다양한 링크 및 정보를 제공합니다.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'무료로 호스팅되는 "데모 전용" 서비스로, 여기서 최신 버전의 Application Express를 미리 경험해 볼 수 있습니다.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_link_text=>'Oracle 교육 라이브러리'
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'OBE(Oracle by Examples)는 다양한 응용 프로그램 구성 요소를 작성할 수 있도록 안내하는 스크린 샷 포함 단계별 지침 및 필요 조건 파일을 제공합니다.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list(
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'비밀번호 재설정'
,p_list_item_link_target=>'f?p=&APP_ID.:7:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'작업 영역에 사인인할 수 없습니까? 여기서 비밀번호를 재설정하십시오.'
,p_translate_list_text_y_n=>'Y'
...
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'내 작업 영역 찾기'
,p_list_item_link_target=>'f?p=&APP_ID.:4:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'나와 연관된 작업 영역을 잊었습니까? 여기서 찾을 수 있습니다.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>'!'||wwv_flow_api.id(6153929631135099)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
...
,p_list_text_01=>'인스턴스 관리로 로그인합니다.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>'!'||wwv_flow_api.id(6153929631135099)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(333182002517862192.4558)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'관리'
,p_list_item_link_target=>'f?p=4050:3:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'인스턴스 관리로 이동합니다.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>wwv_flow_api.id(6153929631135099)
...
,p_list_item_link_text=>'작업 영역 요청'
...
,p_list_text_01=>'자체 작업 영역을 요청하려면 이 마법사를 완료하십시오.'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1349046415926832.4558)
...
,p_computation_error_message=>'F4550_SERVICE_REQUEST_URL 계산 중 오류 발생: #SQLERRM#'
);
end;
/
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983000163308436.4558)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4558)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983424337308436.4558)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4558)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983847896308436.4558)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4558)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824984287203308437.4558)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4558)
...
,p_shortcut_type=>'HTML_TEXT'
,p_shortcut=>'통합 온라인 애플리케이션 개발 모음에 즉시 액세스하십시오. &PRODUCT_NAME.을(를) 사용하면 강력한 동적 웹 애플리케이션을 생성하여 원하는 브라우저에서 Oracle 데이터베이스의 모든 기능을 활용할 수 있습니다.'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>1.4558
,p_user_interface_id=>wwv_flow_api.id(4972214035302345.4558)
,p_name=>'Oracle Application Express - 사인인'
,p_page_mode=>'NORMAL'
,p_step_title=>'&PRODUCT_NAME. - 사인인'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">작업 영역을 입력하십시오. 작업 영역 이름은 대소문자를 구분하지 않습니다.</div>',
'<div class="htmldbInfoBodyP">이 서비스는 가상 전용 데이터베이스에 대한 액세스를 제공하는 온라인 개발 서비스입니다. 다중 작업 영역에 동일한 사용자 이름이 존재할 수 있으므로 이 서비스를 사용할 때는 작업 영역을 입력해야 합니다.</div>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">사용자 이름을 입력하십시오. 사용자 이름은 대소문자를 구분하지 않습니다.</div>',
'<div class="htmldbInfoBodyP">인증을 받으면 적절한 증명서가 생긴 것으로 간주되므로 추가 사용자를 생성할 수 있습니다.</div>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">비밀번호를 입력하십시오. 비밀번호는 대소문자를 구분합니다. 이 비밀번호는 이 서비스에만 한정됩니다. 각 작업 영역에 여러 명의 사용자가 있을 수 있습니다.</div>',
'<div class="htmldbInfoBodyP">비밀번호를 잊어버린 경우 <span class="fielddatabold">비밀번호 재설정</span>을 선택하십시오.</div>'))
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_error_message=>'작업 영역 이름을 입력하십시오.'
,p_always_execute=>'N'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'사용자 이름을 입력하십시오.'
,p_always_execute=>'N'
...
,p_item_css_classes=>'icon-login-username'
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'작업 영역과 연관된 전자 메일 주소를 입력하십시오. 작업 영역 이름이 이 전자 메일로 전송됩니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
,p_process_error_message=>'오류'
,p_process_when_button_id=>wwv_flow_api.id(26487014153670357.4558)
,p_process_success_message=>'&F4550_P4_EMAIL.이(가) 레코드에 존재할 경우 이 전자 메일 주소와 연관된 작업 영역 이름을 전송합니다. 작업 영역 이름을 수신하는 데 문제가 있는 경우 관리자에게 문의하십시오.'
);
end;
/
...
,p_prompt=>'<span class="instructiontext">작업 영역 이름과 전자 메일 주소 조합이 부적합합니다.</span>'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'N'
,p_help_text=>'작업 영역을 입력하십시오. 작업 영역을 모르면 내 작업 영역 찾기 링크를 사용하십시오.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'비밀번호를 전자 메일로 받을 수 있도록 전자 메일 주소를 입력하십시오.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'EMAIL'
,p_attribute_05=>'BOTH'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'전자 메일은 비워 둘 수 없습니다'
,p_always_execute=>'N'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'작업 영역은 비워둘 수 없습니다.'
,p_always_execute=>'N'
...
,p_error_message=>'INTERNAL 작업 영역에 대한 비밀번호 재설정 작업은 지원되지 않습니다.'
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(47286220449334625.4558)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
...
,p_process_error_message=>'비밀번호를 재설정할 수 없습니다.'
,p_process_when_button_id=>wwv_flow_api.id(47286811980358498.4558)
,p_process_success_message=>'비밀번호 재설정 요청이 처리를 위해 전송되었습니다.'
);
end;
/
...
,p_button_template_id=>wwv_flow_api.id(781653829819356486.4558)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'사인인 페이지로 돌아가기'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
,p_name=>'내부 관리 로그인'
,p_page_mode=>'NORMAL'
,p_step_title=>'&PRODUCT_NAME. 관리 서비스'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_api.id(222575208632450607)
...
,p_item_css_classes=>'icon-login-username'
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'사용자 이름을 입력하십시오. 사용자 이름은 대소문자를 구분하지 않습니다. 인증을 받으면 적절한 증명서가 생긴 것으로 간주되므로 추가 사용자 이름을 생성할 수 있습니다.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'비밀번호를 입력하십시오. 비밀번호는 대소문자를 구분합니다. 비밀번호를 잊어버린 경우 "비밀번호를 잊어버렸습니까?" 링크를 누르십시오. 각 작업 영역에 여러 명의 사용자가 있을 수 있습니다.'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_computation(
...
wwv_flow_api.create_page(
 p_id=>20.4558
,p_user_interface_id=>wwv_flow_api.id(4972214035302345.4558)
,p_name=>'Oracle Application Express 로그인'
,p_page_mode=>'NORMAL'
,p_step_title=>'&PRODUCT_NAME. 로그인'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_javascript_code=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
,p_button_template_id=>wwv_flow_api.id(781653829819356486.4558)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'새 작업 영역을 요청하십시오.'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_button_redirect_url=>'f?p=4700:1:&SESSION.::&DEBUG.:RP:::'
,p_button_condition=>'wwv_flow_platform.get_preference( p_preference_name => ''SERVICE_REQUEST_FLOW'' ) <> ''MANUAL'''
,p_button_condition_type=>'PLSQL_EXPRESSION'
