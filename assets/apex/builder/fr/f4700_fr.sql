...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902293970790407815')
...
,p_substitution_value_02=>'Terminé'
...
,p_substitution_value_09=>'Retour à l''application'
...
,p_substitution_value_12=>'Copyright &copy; 1999, 2015, Oracle. Tous droits réservés.'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1352228430926978.4702)
...
'    return FALSE;',
'end if;'))
,p_error_message=>'Les demandes d''espace de travail ne sont pas activées.'
...
,p_lov_disp_value=>'Utiliser un schéma existant de la base de données'
...
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Développement d''applications'
...
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Applications packagées uniquement'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824976787312308427.4702)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4702)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977164944308427.4702)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4702)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977534964308429.4702)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4702)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977932305308429.4702)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4702)
...
,p_shortcut=>'<a href="javascript:popupFieldHelp(''#CURRENT_ITEM_ID#'',''&SESSION.'')" tabindex="999" title="Aide sur cet élément."><img src="#IMAGE_PREFIX#infoicon_status_gray.gif" width="16" height="16" /></a>'
);
end;
/
...
,p_last_upd_yyyymmddhh24miss=>'20150428184034'
);
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Demande de service'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
...
wwv_flow_api.create_page(
 p_id=>2.4702
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4702)
,p_name=>'Demande d''espace de travail - Deuxième page'
,p_page_mode=>'NORMAL'
,p_step_title=>'Demande d''espace de travail - Deuxième page'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Les informations de votre compte seront envoyées à cette adresse électronique.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
,p_field_template=>wwv_flow_api.id(481972771960821314.4702)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Saisissez le nom d''espace de travail que vous voulez. Après avoir fourni les infos de paramétrage pour votre espace de travail, vous vous connecterez à l''aide d''une combinaison espace de travail/nom utilisateur/mot de passe.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'BOTH'
...
,p_plug_name=>'Espace de travail demandé.'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(481970015003751305.4702)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18348331817861713.4702)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18348522944868646.4702)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18348331817861713.4702)
,p_button_name=>'FINISH'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(481975658518888812.4702)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Passer à l''écran de connexion'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4702)
,p_tab_set=>'HOME'
,p_name=>'Demande d''espace de travail - Identification du schéma'
,p_page_mode=>'NORMAL'
,p_step_title=>'Demande d''espace de travail - Identification du schéma'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4702)
,p_page_template_options=>'#DEFAULT#'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Sélectionnez la quantité d''espace disque dont vous aurez besoin. Une fois que votre schéma est créé, vous pouvez demander de l''espace supplémentaire si nécessaire.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
'Le nom de schéma est l''utilisateur de base de données Oracle qui sera propriétaire de vos objets de base de données. Choisissez-le soigneusement car le changement de schéma peut être laborieux. Après avoir fourni les infos de paramétrage pour votre s'
||'ervice, vous recevrez votre mot de passe de schéma et votre mot de passe de connexion. Une fois que votre espace de travail est créé, vous pouvez y ajouter des schémas supplémentaires.',
'',
'',
'',
'Pour être valides, les noms de schéma doivent respecter les règles suivantes :',
'',
' - Leur longueur doit être comprise entre 1 et 30 octets',
'',
' - Ils ne doivent pas contenir de guillemets',
'',
' - Ils doivent commencer par un caractère alphabétique',
'',
' - Ils ne peuvent contenir que des caractères alphanumériques et',
'',
'   des caractères souligné (_), dollar ($) et dièse (#).',
'',
' - Il ne doit pas s''agir de mots réservés Oracle',
'',
' - Ils ne doivent pas être DUAL'))
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Saisissez le nom du schéma auquel vous voulez que votre nouvel espace de travail &PRODUCT_NAME. ait accès. Après avoir créé votre espace de travail, vous pouvez y ajouter des schémas.',
''))
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Indiquez si vous voulez créer un schéma de base de données ou configurer un schéma de base de données existant pour votre nouvel espace de travail.'
,p_attribute_01=>'1'
...
,p_error_message=>'Le schéma &EXISTING_SCHEMA_NAME. n''existe pas.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''NO'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(11472001772984287.4702)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Le nom de schéma (&SCHEMA_NAME.) est réservé ou limité. Saisissez-en un autre.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4702)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Le nom de schéma n''est pas valide. Indiquez-en un autre.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4702)
...
wwv_flow_api.create_page(
 p_id=>26.4702
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4702)
,p_name=>'Demande d''espace de travail - Avertissements de schéma'
,p_page_mode=>'NORMAL'
,p_step_title=>'Demande d''espace de travail - Avertissements de schéma'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4702)
,p_page_template_options=>'#DEFAULT#'
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Demande d''espace de travail - Description de projet'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4702)
,p_page_template_options=>'#DEFAULT#'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p class="a-Wizard-text">Cette information aide l''administrateur &PRODUCT_NAME. à comprendre comment vous comptez utiliser ce service.</p>',
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'Saisissez le but de votre demande de service. Cette information est destinée à l''administrateur &PRODUCT_NAME..'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'Si l''accord de votre société ou de votre service requiert une justification pour votre demande, fournissez-en une.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Accord de service'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4702)
,p_page_template_options=>'#DEFAULT#'
...
,p_name=>'Demande d''espace de travail - Confirmation'
,p_page_mode=>'NORMAL'
,p_step_title=>'Demande d''espace de travail - Confirmation'
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'<p class="a-Wizard-text">Vérifiez votre demande d''espace de travail.</p>'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
...
,p_item_plug_id=>wwv_flow_api.id(94840826419648214.4702)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Adresse électronique de l''administrateur'
...
,p_item_plug_id=>wwv_flow_api.id(94840826419648214.4702)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Utiliser le schéma existant'
...
,p_item_plug_id=>wwv_flow_api.id(94840826419648214.4702)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Taille de la base de données (Mo)'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Vous devez saisir le code de vérification qui apparaît dans la boîte.',
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Code de vérification non valide'
,p_always_execute=>'N'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Toutes les valeurs ne sont pas définies correctement, redémarrez le processus de demande d''espace de travail.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(318141939408.4702)
,p_associated_item=>wwv_flow_api.id(.4702)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Les conditions n''ont pas été correctement acceptées.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(318141939408.4702)
,p_associated_item=>wwv_flow_api.id(.4702)
...
wwv_flow_api.create_page(
 p_id=>73.4702
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4702)
,p_name=>'Création d''espace de travail &PRODUCT_NAME.'
,p_page_mode=>'NORMAL'
,p_step_title=>'Création d''espace de travail &PRODUCT_NAME.'
,p_allow_duplicate_submissions=>'N'
...
'<h2 class="a-Wizard-subTitle">Espace de travail créé</h2>'))
);
wwv_flow_api.create_page_plug(
