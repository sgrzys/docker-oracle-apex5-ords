...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902240590326377730')
...
,p_substitution_value_14=>'Retour à l''application'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(131180169902861.4157)
...
'</div>'))
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>702684260095026477.4157
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780089694684785.4157)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4157)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780455120684785.4157)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4157)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780833657684786.4157)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4157)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146781259067684786.4157)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4157)
...
,p_name=>'Page publique de déconnexion'
,p_page_mode=>'NORMAL'
,p_step_title=>'Page publique de déconnexion'
...
,p_last_upd_yyyymmddhh24miss=>'20150428183949'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7642519848874484.4157)
,p_plug_name=>'Vous avez été déconnecté.'
...
'Vous avez été réacheminé ici après avoir utilisé un lien de déconnexion fourni par un modèle d''authentification. Pour être réacheminé vers une page de votre application à la place, procédez comme suit :',
'<ul>',
'<li>Créez une page dans votre application et attribuez-lui un alias PUBLIC_PAGE.',
'<li>Dans la page des attributs de page Builder, sélectionnez l''attribut de page publique Oui - Cette page est publique.',
'<li>Modifiez l''URL de déconnexion dans votre modèle d''authentification pour que le réacheminement se fasse vers cette nouvelle page une fois la procédure de déconnexion terminée. Par exemple, utilisez l''URL de déconnexion suivante :<p>',
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'En cliquant sur le bouton <b>Ne pas purger l''espace de travail</b> ci-dessous, vous demandez à ce que l''espace de travail &P99_WORKSPACE_NAME. ne soit pas purgé. <b>Vous devez exécuter cette action pour éviter que l''espace de travail &P99_WORKSPACE_N'
||'AME. soit supprimé.</b>  '
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
...
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'&P99_LAST_UPDATED_BY., administrateur de l''espace de travail &P99_WORKSPACE_NAME., a déjà indiqué que cet espace de travail ne devait pas être purgé. Cela a été mis à jour par &P99_LAST_UPDATED_BY. le &P99_LAST_UPDATED..',
'<p>',
'Si vous n''avez plus besoin de cet espace de travail, cliquez sur le bouton <b>J''ai changé d''avis. Purger l''espace de travail</b> et l''espace de travail sera automatiquement purgé le ou après le <span style="font-weight:bold;color:#ff0033;">&P99_DATE_'
||'TO_BE_PURGED.</span>.',
''))
,p_translate_title=>'N'
,p_plug_query_row_template=>1
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'Cette application sert à confirmer l''utilisation d''un espace de travail dans &P99_APEX_URL.. Vous avez accédé à cette page via une URL non valide. Si vous avez des questions au sujet de cette application ou du processus de purge, n''hésitez pas à nous'
||' les poser par courriel à l''adresse <a href="mailto:&P99_PURGE_ADMIN_EMAIL.">&P99_PURGE_ADMIN_EMAIL.</a>.'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
,p_plug_name=>'Merci d''utiliser &PRODUCT_NAME. - Espace de travail purgé'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146873381156733851.4157)
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'La suppression de l''espace de travail &P99_WORKSPACE_NAME. inactif est programmée pour le &P99_DATE_TO_BE_PURGED..',
'<br/><br/>'))
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'L''espace de travail <strong>&P99_WORKSPACE_NAME.</strong> a été purgé le <strong>&P99_DATE_PURGED.</strong>.',
'<p>',
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1146918375616882531.4157)
,p_button_image_alt=>'J''ai changé d''avis. Purger l''espace de travail'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_button_condition=>'P99_OK_TO_DELETE'
...
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(498926816038101235.4157)
,p_prompt=>'Espace de travail demandé à l''origine par'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
,p_field_template=>wwv_flow_api.id(1146837484282708152.4157)
,p_item_template_options=>'#DEFAULT#'
...
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(498926816038101235.4157)
,p_prompt=>'Espace de travail à purger ?'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
,p_process_success_message=>'L''espace de travail &P99_WORKSPACE_NAME. ne sera pas purgé. Merci.'
);
wwv_flow_api.create_page_process(
...
,p_process_success_message=>'L''espace de travail &P99_WORKSPACE_NAME. sera purgé le ou après le &P99_DATE_TO_BE_PURGED.. Merci.'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>200.4157
,p_user_interface_id=>wwv_flow_api.id(4973000124302346.4157)
,p_name=>'Annuler l''abonnement à l''état interactif'
,p_page_mode=>'NORMAL'
,p_step_title=>'Annuler l''abonnement à l''état interactif'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(1146777630795684705.4157)
,p_page_template_options=>'#DEFAULT#'
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Vous êtes actuellement abonné à l''état ci-dessous en tant que <strong>&P200_EMAIL.</strong>. Si vous ne voulez plus recevoir de courriels à cette adresse électronique, cliquez sur le bouton <strong>Annuler l''abonnement</strong> ci-dessous :'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_name=>'Merci. - Abonnement annulé'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Merci. Votre abonnement aux courriels d''abonnement d''état a été annulé.  '
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_display_column=>1
,p_plug_display_point=>'BODY_3'
,p_plug_source=>'Cette application permet d''annuler les abonnements d''état. Vous avez accédé à cette page à l''aide d''une URL non valide.'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
...
,p_field_template=>wwv_flow_api.id(1146837484282708152.4157)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Nom de l''état auquel vous êtes abonné.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
...
,p_process_success_message=>'Abonnement annulé. Merci.'
);
wwv_flow_api.create_page_process(
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Saisissez les informations d''identification dans ce panneau pour démarrer une nouvelle session dans cette application &PRODUCT_NAME..'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_plug_name=>'Connectez-vous à l''application &F4155_P1000_APP_ID.'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146873381156733851.4157)
,p_plug_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'Y'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Le mot de passe doit être indiqué.'
,p_always_execute=>'N'
