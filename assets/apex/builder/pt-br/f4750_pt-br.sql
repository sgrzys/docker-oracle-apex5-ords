...
prompt APPLICATION 4755 - Oracle APEX Packaged Applications
--
-- Application Export:
--   Application:     4755
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902296548296411644')
...
,p_substitution_value_05=>'Copyright &copy; 1999, 2015, Oracle. Todos os direitos reservados.'
...
,p_substitution_value_10=>'Concluído'
...
,p_substitution_value_18=>'Retornar à Aplicação'
,p_substitution_string_19=>'DELETE_MSG'
,p_substitution_value_19=>'Gostaria de executar esta ação de exclusão?'
,p_substitution_string_20=>'PAGE'
,p_substitution_value_20=>'Página'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719115788931175389.4755)
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Galeria de Aplicações Empacotadas'
,p_list_item_link_target=>'f?p=&APP_ID.:50:&SESSION.::&DEBUG.:50:::'
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Administração da Aplicação Empacotada'
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Autenticação'
...
,p_list_item_disp_cond_type=>'PLSQL_EXPRESSION'
,p_list_item_disp_condition=>'wwv_flow_platform.get_preference(''SERVICE_REQUESTS_ENABLED'') = ''Y'''
,p_list_text_01=>'Solicitar acesso para armazenamento adicional ou encerrar o espaço de trabalho.'
...
,p_list_text_01=>'Configurar preferências para controlar a funcionalidade do espaço de trabalho.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>wwv_flow_api.id(404682514053862570)
,p_list_item_current_type=>'TARGET_PAGE'
);
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Gerenciar Usuários'
,p_list_item_link_target=>'f?p=&APP_ID.:300:&SESSION.::&DEBUG.:300:::'
,p_list_item_icon=>'icon-apex-user'
,p_list_text_01=>'Controlar acesso de administradores, desenvolvedores da aplicação e usuários finais do espaço de trabalho do Application Express.'
,p_translate_list_text_y_n=>'Y'
...
,p_list_item_link_text=>'Relatórios Salvos'
,p_list_item_link_target=>'f?p=&APP_ID.:13:&SESSION.::&DEBUG.:RP:::'
,p_list_item_icon=>'icon-saved-reports'
,p_list_text_01=>'Exibir e gerenciar relatórios interativos salvos pelos usuários de aplicações empacotadas.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Inscrições'
,p_list_item_link_target=>'f?p=&APP_ID.:17:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'icon-report-subscriptions'
,p_list_text_01=>'Exibir e gerenciar inscrições do relatório interativo criadas pelos usuários de aplicações empacotadas.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list(
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Usuários'
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Designações de Grupos'
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Relatório Detalhado de Utilização de Tablespace (pode levar alguns segundos)'
...
,p_list_item_link_text=>'Identificar Solicitação'
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Definir Solicitação'
...
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Excluir Vários Usuários'
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Atividade de Aplicação'
,p_list_item_link_target=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'icon-utilities-activity'
,p_list_text_01=>'O calendário da atividade da aplicação que relata usuários distintos e totais de views de páginas por dia.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
...
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Views de Página'
,p_list_item_link_target=>'f?p=&APP_ID.:29:&SESSION.::&DEBUG.:RP,29:::'
,p_list_item_icon=>'icon-utilities-page-views'
,p_list_text_01=>'Relatório interativo de cada view de página. Exibe usuário, tempo decorrido e página.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Principais Usuários'
,p_list_item_link_target=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.:RP,30:::'
,p_list_item_icon=>'icon-apex-user'
,p_list_text_01=>'Relatório de views de página agregadas por usuário.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list(
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1355859641927129.4755)
...
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
,p_attribute_01=>'SQL'
,p_error_message=>'Você não está autorizado a usar o SQL Workshop'
...
,p_error_message=>'O Ambiente de Desenvolvimento está usando Autenticação externa'
...
,p_error_message=>'Você não está autorizado a instalar as Aplicações Empacotadas'
...
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Definir nome do usuário para endereço de e-mail completo'
,p_lov_return_value=>'N'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805346868716446830.4755)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'Excluir @ domínio como parte do nome do usuário'
,p_lov_return_value=>'Y'
);
wwv_flow_api.create_list_of_values(
...
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Gráfico'
,p_lov_return_value=>'CHART'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(818320554241815181.4755)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Relatório'
...
,p_lov_disp_value=>'Alterar Autenticação'
...
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Criar Usuário do Application Express'
,p_lov_return_value=>'Y'
);
wwv_flow_api.create_list_of_values(
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(805102768336534835.4755)
,p_lov_name=>'REQUEST SERVICE'
,p_lov_query=>'.'||wwv_flow_api.id(805102768336534835)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103010621534839.4755)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Esquema da Solicitação'
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103339867534842.4755)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Solicitar Armazenamento'
,p_lov_return_value=>'STORAGE'
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103624199534842.4755)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Solicitar Encerramento'
,p_lov_return_value=>'TERMINATION'
...
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Utilizar Usuário Existente'
,p_lov_return_value=>'E'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(492829287682527240.4755)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Criar Novo Usuário'
,p_lov_return_value=>'N'
);
wwv_flow_api.create_list_of_values(
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4755)
,p_short_name=>'Remover Aplicação Empacotada'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4755)
,p_short_name=>'Instalar Aplicação Empacotada'
,p_link=>'f?p=&APP_ID.:83:&SESSION.::&DEBUG.:::'
,p_page_id=>83
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(492872210530717222.4755)
,p_parent_id=>wwv_flow_api.id(806264496767109365.4755)
,p_short_name=>'Instalar Aplicação Empacotada'
...
,p_short_name=>'Desbloquear Aplicação Empacotada'
...
,p_parent_id=>wwv_flow_api.id(.4755)
,p_short_name=>'Alterar Autenticação'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4755)
,p_short_name=>'Atualizar Aplicação Empacotada'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(750897172696068128.4755)
,p_parent_id=>wwv_flow_api.id(.4755)
,p_short_name=>'<span class="u-VisuallyHidden">Aplicações</span><span class="a-Icon icon-breadcrumb-previous"></span>'
,p_link=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::'
,p_page_id=>1
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(788162743515607361.4755)
,p_parent_id=>wwv_flow_api.id(750897172696068128.4755)
,p_short_name=>'Painel de Controle das Aplicações Empacotadas'
...
,p_parent_id=>wwv_flow_api.id(750897172696068128.4755)
,p_short_name=>'Administração da Aplicação Empacotada'
...
,p_short_name=>'Solicitar Serviço'
...
,p_parent_id=>wwv_flow_api.id(798343358044477984.4755)
,p_short_name=>'Gerenciar Usuários'
...
,p_parent_id=>wwv_flow_api.id(801862732676237146.4755)
,p_short_name=>'Criar Vários Usuários'
...
,p_parent_id=>wwv_flow_api.id(798343358044477984.4755)
,p_short_name=>'Gerenciar Relatórios Salvos'
...
,p_parent_id=>wwv_flow_api.id(801862732676237146.4755)
,p_short_name=>'Excluir Vários Usuários'
...
,p_parent_id=>wwv_flow_api.id(798343358044477984.4755)
,p_short_name=>'Gerenciar Inscrições'
...
,p_parent_id=>wwv_flow_api.id(798343358044477984.4755)
,p_short_name=>'Definir Preferências do Espaço de Trabalho'
...
,p_parent_id=>wwv_flow_api.id(798343358044477984.4755)
,p_short_name=>'Solicitar Encerramento do Serviço'
...
,p_parent_id=>wwv_flow_api.id(750897172696068128.4755)
,p_short_name=>'Galeria de Aplicações Empacotadas'
...
,p_short_name=>'Detalhes da Aplicação Empacotada'
...
,p_parent_id=>wwv_flow_api.id(798343358044477984.4755)
,p_short_name=>'Atividade de Aplicação'
...
,p_parent_id=>wwv_flow_api.id(798343358044477984.4755)
,p_short_name=>'Principais Usuários'
,p_link=>'f?p=&APP_ID.:30:&SESSION.'
,p_page_id=>30
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(1224179617523676528.4755)
,p_parent_id=>wwv_flow_api.id(788162743515607361.4755)
,p_short_name=>'Aplicações Empacotadas'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747469399730136676.4755)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747469775365136676.4755)
,p_page_template_id=>wwv_flow_api.id(741366253443994295.4755)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970712970659339897.4755)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970713375545339897.4755)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4755)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970713743513339897.4755)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4755)
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714187781339897.4755)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4755)
,p_name=>'Right Side Bar'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714515296339897.4755)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4755)
,p_name=>'After Body'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714940759339898.4755)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4755)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970715378375339898.4755)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4755)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824980978803308434.4755)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4755)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824981311553308434.4755)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4755)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824981767148308434.4755)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4755)
,p_name=>'Wizard Title'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824982170342308434.4755)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4755)
...
,p_display_name=>'Atributo Dinâmico de Plug-in'
,p_supported_ui_types=>'DESKTOP'
...
,p_display_name=>'Seleção de Assistente'
,p_supported_ui_types=>'DESKTOP'
...
,p_display_name=>'Adicionar caixa de seleção Marcar todas'
,p_category=>'MISC'
,p_supported_ui_types=>'DESKTOP'
...
,p_subscribe_plugin_settings=>true
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>A ação dinâmica "Adicionar caixa de seleção Marcar todas" transforma um cabeçalho de coluna que contém a string #CHECK_ALL_CHECKBOX# em uma caixa de seleção Marcar todas acessível, que marcará ou desmarcará todas as caixas de seleção na sua coluna'
||' correspondente.<p>',
'<p>',
'Para usar este plug-in, verifique se os atributos a seguir estão definidos:',
'<ol>',
'<li>Na coluna de relatórios, defina ''#CHECK_ALL_CHECKBOX#'' como o valor do Cabeçalho.</li>',
'<li>Para o atributo When da Ação Dinâmica, selecione a região do relatório que contém a coluna.</li>',
'<li>Defina a Ação Dinâmica para acionar ''Após Atualização'', e a Ação para ''Carga de Acionamento da Página''. (Ambas serão definidas como padrão apropriadamente se a Ação Dinâmica for criada selecionando a região na seção ''Renderização'' do Designer de '
||'páginas e criando a Ação Dinâmica nela.</li>',
'<li>Isso não tratará a acessibilidade das caixas de seleção renderizadas em cada linha. Isso deve ser feito separadamente na origem da região. (Consulte a região 4000:656 ''Regions'' para ver um exemplo).</li>',
'</ol>',
'</p>'))
,p_version_identifier=>'1.0'
);
...
,p_display_name=>'Gráfico de Barras HTML 5 ***'
,p_supported_ui_types=>'DESKTOP'
...
,p_subscribe_plugin_settings=>true
,p_help_text=>'<p>Este plug-in desenha gráficos de barras horizontais que contêm labels, valores e até mesmo ícones</p>'
,p_version_identifier=>'1.0'
,p_files_version=>16
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006268931685907537.4755)
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006277098711907541.4755)
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006269307704907538.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4755)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006269805212907538.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4755)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006270313871907538.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4755)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006270898104907538.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006271224803907539.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006271675789907539.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272020373907539.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272490890907539.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272846289907539.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006268931685907537.4755)
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006273272857907539.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006273675862907539.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006274092256907540.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006279811153907542.4755)
,p_depending_on_condition_type=>'IN_LIST'
,p_depending_on_expression=>'CUSTOM'
,p_help_text=>'<p>A list of CSS supported colors separated by colons.</p>'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006274433061907540.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006274824808907540.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006274433061907540.4755)
,p_display_sequence=>10
,p_display_value=>'Value'
,p_return_value=>'VALUE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006275327182907540.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006274433061907540.4755)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006275868271907541.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>12
,p_display_sequence=>120
...
,p_is_required=>false
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_api.id(2006274433061907540.4755)
,p_depending_on_condition_type=>'IN_LIST'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006276251069907541.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>13
,p_display_sequence=>130
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006276652694907541.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>14
,p_display_sequence=>140
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006277098711907541.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>15
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006277474563907541.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006277098711907541.4755)
,p_display_sequence=>10
,p_display_value=>'Icon Chart'
,p_return_value=>'ICON'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006277997330907541.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006277098711907541.4755)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006278471627907542.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>16
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006278897464907542.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006278471627907542.4755)
,p_display_sequence=>10
,p_display_value=>'Absolute'
,p_return_value=>'ABSOLUTE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006279373310907542.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006278471627907542.4755)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006279811153907542.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>17
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006280226737907543.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4755)
,p_display_sequence=>5
,p_display_value=>'Default'
,p_return_value=>'DEFAULT'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006280711849907543.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4755)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006281297160907543.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4755)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006281704972907543.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4755)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006282208978907543.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4755)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006282788751907543.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4755)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006283223942907543.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4755)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006283798141907544.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>18
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006284193963907544.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006283798141907544.4755)
,p_display_sequence=>10
,p_display_value=>'Above the bar'
,p_return_value=>'ABOVE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006284698759907545.4755)
,p_plugin_attribute_id=>wwv_flow_api.id(2006283798141907544.4755)
,p_display_sequence=>20
...
begin
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006285119215907545.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>19
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006285570964907546.4755)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4755)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>20
...
,p_display_name=>'Gráfico de Linhas Flutuantes v2 ***'
,p_supported_ui_types=>'DESKTOP'
...
,p_display_name=>'Gráfico de Pizza Flutuante v2 ***'
,p_supported_ui_types=>'DESKTOP:JQM_SMARTPHONE'
...
,p_name=>'Página Global - Desktop'
,p_page_mode=>'NORMAL'
,p_step_title=>'Página Global - Desktop'
...
,p_last_upd_yyyymmddhh24miss=>'20150428185146'
);
...
wwv_flow_api.create_page(
 p_id=>1.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Home das Aplicações Empacotadas'
,p_page_mode=>'NORMAL'
,p_step_title=>'Home das Aplicações Empacotadas'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750747661941502571.4755)
,p_plug_name=>'Sobre'
...
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>Aplicações empacotadas referem-se a um conjunto de aplicações de produtividade de negócios, facilmente instaladas com apenas alguns cliques. Estas soluções podem ser usadas rapidamente comas aplicações de produção para melhorar os processos de neg'
||'ócios e são totalmente suportadas pela Oracle.</p>',
''))
,p_plug_query_row_template=>1
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750750940971502582.4755)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750751542816502585.4755)
,p_plug_name=>'Modo de Acessibilidade'
,p_region_css_classes=>' a-Region--stacked a-Region--padded a-Region--flush a-Region--sideRegion'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750867860695912536.4755)
,p_plug_name=>'Aplicações'
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(750862626609892264.4755)
,p_plug_source_type=>'NATIVE_LIST'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(787083093555047575.4755)
,p_name=>'Aplicações Empacotadas Instaladas'
...
,p_query_no_data_found=>'Nenhuma aplicação empacotada instalada.'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(656958519483052405.4755)
,p_query_column_id=>1
,p_column_alias=>'APP_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Aplicação'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448306370861802.4755)
,p_query_column_id=>2
,p_column_alias=>'RUN_APP_LINK'
,p_column_display_sequence=>4
,p_column_heading=>'Executar link da aplicação'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(656958784419052407.4755)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(886493838302981514.4755)
,p_query_column_id=>4
,p_column_alias=>'APP_ID'
,p_column_display_sequence=>9
,p_column_heading=>'Id da Aplicação'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(886493647565981512.4755)
,p_query_column_id=>5
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448453999861803.4755)
,p_query_column_id=>6
,p_column_alias=>'MODIFY_APP_BUTTON'
,p_column_display_sequence=>5
,p_column_heading=>'Modificar botão da aplicação'
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448530210861804.4755)
,p_query_column_id=>7
,p_column_alias=>'RUN_APP_BUTTON'
,p_column_display_sequence=>6
,p_column_heading=>'Executar botão da aplicação'
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(864570195174731021.4755)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(864570463503731024.4755)
,p_query_column_id=>9
,p_column_alias=>'APP_INFO'
,p_column_display_sequence=>7
,p_column_heading=>'Informações sobre aplicações'
,p_use_as_row_header=>'N'
,p_column_format=>'SINCE'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2310796521456520805.4755)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2310796924341520807.4755)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1494304199802239903.4755)
,p_plug_name=>'Aplicações Empacotadas com Recursos'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1199601170102177728.4755)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(787083093555047575.4755)
,p_button_name=>'NEW_INSTALLED_APPS'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404711161197908978.4755)
,p_button_image_alt=>'Criar Aplicação Empacotada'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(787719037872821217.4755)
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404711161197908978.4755)
,p_button_image_alt=>'Exibir Aplicações Instaladas'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(750755519256502601.4755)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(750751746540502585.4755)
,p_name=>'P1_ACCESSIBILITY_MODE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(750751542816502585.4755)
,p_use_cache_before_default=>'NO'
,p_item_default=>'STANDARD'
,p_prompt=>'Modo de Acessibilidade'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'case ',
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(933144624364626643.4755)
,p_name=>'RENDERING: Page - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(787083093555047575.4755)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(933144967905626652.4755)
,p_event_id=>wwv_flow_api.id(933144624364626643.4755)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(750754662427502591.4755)
...
'    end if;',
'end;'))
,p_process_error_message=>'Erro ao definir o Modo de Acessibilidade'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when=>'P1_ACCESSIBILITY_MODE'
,p_process_when_type=>'REQUEST_EQUALS_CONDITION'
,p_process_success_message=>'Modo de Acessibilidade definido'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959145671052411.4755)
,p_plug_name=>'Principais Aplicações Empacotadas'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959251264052412.4755)
,p_plug_name=>'Aplicações Empacotadas Instaladas pelos Usuários'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4755)
,p_plug_display_sequence=>50
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959463401052414.4755)
,p_plug_name=>'Aplicações Empacotadas'
...
'end loop;'))
,p_plug_source_type=>'NATIVE_PLSQL'
,p_plug_query_row_template=>wwv_flow_api.id(741378333819007312.4755)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959880777052418.4755)
,p_plug_name=>'Sobre'
,p_region_css_classes=>'a-Region--stacked a-Region--padded a-Region--flush a-Region--sideRegion'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4755)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Métricas sobre aplicações empacotadas em seu espaço de trabalho.'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959992513052419.4755)
,p_plug_name=>'Views da Aplicação Empacotada'
...
,p_attribute_05=>'Views de Página'
,p_attribute_06=>'NONE'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788159425426560907.4755)
,p_plug_name=>'Instaladas'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4755)
,p_plug_display_sequence=>20
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788164282527649493.4755)
,p_plug_name=>'Disponíveis para Upgrade'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4755)
,p_plug_display_sequence=>40
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788166095908674996.4755)
,p_plug_name=>'Não Instalado'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4755)
,p_plug_display_sequence=>30
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788982827579790091.4755)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788983890794795218.4755)
,p_plug_name=>'Hidden'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(788983363220793228.4755)
,p_name=>'P2_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(788983890794795218.4755)
...
,p_lov_display_extra=>'YES'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Definir período para restringir consultas monitoradas exibidas nesta página.'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(789119577877826005.4755)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(789084545317643151.4755)
,p_name=>'RENDERING: Dashboard - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(788982827579790091.4755)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(789084801764643152.4755)
,p_event_id=>wwv_flow_api.id(789084545317643151.4755)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page(
 p_id=>3.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Aplicações Empacotadas'
,p_page_mode=>'NORMAL'
,p_step_title=>'Aplicações Empacotadas'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1224170433387563371.4755)
,p_plug_name=>'Aplicações Empacotadas'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(1224170516463563371.4755)
,p_name=>'Packaged Applications'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'A contagem máxima de linhas para este relatório é #MAX_ROW_COUNT# linhas. Aplique um filtro para reduzir o número de registros em sua consulta.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224170864888563380.4755)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171279819563380.4755)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224170911190563380.4755)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171038140563380.4755)
,p_db_column_name=>'INSTALLED'
,p_display_order=>32
,p_column_identifier=>'D'
,p_column_label=>'Instaladas'
,p_column_type=>'STRING'
,p_display_text_as=>'LOV_ESCAPE_SC'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171103374563380.4755)
,p_db_column_name=>'UPGRADE_AVAILABLE'
,p_display_order=>42
,p_column_identifier=>'E'
,p_column_label=>'Atualização disponível'
,p_column_type=>'STRING'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_api.id(801893675976261985)
,p_rpt_show_filter_lov=>'1'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171357038563381.4755)
,p_db_column_name=>'TARGET_URL'
,p_display_order=>52
,p_column_identifier=>'G'
,p_column_label=>'Url de Destino'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962307327400233.4755)
,p_db_column_name=>'CATEGORY_NAME'
,p_display_order=>62
,p_column_identifier=>'H'
,p_column_label=>'Nome da categoria'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1473925915428744023.4755)
,p_db_column_name=>'IS_INSTALLED'
,p_display_order=>63
,p_column_identifier=>'I'
,p_column_label=>'Está Instalado'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962433555400234.4755)
,p_db_column_name=>'IS_NOT_INSTALLED'
,p_display_order=>73
,p_column_identifier=>'J'
,p_column_label=>'não está instalado'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962551146400235.4755)
,p_db_column_name=>'UPGRADE_IS_AVAILABLE'
,p_display_order=>83
,p_column_identifier=>'K'
,p_column_label=>'Upgrade disponível'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(973962130782400231.4755)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(1224170433387563371.4755)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(973962236123400232.4755)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(1224170433387563371.4755)
,p_button_name=>'Reset'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page(
 p_id=>5.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Definir Período de Relatórios do Painel de Controle'
,p_page_mode=>'MODAL'
,p_step_title=>'Definir Período de Relatórios do Painel de Controle'
...
,p_plug_name=>'Definir Período de Relatórios da Home Page'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
,p_prompt=>'Período de Relatórios'
...
,p_lov_display_extra=>'NO'
,p_help_text=>'Definir o período para restringir consultas monitoradas exibidas no painel de controle.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_da_event(
...
wwv_flow_api.create_page(
 p_id=>6.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Home para Administração'
,p_page_mode=>'NORMAL'
,p_step_title=>'Home para Administração'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'A administração permite que você gerencie e monitore aplicações empacotadas em seu espaço de trabalho, dependendo de seus privilégios.'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
...
,p_plug_name=>'Gerenciar Definições do Relatório Interativo'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
...
,p_plug_name=>'Relatórios de Atividades'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4755)
...
wwv_flow_api.create_page(
 p_id=>7.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Detalhes da Aplicação Empacotada'
,p_page_mode=>'MODAL'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
...
,p_plug_name=>'Detalhes da Aplicação Empacotada'
...
wwv_flow_api.create_page(
 p_id=>13.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Gerenciar Relatórios Salvos'
,p_page_mode=>'NORMAL'
,p_step_title=>'Gerenciar Relatórios Salvos'
...
,p_plug_name=>'Relatórios Salvos da Aplicação Empacotada'
...
,p_no_data_found_message=>'As aplicações empacotadas não têm relatórios salvos pelo usuário.'
,p_allow_report_categories=>'N'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
...
,p_display_order=>51
,p_column_identifier=>'J'
,p_column_label=>'Tipo de Relatório'
,p_column_type=>'STRING'
,p_display_text_as=>'LOV_ESCAPE_SC'
...
,p_column_label=>'Nome do Relatório'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
...
,p_error_message=>'O relatório deve ser selecionado para exclusão.'
,p_always_execute=>'N'
...
'    end loop;',
'end loop;'))
,p_process_error_message=>'Não é possível remover o relatório.'
,p_process_when_button_id=>wwv_flow_api.id(802126337999115511.4755)
,p_process_success_message=>'O(s) relatório(s) foi(ram) excluído(s).'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>17.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Gerenciar Inscrições'
,p_page_mode=>'NORMAL'
,p_step_title=>'Gerenciar Inscrições'
...
,p_max_row_count=>'10000'
,p_max_row_count_message=>'Esta consulta retorna mais de 10.000 linhas. Filtre seus dados para garantir resultados completos.'
,p_no_data_found_message=>'As aplicações empacotadas não têm inscrições.'
,p_allow_report_categories=>'N'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
'return true;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'A assinatura deve ser selecionada para exclusão.'
,p_always_execute=>'N'
...
'    end loop;',
'end loop;'))
,p_process_error_message=>'Não é possível remover a assinatura.'
,p_process_when_button_id=>wwv_flow_api.id(805213568160829552.4755)
,p_process_success_message=>'A(s) inscrição(ões) foi(oram) removida(s).'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>22.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Definir Preferências do Espaço de Trabalho'
,p_page_mode=>'NORMAL'
,p_step_title=>'Definir Preferências do Espaço de Trabalho'
...
,p_plug_name=>'Definir Preferências'
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'As preferências controlam a funcionalidade do espaço de trabalho.'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
,p_plug_name=>'Definir Preferências do Espaço de Trabalho'
...
,p_use_cache_before_default=>'NO'
,p_prompt=>'Expiração e Bloqueio da Conta:'
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Selecione para determinar se contas de usuário final do &PRODUCT_NAME. podem ser encerradas ou bloqueadas. Esse recurso se aplica apenas a contas de',
'usuário final criadas usando-se a interface de gerenciamento de usuário do &PRODUCT_NAME..',
' As opções disponíveis incluem:',
'<ul>',
'<li>Ativar</li>',
'<li>Desativar</li>',
'</ul>',
'O recurso oferece segurança adicional de autenticação para aplicações.',
'Se você selecionar<b>Ativar</b>, as senhas da conta do usuário será encerrada após período configurável de tempo,',
'contas serão bloqueadas depois um número configurável de falhas de autenticação e senhas de contas poderão ser definidas para serem encerradas após o primeiro uso.',
'<p>',
'Se o administrador da instalação do &PRODUCT_NAME. tiver especificado a Definição de Ambiente <b>Exigir Encerramento e Bloqueio de Conta de Usuário </b> como Sim, significa que o recurso deve ser ativado em todos os espaços de trabalho e o item exibi'
||'rá <b>Ativado</b> e não poderá ser alterado pelo administrador do espaço de trabalho.'))
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_prompt=>'Número Máximo de Falhas de Log-in Permitidas:'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Informe um número inteiro positivo a ser usado como o número máximo permitido de tentativas de autenticação sem sucesso antes de uma conta de usuário final ser bloqueada.',
'Se você não especificar um valor neste campo, será usada a Definição de Ambiente <b>Número Máximo de Falhas de Log-in Permitidas</b> no nível do site.'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'    45 )'))
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_prompt=>'Vida Útil da Conta do Usuário Final (dias):'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Informe um número inteiro positivo a ser usado como o número máximo de dias em que uma senha de conta de usuário pode ser usada antes de a conta expirar. Se você não especificar um valor neste campo, será usada a Definição de Ambiente <b>Vida Útil da'
||' Senha da  Conta</b> no nível do site.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'end if;'))
,p_process_error_message=>'Não é possível aplicar preferências do espaço de trabalho.'
,p_process_when_button_id=>wwv_flow_api.id(805414831280857790.4755)
,p_process_success_message=>'Preferências de Espaço de Trabalho aplicadas'
);
wwv_flow_api.create_page_process(
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Nome do usuário cuja senha será alterada'
,p_attribute_01=>'Y'
...
,p_error_message=>'O nome do usuário não foi definido corretamente. Feche o browser completamente e tente alterar sua senha novamente.'
,p_always_execute=>'N'
...
wwv_flow_api.create_page(
 p_id=>27.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Atividade de Aplicação'
,p_page_mode=>'NORMAL'
,p_step_title=>'Atividade de Aplicação'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(741368521013994306.4755)
,p_page_template_options=>'#DEFAULT#'
...
,p_plug_name=>'Atividade de Aplicação'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4755)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page(
 p_id=>29.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Views de Página'
,p_page_mode=>'NORMAL'
,p_step_title=>'Views de Página'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(818291832742192134.4755)
...
wwv_flow_api.create_page(
 p_id=>30.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Principais Usuários'
,p_page_mode=>'NORMAL'
,p_step_title=>'Principais Usuários'
...
,p_plug_name=>'Principais Usuários'
,p_plug_template=>wwv_flow_api.id(805538978589340502.4755)
,p_plug_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
...
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Views de Página'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Linhas Extraídas'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
);
...
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Pesquisas de Relatório'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
...
wwv_flow_api.create_page(
 p_id=>46.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Alterar Autenticação'
,p_page_mode=>'MODAL'
,p_step_title=>'Alterar Autenticação'
...
,p_plug_name=>'Alterar Autenticação'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(740771588500180474.4755)
...
,p_plug_name=>'Definições de Autenticação'
...
'<script type="text/javascript">',
'// ocultar os atributos dinâmicos imediatamente depois de serem renderizados, ',
...
'        commit;',
' end;'))
,p_process_error_message=>'A aplicação não foi atualizada com sucesso.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492892500116858121.4755)
,p_process_success_message=>'Esquema de autenticação de aplicação atualizado com sucesso.'
);
wwv_flow_api.create_page_process(
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492892500116858121.4755)
,p_process_success_message=>'Autenticação da aplicação alterada.'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1119586009828190520.4755)
,p_plug_name=>'JSON de Aplicações'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(404672496027804677.4755)
,p_plug_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'Y'
...
,p_plug_name=>'Galeria de Aplicações Empacotadas'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1212073820889771903.4755)
,p_plug_name=>'Pesquisar no Container'
,p_region_template_options=>'#DEFAULT#'
...
,p_prompt=>'Pesquisar'
,p_placeholder=>'pesquisar aplicações empacotadas'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
,p_name=>'Detalhes da Aplicação Empacotada'
,p_page_mode=>'NORMAL'
,p_step_title=>'Detalhes da Aplicação Empacotada'
...
wwv_flow_api.create_page(
 p_id=>83.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Instalar Aplicação Empacotada'
,p_page_mode=>'MODAL'
,p_step_title=>'Instalar Aplicação Empacotada'
...
,p_cache_mode=>'NOCACHE'
,p_cache_timeout_seconds=>21600
,p_last_upd_yyyymmddhh24miss=>'20150428185147'
);
wwv_flow_api.create_page_plug(
...
,p_plug_name=>'Objetos da Websheet Inválidos'
...
,p_plug_name=>'Instalar Aplicação'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(740771588500180474.4755)
,p_plug_display_sequence=>10
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4755)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Instalar Aplicação'
,p_button_position=>'REGION_TEMPLATE_CREATE'
...
,p_item_plug_id=>wwv_flow_api.id(492809197937498056.4755)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Nome do Espaço de Trabalho:'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select DISPLAY_NAME',
'from WWV_FLOW_COMPANIES',
...
,p_plug_name=>'Instalando Aplicação...'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(1164736283212438414.4755)
...
,p_process_error_message=>'A aplicação não foi instalada com sucesso.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Aplicação instalada.'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>100.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Solicitar Serviço - Identificar Solicitação'
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Serviço - Identificar Solicitação'
...
,p_plug_name=>'Identificar Solicitação'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(740771588500180474.4755)
,p_plug_display_sequence=>10
...
,p_plug_name=>'Utilização do Tablespace'
...
,p_prompt=>'Identifique o tipo de serviço que você deseja solicitar:'
,p_source=>'STORAGE'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_RADIOGROUP'
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'Selecione uma solicitação de alteração de serviço e clique em <b>Próximo</b>.'
,p_attribute_01=>'3'
,p_attribute_02=>'NONE'
...
,p_error_message=>'Volume de armazenamento inválido solicitado.'
,p_always_execute=>'N'
...
wwv_flow_api.create_page(
 p_id=>101.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Solicitar Armazenamento - Definir Solicitação'
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Armazenamento - Definir Solicitação'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Especifique o espaço a ser adicionado.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
...
wwv_flow_api.create_page(
 p_id=>102.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Solicitar Término de Serviço - Definir Solicitação'
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Término de Serviço - Definir Solicitação'
...
,p_name=>'Aplicações de Banco de Dados'
,p_template=>wwv_flow_api.id(662132465401686364.4755)
,p_display_sequence=>50
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'Não foram encontradas Aplicações de Banco de Dados.'
,p_query_num_rows_type=>'ROW_RANGES_WITH_LINKS'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_csv_output=>'N'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'Não foram encontradas Aplicações de Websheet.'
,p_query_num_rows_type=>'ROW_RANGES_WITH_LINKS'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_csv_output=>'N'
...
,p_name=>'Encerramento do Serviço do Espaço de Trabalho'
,p_template=>wwv_flow_api.id(740771588500180474.4755)
,p_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
...
'<p>Os administradores de espaços de trabalho usam esta página para solicitar o término do serviço.</p>'))
...
,p_column_display_sequence=>2
,p_column_heading=>'Nome do Espaço de Trabalho'
,p_use_as_row_header=>'N'
,p_lov_show_nulls=>'NO'
,p_include_in_export=>'Y'
);
...
,p_column_display_sequence=>2
,p_column_heading=>'Tablespace Padrão'
,p_use_as_row_header=>'N'
,p_lov_show_nulls=>'NO'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(805274418118000233.4755)
,p_name=>'Desenvolvedores de Aplicações'
,p_template=>wwv_flow_api.id(662132465401686364.4755)
,p_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(805274700563000235.4755)
,p_query_column_id=>1
,p_column_alias=>'THE_NAME'
,p_column_display_sequence=>1
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(805274820294000235.4755)
,p_query_column_id=>2
,p_column_alias=>'THE_NAME'
,p_column_display_sequence=>2
,p_use_as_row_header=>'N'
...
,p_plug_name=>'Solicitar Encerramento do Serviço'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'DEFAULT'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(805132117516607920.4755)
...
wwv_flow_api.create_page(
 p_id=>103.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Relatório Detalhado de Utilização de Tablespaces'
,p_page_mode=>'MODAL'
,p_step_title=>'Relatório Detalhado de Utilização de Tablespaces'
...
,p_name=>'Utilização do Tablespace'
,p_template=>wwv_flow_api.id(404667570222803088.4755)
,p_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>Confirme sua solicitação.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Especifique o espaço que será necessário'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_process_success_message=>'Você solicitou &P101_STORAGE. MB adicionais de armazenamento.'
...
wwv_flow_api.create_page(
 p_id=>105.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Provisionamento: Solicitar Término do Serviço'
,p_page_mode=>'NORMAL'
,p_step_title=>'Provisionamento: Solicitar Término do Serviço'
...
,p_plug_name=>'Confirmar Encerramento do Serviço'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(740771588500180474.4755)
,p_plug_display_sequence=>10
...
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>Esta página permite que o administrador de um espaço de trabalho solicite o encerramento do serviço ao qual ele está conectado no momento.<br/><br/>',
'',
'<b>IMPORTANTE!</b>: Todos os dados, objetos e esquemas de banco de dados, tablespaces, aplicações, scripts, arquivos etc. serão removidos quando o serviço for encerrado.</p>',
'',
'<p>Confirme se você gostaria de encerrar o serviço.</p>'))
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4755)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Encerrar Serviço'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_branch(
...
,p_error_message=>'Já existe uma solicitação de encerramento de serviço para este espaço de trabalho.'
,p_always_execute=>'N'
...
'    p_service_attribute_2  => wwv_flow_user_api.get_email(p_username => upper(wwv_flow.g_user)));',
'end;'))
,p_process_error_message=>'Erro ao submeter a solicitação de encerramento do serviço.'
,p_process_when_button_id=>wwv_flow_api.id(805380789015646517.4755)
,p_process_success_message=>'Solicitação de encerramento do serviço submetida.'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>209.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Configuração da Conta do Application Express'
,p_page_mode=>'MODAL'
,p_step_title=>'Configuração da Conta do Application Express'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(492818829813527218.4755)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#:a-ButtonRegion--noUI'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(492819635063527220.4755)
,p_plug_name=>'Configurar Conta'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(770118466855390796.4755)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(492818829813527218.4755)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4755)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(492819215638527220.4755)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(492818829813527218.4755)
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4755)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Criar Usuário'
,p_button_position=>'REGION_TEMPLATE_CREATE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492819882805527221.4755)
,p_name=>'P209_APP_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4755)
,p_prompt=>'Nome da Aplicação:'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
,p_field_template=>wwv_flow_api.id(741376158824001765.4755)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820018143527222.4755)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820296100527225.4755)
,p_name=>'P209_SCHEMA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4755)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820409273527225.4755)
,p_name=>'P209_METHOD'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4755)
,p_item_default=>'E'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820697304527226.4755)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820844713527226.4755)
,p_name=>'P209_EXISTING_USER'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4755)
,p_prompt=>'Nome do usuário Existente'
,p_source=>'APP_USER'
,p_source_type=>'ITEM'
,p_display_as=>'NATIVE_SELECT_LIST'
...
'order by 1'))
,p_lov_display_null=>'YES'
,p_lov_null_text=>'- Selecionar Usuário -'
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492821075748527226.4755)
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Especifique o nome do usuário a ser usado para efetuar log-in na aplicação empacotada. Os nomes do usuário têm essas restrições: <p/><ul><li>',
'tamanho máximo de 100 caracteres</li><li>',
'nenhum espaço</li>',
'<li>somente esses caracteres especiais são permitidos: @ e pontos (.)</li></ul>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492821585156527227.4755)
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Especifique uma senha. As senhas fazem distinção entre maiúsculas e minúsculas.'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492822027856527228.4755)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492822594676527228.4755)
,p_name=>'P209_EMAIL'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4755)
,p_prompt=>'E-mail'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Especifique um endereço de e-mail para ser usado com notificações e correspondência geral sobre a redefinição de senhas, etc.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(656958442251052404.4755)
,p_name=>'P209_WARNING_MSG'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4755)
,p_prompt=>'Mensagem de Advertência'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'if :P81_APP_TYPE = ''DATABASE'' then',
...
,p_cSize=>30
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(750871254241940005.4755)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch:a-Form-fieldContainer--autoLabelWidth'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(777061579764817791.4755)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823118333527228.4755)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823384065527229.4755)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823728079527229.4755)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492823955896527229.4755)
...
,p_associated_item=>wwv_flow_api.id(492821075748527226.4755)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824175298527231.4755)
...
,p_associated_item=>wwv_flow_api.id(492822594676527228.4755)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824349197527231.4755)
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Endereço de e-mail inválido.'
,p_always_execute=>'N'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824530875527231.4755)
...
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_api.id(492821585156527227.4755)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824717510527231.4755)
...
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_api.id(492822027856527228.4755)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824939547527231.4755)
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'A senha de confirmação corresponde à senha informada.'
,p_always_execute=>'N'
,p_validation_condition=>'P209_CREATE_USER'
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(492819215638527220.4755)
,p_associated_item=>wwv_flow_api.id(.4755)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825193741527232.4755)
,p_validation_name=>'strong password'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825374747527232.4755)
...
'return true;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'O nome do usuário já existe.'
,p_always_execute=>'N'
,p_validation_condition=>'P209_CREATE_USER'
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825541202527232.4755)
,p_validation_name=>'P209_EXISTING_USER Should Not Be Null'
,p_validation_sequence=>80
,p_validation=>'P209_EXISTING_USER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Se não houver usuário, então você deve criar um novo usuário.'
,p_always_execute=>'N'
...
,p_when_button_pressed=>wwv_flow_api.id(492819215638527220.4755)
,p_only_for_changed_rows=>'Y'
,p_associated_item=>wwv_flow_api.id(492820844713527226.4755)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(492826451491527234.4755)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492826790590527234.4755)
,p_event_id=>wwv_flow_api.id(492826451491527234.4755)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492826968456527234.4755)
,p_event_id=>wwv_flow_api.id(492826451491527234.4755)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827153196527234.4755)
,p_event_id=>wwv_flow_api.id(492826451491527234.4755)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(492827265876527234.4755)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827513295527235.4755)
,p_event_id=>wwv_flow_api.id(492827265876527234.4755)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827728196527235.4755)
,p_event_id=>wwv_flow_api.id(492827265876527234.4755)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827960709527235.4755)
,p_event_id=>wwv_flow_api.id(492827265876527234.4755)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492828182378527235.4755)
,p_event_id=>wwv_flow_api.id(492827265876527234.4755)
,p_event_result=>'FALSE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(770119774478414886.4755)
,p_name=>'Close Dialog'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(770118466855390796.4755)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(770120016874414887.4755)
,p_event_id=>wwv_flow_api.id(770119774478414886.4755)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(492825632290527232.4755)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4755)
,p_process_when=>'wwv_flow_global.g_cloud and :P83_AUTH = ''NATIVE_APEX_ACCOUNTS'' and :P81_APP_TYPE = ''DATABASE'''
,p_process_when_type=>'PLSQL_EXPRESSION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(492825893428527233.4755)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'    ); ',
'end;'))
,p_process_error_message=>'Não é possível definir o administrador da Websheet.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4755)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(770120150142419290.4755)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4755)
,p_process_success_message=>'Configuração da conta para executar a aplicação.'
);
end;
/
...
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_plug_header=>'Aplicação empacotada instalada. Porém, houve falha na instalação de objetos de banco de dados e nos dados pré-implantados.'
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
);
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'Nenhum resultado de instalação encontrado'
...
,p_column_display_sequence=>4
,p_column_heading=>'Instruções com Erros'
,p_use_as_row_header=>'N'
,p_column_alignment=>'RIGHT'
,p_sum_column=>'Y'
,p_derived_column=>'N'
...
,p_column_display_sequence=>3
,p_column_heading=>'Instruções Bem-sucedidas'
,p_use_as_row_header=>'N'
,p_column_alignment=>'RIGHT'
,p_sum_column=>'Y'
,p_derived_column=>'N'
...
,p_column_display_sequence=>5
,p_column_heading=>'Total de Instruções'
,p_use_as_row_header=>'N'
,p_column_alignment=>'RIGHT'
,p_sum_column=>'Y'
,p_derived_column=>'N'
...
wwv_flow_api.create_page(
 p_id=>234.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Desbloquear Aplicação Empacotada'
,p_page_mode=>'MODAL'
,p_step_title=>'Desbloquear Aplicação Empacotada'
...
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_header=>'Desbloquear uma aplicação empacotada tornará a aplicação <strong>inelegível para futuros upgrades</strong> e isso <strong>não será mais suportado</strong> pelo Oracle Support.'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4755)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Desbloquear Aplicação'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
...
,p_plug_name=>'Desbloqueando Aplicação...'
,p_region_template_options=>'#DEFAULT#:a-ProcessingRegion--dialog'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1164683681838385745.4755)
,p_plug_display_sequence=>10
...
'  end loop;',
'end;'))
,p_process_error_message=>'Erro ao desbloquear a aplicação'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Aplicação desbloqueada'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>237.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Remover Aplicação Empacotada'
,p_page_mode=>'MODAL'
,p_step_title=>'Remover Aplicação Empacotada'
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4755)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Remover Aplicação'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
...
,p_plug_name=>'Removendo Aplicação...'
...
'  end if;',
'end;'))
,p_process_error_message=>'Erro ao remover a aplicação'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Aplicação removida'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>262.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Atualizar Aplicação Empacotada'
,p_page_mode=>'MODAL'
,p_step_title=>'Atualizar Aplicação Empacotada'
...
,p_plug_name=>'Atualizar Aplicação'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(740771588500180474.4755)
,p_plug_display_sequence=>10
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4755)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Atualizar Aplicação'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
...
,p_plug_name=>'Atualizando Aplicação...'
,p_region_template_options=>'#DEFAULT#:a-ProcessingRegion--dialog'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1164683681838385745.4755)
,p_plug_display_sequence=>10
...
,p_process_error_message=>'A aplicação não foi atualizada com sucesso.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Aplicação Atualizada Com Sucesso.'
);
wwv_flow_api.create_page_process(
...
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Aplicação atualizada.'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>300.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Gerenciar Usuários'
,p_page_mode=>'NORMAL'
,p_step_title=>'Gerenciar Usuários'
...
,p_column_label=>'Conta do Usuário Final'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>11
,p_column_identifier=>'L'
,p_column_label=>'Data do Último Log-in do Builder'
,p_column_type=>'DATE'
...
,p_column_label=>'Último Log-in do Builder'
,p_column_type=>'DATE'
,p_format_mask=>'SINCE'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>19
,p_column_identifier=>'S'
,p_column_label=>'Dias de Vida Útil da Senha'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>20
,p_column_identifier=>'T'
,p_column_label=>'Acessos de Vida Útil da Senha'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>21
,p_column_identifier=>'U'
,p_column_label=>'Acessos à Senha Restantes'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>23
,p_column_identifier=>'W'
,p_column_label=>'Último Endereço IP'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>24
,p_column_identifier=>'X'
,p_column_label=>'Expiração da Conta'
,p_column_type=>'DATE'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>35
,p_column_identifier=>'AI'
,p_column_label=>'Application Builder'
,p_column_type=>'STRING'
...
,p_column_label=>'Classe de exibição do ícone'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_page_plug(
...
,p_plug_name=>'Gerenciar Usuários'
,p_region_template_options=>'#DEFAULT#:a-Region--paddedBody:a-Region--sideRegion'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4755)
...
,p_plug_name=>'Painéis de Controle'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding:a-Region--sideRegion'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4755)
,p_plug_display_sequence=>60
...
,p_button_template_id=>wwv_flow_api.id(758581488338548971.4755)
,p_button_image_alt=>'Criar Vários Usuários'
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
...
wwv_flow_api.create_page(
 p_id=>301.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Criar Usuário'
,p_page_mode=>'NORMAL'
,p_step_title=>'Criar Usuário'
...
,p_plug_name=>'Privilégios da Conta'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4755)
,p_plug_display_sequence=>40
...
,p_plug_name=>'Identificação do Usuário'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4755)
,p_plug_display_sequence=>30
...
,p_plug_name=>'Seletor de Exibição de Região'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(404672496027804677.4755)
,p_plug_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'Y'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'Especifique o esquema padrão usado para procurar dados, criação de aplicações e execução do script SQL. Ao utilizar espaços de trabalho que têm mais de um esquema disponível, este esquema é o padrão para criar aplicações e fazer consultas SQL, etc. E'
||'sse recurso não controla a segurança, somente as preferências do usuário.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
...
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(801868755606261949.4755)
,p_prompt=>'Esquemas Acessíveis (nulo para todos)'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>32
,p_cMaxlength=>4000
,p_cHeight=>1
...
,p_help_text=>'Informe uma lista de esquemas delimitada por dois-pontos para os quais este desenvolvedor tem permissão ao usar o SQL Workshop. A lista de esquemas informada aqui restringe o usuário a um subconjunto dos esquemas provisionados para o espaço de trabal'
||'ho e determina quais nomes de esquemas o usuário verá no SQL Workshop.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_plug_id=>wwv_flow_api.id(801868755606261949.4755)
,p_item_default=>'N'
,p_prompt=>'O usuário é um administrador de espaços de trabalho:'
,p_display_as=>'NATIVE_RADIOGROUP'
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Especifica se este usuário deve ter privilégios de administrador do espaço de trabalho. Os administradores têm acesso a todos os componentes. Além disso, também podem gerenciar contas de usuários, grupos e serviços de desenvolvimento.',
'',
'Os componentes talvez não estejam disponíveis, se forem desativados pelos Administradores da Instância.'))
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_item_plug_id=>wwv_flow_api.id(801868755606261949.4755)
,p_item_default=>'N'
,p_prompt=>'O usuário é um desenvolvedor:'
,p_display_as=>'NATIVE_RADIOGROUP'
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'Especifique se este usuário deverá ter privilégios de desenvolvedor. Os desenvolvedores podem instalar, remover ou fazer upgrade das aplicações empacotadas.'
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
,p_attribute_04=>'VERTICAL'
);
...
,p_use_cache_before_default=>'NO'
,p_item_default=>'Y'
,p_prompt=>'Acesso ao Application Builder'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'YES_NO_RETURNS_Y_OR_N'
,p_lov=>'.'||wwv_flow_api.id(801893675976261985)||'.'
,p_cHeight=>1
...
'<br>',
'O Administrador sempre terá acesso ao Application Builder.<br>',
'O Desenvolvedor deve ter acesso ao Application Builder, ao SQL Workshop ou a ambos.<br>',
'<br>',
'Este atributo sempre fica desativado quando o Acesso ao Application Builder é desativado para o espaço de trabalho por um administrador.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Determines whether a developer has access to the Application Builder.<br>',
'<br>',
'An Administrator will always have access to the Application Builder.<br>',
'A Developer must have access to either the Application Builder, the SQL Workshop, or both.<br>',
'<br>',
'This attribute is always disabled when Application Builder Access is disabled for the workspace by an Administrator.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
'<br>',
'O Administrador sempre terá acesso ao desenvolvimento da Websheet.<br>',
'<br>',
'Este atributo sempre fica desativado quando o Acesso ao Desenvolvimento da Websheet do espaço de trabalho é desativado por um Administrador.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
'<br>',
'O Administrador sempre terá acesso ao SQL Workshop.<br>',
'O Desenvolvedor deve ter acesso ao Application Builder, ao SQL Workshop ou a ambos.<br>',
'<br>',
'Este atributo sempre fica desativado quando o Acesso ao SQL Workshop é desativado para o espaço de trabalho por um administrador.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Determina se um usuário tem acesso ao Team Development.<br>',
'<br>',
'O Administrador sempre terá acesso ao Team Development.<br>',
'<br>',
'Este atributo sempre fica desativado quando o Acesso ao Team Development do espaço de trabalho é desativado por um Administrador.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Especifica o nome do usuário usado para efetuar log-in no sistema. Os nomes do usuário têm estas restrições: <ul><li>',
'comprimento máximo de 100 caracteres</li><li>',
'sem espaço</li>',
'<li>apenas estes caracteres especiais são permitidos: @ e pontos finais (.)</li></ul>',
'<p>O nome do usuário também pode ser usado para referenciar uma atividade do usuário, usando as aplicações do monitor. A variável de bind <code>:app_user </code>retorna o valor do usuário atual ao criar aplicações.</p>',
''))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Especifique o nome do usuário para identificá-lo ainda mais. Esse campo opcional é usado somente para fins de informação.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Especifique o sobrenome do usuário para identificá-lo ainda mais. Esse campo opcional é usado somente para fins de informação.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Use este campo para fazer comentários sobre o usuário apenas para fins de informação.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'Y'
,p_attribute_04=>'NONE'
...
,p_use_cache_before_default=>'NO'
,p_prompt=>'Senha'
,p_post_element_text=>' <span class="instructiontext">As senhas fazem distinção entre maiúsculas e minúsculas</span>'
,p_display_as=>'NATIVE_PASSWORD'
,p_cSize=>30
,p_cMaxlength=>255
,p_field_template=>wwv_flow_api.id(741376307162001773.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Especifique uma senha. As senhas fazem distinção entre maiúsculas e minúsculas. Os desenvolvedores podem alterar suas próprias senhas. Os desenvolvedores com o privilégio Administrador podem alterar as senhas de usuários que estejam no mesmo espaço d'
||'e trabalho.'
...
,p_item_plug_id=>wwv_flow_api.id(801880245567261967.4755)
,p_item_default=>'Y'
,p_prompt=>'Exigir Alteração da Senha na Primeira Vez'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'YES_NO_RETURNS_Y_OR_N'
,p_lov=>'.'||wwv_flow_api.id(801893675976261985)||'.'
,p_cHeight=>1
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Selecione <b>Sim</b> para exigir que o usuário desta conta altere a senha imediatamente após efetuar o log-in pela primeira vez usando a senha atual. Essa regra se aplica ao uso dessa conta para a administração e o desenvolvimento de espaço de trabal'
||'hos, assim como para o log-in nas aplicações desenvolvidas.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'O nome do usuário deve ser especificado.'
,p_always_execute=>'N'
...
,p_error_message=>'Nome do Usuário Inválido.'
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
,p_associated_item=>wwv_flow_api.id(801875696425261961.4755)
...
,p_validation_type=>'NOT_EXISTS'
,p_error_message=>'O usuário &F4750_P301_USER_NAME. já existe.'
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
,p_associated_item=>wwv_flow_api.id(801875696425261961.4755)
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'O Endereço de E-mail deve ser especificado.'
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Esquema Padrão deve estar nos Esquemas Acessíveis.'
,p_always_execute=>'N'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'As senhas não correspondem.  '
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
...
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'O nome do usuário não corresponde à expressão definida para a instância.'
,p_always_execute=>'N'
,p_validation_condition=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
,p_process_success_message=>'Usuário criado.'
...
wwv_flow_api.create_page(
 p_id=>302.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Criar Vários Usuários'
,p_page_mode=>'NORMAL'
,p_step_title=>'Criar Vários Usuários'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>Informe ou copie e cole os endereços de e-mail separados por vírgulas, pontos-e-vírgulas ou novas linhas. Observe que se você copiar e colar endereços de e-mail das mensagens de e-mail, textos incorretos serão filtrados. Todos os usuários de e-mai'
||'l fornecidos serão adicionados como atribuição selecionada. Os endereços de e-mail existentes ou duplicados serão ignorados.',
'',
'<p>Observe que a senha que você especificar será designada a cada usuário e os usuários precisarão alterar suas senhas depois que fizerem log-in.</p>'))
,p_plug_query_row_template=>1
,p_plug_column_width=>'valign=top'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_plug_name=>'Criar Vários Usuários'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(805132117516607920.4755)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'Y'
...
,p_prompt=>'Lista de Endereços de E-mail'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>80
,p_cMaxlength=>32767
,p_cHeight=>10
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Informe ou copie e cole os endereços de e-mail separados por vírgulas, pontos-e-vírgulas ou novas linhas. Observe que se você copiar e colar endereços de e-mail das mensagens de e-mail, textos incorretos serão filtrados.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Especifique se deve ser incluído o endereço de e-mail completo ou se deve ser excluído o nome do domínio.',
'As opções incluem:',
'<ul>',
'<li>Definir nome do usuário para endereço de e-mail completo – Inclui o endereço de e-mail completo.</li>',
'<li>Excluir domínio @ como parte do nome do usuário – Remove todo o texto após o símbolo @ (por exemplo,  <code>user1@xyz.com</code> torna-se <code>user1</code>).</li>',
'</ul>',
''))
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
...
,p_item_plug_id=>wwv_flow_api.id(801904748492279859.4755)
,p_item_default=>'N'
,p_prompt=>'Os usuários são administradores de espaços de trabalho:'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_named_lov=>'YES_NO_RETURNS_Y_OR_N'
,p_lov=>'.'||wwv_flow_api.id(801893675976261985)||'.'
,p_tag_attributes=>'onClick="javascript:if (document.forms[0].P52_ADMIN_0.checked) document.forms[0].P52_DEVELOPER_0.checked = true;"'
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'Especifique se estes usuários devem ter privilégios de administrador de espaços de trabalho. Como desenvolvedores, os administradores de espaços de trabalho podem criar e modificar aplicações e objetos do banco de dados. Além disso, eles também podem'
||' gerenciar contas de usuários, grupos e serviços de desenvolvimento.'
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_item_plug_id=>wwv_flow_api.id(801904748492279859.4755)
,p_item_default=>'N'
,p_prompt=>'Usuários e desenvolvedores:'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_named_lov=>'DEVELOPER TYPE'
,p_lov=>'.'||wwv_flow_api.id(801895490296261989)||'.'
,p_tag_attributes=>'onClick="javascript:if (document.forms[0].P52_ADMIN_0.checked) document.forms[0].P52_DEVELOPER_0.checked = true;"'
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'Especifique se estes usuários deverão ter privilégios de desenvolvedor. Os desenvolvedores podem criar e modificar aplicações e objetos do banco de dados.'
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_error_message=>'Senha e confirmação de senha não correspondem.'
,p_always_execute=>'N'
...
,p_cache_timeout_seconds=>21600
,p_help_text=>'AEADM/aadm_users.htm'
,p_last_upd_yyyymmddhh24miss=>'20150428185148'
);
wwv_flow_api.create_page_plug(
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'Nenhum endereço de e-mail válido encontrado.'
,p_query_num_rows_type=>'0'
,p_query_row_count_max=>5000
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_break_type_flag=>'DEFAULT_BREAK_FORMATTING'
...
,p_column_display_sequence=>1
,p_column_heading=>'Nomes de usuários'
,p_use_as_row_header=>'N'
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'Nenhum novo usuário inválido encontrado'
,p_query_num_rows_type=>'0'
,p_query_row_count_max=>5000
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_break_type_flag=>'DEFAULT_BREAK_FORMATTING'
...
,p_column_display_sequence=>2
,p_column_heading=>'Por Que Inválido?'
);
wwv_flow_api.create_page_plug(
...
,p_plug_name=>'Não Há Usuários Válidos'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404672496027804677.4755)
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'<p>A lista de nomes de usuários da página anterior não encontrou nomes de usuários válidos e &P303_INVALID_COUNT. nomes de usuários inválidos. Volte e verifique a lista de nomes de usuários fornecidas.</p>'
,p_plug_query_row_template=>1
,p_plug_query_num_rows=>15
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4755)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Criar Usuários Válidos'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
...
'',
'commit;'))
,p_process_error_message=>'Erro Inesperado ao Criar os Usuários'
,p_process_success_message=>'Usuários Criados'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>305.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Excluir Vários Usuários'
,p_page_mode=>'NORMAL'
,p_step_title=>'Excluir Vários Usuários'
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4755)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Excluir Usuários'
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_branch(
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Selecione pelo menos um usuário para exclusão.'
,p_always_execute=>'N'
...
'end loop;'))
,p_process_error_message=>'Falha na exclusão do(s) usuário(s).'
,p_process_when_button_id=>wwv_flow_api.id(805152655703739453.4755)
,p_process_success_message=>'Usuário(s) excluído(s).'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>306.4755
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4755)
,p_name=>'Editar Usuário'
,p_page_mode=>'NORMAL'
,p_step_title=>'Editar Usuário'
...
,p_plug_name=>'Usuários do &PRODUCT_NAME.'
,p_region_template_options=>'#DEFAULT#:a-Region--paddedBody:a-Region--sideRegion'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4755)
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>Este gerenciador de usuários mantém contas para uso por esquemas de autenticação que realizam a autenticação com base no nome de usuário e na senha armazenados nessas contas.</p>',
'<p>Se você deseja alterar a senha de um usuário, informe uma nova senha; caso contrário, deixe as colunas de senha nulas e a senha atual não será alterada.</p>'))
,p_plug_query_row_template=>wwv_flow_api.id(1939532588110833.4755)
...
,p_plug_name=>'Usuário: &F4750_P306_USER_NAME.'
,p_region_template_options=>'#DEFAULT#:a-ButtonRegion--withItems:a-ButtonRegion--noUI:a-ButtonRegion--showTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(740735067061086300.4755)
,p_plug_display_sequence=>20
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4755)
,p_button_image_alt=>'Excluir Usuário'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Identifica o espaço de trabalho ao qual este usuário pertence.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_field_template=>wwv_flow_api.id(741376307162001773.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Especifica o endereço de e-mail para ser usado com correspondências gerais e notificações sobre redefinição de senhas, etc.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'EMAIL'
,p_attribute_05=>'BOTH'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>'Especifique o formato de data da Oracle padrão do usuário. Isto controlará o formato de data padrão dentro do SQL Workshop.'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Especifique se este usuário deve ter privilégios de administrador do espaço de trabalho. Os administradores têm acesso a todos os componentes. Além disso, também podem gerenciar contas de usuários, grupos e serviços de desenvolvimento.',
'',
'Os componentes talvez não estejam disponíveis, se forem desativados pelos Administradores da Instância.'))
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>O usuário pertence aos grupos que estão destacados. Para adicionar um usuário ao grupo, clique no nome para que ele seja destacado. Para remover um grupo, clique nele novamente para apagar o destaque. </p> <p>',
'As atribuições do grupo permitem que os desenvolvedores controlem o acesso a recursos e funções específicas por grupos. ',
'Esse recurso do grupo está incorporado ao Application Builder e funciona melhor (e de forma mais conveniente) com a autenticação baseada em cookies. ',
'Entretanto, esse recurso do grupo de usuários não pode ser usado em esquemas de autenticação diferentes.</p>'))
,p_attribute_01=>'Y'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'A senha usada para efetuar log-in no sistema. Não informe uma senha, a menos que você queira alterar a senha atual.'
,p_attribute_01=>'N'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Informe a senha novamente. Não informe uma senha, a menos que você queira alterar a senha atual.'
,p_attribute_01=>'N'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Indica se a senha está expirada ou é válida para o log-in do desenvolvedor ou administrador do espaço de trabalho.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_api.id(805491259930047781.4755)
,p_prompt=>'Senha do Usuário Final'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Indica se a senha está expirada ou válida para o log-in do Usuário Final.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'Marque esta caixa de seleção para expirar a senha do usuário. Isso afeta o log-in e o acesso do desenvolvedor/administrador como usuário final. Se estiver expirada, na próxima vez que esta conta for acessada, o usuário será solicitado a fornecer a an'
||'tiga senha junto com a nova senha para efetuar o log-in.'
,p_attribute_01=>'1'
);
wwv_flow_api.create_page_item(
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Você deve fornecer um nome de usuário.'
,p_always_execute=>'N'
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Você não pode remover o privilégio admin de si mesmo.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(805491074986047781.4755)
...
'end loop;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Se você atualizar o Nome do usuário, forneça uma nova senha.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(805491074986047781.4755)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'A senha não foi confirmada corretamente; informe exatamente a mesma senha duas vezes.'
,p_always_execute=>'N'
,p_validation_condition=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
'    exit;',
'end loop;'))
,p_process_error_message=>'Erro ao extrair informações sobre o usuário.'
);
wwv_flow_api.create_page_process(
...
'  end if;',
'end;'))
,p_process_error_message=>'Erro ao atualizar usuário.'
,p_process_when_button_id=>wwv_flow_api.id(805491074986047781.4755)
,p_process_success_message=>'Usuário "&F4750_P306_USER_NAME." atualizado.'
);
wwv_flow_api.create_page_process(
...
,p_process_success_message=>'Usuário &F4750_P306_USER_NAME. excluído.'
);
wwv_flow_api.create_page_process(
...
,p_plug_name=>'Feedback existente nesta página'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'Nenhum feedback informado nesta página.'
...
,p_column_display_sequence=>5
,p_column_heading=>'Resposta Pública'
,p_use_as_row_header=>'N'
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'A Aplicação na qual você está fornecendo feedback.'
,p_attribute_01=>'Y'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'A página na qual você está fornecendo feedback.'
,p_attribute_01=>'Y'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(829721255038941612.4755)
,p_prompt=>'Feedback para o Application Builder e o APEX Application Development'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>96
,p_cMaxlength=>4000
,p_cHeight=>4
,p_field_template=>wwv_flow_api.id(741376307162001773.4755)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Ajude a aprimorar o &PRODUCT_NAME. fornecendo seus comentários.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'Identifique em qual componente ou funcionalidade você está inserindo comentários.'
,p_attribute_01=>'3'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_validation(
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(829724817666941621.4755)
...
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(829724329405941619.4755)
,p_associated_item=>wwv_flow_api.id(829722489187941618.4755)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
