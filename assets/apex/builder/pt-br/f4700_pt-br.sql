...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902294712577408700')
...
,p_substitution_value_02=>'Concluído'
...
,p_substitution_value_09=>'Retornar à Aplicação'
,p_substitution_string_10=>'MSG_LANGUAGE'
,p_substitution_value_10=>'Idioma'
,p_substitution_string_11=>'PRODUCT_TYPE'
,p_substitution_value_11=>'Solicitar um Espaço de Trabalho'
,p_substitution_string_12=>'MSG_COPYRIGHT'
,p_substitution_value_12=>'Copyright &copy; 1999, 2015, Oracle. Todos os direitos reservados.'
...
,p_list_item_link_text=>'Identificação'
...
,p_list_item_link_text=>'Confirmação'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1352228430926978.4705)
...
'    return FALSE;',
'end if;'))
,p_error_message=>'As solicitações de espaço de trabalho não estão ativas.'
...
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Desenvolvimento de Aplicações'
...
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Só Aplicações Empacotadas'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824976787312308427.4705)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4705)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977164944308427.4705)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4705)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977534964308429.4705)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4705)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977932305308429.4705)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4705)
...
,p_last_upd_yyyymmddhh24miss=>'20150428185144'
);
...
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4705)
,p_tab_set=>'HOME'
,p_name=>'Solicitar Espaço de Trabalho'
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Serviço'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
...
,p_plug_name=>'Solicitar um Espaço de Trabalho'
...
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_header=>'<p class="a-Wizard-subHeading">Que tipo de espaço de trabalho você deseja solicitar?</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page(
 p_id=>2.4705
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4705)
,p_name=>'Solicitar Espaço de Trabalho - Segunda Página'
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Espaço de Trabalho - Segunda Página'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'As informações de sua conta serão enviadas para este endereço de e-mail.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
,p_field_template=>wwv_flow_api.id(481972771960821314.4705)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Informe o nome do espaço de trabalho que você gostaria de ter. Quando o espaço de trabalho for provisionado, você efetuará log-in usando uma combinação de espaço de trabalho/nome de usuário/senha.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'BOTH'
...
,p_error_message=>'E-mail inválido'
,p_always_execute=>'N'
...
'return true;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Informe um nome de espaço de trabalho diferente.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(624350696578280086.4705)
...
,p_error_message=>'Nome de espaço de trabalho inválido.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(624350696578280086.4705)
...
wwv_flow_api.create_page(
 p_id=>3.4705
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4705)
,p_name=>'Solicitar Espaço de Trabalho - Confirmação'
,p_page_mode=>'NORMAL'
...
,p_plug_name=>'Espaço de Trabalho Solicitado!'
,p_region_css_classes=>'a-Wizard--requestWorkspace'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(481970015003751305.4705)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18348331817861713.4705)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18348522944868646.4705)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18348331817861713.4705)
,p_button_name=>'FINISH'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(481975658518888812.4705)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Tela Continuar para Efetuar Sign-in'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4705)
,p_tab_set=>'HOME'
,p_name=>'Solicitar Espaço de Trabalho - Identificar Esquema'
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Espaço de Trabalho - Identificar Esquema'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4705)
,p_page_template_options=>'#DEFAULT#'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Selecione o espaço em disco de que precisará. Quando o seu esquema for criado, você poderá solicitar mais espaço, se necessário.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
'O nome do esquema é o usuário do banco de dados Oracle que será proprietário dos seus objetos de banco de dados. Dedique algum tempo à escolha desse nome, pois a alteração de esquemas pode ser uma tarefa demorada. Quando seu serviço for provisionado,'
||' você receberá a senha do seu esquema e sua senha de log-in.',
'',
'',
'',
'Os nomes de esquemas válidos devem seguir as seguintes diretrizes:',
'',
' - Devem ter entre 1 e 30 bytes',
'',
' - Não podem conter aspas',
'',
' - Devem começar com um caractere alfabético',
'',
' - Só podem conter caracteres alfanuméricos, com exceção de',
'',
'   (_) sublinhado, ($) cifrão e (#) cerquilha.',
'',
' - Não podem ser uma palavra reservada do Oracle',
'',
' - Não podem ser do tipo DUAL'))
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Informe o nome do esquema que deseja tornar acessível para o novo espaço de trabalho &PRODUCT_NAME. Quando o seu espaço de trabalho for criado, você poderá adicionar outros esquemas a ele.',
''))
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Selecione se você deseja criar um novo esquema de banco de dados ou configurar um esquema de banco de dados existente para o seu novo espaço de trabalho.'
,p_attribute_01=>'1'
...
,p_error_message=>'O esquema &EXISTING_SCHEMA_NAME. não existe.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''NO'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(11472001772984287.4705)
...
,p_error_message=>'O nome do esquema não deve conter espaços.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4705)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'O nome do esquema não deve conter aspas.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4705)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'O nome do esquema (&SCHEMA_NAME.) é reservado ou restrito. Informe outro esquema.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4705)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'O nome do esquema não é válido. Especifique outro nome.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4705)
...
wwv_flow_api.create_page(
 p_id=>26.4705
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4705)
,p_name=>'Solicitar Espaço de Trabalho - Advertências do Esquema'
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Espaço de Trabalho - Advertências do Esquema'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4705)
,p_page_template_options=>'#DEFAULT#'
...
,p_plug_name=>'Solicitar Espaço de Trabalho'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'DEFAULT'
,p_escape_on_http_output=>'Y'
...
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4705)
,p_tab_set=>'HOME'
,p_name=>'Solicitar Espaço de Trabalho - Descrição do Projeto'
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Espaço de Trabalho - Descrição do Projeto'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4705)
,p_page_template_options=>'#DEFAULT#'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p class="a-Wizard-text">Essas informações ajudam o administrador do &PRODUCT_NAME. a entender como você pretende usar este serviço.</p>',
...
,p_prompt=>'Por que você está solicitando este serviço?'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'Informe o objetivo da sua solicitação de serviço. Essas informações deverão ser utilizadas pelo administrador do &PRODUCT_NAME.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(516409441539385628.4705)
,p_prompt=>'Justificativa para a solicitação de serviço; opcional'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>70
,p_cMaxlength=>32767
,p_cHeight=>8
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'Se sua empresa ou acordo de serviço exigir que você justifique a sua solicitação, forneça uma justificativa.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Explique por que está solicitando este serviço.'
,p_always_execute=>'N'
...
wwv_flow_api.create_page(
 p_id=>28.4705
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4705)
,p_name=>'Acordo de Serviço'
,p_page_mode=>'NORMAL'
,p_step_title=>'Acordo de Serviço'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4705)
,p_page_template_options=>'#DEFAULT#'
...
,p_error_message=>'Você deve aceitar os termos para prosseguir.'
,p_always_execute=>'N'
...
,p_name=>'Solicitar Espaço de Trabalho - Confirmação'
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Espaço de Trabalho - Confirmação'
...
,p_cache_mode=>'NOCACHE'
,p_cache_timeout_seconds=>21600
,p_last_upd_yyyymmddhh24miss=>'20150428185145'
);
wwv_flow_api.create_page_plug(
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'<p class="a-Wizard-text">Verifique sua solicitação de espaço de trabalho.</p>'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
...
,p_button_template_id=>wwv_flow_api.id(481975242743888810.4705)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Submeter Solicitação'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
,p_use_cache_before_default=>'NO'
,p_prompt=>'Código de Verificação'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>10
,p_cMaxlength=>5
,p_tag_css_classes=>'a-Form-field a-Form-field--readOnly'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Você deve informara o código de verificação exibido na caixa.',
'Tome cuidado ao inserir letras, já que elas <b>fazem distinção entre maiúsculas e minúsculas</b>.'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Código de Verificação Inválido'
,p_always_execute=>'N'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Todos os valores não foram definidos adequadamente. Reinicie o processo de solicitação do espaço de trabalho.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(318141939408.4705)
,p_associated_item=>wwv_flow_api.id(.4705)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Os termos não foram aceitos adequadamente.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(318141939408.4705)
,p_associated_item=>wwv_flow_api.id(.4705)
...
wwv_flow_api.create_page(
 p_id=>73.4705
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4705)
,p_name=>'Criação do Espaço de Trabalho do &PRODUCT_NAME.'
,p_page_mode=>'NORMAL'
,p_step_title=>'Criação do Espaço de Trabalho do &PRODUCT_NAME.'
,p_allow_duplicate_submissions=>'N'
...
'<h2 class="a-Wizard-subTitle">Espaço de Trabalho Criado com Sucesso</h2>'))
);
wwv_flow_api.create_page_plug(
