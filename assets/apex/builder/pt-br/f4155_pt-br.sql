...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902241364816378627')
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(131180169902861.416)
...
'</div>'))
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>702684260095026477.416
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780089694684785.416)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.416)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780455120684785.416)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.416)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780833657684786.416)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.416)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146781259067684786.416)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.416)
...
,p_display_name=>'Autenticação Interna de Log-in'
...
,p_last_upd_yyyymmddhh24miss=>'20150428185102'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7642519848874484.416)
,p_plug_name=>'Você efetuou o log-out com sucesso.'
...
'Você foi redirecionado para cá depois de usar um link de log-out fornecido por um esquema de autenticação. Para redirecionar para uma página do seu aplicativo, faça o seguinte:',
'<ul>',
'<li>Crie uma página na aplicação e dê a ela o alias PUBLIC_PAGE.',
'<li>Na página de atributos de página do Builder, selecione o atributo de Página Pública "Sim - Esta página é pública".',
'<li>Altere o URL de log-out no esquema de autenticação para redirecionar para essa nova página após a execução do procedimento de log-out. Por exemplo, use o seguinte URL de log-out:<p>',
...
,p_plug_name=>'Alterar Senha - Botões'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page(
 p_id=>99.416
,p_user_interface_id=>wwv_flow_api.id(4973000124302346.416)
,p_name=>'&PRODUCT_NAME. Espaço de Trabalho Inativo'
,p_page_mode=>'NORMAL'
,p_step_title=>'&PRODUCT_NAME. Espaço de Trabalho Inativo'
...
,p_plug_name=>'Espaço de Trabalho'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146834495802703415.416)
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'Ao clicar no botão <b>Não Expurgar Espaço de Trabalho</b> abaixo, você está solicitando que o espaço de trabalho &P99_WORKSPACE_NAME. não seja excluído.  <b>Você deve executar esta ação para evitar que o espaço de trabalho &P99_WORKSPACE_NAME. seja e'
||'xcluído.</b>  '
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
...
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'&P99_LAST_UPDATED_BY., um administrador do espaço de trabalho &P99_WORKSPACE_NAME. já designado a este espaço de trabalho não deve ser expurgado. Ele foi atualizado por &P99_LAST_UPDATED_BY. em &P99_LAST_UPDATED..',
'<p>',
'Se você não precisar mais deste espaço de trabalho, clique no botão <b>Mudei de ideia – Expurgue o Espaço de Trabalho</b> e o espaço de trabalho será expurgado automaticamente em ou após <span style="font-weight:bold;color:#ff0033;">&P99_DATE_TO_BE_P'
||'URGED.</span>.',
''))
,p_translate_title=>'N'
,p_plug_query_row_template=>1
...
,p_plug_name=>'Solicitação Inválida'
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'Esta aplicação é usada para confirmar o uso de um espaço de trabalho no &P99_APEX_URL. Você acessou esta página usando um URL inválido. Se tiver dúvidas sobre esta aplicação ou sobre o processo de expurgação, sinta-se à vontade para perguntar através'
||' do e-mail <a href="mailto:&P99_PURGE_ADMIN_EMAIL.">&P99_PURGE_ADMIN_EMAIL.</a>.'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
,p_plug_name=>'Expurgação de Espaço de Trabalho do &PRODUCT_NAME.'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146873381156733851.416)
...
,p_plug_name=>'Obrigado por usar o &PRODUCT_NAME. - Espaço de trabalho Expurgado'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146873381156733851.416)
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'O Espaço de Trabalho desativado &P99_WORKSPACE_NAME. foi programado para ser excluído em &P99_DATE_TO_BE_PURGED..',
'<br/><br/>'))
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'O Espaço de Trabalho <strong>&P99_WORKSPACE_NAME.</strong> foi expurgado em <strong>&P99_DATE_PURGED.</strong>.',
'<p>',
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1146918375616882531.416)
,p_button_image_alt=>'Não Expurgar Espaço de Trabalho'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1146918375616882531.416)
,p_button_image_alt=>'Mudei de ideia - Expurge o Espaço de Trabalho'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_button_condition=>'P99_OK_TO_DELETE'
...
,p_item_sequence=>95
,p_item_plug_id=>wwv_flow_api.id(498926816038101235.416)
,p_prompt=>'Data de Expurgação do Alvo'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
...
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(498926816038101235.416)
,p_prompt=>'Espaço de Trabalho Solicitado Originalmente Por'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
,p_field_template=>wwv_flow_api.id(1146837484282708152.416)
,p_item_template_options=>'#DEFAULT#'
...
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(498926816038101235.416)
,p_prompt=>'Espaço de trabalho a ser Expurgado?'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(498926816038101235.416)
,p_prompt=>'URL do Espaço de Trabalho'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
,p_field_template=>wwv_flow_api.id(1146837484282708152.416)
,p_item_template_options=>'#DEFAULT#'
...
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(498926816038101235.416)
,p_prompt=>'Administradores de Espaços de Trabalho'
...
,p_process_success_message=>'O Espaço de Trabalho &P99_WORKSPACE_NAME. não será expurgado. Obrigada.'
);
wwv_flow_api.create_page_process(
...
,p_process_success_message=>'O Espaço de Trabalho &P99_WORKSPACE_NAME. será expurgado em ou após &P99_DATE_TO_BE_PURGED. Obrigado.'
);
wwv_flow_api.create_page_process(
...
'    end if;',
'end;'))
,p_process_error_message=>'Espaço de trabalho e identificador da solicitação inválido.'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>200.416
,p_user_interface_id=>wwv_flow_api.id(4973000124302346.416)
,p_name=>'Cancelar Inscrições do Relatório Interativo'
,p_page_mode=>'NORMAL'
,p_step_title=>'Cancelar Inscrições do Relatório Interativo'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(1146777630795684705.416)
,p_page_template_options=>'#DEFAULT#'
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Atualmente você está inscrito no relatório abaixo como <strong>&P200_EMAIL.</strong>. Se não quiser mais receber e-mails neste endereço, clique em <strong>Cancelar Inscrição</strong> abaixo:'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_name=>'Obrigado. Inscrição cancelada'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Obrigado. Agora você teve a inscrição cancelada dos e-mails de inscrição do relatório.  '
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_display_column=>1
,p_plug_display_point=>'BODY_3'
,p_plug_source=>'Esta aplicação é usada para cancelar as inscrições do relatório. Você acessou esta página usando um URL inválido.'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
...
,p_plug_name=>'Cancelar Inscrição'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146873381156733851.416)
,p_plug_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'N'
...
,p_button_template_id=>wwv_flow_api.id(1146918375616882531.416)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Cancelar Inscrição'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_grid_new_grid=>false
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
...
,p_field_template=>wwv_flow_api.id(1146837484282708152.416)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Nome do relatório ao qual você está inscrito.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
...
,p_process_success_message=>'Não Inscrito. Obrigado.'
);
wwv_flow_api.create_page_process(
...
'    end if;',
'end;'))
,p_process_error_message=>'Inscrição inválida e identificador da solicitação.'
);
end;
/
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Informe suas credenciais neste form para iniciar uma nova sessão nesta aplicação do &PRODUCT_NAME..'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_plug_name=>'Log-in na Aplicação &F4155_P1000_APP_ID.'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146873381156733851.416)
,p_plug_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'Y'
