...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902292984685406544')
...
,p_substitution_value_11=>'Copyright &copy; 1999, 2015, Oracle. Todos os direitos reservados.'
...
,p_list_text_01=>'Home page do Oracle Application Express na qual você pode fazer download da versão mais recente, revisar a documentação e acessar a garantia adicional.'
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>' alt=""'
,p_list_text_01=>'Obtenha suporte gratuito orientado à comunidade para esclarecer suas dúvidas sobre o Application Express no fórum de discussões do OTN. '
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Revisar referências, aplicações, consultando empresas, hospedando empresas e muito mais.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list(
...
,p_list_text_01=>'Uma página dedicada àqueles que estão começando a trabalhar com o Oracle Application Express, com informações e vários links.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Serviço de hospedagem gratuita "somente para demonstração" no qual você pode analisar a versão mais recente do Application Express.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'O Oracle by Examples (OBEs) fornece arquivos de pré-requisitos e instruções passo a passo com capturas de tela que o conduzem pela criação de vários componentes da aplicação.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list(
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Não é possível efetuar sign-in de seu espaço de trabalho? Tente redefinir sua senha aqui.'
,p_translate_list_text_y_n=>'Y'
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Não lembra a quais espaços de trabalho você está associado? Localize-os aqui.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>'!'||wwv_flow_api.id(6153929631135099)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
...
,p_list_text_01=>'Efetue Log-in na Administração de Instância.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>'!'||wwv_flow_api.id(6153929631135099)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(333182002517862192.4555)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'Administração'
,p_list_item_link_target=>'f?p=4050:3:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Navegar até Administração de Instância.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>wwv_flow_api.id(6153929631135099)
...
,p_list_text_01=>'Conclua este assistente para solicitar seu próprio espaço de trabalho.'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1349046415926832.4555)
...
,p_computation_error_message=>'Erro no cálculo de F4550_SERVICE_REQUEST_URL: #SQLERRM#'
);
end;
/
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983000163308436.4555)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4555)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983424337308436.4555)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4555)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983847896308436.4555)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4555)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824984287203308437.4555)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4555)
...
,p_shortcut_type=>'HTML_TEXT'
,p_shortcut=>'Obtenha acesso instantâneo a um conjunto on-line integrado para desenvolvimento de aplicações. O &PRODUCT_NAME. permite criar aplicações web dinâmicas e robustas, e aproveitar todo o potencial do banco de dados Oracle, tudo isso com seu browser favor'
||'ito.'
);
end;
/
...
,p_last_upd_yyyymmddhh24miss=>'20150428185143'
);
...
wwv_flow_api.create_page(
 p_id=>1.4555
,p_user_interface_id=>wwv_flow_api.id(4972214035302345.4555)
,p_name=>'Oracle Application Express - Efetuar Sign-in'
,p_page_mode=>'NORMAL'
,p_step_title=>'&PRODUCT_NAME. - Efetuar Sign-in'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
...
,p_plug_name=>'Tarefas Específicas de Site'
,p_region_template_options=>'#DEFAULT#'
...
,p_button_image_alt=>'Solicitar um Espaço de Trabalho'
...
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Efetuar Sign-in'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_grid_new_grid=>false
);
...
,p_placeholder=>'Espaço de Trabalho'
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">Informe seu espaço de trabalho. O atributo de espaço de trabalho não faz distinção entre maiúsculas e minúsculas.</div>',
'<div class="htmldbInfoBodyP">Este é um serviço de desenvolvimento on-line que permite acesso a um banco de dados privado virtual. Como o mesmo nome de usuário pode existir em vários espaços de trabalho, você deverá informar seu espaço de trabalho ao '
||'usar este serviço.</div>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">Informe seu nome de usuário. O nome de usuário não faz distinção entre maiúsculas e minúsculas.</div>',
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">Informe sua senha. Senhas fazem distinção entre maiúsculas e minúsculas. Essa senha é específica para esse serviço. Observe que cada espaço de trabalho pode ter vários usuários.</div>',
...
,p_error_message=>'Informe um nome de espaço de trabalho'
,p_always_execute=>'N'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Informe seu nome do usuário'
,p_always_execute=>'N'
...
,p_placeholder=>'endereço de e-mail'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>50
,p_cMaxlength=>2000
...
,p_item_css_classes=>'icon-login-username'
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Informe o endereço de e-mail associado ao seu espaço de trabalho. Iremos enviar o nome do espaço de trabalho para este e-mail.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'N'
,p_help_text=>'Informe o espaço de trabalho.  Caso não saiba qual é o seu espaço de trabalho, use o link Localizar Meu Espaço de Trabalho.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Informe seu endereço de e-mail para que possamos enviar a senha.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'EMAIL'
,p_attribute_05=>'BOTH'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'O e-mail não pode ficar em branco'
,p_always_execute=>'N'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'O espaço de trabalho não pode ficar em branco'
,p_always_execute=>'N'
...
,p_plug_name=>'Efetuou Sign-out com sucesso'
,p_region_template_options=>'#DEFAULT#:a-Form--labelsAbove'
,p_plug_template=>wwv_flow_api.id(781646415851311877.4555)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
,p_button_template_id=>wwv_flow_api.id(781653829819356486.4555)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Retornar à Página de Sign-in'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
,p_plug_name=>'Serviços de Administração'
,p_region_template_options=>'#DEFAULT#:a-Form--labelsAbove'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(781646415851311877.4555)
,p_plug_display_sequence=>20
...
,p_button_template_id=>wwv_flow_api.id(781653829819356486.4555)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Efetuar Sign-in na Administração'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_branch(
...
,p_item_css_classes=>'icon-login-username'
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Informe seu nome do usuário. O nome do usuário faz distinção entre maiúsculas e minúsculas. Recebida a autenticação e presumindo-se que você tenha as credenciais corretas, você pode criar nomes de usuário adicionais.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'Informe sua senha. As senhas fazem distinção entre maiúsculas e minúsculas. Se você esquecer a senha, clique no link "esqueceu sua senha". Observe que cada espaço de trabalho pode ter vários usuários.'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_computation(
...
,p_button_template_id=>wwv_flow_api.id(781653829819356486.4555)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Solicitar um Novo Espaço de Trabalho'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_button_redirect_url=>'f?p=4700:1:&SESSION.::&DEBUG.:RP:::'
,p_button_condition=>'wwv_flow_platform.get_preference( p_preference_name => ''SERVICE_REQUEST_FLOW'' ) <> ''MANUAL'''
,p_button_condition_type=>'PLSQL_EXPRESSION'
...
,p_button_template_options=>'#DEFAULT#:a-Button--large'
,p_button_template_id=>wwv_flow_api.id(781653829819356486.4555)
,p_button_image_alt=>'Efetuar Sign-out'
,p_button_position=>'REGION_TEMPLATE_NEXT'
