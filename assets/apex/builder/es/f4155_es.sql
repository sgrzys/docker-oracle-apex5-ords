...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902240362045377505')
...
,p_substitution_value_14=>'Volver a la Aplicación'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(131180169902861.4156)
...
'</div>'))
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>702684260095026477.4156
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780089694684785.4156)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4156)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780455120684785.4156)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4156)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146780833657684786.4156)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4156)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1146781259067684786.4156)
,p_page_template_id=>wwv_flow_api.id(1146777630795684705.4156)
...
,p_display_name=>'Autenticación de Conexión Interna'
...
,p_name=>'Página Pública para Desconexión'
,p_page_mode=>'NORMAL'
,p_step_title=>'Página Pública para Desconexión'
...
,p_last_upd_yyyymmddhh24miss=>'20150428183656'
);
...
'Se le ha redirigido aquí después de utilizar el enlace de desconexión proporcionado por un esquema de autenticación. Para redirigirlo en su lugar a una página de su aplicación, realice lo siguiente:',
'<ul>',
'<li>Cree una página en la aplicación y proporciónele un alias PUBLIC_PAGE.',
'<li>En la página de atributos de la página Creador, seleccione el atributo de página pública "Sí: Esta página es pública".',
'<li>Cambie la URL de desconexión en el esquema de autenticación para redirigirla a esta nueva página después de que se ejecute el procedimiento de desconexión. Por ejemplo, utilice la siguiente URL de desconexión:<p>',
...
wwv_flow_api.create_page(
 p_id=>50.4156
,p_user_interface_id=>wwv_flow_api.id(4973000124302346.4156)
,p_name=>'Cambiar Contraseña del Usuario Final'
,p_page_mode=>'NORMAL'
,p_step_title=>'Cambiar Contraseña del Usuario Final'
...
,p_plug_name=>'Cambiar Contraseña: Cuerpo'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
,p_plug_name=>'Cambiar Contraseña: Botones'
,p_region_template_options=>'#DEFAULT#'
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'Al hacer clic en el botón <b>No Depurar Espacio de Trabajo</b> a continuación, solicita que el espacio de trabajo &P99_WORKSPACE_NAME. no se depure. <b>Debe realizar esta acción para evitar la depuración del espacio de trabajo &P99_WORKSPACE_NAME..'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
...
'<p>',
'Si ya no necesita este espacio de trabajo, haga clic en el botón <b>He cambiado de opinión - Depurar espacio de trabajo</b> y el espacio de trabajo se depurará automáticamente en una fecha igual o posterior al <span style="font-weight:bold;color:#ff0'
...
,p_plug_name=>'Solicitud No Válida'
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'Esta aplicación se utiliza para confirmar el uso de un espacio de trabajo en &P99_APEX_URL.. Ha accedido a esta página mediante una URL no válida. Si tiene dudas sobre esta aplicación o sobre el proceso de depuración, puede enviar un correo electróni'
...
,p_plug_name=>'Depuración de Espacio de Trabajo de &PRODUCT_NAME.'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146873381156733851.4156)
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Se ha programado la supresión del espacio de trabajo inactivo &P99_WORKSPACE_NAME. el &P99_DATE_TO_BE_PURGED..',
'<br/><br/>'))
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'El espacio de trabajo <strong>&P99_WORKSPACE_NAME.</strong> se depuró el <strong>&P99_DATE_PURGED.</strong>.',
'<p>',
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1146918375616882531.4156)
,p_button_image_alt=>'He cambiado de opinión - Depurar espacio de trabajo'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_button_condition=>'P99_OK_TO_DELETE'
...
,p_item_sequence=>95
,p_item_plug_id=>wwv_flow_api.id(498926816038101235.4156)
,p_prompt=>'Fecha de Depuración de Destino'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
...
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(498926816038101235.4156)
,p_prompt=>'¿Depurar espacio de trabajo?'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
,p_process_success_message=>'El espacio de trabajo &P99_WORKSPACE_NAME. no se depurará. Gracias.'
);
wwv_flow_api.create_page_process(
...
,p_process_success_message=>'El espacio de trabajo &P99_WORKSPACE_NAME. se depurará el &P99_DATE_TO_BE_PURGED. o después. Gracias.'
);
wwv_flow_api.create_page_process(
...
'    end if;',
'end;'))
,p_process_error_message=>'Identificador de solicitud y espacio de trabajo no válido.'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>200.4156
,p_user_interface_id=>wwv_flow_api.id(4973000124302346.4156)
,p_name=>'Cancelar Suscripción a Informes Interactivos'
,p_page_mode=>'NORMAL'
,p_step_title=>'Cancelar Suscripción a Informes Interactivos'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(1146777630795684705.4156)
,p_page_template_options=>'#DEFAULT#'
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Actualmente está subscrito al informe siguiente como <strong>&P200_EMAIL.</strong>.  Si ya no desea recibir más correos electrónicos en las direcciones de correo electrónico, haga clic en <strong>Cancelar Suscripción</strong> a continuación.'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_name=>'Gracias: Suscripción Cancelada'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Gracias. Ahora ha cancelado la suscripción de los correos electrónicos de suscripción a informes.  '
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'PLSQL_EXPRESSION'
...
,p_plug_display_column=>1
,p_plug_display_point=>'BODY_3'
,p_plug_source=>'Esta aplicación se utilizar para cancelar suscripciones a informes.  Ha accedido a esta página mediante una URL no válida.'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
...
,p_plug_name=>'Cancelar Suscripción'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146873381156733851.4156)
,p_plug_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'N'
...
,p_button_template_id=>wwv_flow_api.id(1146918375616882531.4156)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Cancelar Suscripción'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_grid_new_grid=>false
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
...
,p_field_template=>wwv_flow_api.id(1146837484282708152.4156)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Nombre de la aplicación.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
...
,p_field_template=>wwv_flow_api.id(1146837484282708152.4156)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Nombre de la página.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
...
,p_field_template=>wwv_flow_api.id(1146837484282708152.4156)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Nombre del informe al que está suscrito.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
...
,p_process_success_message=>'Suscripción Cancelada. Gracias.'
);
wwv_flow_api.create_page_process(
...
'    end if;',
'end;'))
,p_process_error_message=>'Identificador de solicitud y suscripción no válido.'
);
end;
/
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Introduzca las credenciales en esta pantalla para iniciar una nueva sesión en esta aplicación &PRODUCT_NAME.'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_plug_name=>'Conectar a la Aplicación &F4155_P1000_APP_ID.'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1146873381156733851.4156)
,p_plug_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'Y'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Se debe proporcionar la contraseña.'
,p_always_execute=>'N'
