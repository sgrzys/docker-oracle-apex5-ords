...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902291901861405396')
...
,p_substitution_value_08=>'Volver a la Aplicación'
...
,p_substitution_value_11=>'Copyright &copy; 1999, 2015, Oracle. Todos los derechos reservados.'
...
,p_list_text_01=>'Página inicial de Oracle Application Express donde puede descargar la última versión, revisar documentación y acceder a la garantía ampliada.'
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>' alt=""'
,p_list_text_01=>'Obtener soporte de la comunidad para sus preguntas sobre Application Express en los foros de discusión de OTN. '
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Revisar referencias, aplicaciones, consultorías, empresas de alojamiento y mucho más.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list(
...
,p_list_text_01=>'Una página dedicada a ofrecer una introducción a Oracle Application Express con gran cantidad de información y enlaces.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Servicio de "solo demostración" alojado gratuitamente donde puede probar la última versión de Application Express.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Oracle by Examples (OBEs) proporciona archivos de requisitos e instrucciones paso a paso con capturas de pantalla que le guiarán en la creación de los diferentes componentes de aplicación.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list(
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Restablecer Contraseña'
,p_list_item_link_target=>'f?p=&APP_ID.:7:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'¿No puede conectarse a su espacio de trabajo? Pruebe a restablecer su contraseña aquí.'
,p_translate_list_text_y_n=>'Y'
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'¿Ha olvidado los espacios de trabajo a los que está asociado? Aquí puede obtener más información.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>'!'||wwv_flow_api.id(6153929631135099)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
...
,p_list_text_01=>'Conectar a Administración de Instancia.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>'!'||wwv_flow_api.id(6153929631135099)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(333182002517862192.4551)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'Administración'
,p_list_item_link_target=>'f?p=4050:3:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Navegue a Administración de Instancia.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>wwv_flow_api.id(6153929631135099)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1349046415926832.4551)
...
,p_computation_error_message=>'Error en cálculo de F4550_SERVICE_REQUEST_URL: #SQLERRM#'
);
end;
/
...
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'Administración (DBA)'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983000163308436.4551)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4551)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983424337308436.4551)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4551)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983847896308436.4551)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4551)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824984287203308437.4551)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4551)
...
,p_shortcut_type=>'HTML_TEXT'
,p_shortcut=>'Obtenga acceso inmediato a una serie integrada de desarrollo de aplicaciones en línea. Con &PRODUCT_NAME. puede crear aplicaciones Web dinámicas y robustas con toda la potencia de la base de datos Oracle, todo desde su explorador favorito.'
);
end;
/
...
,p_last_upd_yyyymmddhh24miss=>'20150428183740'
);
...
wwv_flow_api.create_page(
 p_id=>1.4551
,p_user_interface_id=>wwv_flow_api.id(4972214035302345.4551)
,p_name=>'Oracle Application Express: Conexión'
,p_page_mode=>'NORMAL'
,p_step_title=>'&PRODUCT_NAME.:Conexión'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
...
,p_plug_name=>'Tareas Específicas de la Dirección'
,p_region_template_options=>'#DEFAULT#'
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(781649650278313424.4551)
,p_button_image_alt=>'Restablecer Contraseña'
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">Introduzca el espacio de trabajo. El nombre de espacio de trabajo no es sensible a mayúsculas/minúsculas.</div>',
'<div class="htmldbInfoBodyP"> Se trata de un servicio de desarrollo en línea que proporciona acceso a una base de datos privada virtual. Ya que el mismo nombre de usuario puede existir en varios espacios de trabajo, se le pedirá que introduzca el esp'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">Introduzca el nombre de usuario. Los nombres de usuarios no son sensibles a mayúsculas/minúsculas. </div>',
'<div class="htmldbInfoBodyP">Después de autenticarse y si tiene las credenciales adecuadas, puede crear más usuarios.</div>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">Introduzca la contraseña. Las contraseñas son sensibles a mayúsculas/minúsculas. Esta contraseña es específica de este servicio. Tenga en cuenta que cada espacio de trabajo puede tener varios usuarios.</div>',
'<div class="htmldbInfoBodyP">Si olvida la contraseña, seleccione <span class="fielddatabold">Restablecer Contraseña</span>.</div>'))
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Introduzca su contraseña'
,p_always_execute=>'N'
...
,p_placeholder=>'dirección de correo electrónico'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>50
,p_cMaxlength=>2000
...
,p_item_css_classes=>'icon-login-username'
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Introduzca la dirección de correo electrónico asociada al espacio de trabajo. Se enviará el nombre del espacio de trabajo a esta dirección.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
,p_process_success_message=>'Si &F4550_P4_EMAIL. existe en nuestros registros, enviaremos los nombres de espacio de trabajo asociados a esta dirección de correo electrónico. Si tienen problemas para recibirlos, póngase en contacto con el administrador.'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>7.4551
,p_user_interface_id=>wwv_flow_api.id(4972214035302345.4551)
,p_name=>'Restablecer Contraseña'
,p_page_mode=>'NORMAL'
,p_step_title=>'Restablecer Contraseña'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
,p_plug_name=>'Restablecer Contraseña'
,p_region_template_options=>'#DEFAULT#:a-Form--labelsAbove'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(781646415851311877.4551)
,p_plug_display_sequence=>10
...
,p_prompt=>'<span class="instructiontext">No ha proporcionado una combinación de nombre de espacio de trabajo y dirección de correo electrónico válida.</span>'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Introduzca la dirección de correo electrónico para recibir la contraseña.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'EMAIL'
,p_attribute_05=>'BOTH'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'La dirección de correo electrónico no puede estar en blanco'
,p_always_execute=>'N'
...
,p_error_message=>'La operación de restablecimiento de contraseña no está soportada en un espacio de trabajo interno.'
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(47286220449334625.4551)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
...
,p_process_error_message=>'No se ha podido restablecer la contraseña.'
,p_process_when_button_id=>wwv_flow_api.id(47286811980358498.4551)
,p_process_success_message=>'La solicitud de restablecimiento de contraseña se ha enviado para procesamiento .'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>8.4551
,p_user_interface_id=>wwv_flow_api.id(4972214035302345.4551)
,p_name=>'Confirmación de Desconexión'
,p_page_mode=>'NORMAL'
,p_step_title=>'Confirmación de Desconexión'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
,p_plug_name=>'Desconexión Correcta'
,p_region_template_options=>'#DEFAULT#:a-Form--labelsAbove'
,p_plug_template=>wwv_flow_api.id(781646415851311877.4551)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
,p_button_template_id=>wwv_flow_api.id(781653829819356486.4551)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Volver a la Página de Conexión'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
wwv_flow_api.create_page(
 p_id=>10.4551
,p_user_interface_id=>wwv_flow_api.id(4972214035302345.4551)
,p_name=>'Conexión de Administración Interna'
,p_page_mode=>'NORMAL'
,p_step_title=>'Servicios de Administración de &PRODUCT_NAME.'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_api.id(222575208632450607)
...
,p_plug_name=>'Servicios de Administración'
,p_region_template_options=>'#DEFAULT#:a-Form--labelsAbove'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(781646415851311877.4551)
,p_plug_display_sequence=>20
...
,p_button_template_id=>wwv_flow_api.id(781653829819356486.4551)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Conectar a Administración'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_branch(
...
,p_item_css_classes=>'icon-login-username'
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Introduzca el nombre de usuario. Los nombres de usuarios no son sensibles a mayúsculas/minúsculas. Después de autenticarse y si tiene las credenciales adecuadas, puede crear más nombres de usuario.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'Introduzca la contraseña. Las contraseñas son sensibles a mayúsculas/minúsculas. Si olvida la contraseña, haga clic en el enlace "¿Contraseña Olvidada?". Tenga en cuenta que cada espacio de trabajo puede tener varios usuarios.'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_computation(
...
wwv_flow_api.create_page(
 p_id=>20.4551
,p_user_interface_id=>wwv_flow_api.id(4972214035302345.4551)
,p_name=>'Conexión a Oracle Application Express'
,p_page_mode=>'NORMAL'
,p_step_title=>'Conexión a &PRODUCT_NAME.'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_javascript_code=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
