...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902293712107407587')
...
,p_substitution_value_09=>'Volver a la Aplicación'
...
,p_substitution_value_12=>'Copyright &copy; 1999, 2015, Oracle. Todos los derechos reservados.'
...
,p_list_item_link_text=>'Identificación'
...
,p_list_item_link_text=>'Justificación'
...
,p_list_item_link_text=>'Confirmación'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1352228430926978.4701)
...
'    return FALSE;',
'end if;'))
,p_error_message=>'Las solicitudes de espacio de trabajo no están activadas.'
...
,p_lov_disp_value=>'Acepto los términos'
...
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Sólo Aplicaciones Empaquetadas'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824976787312308427.4701)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4701)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977164944308427.4701)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4701)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977534964308429.4701)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4701)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977932305308429.4701)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4701)
...
,p_last_upd_yyyymmddhh24miss=>'20150428183741'
);
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Servicio'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
...
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_header=>'<p class="a-Wizard-subHeading">¿Qué tipo de espacio de trabajo desea solicitar?</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page(
 p_id=>2.4701
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4701)
,p_name=>'Solicitar Espacio de Trabajo: Segunda Página'
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Espacio de Trabajo: Segunda Página'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'La información de su cuenta se enviará a esta dirección de correo electrónico.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
,p_field_template=>wwv_flow_api.id(481972771960821314.4701)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Introduzca el nombre del espacio de trabajo que desea tener. Cuando se haya provisionado el espacio de trabajo, se conectará con una combinación de espacio de trabajo / nombre de usuario / contraseña.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'BOTH'
...
,p_error_message=>'Correo electrónico no válido'
,p_always_execute=>'N'
...
,p_error_message=>'Nombre de espacio de trabajo no válido.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(624350696578280086.4701)
...
wwv_flow_api.create_page(
 p_id=>3.4701
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4701)
,p_name=>'Solicitar Espacio de Trabajo: Confirmación'
,p_page_mode=>'NORMAL'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18348331817861713.4701)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18348522944868646.4701)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18348331817861713.4701)
,p_button_name=>'FINISH'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(481975658518888812.4701)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Continuar a la Pantalla de Conexión'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Espacio de Trabajo: Identificar Esquema'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4701)
,p_page_template_options=>'#DEFAULT#'
...
,p_prompt=>'Asignación de Espacio'
...
'El esquema es el usuario de base de datos Oracle que será el propietario de los objetos de base de datos. Dedique un poco de tiempo a seleccionar este nombre ya que el cambio de esquemas puede ser una tarea relacionada. Cuando se haya provisionado el'
||' servicio, recibirá la contraseña del esquema y la contraseña de conexión. Una vez creado el espacio de trabajo, podrá agregarle esquemas adicionales. ',
'',
'',
'',
'Los nombres de esquema válidos deben cumplir las siguientes directrices:',
'',
...
'',
' - Sólo pueden contener caracteres alfanuméricos, excepto los signos',
'',
'   (_) subrayado, ($) dólar y (#) almohadilla.',
'',
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Introduzca el nombre del esquema que desea hacer accesible al nuevo espacio de trabajo de &PRODUCT_NAME. Una vez creado el espacio de trabajo, podrá agregarle esquemas adicionales.',
''))
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'El nombre del esquema no es válido. Especifique otro nombre.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4701)
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Espacio de Trabajo: Advertencias de Esquema'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4701)
,p_page_template_options=>'#DEFAULT#'
...
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4701)
,p_tab_set=>'HOME'
,p_name=>'Solicitar Espacio de Trabajo: Descripción de Proyecto'
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Espacio de Trabajo: Descripción de Proyecto'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4701)
,p_page_template_options=>'#DEFAULT#'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p class="a-Wizard-text">Esta información ayuda al administrador de &PRODUCT_NAME. a comprender cómo desea utilizar este servicio.</p>',
...
,p_prompt=>'¿Por qué solicita este servicio?'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'Introduzca el objetivo de la solicitud de servicio. Esta información la utilizará el administrador de &PRODUCT_NAME.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(516409441539385628.4701)
,p_prompt=>'Justificación de solicitud de servicio, opcional'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>70
,p_cMaxlength=>32767
,p_cHeight=>8
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'Si el acuerdo de servicio o compañía necesita que justifique la solicitud, proporcione una justificación.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Debe explicar por qué solicita este servicio.'
,p_always_execute=>'N'
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Acuerdo de Servicio'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4701)
,p_page_template_options=>'#DEFAULT#'
...
,p_page_is_public_y_n=>'N'
,p_cache_mode=>'NOCACHE'
,p_last_upd_yyyymmddhh24miss=>'20150428183742'
);
wwv_flow_api.create_page_plug(
...
,p_error_message=>'Debe aceptar los términos para continuar.'
,p_always_execute=>'N'
...
,p_name=>'Solicitar Espacio de Trabajo: Confirmación'
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Espacio de Trabajo: Confirmación'
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'<p class="a-Wizard-text">Verifique la solicitud de espacio de trabajo.</p>'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
...
,p_item_plug_id=>wwv_flow_api.id(94840826419648214.4701)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Correo Electrónico del Administrador'
...
,p_item_plug_id=>wwv_flow_api.id(94840826419648214.4701)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Tamaño de la Base de Datos (MB)'
...
,p_use_cache_before_default=>'NO'
,p_prompt=>'Código de Verificación'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>10
,p_cMaxlength=>5
,p_tag_css_classes=>'a-Form-field a-Form-field--readOnly'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Debe introducir el código de verificación que aparece en el recuadro.',
'Tenga cuidado al introducir las letras porque son <b>sensibles a mayúsculas/minúsculas</b>.'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Código de verificación no válido'
,p_always_execute=>'N'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Todos los valores no están definidos correctamente; reinicie el proceso de solicitud de espacio de trabajo.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(318141939408.4701)
,p_associated_item=>wwv_flow_api.id(.4701)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Los términos no se han aceptado correctamente.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(318141939408.4701)
,p_associated_item=>wwv_flow_api.id(.4701)
...
wwv_flow_api.create_page(
 p_id=>73.4701
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4701)
,p_name=>'Creación de Espacio de Trabajo de &PRODUCT_NAME.'
,p_page_mode=>'NORMAL'
,p_step_title=>'Creación de Espacio de Trabajo de &PRODUCT_NAME.'
,p_allow_duplicate_submissions=>'N'
