...
prompt APPLICATION 4751 - Oracle APEX Packaged Applications
--
-- Application Export:
--   Application:     4751
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902295595855409752')
...
,p_substitution_value_05=>'Copyright &copy; 1999, 2015, Oracle. Todos los derechos reservados.'
...
,p_substitution_value_08=>'Tabla de Diseño de Página'
...
,p_substitution_value_18=>'Volver a la Aplicación'
,p_substitution_string_19=>'DELETE_MSG'
,p_substitution_value_19=>'¿Desea realizar esta acción de supresión?'
...
,p_list_item_link_text=>'Cambiar Mi Contraseña'
...
,p_list_item_link_text=>'Documentación'
...
,p_list_item_link_text=>'Foro de Discusión'
...
,p_list_item_link_text=>'Aplicaciones de Hoja de Cálculo Web'
...
,p_list_item_link_text=>'Informes de Aplicación Cruzados'
...
,p_list_item_link_text=>'Métodos de las Tablas'
...
,p_list_item_link_text=>'Comparación de Esquema'
...
,p_list_item_link_text=>'Configuración de Desarrollo de Equipos'
...
,p_list_item_link_text=>'Resumen de Versión'
...
,p_list_item_link_text=>'Utilidades de la Función'
...
,p_list_item_link_text=>'Gestionar Áreas de Enfoque'
...
,p_list_item_link_text=>'Actualizar Responsables'
...
,p_list_item_display_sequence=>400
,p_list_item_link_text=>'Aplicaciones Empaquetadas'
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Galería de Aplicaciones Empaquetadas'
,p_list_item_link_target=>'f?p=&APP_ID.:50:&SESSION.::&DEBUG.:50:::'
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Administración de Aplicaciones Empaquetadas'
...
,p_list_text_01=>'Controlar acceso de los administradores de espacio de trabajo, desarrolladores de aplicación y usuarios finales de Application Express.'
,p_translate_list_text_y_n=>'Y'
...
,p_list_text_01=>'Ver y gestionar informes interactivos guardados y creados por usuarios de aplicaciones empaquetadas.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Actividad de Aplicaciones'
,p_list_item_link_target=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'icon-utilities-activity'
,p_list_text_01=>'Calendario mensual de actividad de aplicación que informa de los distintos usuarios y vistas totales de página por día.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
...
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Vistas de Página'
,p_list_item_link_target=>'f?p=&APP_ID.:29:&SESSION.::&DEBUG.:RP,29:::'
,p_list_item_icon=>'icon-utilities-page-views'
,p_list_text_01=>'Informes interactivo de cada vista de página. Ver usuario, tiempo transcurrido y página.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'icon-apex-user'
,p_list_text_01=>'Informe de vistas de página agregadas por usuarios.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list(
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1355859641927129.4751)
...
,p_error_message=>'No está autorizado para administrar aplicaciones'
...
'    );'))
,p_error_message=>'No está autorizado para acceder a los paneles de control y la actividad de supervisión.'
...
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
,p_attribute_01=>'SQL'
,p_error_message=>'No está autorizado a utilizar Taller de SQL.'
...
'                   and value = ''Y'')'))
,p_error_message=>'No hay privilegios para la operación intentada'
...
,p_error_message=>'SSO de creador no está activado'
...
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
,p_attribute_01=>'EDIT'
,p_error_message=>'No tiene privilegios para realizar esta operación'
...
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
,p_attribute_01=>'EDIT'
,p_error_message=>'No está autorizado para editar aplicaciones'
...
,p_error_message=>'El entorno de desarrollo utiliza autenticación externa'
...
,p_error_message=>'No está autorizado a instalar aplicaciones empaquetadas'
...
,p_icon_sequence=>10
,p_icon_subtext=>'Desconexión'
,p_icon_target=>'&LOGOUT_URL.'
,p_icon_image_alt=>'Desconexión'
,p_icon_height=>32
,p_icon_width=>32
,p_icon_height2=>24
,p_icon_width2=>24
...
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Definir dirección de correo electrónico completa como nombre de usuario'
,p_lov_return_value=>'N'
);
wwv_flow_api.create_static_lov_data(
...
,p_lov_disp_value=>'Cambiar Autenticación'
...
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Hoja de Cálculo Web'
...
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Solicitar Terminación'
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(805102768336534835.4751)
,p_lov_name=>'REQUEST SERVICE'
,p_lov_query=>'.'||wwv_flow_api.id(805102768336534835)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103010621534839.4751)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Solicitar Esquema'
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103339867534842.4751)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Solicitar Almacenamiento'
,p_lov_return_value=>'STORAGE'
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103624199534842.4751)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Solicitar Terminación'
,p_lov_return_value=>'TERMINATION'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4751)
,p_short_name=>'Eliminar Aplicación Empaquetada'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4751)
,p_short_name=>'Instalar Aplicación Empaquetada'
,p_link=>'f?p=&APP_ID.:83:&SESSION.::&DEBUG.:::'
,p_page_id=>83
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(492872210530717222.4751)
,p_parent_id=>wwv_flow_api.id(806264496767109365.4751)
,p_short_name=>'Instalar Aplicación Empaquetada'
...
,p_short_name=>'Desbloquear Aplicación Empaquetada'
...
,p_parent_id=>wwv_flow_api.id(.4751)
,p_short_name=>'Cambiar Autenticación'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4751)
,p_short_name=>'Actualizar Aplicación Empaquetada'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(750897172696068128.4751)
,p_parent_id=>wwv_flow_api.id(.4751)
,p_short_name=>'<span class="u-VisuallyHidden">Aplicaciones</span><span class="a-Icon icon-breadcrumb-previous"></span>'
,p_link=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::'
,p_page_id=>1
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(788162743515607361.4751)
,p_parent_id=>wwv_flow_api.id(750897172696068128.4751)
,p_short_name=>'Panel de Control de Aplicaciones Empaquetadas'
...
,p_parent_id=>wwv_flow_api.id(750897172696068128.4751)
,p_short_name=>'Administración de Aplicaciones Empaquetadas'
...
,p_parent_id=>wwv_flow_api.id(798343358044477984.4751)
,p_short_name=>'Solicitar Terminación del Servicio'
...
,p_parent_id=>wwv_flow_api.id(750897172696068128.4751)
,p_short_name=>'Galería de Aplicaciones Empaquetadas'
...
,p_short_name=>'Detalles de Aplicación Empaquetada'
...
,p_parent_id=>wwv_flow_api.id(798343358044477984.4751)
,p_short_name=>'Actividad de Aplicaciones'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(1224179617523676528.4751)
,p_parent_id=>wwv_flow_api.id(788162743515607361.4751)
,p_short_name=>'Aplicaciones Empaquetadas'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747469399730136676.4751)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747469775365136676.4751)
,p_page_template_id=>wwv_flow_api.id(741366253443994295.4751)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970712970659339897.4751)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970713375545339897.4751)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4751)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970713743513339897.4751)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4751)
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714187781339897.4751)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4751)
,p_name=>'Right Side Bar'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714515296339897.4751)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4751)
,p_name=>'After Body'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714940759339898.4751)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4751)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970715378375339898.4751)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4751)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824980978803308434.4751)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4751)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824981311553308434.4751)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4751)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824981767148308434.4751)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4751)
,p_name=>'Wizard Title'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824982170342308434.4751)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4751)
...
,p_page_name=>'winlov'
,p_page_title=>'Cuadro de Diálogo Buscar'
...
,p_display_name=>'Autorización de Desarrollador'
...
,p_display_name=>'Atributo Dinámico de Plugin'
,p_supported_ui_types=>'DESKTOP'
...
,p_subscribe_plugin_settings=>true
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>Introduzca el nombre de usuario y la contraseña para la autenticación en el directorio LDAP identificado en la página de conexión. Recuerde que las contraseñas pueden ser sensibles a mayúsculas/minúsculas.</p>',
''))
,p_version_identifier=>'1.0'
);
wwv_flow_api.create_plugin_attribute(
...
,p_display_name=>'Selección de Asistente'
,p_supported_ui_types=>'DESKTOP'
...
,p_subscribe_plugin_settings=>true
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>La acción dinámica "Agregar Casilla de Control Activar Todo" convierte una cabecera de columna que contiene la cadena #CHECK_ALL_CHECKBOX# en una casilla de control de estilo Activar Todo accesible, que permite activar y desactivar todas las casil'
||'las de control en su columna correspondiente.<p>',
'<p>',
'Para utilizar este plugin, asegúrese de que están definidos los siguientes atributos:',
'<ol>',
'<li>En la columna de informe, ''#CHECK_ALL_CHECKBOX#'' definido como el valor de cabecera.</li>',
'<li>Para el atributo Cuándo de Acción Dinámica, seleccione la región de informe que contenga la columna.</li>',
'<li>Defina la acción dinámica para que dispare ''Después de Refrescamiento'' y la acción en ''Arrancar al Cargar Página''. (Ambos se definirán por defecto de forma adecuada si la acción dinámica se crea mediante la selección de la región en la sección ''P'
||'resentación'' del Diseñador de Páginas y la creación de la acción dinámica desde ahí.</li>',
'<li>Con esto no se manejará la accesibilidad de las casillas de control que se presentan en cada fila. Esto se debe realizar por separado en el origen de región. (Consulte la región 4000:656 ''Regiones'' para obtener un ejemplo).</li>',
'</ol>',
'</p>'))
,p_version_identifier=>'1.0'
);
...
,p_subscribe_plugin_settings=>true
,p_help_text=>'<p>Este plugin crea gráficos de barras horizontales que contienen etiquetas, valores e incluso iconos</p>'
,p_version_identifier=>'1.0'
,p_files_version=>16
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006268931685907537.4751)
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006277098711907541.4751)
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006269307704907538.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4751)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006269805212907538.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4751)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006270313871907538.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4751)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006270898104907538.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006271224803907539.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006271675789907539.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272020373907539.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272490890907539.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272846289907539.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006268931685907537.4751)
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006273272857907539.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006273675862907539.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006274092256907540.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006279811153907542.4751)
,p_depending_on_condition_type=>'IN_LIST'
,p_depending_on_expression=>'CUSTOM'
,p_help_text=>'<p>A list of CSS supported colors separated by colons.</p>'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006274433061907540.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006274824808907540.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006274433061907540.4751)
,p_display_sequence=>10
,p_display_value=>'Value'
,p_return_value=>'VALUE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006275327182907540.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006274433061907540.4751)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006275868271907541.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>12
,p_display_sequence=>120
...
,p_is_required=>false
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_api.id(2006274433061907540.4751)
,p_depending_on_condition_type=>'IN_LIST'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006276251069907541.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>13
,p_display_sequence=>130
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006276652694907541.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>14
,p_display_sequence=>140
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006277098711907541.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>15
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006277474563907541.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006277098711907541.4751)
,p_display_sequence=>10
,p_display_value=>'Icon Chart'
,p_return_value=>'ICON'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006277997330907541.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006277098711907541.4751)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006278471627907542.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>16
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006278897464907542.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006278471627907542.4751)
,p_display_sequence=>10
,p_display_value=>'Absolute'
,p_return_value=>'ABSOLUTE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006279373310907542.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006278471627907542.4751)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006279811153907542.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>17
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006280226737907543.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4751)
,p_display_sequence=>5
,p_display_value=>'Default'
,p_return_value=>'DEFAULT'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006280711849907543.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4751)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006281297160907543.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4751)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006281704972907543.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4751)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006282208978907543.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4751)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006282788751907543.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4751)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006283223942907543.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4751)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006283798141907544.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>18
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006284193963907544.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006283798141907544.4751)
,p_display_sequence=>10
,p_display_value=>'Above the bar'
,p_return_value=>'ABOVE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006284698759907545.4751)
,p_plugin_attribute_id=>wwv_flow_api.id(2006283798141907544.4751)
,p_display_sequence=>20
...
begin
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006285119215907545.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>19
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006285570964907546.4751)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4751)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>20
...
,p_display_name=>'Gráfico de Líneas Flot v2 ***'
,p_supported_ui_types=>'DESKTOP'
...
,p_display_name=>'Gráfico de Tarta Flot v2 ***'
,p_supported_ui_types=>'DESKTOP:JQM_SMARTPHONE'
...
,p_name=>'Página Global - Escritorio'
,p_page_mode=>'NORMAL'
,p_step_title=>'Página Global - Escritorio'
...
,p_last_upd_yyyymmddhh24miss=>'20150428183743'
);
...
,p_button_image_alt=>'Administración'
...
wwv_flow_api.create_page(
 p_id=>1.4751
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4751)
,p_name=>'Página Inicial de Aplicaciones Empaquetadas'
,p_page_mode=>'NORMAL'
,p_step_title=>'Página Inicial de Aplicaciones Empaquetadas'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750747661941502571.4751)
...
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>Las aplicaciones empaquetadas son un conjunto de aplicaciones de productividad del negocio que se instalan fácilmente con sólo unos clics. Estas soluciones pueden utilizarse como aplicaciones de producción para mejorar los procesos de negocio y so'
||'n soportadas por Oracle.</p>',
''))
,p_plug_query_row_template=>1
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750750940971502582.4751)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750751542816502585.4751)
,p_plug_name=>'Modo de Accesibilidad'
,p_region_css_classes=>' a-Region--stacked a-Region--padded a-Region--flush a-Region--sideRegion'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750867860695912536.4751)
,p_plug_name=>'Aplicaciones'
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(750862626609892264.4751)
,p_plug_source_type=>'NATIVE_LIST'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(787083093555047575.4751)
,p_name=>'Aplicaciones Empaquetadas Instaladas'
...
,p_query_no_data_found=>'No se han instalado aplicaciones empaquetadas.'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(656958519483052405.4751)
,p_query_column_id=>1
,p_column_alias=>'APP_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Aplicación'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448306370861802.4751)
,p_query_column_id=>2
,p_column_alias=>'RUN_APP_LINK'
,p_column_display_sequence=>4
,p_column_heading=>'Ejecutar Enlace de Aplicación'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(656958784419052407.4751)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(886493838302981514.4751)
,p_query_column_id=>4
,p_column_alias=>'APP_ID'
,p_column_display_sequence=>9
,p_column_heading=>'ID de Aplicación'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(886493647565981512.4751)
,p_query_column_id=>5
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448453999861803.4751)
,p_query_column_id=>6
,p_column_alias=>'MODIFY_APP_BUTTON'
,p_column_display_sequence=>5
,p_column_heading=>'Botón Modificar Aplicación'
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448530210861804.4751)
,p_query_column_id=>7
,p_column_alias=>'RUN_APP_BUTTON'
,p_column_display_sequence=>6
,p_column_heading=>'Botón Ejecutar Aplicación'
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(864570195174731021.4751)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(864570463503731024.4751)
,p_query_column_id=>9
,p_column_alias=>'APP_INFO'
,p_column_display_sequence=>7
,p_column_heading=>'Información de Aplicación'
,p_use_as_row_header=>'N'
,p_column_format=>'SINCE'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2310796521456520805.4751)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2310796924341520807.4751)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1494304199802239903.4751)
,p_plug_name=>'Aplicaciones Empaquetadas Destacadas'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1199601170102177728.4751)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(787083093555047575.4751)
,p_button_name=>'NEW_INSTALLED_APPS'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404711161197908978.4751)
,p_button_image_alt=>'Crear Aplicación Empaquetada'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(787719037872821217.4751)
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404711161197908978.4751)
,p_button_image_alt=>'Ver Aplicaciones Instaladas'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(750755519256502601.4751)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(750751746540502585.4751)
,p_name=>'P1_ACCESSIBILITY_MODE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(750751542816502585.4751)
,p_use_cache_before_default=>'NO'
,p_item_default=>'STANDARD'
,p_prompt=>'Modo de Accesibilidad'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'case ',
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(933144624364626643.4751)
,p_name=>'RENDERING: Page - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(787083093555047575.4751)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(933144967905626652.4751)
,p_event_id=>wwv_flow_api.id(933144624364626643.4751)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(750754662427502591.4751)
...
'    end if;',
'end;'))
,p_process_error_message=>'Error al definir el modo de accesibilidad'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when=>'P1_ACCESSIBILITY_MODE'
,p_process_when_type=>'REQUEST_EQUALS_CONDITION'
,p_process_success_message=>'Juego de Modos de Accesibilidad'
);
end;
/
...
,p_last_upd_yyyymmddhh24miss=>'20150428183744'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959145671052411.4751)
,p_plug_name=>'Aplicaciones Empaquetadas Principales'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959251264052412.4751)
,p_plug_name=>'Aplicaciones Empaquetadas Instaladas por los Usuarios'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4751)
,p_plug_display_sequence=>50
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959463401052414.4751)
,p_plug_name=>'Aplicaciones Empaquetadas'
...
'end loop;'))
,p_plug_source_type=>'NATIVE_PLSQL'
,p_plug_query_row_template=>wwv_flow_api.id(741378333819007312.4751)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959880777052418.4751)
,p_plug_name=>'Acerca de'
,p_region_css_classes=>'a-Region--stacked a-Region--padded a-Region--flush a-Region--sideRegion'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4751)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Métricas sobre aplicaciones empaquetadas en su espacio de trabajo.'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959992513052419.4751)
,p_plug_name=>'Vistas de Aplicaciones Empaquetadas'
...
,p_attribute_05=>'Vistas de Página'
,p_attribute_06=>'NONE'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788159425426560907.4751)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788164282527649493.4751)
,p_plug_name=>'Disponible para Actualizar'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4751)
,p_plug_display_sequence=>40
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788166095908674996.4751)
,p_plug_name=>'No Instalado'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4751)
,p_plug_display_sequence=>30
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788982827579790091.4751)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788983890794795218.4751)
,p_plug_name=>'Hidden'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(788983363220793228.4751)
,p_name=>'P2_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(788983890794795218.4751)
...
,p_lov_display_extra=>'YES'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Defina un marco temporal que restrinja las consultas de supervisión de esta página.'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(789119577877826005.4751)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(789084545317643151.4751)
,p_name=>'RENDERING: Dashboard - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(788982827579790091.4751)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(789084801764643152.4751)
,p_event_id=>wwv_flow_api.id(789084545317643151.4751)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Aplicaciones Empaquetadas'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1224170433387563371.4751)
,p_plug_name=>'Aplicaciones Empaquetadas'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(1224170516463563371.4751)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224170864888563380.4751)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171279819563380.4751)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224170911190563380.4751)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171038140563380.4751)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171103374563380.4751)
,p_db_column_name=>'UPGRADE_AVAILABLE'
,p_display_order=>42
,p_column_identifier=>'E'
,p_column_label=>'Actualización Disponible'
,p_column_type=>'STRING'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_api.id(801893675976261985)
,p_rpt_show_filter_lov=>'1'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171357038563381.4751)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962307327400233.4751)
,p_db_column_name=>'CATEGORY_NAME'
,p_display_order=>62
,p_column_identifier=>'H'
,p_column_label=>'Nombre de la Categoría'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1473925915428744023.4751)
,p_db_column_name=>'IS_INSTALLED'
,p_display_order=>63
,p_column_identifier=>'I'
,p_column_label=>'Instalado'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962433555400234.4751)
,p_db_column_name=>'IS_NOT_INSTALLED'
,p_display_order=>73
,p_column_identifier=>'J'
,p_column_label=>'Sin Instalar'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962551146400235.4751)
,p_db_column_name=>'UPGRADE_IS_AVAILABLE'
,p_display_order=>83
,p_column_identifier=>'K'
,p_column_label=>'La actualización está disponible'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(973962130782400231.4751)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(1224170433387563371.4751)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(973962236123400232.4751)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(1224170433387563371.4751)
,p_button_name=>'Reset'
,p_button_action=>'REDIRECT_PAGE'
...
,p_plug_name=>'Definir Marco Temporal de Informes de la Página Inicial'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
,p_lov_display_extra=>'NO'
,p_help_text=>'Defina el marco temporal para restringir las consultas de supervisión que aparecen en el panel de control.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_da_event(
...
wwv_flow_api.create_page(
 p_id=>6.4751
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4751)
,p_name=>'Página Inicial de Administración'
,p_page_mode=>'NORMAL'
,p_step_title=>'Página Inicial de Administración'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'La administración le permite gestionar y supervisar aplicaciones empaquetadas en su espacio de trabajo según sus privilegios.'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
...
,p_plug_name=>'Gestionar Configuración de Informes Interactivos'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
...
wwv_flow_api.create_page(
 p_id=>7.4751
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4751)
,p_name=>'Detalle de Aplicación Empaquetada'
,p_page_mode=>'MODAL'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
...
,p_plug_name=>'Detalle de Aplicación Empaquetada'
...
,p_plug_name=>'Informes Guardados de Aplicación Empaquetada'
...
,p_max_row_count_message=>'Esta consulta devuelve más de 10.000 filas, filtre los datos para asegurar resultados completos.'
,p_no_data_found_message=>'Las aplicaciones empaquetadas no tienen ningún informe guardado por usuario.'
,p_allow_report_categories=>'N'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4751)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Suprimir Selección'
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
...
,p_max_row_count=>'10000'
,p_max_row_count_message=>'Esta consulta devuelve más de 10.000 filas, filtre los datos para asegurar resultados completos.'
,p_no_data_found_message=>'Las aplicaciones empaquetadas no tienen ninguna suscripción.'
,p_allow_report_categories=>'N'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
,p_column_label=>'Fecha de Finalización'
,p_column_type=>'DATE'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
...
,p_column_label=>'Correo Electrónico De'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
...
,p_column_label=>'Enviar Correo Electrónico a'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
...
'return true;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Debe seleccionar la suscripción que desea suprimir.'
,p_always_execute=>'N'
...
'    end loop;',
'end loop;'))
,p_process_error_message=>'No se ha podido eliminar la suscripción.'
...
,p_plug_name=>'Control de Conexión a la Cuenta'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4751)
,p_plug_display_sequence=>20
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Realice una selección para determinar si las cuentas de usuario final de &PRODUCT_NAME. pueden estar vencidas o bloqueadas. Esta función se aplica sólo a',
'las cuentas de usuario final creadas utilizando la interfaz de gestión de usuarios de &PRODUCT_NAME..',
' Las opciones disponibles incluyen:',
'<ul>',
'<li>Activar</li>',
'<li>Desactivar</li>',
'</ul>',
'Esta función proporciona seguridad de autenticación adicional para las aplicaciones.',
'Si selecciona <b>Activar</b>, las contraseñas de la cuenta de usuario vencerán después de un período de tiempo configurable,',
'las cuentas se bloquearán después de un número configurable de fallos de autenticación y las contraseñas de la cuenta se pueden definir para que venzan después del primer uso.',
'<p>',
'Si el administrador de &PRODUCT_NAME. para esta instalación ha definido el valor de entorno <b>Requerir Bloqueo y Vencimiento de Cuenta de Usuario</b> en Sí, esto significa que la función se debe activar para todos los espacios de trabajo y el elemen'
||'to mostrará <b>Activar</b> y el administrador del espacio de trabajo no lo puede cambiar.'))
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_prompt=>'Máximo de Fallos de Conexión Permitidos:'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Introduzca un entero positivo para utilizar como el número máximo de intentos de autenticación incorrectos consecutivos permitidos antes de que se bloquee una cuenta de usuario final.',
'Si no especifica un valor en este campo, se utilizará el valor de entorno <b>Máximo de Fallos de Conexión Permitidos</b> en el nivel de ubicación.'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'    45 )'))
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_prompt=>'Duración de Cuenta de Usuario Final (días):'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Introduzca un entero positivo para utilizar como el número máximo de días que se puede utilizar la contraseña de una cuenta de usuario final antes del vencimiento de la cuenta. Si no especifica un valor en este campo, se utilizará el valor de entorno'
||' <b>Duración de Contraseña de Cuenta</b> en el nivel de ubicación.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page(
 p_id=>24.4751
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4751)
,p_name=>'Cambiar Mi Contraseña'
,p_page_mode=>'MODAL'
,p_step_title=>'Cambiar Mi Contraseña'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Nombre del usuario para el que se cambia la contraseña'
,p_attribute_01=>'Y'
...
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(808618444674696806.4751)
,p_prompt=>'Introducir Contraseña Actual'
,p_display_as=>'NATIVE_PASSWORD'
,p_cSize=>30
,p_cMaxlength=>4000
,p_field_template=>wwv_flow_api.id(741012333966774170.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Introduzca su contraseña actual.'
,p_attribute_01=>'N'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_item_plug_id=>wwv_flow_api.id(808618444674696806.4751)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Introducir Nueva Contraseña'
,p_display_as=>'NATIVE_PASSWORD'
,p_cSize=>30
,p_cMaxlength=>2000
,p_field_template=>wwv_flow_api.id(741012333966774170.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Introduzca la nueva contraseña'
,p_attribute_01=>'N'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_item_plug_id=>wwv_flow_api.id(808618444674696806.4751)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Confirmar Nueva Contraseña'
,p_display_as=>'NATIVE_PASSWORD'
,p_cSize=>30
,p_cMaxlength=>2000
,p_field_template=>wwv_flow_api.id(741012333966774170.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Vuelva a introducir la nueva contraseña'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_validation(
...
,p_error_message=>'No se ha definido el nombre de usuario correctamente. Cierre el explorador e intente volver a cambiar la contraseña.'
,p_always_execute=>'N'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Se debe especificar la contraseña.'
,p_always_execute=>'N'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Se debe especificar la contraseña de confirmación.'
,p_always_execute=>'N'
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'La contraseña de confirmación no coincide con la contraseña.'
,p_always_execute=>'N'
...
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Contraseña no válida'
,p_always_execute=>'N'
...
'end;'))
,p_process_error_message=>'Error al cambiar la contraseña.'
,p_process_when=>':F4750_P24_PASSWORD = :F4750_P24_CONFIRM_PASSWORD'
,p_process_when_type=>'PLSQL_EXPRESSION'
,p_process_success_message=>'La contraseña ha cambiado.'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>29.4751
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4751)
,p_name=>'Vistas de Página'
,p_page_mode=>'NORMAL'
,p_step_title=>'Vistas de Página'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(818291832742192134.4751)
...
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Vistas de Página'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Búsquedas de Informe'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Vista Más Reciente'
,p_column_type=>'DATE'
,p_format_mask=>'SINCE'
,p_tz_dependent=>'N'
);
...
wwv_flow_api.create_page(
 p_id=>46.4751
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4751)
,p_name=>'Cambiar Autenticación'
,p_page_mode=>'MODAL'
,p_step_title=>'Cambiar Autenticación'
...
,p_plug_name=>'Cambiar Autenticación'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(740771588500180474.4751)
...
,p_plug_name=>'Configuración de Autenticación'
...
'<script type="text/javascript">',
'// ocultar los atributos dinámicos inmediatamente después de su representación, ',
...
,p_item_plug_id=>wwv_flow_api.id(492893177518858121.4751)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Nombre de la Aplicación:'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select name ',
'from wwv_flows',
...
'        commit;',
' end;'))
,p_process_error_message=>'La aplicación no se ha actualizado correctamente.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492892500116858121.4751)
,p_process_success_message=>'El esquema de autenticación de la aplicación se ha actualizado correctamente.'
);
wwv_flow_api.create_page_process(
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492892500116858121.4751)
,p_process_success_message=>'La autenticación de la aplicación ha cambiado.'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1119586009828190520.4751)
,p_plug_name=>'Aplicaciones: JSON'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(404672496027804677.4751)
,p_plug_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'Y'
...
,p_plug_name=>'Galería de Aplicaciones Empaquetadas'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1212073820889771903.4751)
,p_plug_name=>'Contenedor de Búsqueda'
,p_region_template_options=>'#DEFAULT#'
...
,p_prompt=>'Buscar'
,p_placeholder=>'buscar aplicaciones empaquetadas'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
wwv_flow_api.create_page(
 p_id=>81.4751
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4751)
,p_name=>'Detalles de Aplicación Empaquetada'
,p_page_mode=>'NORMAL'
,p_step_title=>'Detalles de Aplicación Empaquetada'
...
wwv_flow_api.create_page(
 p_id=>83.4751
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4751)
,p_name=>'Instalar Aplicación Empaquetada'
,p_page_mode=>'MODAL'
,p_step_title=>'Instalar Aplicación Empaquetada'
...
,p_plug_name=>'Objetos de Hoja de Cálculo Web no Válidos'
...
,p_plug_name=>'Instalar Aplicación'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(740771588500180474.4751)
,p_plug_display_sequence=>10
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4751)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Instalar Aplicación'
,p_button_position=>'REGION_TEMPLATE_CREATE'
...
,p_button_template_id=>wwv_flow_api.id(758581488338548971.4751)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Gestionar Objetos de Base de Datos de Hoja de Cálculo Web'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
,p_item_plug_id=>wwv_flow_api.id(492809197937498056.4751)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Correo Electrónico de Proveedor:'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
,p_plug_name=>'Instalando Aplicación...'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(1164736283212438414.4751)
...
,p_process_error_message=>'La aplicación no se ha instalado correctamente.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Aplicación Instalada.'
);
wwv_flow_api.create_page_process(
...
,p_prompt=>'Señale el tipo de servicio que desea solicitar:'
,p_source=>'STORAGE'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_RADIOGROUP'
...
,p_error_message=>'Cantidad de almacenamiento solicitada no válida.'
,p_always_execute=>'N'
...
wwv_flow_api.create_page(
 p_id=>102.4751
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4751)
,p_name=>'Solicitar Terminación del Servicio: Definir Solicitud'
,p_page_mode=>'NORMAL'
,p_step_title=>'Solicitar Terminación del Servicio: Definir Solicitud'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'No se ha encontrado ninguna aplicación de base de datos.'
,p_query_num_rows_type=>'ROW_RANGES_WITH_LINKS'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_csv_output=>'N'
...
,p_name=>'Aplicaciones de Hoja de Cálculo Web'
,p_template=>wwv_flow_api.id(662132465401686364.4751)
,p_display_sequence=>60
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'No se ha encontrado ninguna aplicación de hoja de cálculo web.'
,p_query_num_rows_type=>'ROW_RANGES_WITH_LINKS'
,p_query_row_count_max=>500
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_csv_output=>'N'
...
,p_name=>'Terminación del Servicio del Espacio de Trabajo'
,p_template=>wwv_flow_api.id(740771588500180474.4751)
,p_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
...
'<p>Los administradores de espacio de trabajo utilizan esta página para solicitar la terminación del servicio.</p>'))
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(805274418118000233.4751)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(805274700563000235.4751)
,p_query_column_id=>1
,p_column_alias=>'THE_NAME'
,p_column_display_sequence=>1
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(805274820294000235.4751)
,p_query_column_id=>2
,p_column_alias=>'THE_NAME'
,p_column_display_sequence=>2
,p_use_as_row_header=>'N'
...
,p_plug_name=>'Solicitar Terminación del Servicio'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'DEFAULT'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(805132117516607920.4751)
...
,p_cache_mode=>'NOCACHE'
,p_help_text=>'AEADM/aadm_request.htm'
,p_last_upd_yyyymmddhh24miss=>'20150428183745'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page(
 p_id=>105.4751
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4751)
,p_name=>'Provisionamiento: Solicitar Terminación del Servicio'
,p_page_mode=>'NORMAL'
,p_step_title=>'Provisionamiento: Solicitar Terminación del Servicio'
...
,p_plug_name=>'Confirmar Terminación del Servicio'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(740771588500180474.4751)
,p_plug_display_sequence=>10
...
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>Esta página permite al administrador de un espacio de trabajo solicitar la terminación del servicio al que está conectado actualmente.<br><br>',
'',
'<b>IMPORTANTE:</b> cuando se termine el servicio, se eliminarán todos los datos, objetos de base de datos, esquemas de base de datos, tablespaces, aplicaciones, scripts, archivos, etc.</p>',
'',
...
,p_error_message=>'Ya existe una solicitud de terminación de servicio para este espacio de trabajo.'
,p_always_execute=>'N'
...
'    p_service_attribute_2  => wwv_flow_user_api.get_email(p_username => upper(wwv_flow.g_user)));',
'end;'))
,p_process_error_message=>'Error al ejecutar la solicitud de terminación de servicio.'
,p_process_when_button_id=>wwv_flow_api.id(805380789015646517.4751)
,p_process_success_message=>'Solicitud de terminación del servicio ejecutada.'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>209.4751
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4751)
,p_name=>'Configuración de Cuenta Application Express'
,p_page_mode=>'MODAL'
,p_step_title=>'Configuración de Cuenta Application Express'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(492818829813527218.4751)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#:a-ButtonRegion--noUI'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(492819635063527220.4751)
,p_plug_name=>'Configurar Cuenta'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(770118466855390796.4751)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(492818829813527218.4751)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4751)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(492819215638527220.4751)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(492818829813527218.4751)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492819882805527221.4751)
,p_name=>'P209_APP_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4751)
,p_prompt=>'Nombre de la Aplicación:'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
,p_field_template=>wwv_flow_api.id(741376158824001765.4751)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820018143527222.4751)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820296100527225.4751)
,p_name=>'P209_SCHEMA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4751)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820409273527225.4751)
,p_name=>'P209_METHOD'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4751)
,p_item_default=>'E'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820697304527226.4751)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820844713527226.4751)
,p_name=>'P209_EXISTING_USER'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4751)
,p_prompt=>'Nombre de Usuario Existente'
,p_source=>'APP_USER'
,p_source_type=>'ITEM'
,p_display_as=>'NATIVE_SELECT_LIST'
...
'order by 1'))
,p_lov_display_null=>'YES'
,p_lov_null_text=>'- Seleccionar Usuario -'
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492821075748527226.4751)
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Especifique el nombre de usuario utilizado para conectar a la aplicación empaquetada. Los nombres de usuario tienen las siguientes restricciones: <ul><li>',
'longitud máxima de 100 caracteres</li><li>',
'sin espacios</li>',
'',
'<li>sólo se permiten los caracteres especiales @ y los puntos (.)</li></ul>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492821585156527227.4751)
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Especifique una contraseña. Las contraseñas son sensibles a mayúsculas/minúsculas.'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492822027856527228.4751)
,p_name=>'P209_CONFIRM_PASSWORD'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4751)
,p_prompt=>'Confirmar Contraseña'
,p_display_as=>'NATIVE_PASSWORD'
,p_cSize=>30
,p_cMaxlength=>4000
,p_display_when=>':P83_AUTH = ''NATIVE_APEX_ACCOUNTS'' and wwv_flow_global.g_cloud'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Vuelva a introducir la contraseña.'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492822594676527228.4751)
,p_name=>'P209_EMAIL'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4751)
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Especifique la dirección de correo electrónico que se utilizará para la correspondencia en general, notificaciones sobre restablecimiento de contraseñas, etc.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(656958442251052404.4751)
,p_name=>'P209_WARNING_MSG'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4751)
,p_prompt=>'Mensaje de Advertencia'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'if :P81_APP_TYPE = ''DATABASE'' then',
...
,p_cSize=>30
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(750871254241940005.4751)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch:a-Form-fieldContainer--autoLabelWidth'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(777061579764817791.4751)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823118333527228.4751)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823384065527229.4751)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823728079527229.4751)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492823955896527229.4751)
...
,p_associated_item=>wwv_flow_api.id(492821075748527226.4751)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824175298527231.4751)
...
,p_associated_item=>wwv_flow_api.id(492822594676527228.4751)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824349197527231.4751)
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Dirección de correo electrónico no válida.'
,p_always_execute=>'N'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824530875527231.4751)
...
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_api.id(492821585156527227.4751)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824717510527231.4751)
...
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_api.id(492822027856527228.4751)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824939547527231.4751)
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'La contraseña de confirmación no coincide con la contraseña introducida.'
,p_always_execute=>'N'
,p_validation_condition=>'P209_CREATE_USER'
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(492819215638527220.4751)
,p_associated_item=>wwv_flow_api.id(.4751)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825193741527232.4751)
,p_validation_name=>'strong password'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825374747527232.4751)
...
'return true;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'El nombre de usuario ya existe.'
,p_always_execute=>'N'
,p_validation_condition=>'P209_CREATE_USER'
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825541202527232.4751)
,p_validation_name=>'P209_EXISTING_USER Should Not Be Null'
,p_validation_sequence=>80
,p_validation=>'P209_EXISTING_USER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Si no hay ningún usuario existente, debe crear un nuevo usuario.'
,p_always_execute=>'N'
...
,p_when_button_pressed=>wwv_flow_api.id(492819215638527220.4751)
,p_only_for_changed_rows=>'Y'
,p_associated_item=>wwv_flow_api.id(492820844713527226.4751)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(492826451491527234.4751)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492826790590527234.4751)
,p_event_id=>wwv_flow_api.id(492826451491527234.4751)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492826968456527234.4751)
,p_event_id=>wwv_flow_api.id(492826451491527234.4751)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827153196527234.4751)
,p_event_id=>wwv_flow_api.id(492826451491527234.4751)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(492827265876527234.4751)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827513295527235.4751)
,p_event_id=>wwv_flow_api.id(492827265876527234.4751)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827728196527235.4751)
,p_event_id=>wwv_flow_api.id(492827265876527234.4751)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827960709527235.4751)
,p_event_id=>wwv_flow_api.id(492827265876527234.4751)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492828182378527235.4751)
,p_event_id=>wwv_flow_api.id(492827265876527234.4751)
,p_event_result=>'FALSE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(770119774478414886.4751)
,p_name=>'Close Dialog'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(770118466855390796.4751)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(770120016874414887.4751)
,p_event_id=>wwv_flow_api.id(770119774478414886.4751)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(492825632290527232.4751)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4751)
,p_process_when=>'wwv_flow_global.g_cloud and :P83_AUTH = ''NATIVE_APEX_ACCOUNTS'' and :P81_APP_TYPE = ''DATABASE'''
,p_process_when_type=>'PLSQL_EXPRESSION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(492825893428527233.4751)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'    ); ',
'end;'))
,p_process_error_message=>'No se ha podido definir el administrador de la hoja de cálculo web.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4751)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(770120150142419290.4751)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4751)
,p_process_success_message=>'Configuración de la cuenta para ejecutar la aplicación.'
);
end;
/
...
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_plug_header=>'Se ha instalado la aplicación empaquetada. Sin embargo, ha fallado la instalación de los objetos de base de datos y datos iniciales.'
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
);
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'No se han encontrado resultados de instalación'
...
wwv_flow_api.create_page(
 p_id=>234.4751
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4751)
,p_name=>'Desbloquear Aplicación Empaquetada'
,p_page_mode=>'MODAL'
,p_step_title=>'Desbloquear Aplicación Empaquetada'
...
'Al desbloquear una aplicación empaquetada, la aplicación será <strong>no seleccionable para futuras actualizaciones</strong> y',
'<strong>ya no estará soportada</strong> por los Servicios de Soporte Oracle.'))
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4751)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Desbloquear Aplicación'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
...
,p_plug_name=>'Desbloqueando Aplicación...'
,p_region_template_options=>'#DEFAULT#:a-ProcessingRegion--dialog'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1164683681838385745.4751)
,p_plug_display_sequence=>10
...
'  end loop;',
'end;'))
,p_process_error_message=>'Error al desbloquear la aplicación'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Aplicación Desbloqueada'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>237.4751
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4751)
,p_name=>'Eliminar Aplicación Empaquetada'
,p_page_mode=>'MODAL'
,p_step_title=>'Eliminar Aplicación Empaquetada'
...
,p_plug_name=>'Eliminar Aplicación'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(740771588500180474.4751)
,p_plug_display_sequence=>35
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4751)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Eliminar Aplicación'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
...
,p_plug_name=>'Eliminando Aplicación...'
...
'  end if;',
'end;'))
,p_process_error_message=>'Error al eliminar la aplicación'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Aplicación Eliminada'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>262.4751
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4751)
,p_name=>'Actualizar Aplicación Empaquetada'
,p_page_mode=>'MODAL'
,p_step_title=>'Actualizar Aplicación Empaquetada'
...
,p_plug_name=>'Actualizar Aplicación'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(740771588500180474.4751)
,p_plug_display_sequence=>10
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4751)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Actualizar Aplicación'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
...
,p_plug_name=>'Actualizando Aplicación...'
,p_region_template_options=>'#DEFAULT#:a-ProcessingRegion--dialog'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1164683681838385745.4751)
,p_plug_display_sequence=>10
...
,p_process_error_message=>'La aplicación no se ha actualizado correctamente.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'La aplicación se ha actualizado correctamente.'
);
wwv_flow_api.create_page_process(
...
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Aplicación Actualizada.'
);
end;
/
...
,p_display_order=>3
,p_column_identifier=>'G'
,p_column_label=>'Correo Electrónico'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>9
,p_column_identifier=>'K'
,p_column_label=>'Estado de la Contraseña'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>11
,p_column_identifier=>'L'
,p_column_label=>'Fecha de Última Conexión del Creador'
,p_column_type=>'DATE'
...
,p_column_label=>'Última Conexión del Creador'
,p_column_type=>'DATE'
,p_format_mask=>'SINCE'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>19
,p_column_identifier=>'S'
,p_column_label=>'Días de Duración de la Contraseña'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>20
,p_column_identifier=>'T'
,p_column_label=>'Accesos de Duración de la Contraseña'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>21
,p_column_identifier=>'U'
,p_column_label=>'Accesos de Contraseña Restantes'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>23
,p_column_identifier=>'W'
,p_column_label=>'Última Dirección IP'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>26
,p_column_identifier=>'Z'
,p_column_label=>'Cambiar Contraseña en el Primer Uso'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>27
,p_column_identifier=>'AA'
,p_column_label=>'Contraseña Usada por Primera Vez'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>37
,p_column_identifier=>'AK'
,p_column_label=>'Hojas de Cálculo Web'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_worksheet_column(
...
,p_plug_name=>'Identificación de Usuario'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4751)
,p_plug_display_sequence=>30
...
,p_plug_name=>'Selector de Visualización de Región'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(404672496027804677.4751)
,p_plug_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'Y'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'Especifique el esquema por defecto utilizado para examinar datos, crear aplicaciones y ejecutar archivos de comandos SQL. Al utilizar espacios de trabajo con más de un esquema disponible, utilice este esquema como valor por defecto para crear aplicac'
||'iones, realizar consultas SQL, etc. Esta función no controla la seguridad, sólo las preferencias del usuario.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
...
,p_help_text=>'Introduzca una lista de esquemas delimitada por dos puntos de los esquemas en los que tenga permiso este desarrollador cuando utilice el Taller SQL. La lista de esquemas introducidos aquí restringe el usuario a un subjuego del juego completo de esque'
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Especifique si este usuario debe tener privilegios de administrador de espacio de trabajo. Los administradores tienen acceso a todos los componentes. Además, también pueden gestionar cuentas de usuario, grupos y servicios de desarrollo.',
'',
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'Especifique si este usuario debe tener privilegios de desarrollador. Los desarrolladores pueden instalar, eliminar o actualizar aplicaciones empaquetadas.'
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
,p_attribute_04=>'VERTICAL'
);
...
'<br>',
'Un administrador siempre tendrá acceso al creador de aplicaciones.<br>',
'Un desarrollador debe tener acceso al creador de aplicaciones, al taller de SQL o a ambos.<br>',
'<br>',
'Este atributo siempre está desactivado cuando un administrador desactiva el acceso al creador de aplicaciones para el espacio de trabajo.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
'Un desarrollador debe tener acceso al creador de aplicaciones, al taller de SQL o a ambos.<br>',
'<br>',
'Este atributo está siempre desactivado si un administrador ha desactivado el acceso al creador de aplicaciones.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_use_cache_before_default=>'NO'
,p_item_default=>'Y'
,p_prompt=>'Acceso a Desarrollo de Hojas de Cálculo Web'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'YES_NO_RETURNS_Y_OR_N'
,p_lov=>'.'||wwv_flow_api.id(801893675976261985)||'.'
,p_cHeight=>1
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Determina si un desarrollador tiene acceso al desarrollo de hojas de cálculo web.<br>',
'<br>',
'Un administrador siempre tendrá acceso al desarrollo de hojas de cálculo web.<br>',
'<br>',
'Este atributo siempre está desactivado cuando un administrador desactiva el acceso al desarrollo de hojas de cálculo web para el espacio de trabajo.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
'<br>',
'Un administrador siempre tendrá acceso al taller de SQL.<br>',
'Un desarrollador debe tener acceso al creador de aplicaciones, al taller de SQL o a ambos.<br>',
'<br>',
'Este atributo siempre está desactivado cuando un administrador desactiva el acceso al taller de SQL para el espacio de trabajo.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
'<br>',
'Un administrador siempre tendrá acceso al desarrollo de equipos.<br>',
'<br>',
'Este atributo siempre está desactivado cuando un administrador desactiva el acceso al desarrollo de equipos para el espacio de trabajo.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
'',
'<li>sólo se permiten los caracteres especiales @ y los puntos (.)</li></ul>',
'<p>El nombre de usuario también se puede utilizar para hacer referencia a la actividad del usuario mediante aplicaciones de supervisión. La variable de enlace <code>:app_user </code>devolverá el valor del usuario actual al crear aplicaciones.</p>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(801875453309261960.4751)
,p_prompt=>'Dirección de Correo Electrónico'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>60
,p_cMaxlength=>240
,p_field_template=>wwv_flow_api.id(741376307162001773.4751)
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Especifique el nombre para identificar más al usuario. Este campo opcional se utiliza sólo para fines informativos.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Especifique el apellido para identificar más al usuario. Este campo opcional se utiliza sólo para fines informativos.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Utilice este campo para registrar comentarios sobre el usuario sólo para fines informativos.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'Y'
,p_attribute_04=>'NONE'
...
,p_use_cache_before_default=>'NO'
,p_prompt=>'Contraseña'
,p_post_element_text=>' <span class="instructiontext">Las contraseñas son sensibles a mayúsculas/minúsculas</span>'
,p_display_as=>'NATIVE_PASSWORD'
,p_cSize=>30
,p_cMaxlength=>255
,p_field_template=>wwv_flow_api.id(741376307162001773.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Especifique una contraseña. Las contraseñas son sensibles a mayúsculas/minúsculas. Los desarrolladores pueden cambiar sus contraseñas y, si tienen privilegio administrativo, las de otros usuarios del mismo espacio de trabajo.'
...
,p_item_plug_id=>wwv_flow_api.id(801880245567261967.4751)
,p_item_default=>'Y'
,p_prompt=>'Requerir Cambio de Contraseña en el Primer Uso'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'YES_NO_RETURNS_Y_OR_N'
,p_lov=>'.'||wwv_flow_api.id(801893675976261985)||'.'
,p_cHeight=>1
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Seleccione <b>Sí</b> para que el usuario de esta cuenta cambie la contraseña inmediatamente después de conectarse la primera vez con la contraseña actual. Esta regla se aplica al uso de esta cuenta para la administración o el desarrollo del espacio d'
||'e trabajo así como a su uso para la conexión a las aplicaciones desarrolladas.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
...
,p_error_message=>'Nombre de usuario no válido.'
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
,p_associated_item=>wwv_flow_api.id(801875696425261961.4751)
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Se debe especificar la dirección de correo electrónico.'
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Las contraseñas no coinciden.  '
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
...
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'El nombre de usuario no coincide con la expresión definida para la instancia.'
,p_always_execute=>'N'
,p_validation_condition=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>Introduzca o copie y pegue direcciones de correo electrónico separadas por comas, puntos y comas o en líneas distintas. Tenga en cuenta que si copia y pega direcciones de correo electrónico a partir de mensajes de correo electrónico, se filtrará e'
||'l texto extraño. Todos los usuarios de correo electrónico se agregarán como el rol seleccionado. Las direcciones de correo electrónico existentes o duplicadas se ignorarán.',
'',
'<p>Tenga en cuenta que la contraseña que especifique se asignarán a los usuarios, que deberán cambiar sus contraseñas cuando se conecten.</p>'))
,p_plug_query_row_template=>1
,p_plug_column_width=>'valign=top'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_prompt=>'Lista de Direcciones de Correo Electrónico'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>80
,p_cMaxlength=>32767
,p_cHeight=>10
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Introduzca o copie y pegue direcciones de correo electrónico separadas por comas, puntos y comas o en líneas distintas. Tenga en cuenta que si copia y pega direcciones de correo electrónico a partir de mensajes de correo electrónico, se filtrará el t'
||'exto extraño.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Especifique si desea incluir la dirección de correo electrónico completa, o bien excluir el nombre de dominio. Las opciones incluyen:',
'<ul>',
'<li>Definir dirección de correo electrónico completa como nombre de usuario - Incluye la dirección de correo electrónico completa.</li>',
'<li>Excluir dominio @ como parte del nombre de usuario - Elimina todo el texto situado detrás del símbolo @ (por ejemplo, <code>usuario1@xyz.com</code> pasa a ser <code>usuario1</code>).</li>',
'</ul>'))
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'Especifique si estos usuarios deben tener privilegios de administrador de espacio de trabajo. Al igual que los desarrolladores, pueden crear y modificar aplicaciones y objetos de base de datos. Además, también pueden gestionar cuentas de usuario, gru'
...
,p_error_message=>'La contraseña y su confirmación no coinciden.'
,p_always_execute=>'N'
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'No se han encontrado direcciones de correo electrónico válidas.'
,p_query_num_rows_type=>'0'
,p_query_row_count_max=>5000
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_break_type_flag=>'DEFAULT_BREAK_FORMATTING'
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'No se han encontrado usuarios nuevos no válidos'
,p_query_num_rows_type=>'0'
,p_query_row_count_max=>5000
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_break_type_flag=>'DEFAULT_BREAK_FORMATTING'
...
,p_column_display_sequence=>2
,p_column_heading=>'¿Por qué no es válido?'
);
wwv_flow_api.create_page_plug(
...
,p_plug_name=>'No Existen Usuarios Válidos'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404672496027804677.4751)
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'<p>La lista de nombres de usuario de la página anterior ha encontrado nombres de usuario no válidos y &P303_INVALID_COUNT. nombres de usuario no válidos. Vuelva atrás y verifique la lista de nombres de usuario que ha proporcionado.</p>'
,p_plug_query_row_template=>1
,p_plug_query_num_rows=>15
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4751)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Crear Usuarios Válidos'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
...
,p_cache_timeout_seconds=>21600
,p_help_text=>'AEADM/aadm_users.htm'
,p_last_upd_yyyymmddhh24miss=>'20150428183746'
);
wwv_flow_api.create_page_plug(
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>Este gestor de usuarios mantiene cuentas que utilizarán los esquemas de autenticación que se autentican con el nombre de usuario y la contraseña almacenados en estas cuentas.</p>',
'<p>Si desea cambiar la contraseña del usuario, introduzca una nueva contraseña. De lo contrario, deje las columnas de contraseña como NULL y no se cambiará la contraseña actual.</p>'))
,p_plug_query_row_template=>wwv_flow_api.id(1939532588110833.4751)
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>'Especifique el formato de fecha de Oracle por defecto para el usuario. De esta forma se controlará el formato de fecha por defecto dentro del Taller de SQL.'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Especifique si este usuario debe tener privilegios de administrador de espacio de trabajo. Los administradores tienen acceso a todos los componentes. Además, también pueden gestionar cuentas de usuario y servicios de desarrollo.',
'',
'Si los administradores de instancia desactivan los componentes, puede que estos no se encuentren disponibles.'))
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'El usuario pertenece a los grupos resaltados. Para agregar un usuario al grupo, haga clic en el nombre para que se resalte. Para eliminar un grupo, vuelva a hacer clic para que deje de estar resaltado. </p> <p>',
'Las asignaciones de grupo permiten a los desarrolladores controlar el acceso por grupo a funciones concretas. Esta funcionalidad está incorporada en Creador de Aplicaciones y funciona mejor (y es más cómoda) con autenticación basada en cookie. Sin em'
||'bargo, esta funcionalidad de grupo de usuario no es portable en otros esquemas de autenticación. Sólo es útil si se utiliza autenticación interna.</p>'))
,p_attribute_01=>'Y'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Contraseña utilizada para conectar al sistema. No introduzca ninguna contraseña a menos que desee cambiar la actual.'
,p_attribute_01=>'N'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Vuelva a introducir la contraseña. No introduzca una contraseña a menos que desee cambiar la actual.'
,p_attribute_01=>'N'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_api.id(805491259930047781.4751)
,p_prompt=>'Contraseña de Desarrollador/Administrador:'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Indica si la contraseña ha vencido o es válida para la conexión del desarrollador o administrador del espacio de trabajo.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_api.id(805491259930047781.4751)
,p_prompt=>'Contraseña del Usuario Final:'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Indica si la contraseña ha vencido o es válida para la conexión de usuario final.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_item_plug_id=>wwv_flow_api.id(805491259930047781.4751)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Forzar Vencimiento de Contraseña'
,p_display_as=>'NATIVE_CHECKBOX'
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'Active esta casilla de control para que venza la contraseña del usuario. Esto afecta tanto a la conexión de desarrollador/administrador como al acceso como usuario final. Si vence, la próxima vez que se accede a esta cuenta, se pedirá al usuario que '
||'proporcione la contraseña antigua y la nueva para conectarse.'
,p_attribute_01=>'1'
);
wwv_flow_api.create_page_item(
...
'end loop;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Si actualiza el nombre de usuario, debe proporcionar una nueva contraseña.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(805491074986047781.4751)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'La contraseña no se ha confirmado correctamente, introduzca exactamente la misma contraseña dos veces.'
,p_always_execute=>'N'
,p_validation_condition=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
'    exit;',
'end loop;'))
,p_process_error_message=>'Error al recuperar la información del usuario.'
);
wwv_flow_api.create_page_process(
...
,p_plug_name=>'Comentarios Existentes sobre esta Página'
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'No se han introducido comentarios para esta página.'
...
,p_column_display_sequence=>5
,p_column_heading=>'Respuesta Pública'
,p_use_as_row_header=>'N'
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Aplicación sobre la que realiza sus comentarios.'
,p_attribute_01=>'Y'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Página sobre la que realiza sus comentarios.'
,p_attribute_01=>'Y'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(829721255038941612.4751)
,p_prompt=>'Comentario para Creador de Aplicaciones y Desarrollo de Aplicaciones APEX'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>96
,p_cMaxlength=>4000
,p_cHeight=>4
,p_field_template=>wwv_flow_api.id(741376307162001773.4751)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Para ayudar a mejorar &PRODUCT_NAME., proporciónenos sus comentarios.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(829724817666941621.4751)
,p_validation_name=>'Feedback not null'
,p_validation_sequence=>20
,p_validation=>'P11001_FEEDBACK'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Debe especificar un valor'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(829724329405941619.4751)
,p_associated_item=>wwv_flow_api.id(829722489187941618.4751)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
