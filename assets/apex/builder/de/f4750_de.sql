...
prompt APPLICATION 4753 - Oracle APEX Packaged Applications
--
-- Application Export:
--   Application:     4753
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902295316597409366')
...
,p_substitution_value_05=>'Copyright &copy; 1999, 2015, Oracle. All rights reserved. Alle Rechte vorbehalten.'
,p_substitution_string_06=>'MSG_USER'
,p_substitution_value_06=>'Benutzer'
,p_substitution_string_07=>'MSG_JSCRIPT'
,p_substitution_value_07=>'Wenn Sie dieses Produkt ausführen, muss JavaScript aktiviert sein.'
,p_substitution_string_08=>'MSG_TBL_SUMMARY'
,p_substitution_value_08=>'Tabelle für das Seitenlayout'
...
,p_substitution_value_18=>'Zurück zu Anwendung'
,p_substitution_string_19=>'DELETE_MSG'
,p_substitution_value_19=>'Soll dieser Löschvorgang ausgeführt werden?'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(719115788931175389.4753)
...
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Mitgelieferte App-Administration'
...
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Bestätigen'
...
,p_list_item_disp_cond_type=>'PLSQL_EXPRESSION'
,p_list_item_disp_condition=>'wwv_flow_platform.get_preference(''SERVICE_REQUESTS_ENABLED'') = ''Y'''
,p_list_text_01=>'Zugriff auf zusätzlichen Speicher oder zur Beendigung des Workspace anfordern.'
...
,p_list_text_01=>'Voreinstellungen zur Kontrolle der Funktionalität für den Workspace konfigurieren.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>wwv_flow_api.id(404682514053862570)
,p_list_item_current_type=>'TARGET_PAGE'
);
...
,p_list_text_01=>'Interaktive Berichte, die von Benutzern der mitgelieferten Anwendungen gespeichert wurden, anzeigen und verwalten.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
...
,p_list_text_01=>'Interaktive Berichtsabonnements, die von Benutzern der mitgelieferten Anwendungen erstellt wurden, anzeigen und verwalten.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list(
...
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Mehrere Benutzer löschen'
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Anwendungsaktivität'
,p_list_item_link_target=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'icon-utilities-activity'
,p_list_text_01=>'Monatlicher Kalender der Anwendungsaktivitäten, in dem verschiedene Benutzer und die gesamten Seitenansichten pro Tag aufgeführt werden.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1355859641927129.4753)
...
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Benutzername auf vollständige E-Mail-Adresse festlegen'
,p_lov_return_value=>'N'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805346868716446830.4753)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'@ Domain als Teil des Benutzernamens ausschließen'
,p_lov_return_value=>'Y'
);
wwv_flow_api.create_list_of_values(
...
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Täglich'
,p_lov_return_value=>'D'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805285009454012075.4753)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Wöchentlich'
...
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Primärer Standardwert'
...
,p_lov_disp_value=>'Authentifizierung ändern'
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(805102768336534835.4753)
,p_lov_name=>'REQUEST SERVICE'
,p_lov_query=>'.'||wwv_flow_api.id(805102768336534835)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103010621534839.4753)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Schema anfordern'
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103339867534842.4753)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Speicherplatz anfordern'
,p_lov_return_value=>'STORAGE'
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(805103624199534842.4753)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Ende anfordern'
,p_lov_return_value=>'TERMINATION'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4753)
,p_short_name=>'Mitgelieferte Anwendung entfernen'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4753)
,p_short_name=>'Mitgelieferte Anwendung installieren'
,p_link=>'f?p=&APP_ID.:83:&SESSION.::&DEBUG.:::'
,p_page_id=>83
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(492872210530717222.4753)
,p_parent_id=>wwv_flow_api.id(806264496767109365.4753)
,p_short_name=>'Mitgelieferte Anwendung installieren'
...
,p_short_name=>'Mitgelieferte Anwendung entsperren'
...
,p_parent_id=>wwv_flow_api.id(.4753)
,p_short_name=>'Authentifizierung ändern'
...
,p_parent_id=>wwv_flow_api.id(806264496767109365.4753)
,p_short_name=>'Mitgelieferte Anwendung updaten'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(750897172696068128.4753)
,p_parent_id=>wwv_flow_api.id(.4753)
,p_short_name=>'<span class="u-VisuallyHidden">Anwendungen</span><span class="a-Icon icon-breadcrumb-previous"></span>'
,p_link=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::'
,p_page_id=>1
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(788162743515607361.4753)
,p_parent_id=>wwv_flow_api.id(750897172696068128.4753)
,p_short_name=>'Mitgeliefertes App-Dashboard'
...
,p_parent_id=>wwv_flow_api.id(750897172696068128.4753)
,p_short_name=>'Administration von mitgelieferter App'
...
,p_parent_id=>wwv_flow_api.id(801862732676237146.4753)
,p_short_name=>'Mehrere Benutzer löschen'
...
,p_parent_id=>wwv_flow_api.id(750897172696068128.4753)
,p_short_name=>'Mitgelieferte Apps-Galerie'
...
,p_short_name=>'Mitgelieferte Anwendung - Details'
...
,p_parent_id=>wwv_flow_api.id(798343358044477984.4753)
,p_short_name=>'Anwendungsaktivität'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(1224179617523676528.4753)
,p_parent_id=>wwv_flow_api.id(788162743515607361.4753)
,p_short_name=>'Mitgelieferte Anwendungen'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747469399730136676.4753)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(747469775365136676.4753)
,p_page_template_id=>wwv_flow_api.id(741366253443994295.4753)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970712970659339897.4753)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970713375545339897.4753)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4753)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970713743513339897.4753)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4753)
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714187781339897.4753)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4753)
,p_name=>'Right Side Bar'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714515296339897.4753)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4753)
,p_name=>'After Body'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970714940759339898.4753)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4753)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(970715378375339898.4753)
,p_page_template_id=>wwv_flow_api.id(741369094170994311.4753)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824980978803308434.4753)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4753)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824981311553308434.4753)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4753)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824981767148308434.4753)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4753)
,p_name=>'Wizard Title'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824982170342308434.4753)
,p_page_template_id=>wwv_flow_api.id(741371098457994312.4753)
...
,p_display_name=>'Kontrollkästchen "Alle prüfen" hinzufügen'
,p_category=>'MISC'
,p_supported_ui_types=>'DESKTOP'
...
,p_subscribe_plugin_settings=>true
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>Die dynamische Aktion "Kontrollkästchen Alle prüfen hinzufügen" macht eine Spaltenüberschrift, die die Zeichenfolge #CHECK_ALL_CHECKBOX# enthält, zu einem zugänglichen Kontrollkästchen "Alle prüfen", das alle Kontrollkästchen in der entsprechenden'
||' Spalte wählt bzw. deren Auswahl aufhebt.<p>',
'<p>',
'Zur Verwendung dieses Plug-ins müssen die folgenden Attribute festgelegt sein:',
'<ol>',
'<li>In der Berichtsspalte ist ''#CHECK_ALL_CHECKBOX#'' als Überschriftenwert definiert.</li>',
'<li>Für das When-Attribut der dynamischen Aktion muss die Berichtsregion gewählt sein, die die Spalte enthält.</li>',
'<li>Die dynamische Aktion zur Auslösung von "Nach Refresh" und die Aktion "Bei Laden von Seite auslösen" müssen definiert sein. (Beide sind entsprechend als Standardwert definiert, wenn die dynamische Aktion durch Auswahl der Region im Abschnitt "Ren'
||'dering" des Page Designers erstellt wird und die dynamische Aktion von dort erstellt wird.</li>',
'<li>Dadurch wird die Zugänglichkeit der Kontrollkästchen nicht festgelegt, die auf jeder Zeile gerendert werden, dies muss separat in der Regionsquelle erfolgen. (Ein Beispiel finden Sie unter 4000:656 "Region").</li>',
'</ol>',
'</p>'))
,p_version_identifier=>'1.0'
);
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006268931685907537.4753)
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006277098711907541.4753)
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006269307704907538.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4753)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006269805212907538.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4753)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006270313871907538.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006268931685907537.4753)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006270898104907538.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006271224803907539.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006271675789907539.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272020373907539.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272490890907539.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006272846289907539.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006268931685907537.4753)
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006273272857907539.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006273675862907539.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006274092256907540.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(2006279811153907542.4753)
,p_depending_on_condition_type=>'IN_LIST'
,p_depending_on_expression=>'CUSTOM'
,p_help_text=>'<p>A list of CSS supported colors separated by colons.</p>'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006274433061907540.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006274824808907540.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006274433061907540.4753)
,p_display_sequence=>10
,p_display_value=>'Value'
,p_return_value=>'VALUE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006275327182907540.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006274433061907540.4753)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006275868271907541.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>12
,p_display_sequence=>120
...
,p_is_required=>false
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_api.id(2006274433061907540.4753)
,p_depending_on_condition_type=>'IN_LIST'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006276251069907541.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>13
,p_display_sequence=>130
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006276652694907541.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>14
,p_display_sequence=>140
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006277098711907541.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>15
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006277474563907541.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006277098711907541.4753)
,p_display_sequence=>10
,p_display_value=>'Icon Chart'
,p_return_value=>'ICON'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006277997330907541.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006277098711907541.4753)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006278471627907542.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>16
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006278897464907542.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006278471627907542.4753)
,p_display_sequence=>10
,p_display_value=>'Absolute'
,p_return_value=>'ABSOLUTE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006279373310907542.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006278471627907542.4753)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006279811153907542.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>17
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006280226737907543.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4753)
,p_display_sequence=>5
,p_display_value=>'Default'
,p_return_value=>'DEFAULT'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006280711849907543.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4753)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006281297160907543.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4753)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006281704972907543.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4753)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006282208978907543.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4753)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006282788751907543.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4753)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006283223942907543.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006279811153907542.4753)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006283798141907544.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>18
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006284193963907544.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006283798141907544.4753)
,p_display_sequence=>10
...
begin
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2006284698759907545.4753)
,p_plugin_attribute_id=>wwv_flow_api.id(2006283798141907544.4753)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006285119215907545.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>19
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2006285570964907546.4753)
,p_plugin_id=>wwv_flow_api.id(3347748742822204626.4753)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>20
...
,p_last_upd_yyyymmddhh24miss=>'20150428183449'
);
...
wwv_flow_api.create_page(
 p_id=>1.4753
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4753)
,p_name=>'Mitgelieferte Apps - Home'
,p_page_mode=>'NORMAL'
,p_step_title=>'Mitgelieferte Apps - Home'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750747661941502571.4753)
,p_plug_name=>'Info'
...
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>Mitgelieferte Anwendungen bestehen aus einer Suite von Business Productivity-Anwendungen, die einfach mit einigen wenigen Klicks installiert werden können. Diese Lösungen können jederzeit als Production-Anwendungen verwendet werden, um Geschäftspr'
||'ozesse zu verbessern. Sie werden voll von Oracle unterstützt.</p>',
''))
,p_plug_query_row_template=>1
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750750940971502582.4753)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750751542816502585.4753)
,p_plug_name=>'Barrierefreiheitsmodus'
,p_region_css_classes=>' a-Region--stacked a-Region--padded a-Region--flush a-Region--sideRegion'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(750867860695912536.4753)
,p_plug_name=>'Apps'
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(750862626609892264.4753)
,p_plug_source_type=>'NATIVE_LIST'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(787083093555047575.4753)
,p_name=>'Installierte mitgelieferte Apps'
...
,p_query_no_data_found=>'Keine mitgelieferten Anwendungen installiert.'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(656958519483052405.4753)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448306370861802.4753)
,p_query_column_id=>2
,p_column_alias=>'RUN_APP_LINK'
,p_column_display_sequence=>4
,p_column_heading=>'App-Link ausführen'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(656958784419052407.4753)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(886493838302981514.4753)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(886493647565981512.4753)
,p_query_column_id=>5
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448453999861803.4753)
,p_query_column_id=>6
,p_column_alias=>'MODIFY_APP_BUTTON'
,p_column_display_sequence=>5
,p_column_heading=>'Schaltfläche "App ändern"'
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(926448530210861804.4753)
,p_query_column_id=>7
,p_column_alias=>'RUN_APP_BUTTON'
,p_column_display_sequence=>6
,p_column_heading=>'Schaltfläche "App ausführen"'
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(864570195174731021.4753)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(864570463503731024.4753)
,p_query_column_id=>9
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2310796521456520805.4753)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2310796924341520807.4753)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1494304199802239903.4753)
,p_plug_name=>'Unterstützte mitgelieferte Anwendungen'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1199601170102177728.4753)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(787083093555047575.4753)
,p_button_name=>'NEW_INSTALLED_APPS'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404711161197908978.4753)
,p_button_image_alt=>'Mitgelieferte App erstellen'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(787719037872821217.4753)
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404711161197908978.4753)
,p_button_image_alt=>'Installierte Anwendungen anzeigen'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(750755519256502601.4753)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(750751746540502585.4753)
,p_name=>'P1_ACCESSIBILITY_MODE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(750751542816502585.4753)
,p_use_cache_before_default=>'NO'
,p_item_default=>'STANDARD'
,p_prompt=>'Barrierefreiheitsmodus'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'case ',
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(933144624364626643.4753)
,p_name=>'RENDERING: Page - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(787083093555047575.4753)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(933144967905626652.4753)
,p_event_id=>wwv_flow_api.id(933144624364626643.4753)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(750754662427502591.4753)
...
'    end if;',
'end;'))
,p_process_error_message=>'Fehler beim Festlegen des Barrierefreiheitsmodus'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when=>'P1_ACCESSIBILITY_MODE'
,p_process_when_type=>'REQUEST_EQUALS_CONDITION'
,p_process_success_message=>'Barrierefreiheitsmodus festgelegt'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959145671052411.4753)
,p_plug_name=>'Top mitgelieferte Anwendungen'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959251264052412.4753)
,p_plug_name=>'Von Benutzern installierte mitgelieferte Anwendungen'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4753)
,p_plug_display_sequence=>50
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959463401052414.4753)
,p_plug_name=>'Mitgelieferte Anwendungen'
...
'end loop;'))
,p_plug_source_type=>'NATIVE_PLSQL'
,p_plug_query_row_template=>wwv_flow_api.id(741378333819007312.4753)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959880777052418.4753)
,p_plug_name=>'Info'
,p_region_css_classes=>'a-Region--stacked a-Region--padded a-Region--flush a-Region--sideRegion'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4753)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Metriken zu mitgelieferten Anwendungen in Ihrem Workspace.'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(656959992513052419.4753)
,p_plug_name=>'Mitgelieferte Anwendungen - Views'
...
,p_attribute_05=>'Seitenansichten'
,p_attribute_06=>'NONE'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788159425426560907.4753)
,p_plug_name=>'Installiert'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4753)
,p_plug_display_sequence=>20
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788164282527649493.4753)
,p_plug_name=>'Zum Upgrade verfügbar'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4753)
,p_plug_display_sequence=>40
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788166095908674996.4753)
,p_plug_name=>'Nicht installiert'
,p_region_css_classes=>'u-Height h200'
,p_region_template_options=>'#DEFAULT#:a-Region--noTopBorder:a-Region--noPadding:a-Region--hideHeader'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4753)
,p_plug_display_sequence=>30
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788982827579790091.4753)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(788983890794795218.4753)
,p_plug_name=>'Hidden'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(788983363220793228.4753)
,p_name=>'P2_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(788983890794795218.4753)
...
,p_lov_display_extra=>'YES'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Legen Sie einen Zeitrahmen fest, um die auf dieser Seite angezeigten Monitorabfragen einzuschränken.'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(789119577877826005.4753)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(789084545317643151.4753)
,p_name=>'RENDERING: Dashboard - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(788982827579790091.4753)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(789084801764643152.4753)
,p_event_id=>wwv_flow_api.id(789084545317643151.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Mitgelieferte Anwendungen'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1224170433387563371.4753)
,p_plug_name=>'Mitgelieferte Anwendungen'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(1224170516463563371.4753)
,p_name=>'Packaged Applications'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'Die maximale Anzahl der Zeilen für diesen Bericht beträgt #MAX_ROW_COUNT#. Wenden Sie einen Filter an, um die Anzahl der Datensätze in der Abfrage zu reduzieren.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224170864888563380.4753)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171279819563380.4753)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224170911190563380.4753)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171038140563380.4753)
,p_db_column_name=>'INSTALLED'
,p_display_order=>32
,p_column_identifier=>'D'
,p_column_label=>'Installiert'
,p_column_type=>'STRING'
,p_display_text_as=>'LOV_ESCAPE_SC'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171103374563380.4753)
,p_db_column_name=>'UPGRADE_AVAILABLE'
,p_display_order=>42
,p_column_identifier=>'E'
,p_column_label=>'Upgrade verfügbar'
,p_column_type=>'STRING'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_api.id(801893675976261985)
,p_rpt_show_filter_lov=>'1'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1224171357038563381.4753)
,p_db_column_name=>'TARGET_URL'
,p_display_order=>52
,p_column_identifier=>'G'
,p_column_label=>'Ziel-URL'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962307327400233.4753)
,p_db_column_name=>'CATEGORY_NAME'
,p_display_order=>62
,p_column_identifier=>'H'
,p_column_label=>'Kategoriename'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1473925915428744023.4753)
,p_db_column_name=>'IS_INSTALLED'
,p_display_order=>63
,p_column_identifier=>'I'
,p_column_label=>'Ist installiert'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962433555400234.4753)
,p_db_column_name=>'IS_NOT_INSTALLED'
,p_display_order=>73
,p_column_identifier=>'J'
,p_column_label=>'Ist nicht installiert'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(973962551146400235.4753)
,p_db_column_name=>'UPGRADE_IS_AVAILABLE'
,p_display_order=>83
,p_column_identifier=>'K'
,p_column_label=>'Upgrade ist verfügbar'
,p_column_type=>'STRING'
,p_display_text_as=>'HIDDEN'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(973962130782400231.4753)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(1224170433387563371.4753)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(973962236123400232.4753)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(1224170433387563371.4753)
,p_button_name=>'Reset'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page(
 p_id=>5.4753
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4753)
,p_name=>'Zeitrahmen für Dashboard-Berichtserstellung festlegen'
,p_page_mode=>'MODAL'
,p_step_title=>'Zeitrahmen für Dashboard-Berichtserstellung festlegen'
...
,p_plug_name=>'Zeitrahmen für Homepagebericht festlegen'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
,p_lov_display_extra=>'NO'
,p_help_text=>'Legen Sie den Zeitrahmen fest, um die auf dem Dashboard angezeigten Monitorabfragen einzuschränken.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_da_event(
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Mit der Administration können Sie mitgelieferte Anwendungen in Ihrem Workspace verwalten und überwachen, je nach Ihren Berechtigungen.'
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
...
,p_plug_name=>'Einstellungen für interaktive Berichte verwalten'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
...
,p_plug_name=>'Aktivitätsberichte'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4753)
...
wwv_flow_api.create_page(
 p_id=>7.4753
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4753)
,p_name=>'Mitgelieferte Anwendung - Details'
,p_page_mode=>'MODAL'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
...
,p_plug_name=>'Mitgelieferte Anwendung - Details'
...
,p_plug_name=>'Mitgelieferte Anwendung - Gespeicherte Berichte'
...
,p_error_message=>'Bericht muss zum Löschen ausgewählt werden.'
,p_always_execute=>'N'
...
,p_process_success_message=>'Der/die gelöschte(n) Bericht(e).'
);
end;
/
...
,p_max_row_count=>'10000'
,p_max_row_count_message=>'Diese Abfrage gibt über 10.000 Zeilen zurück. Filtern Sie die Daten, um vollständige Ergebnisse zu gewährleisten.'
,p_no_data_found_message=>'Für mitgelieferte Anwendungen sind keine Abonnements vorhanden.'
,p_allow_report_categories=>'N'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
'return true;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Subscription muss zum Löschen ausgewählt werden.'
,p_always_execute=>'N'
...
,p_last_upd_yyyymmddhh24miss=>'20150428183450'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(805410076630857770.4753)
,p_plug_name=>'Accountsteuerung für die Anmeldung'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4753)
,p_plug_display_sequence=>20
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'Steuerungsfunktionalität zu den Voreinstellungen für den Workspace.'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Treffen Sie eine Auswahl, um festzulegen, ob &PRODUCT_NAME.-Endbenutzer-Accounts ablaufen oder gesperrt werden können. Diese Funktion gilt nur für Endbenutzer-Accounts, die in der &PRODUCT_NAME.-Benutzerverwaltungsoberfläche erstellt wurden.',
'Zu den verfügbaren Optionen gehören:',
'<ul>',
'<li>Aktivieren</li>',
'<li>Deaktivieren</li>',
'</ul>',
'Diese Funktion bietet Anwendungen eine zusätzliche Authentifizierungssicherheit.',
'Wenn Sie <b>Aktivieren</b> auswählen, laufen die Benutzer-Account-Kennwörter nach einer konfigurierbaren Zeitperiode ab, werden Accounts nach Erreichen einer konfigurierbaren Anzahl von nicht erfolgreichen Authentifizierungsversuchen gesperrt, und Ac'
||'count-Kennwörter können nach der ersten Verwendung ablaufen.',
'<p>',
'Wenn der &PRODUCT_NAME.-Administrator für diese Installation die Umgebungseinstellung <b>Mit Ablauf und Sperre des Benutzer-Accounts</b> auf <b>Ja</b> gesetzt hat, muss diese Funktion für alle Workspaces aktiviert werden, und das Element zeigt <b>Akt'
||'ivieren</b> an und kann nicht vom Workspace-Administrator geändert werden.'))
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_prompt=>'Maximal zulässige nicht erfolgreiche Anmeldeversuche:'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Geben Sie eine positive Ganzzahl ein, die angibt, wie viele aufeinanderfolgende, nicht erfolgreiche Authentifizierungsversuche zulässig sind, bevor ein Endbenutzer-Account gesperrt wird.',
'Wenn Sie in diesem Feld keinen Wert eingeben, wird die Umgebungseinstellung <b>Maximal zulässige nicht erfolgreiche Anmeldeversuche</b> auf Site-Ebene verwendet.'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'    45 )'))
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_prompt=>'Gültigkeitsdauer Endbenutzeraccount (Tage):'
...
'Wenn Sie in diesem Feld keinen Wert angeben, wird die Umgebungseinstellung <b>Gültigkeitsdauer für das Account-Kennwort</b> auf Site-Ebene verwendet.'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_error_message=>'Der Wert liegt außerhalb des gültigen Bereichs.'
,p_always_execute=>'N'
...
'end if;'))
,p_process_error_message=>'Anwenden von Workspace-Voreinstellungen nicht möglich.'
...
wwv_flow_api.create_page(
 p_id=>24.4753
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4753)
,p_name=>'Mein Kennwort ändern'
,p_page_mode=>'MODAL'
,p_step_title=>'Mein Kennwort ändern'
...
,p_plug_name=>'Schaltflächenleiste'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Der Name des Benutzers, dessen Kennwort geändert werden soll'
,p_attribute_01=>'Y'
...
,p_item_plug_id=>wwv_flow_api.id(808618444674696806.4753)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Neues Kennwort bestätigen'
,p_display_as=>'NATIVE_PASSWORD'
,p_cSize=>30
,p_cMaxlength=>2000
,p_field_template=>wwv_flow_api.id(741012333966774170.4753)
...
,p_error_message=>'Der Benutzername wurde nicht korrekt festgelegt. Schließen Sie den Browser, und versuchen Sie erneut, das Kennwort zu ändern.'
,p_always_execute=>'N'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'"Kennwort bestätigen" muss angegeben werden.'
,p_always_execute=>'N'
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Die Kennwortbestätigung stimmt nicht mit dem Kennwort überein.'
,p_always_execute=>'N'
...
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Ungültiges Kennwort'
,p_always_execute=>'N'
...
'end;'))
,p_process_error_message=>'Fehler beim Ändern von Kennwort.'
,p_process_when=>':F4750_P24_PASSWORD = :F4750_P24_CONFIRM_PASSWORD'
,p_process_when_type=>'PLSQL_EXPRESSION'
,p_process_success_message=>'Kennwort geändert.'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page(
 p_id=>27.4753
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4753)
,p_name=>'Anwendungsaktivität'
,p_page_mode=>'NORMAL'
,p_step_title=>'Anwendungsaktivität'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(741368521013994306.4753)
,p_page_template_options=>'#DEFAULT#'
...
,p_plug_name=>'Anwendungsaktivität'
,p_region_template_options=>'#DEFAULT#:a-Region--noPadding'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404667570222803088.4753)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(818291832742192134.4753)
...
wwv_flow_api.create_page(
 p_id=>46.4753
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4753)
,p_name=>'Authentifizierung ändern'
,p_page_mode=>'MODAL'
,p_step_title=>'Authentifizierung ändern'
...
,p_plug_name=>'Authentifizierung ändern'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(740771588500180474.4753)
...
'        commit;',
' end;'))
,p_process_error_message=>'Anwendung wurde nicht erfolgreich upgedatet.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492892500116858121.4753)
,p_process_success_message=>'Anwendungsauthentifizierungsschema erfolgreich upgedatet.'
);
wwv_flow_api.create_page_process(
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492892500116858121.4753)
,p_process_success_message=>'Anwendungsauthentifizierung geändert.'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1119586009828190520.4753)
,p_plug_name=>'Anwendungen - JSON'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(404672496027804677.4753)
,p_plug_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'Y'
...
,p_plug_name=>'Mitgelieferte Apps-Galerie'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1212073820889771903.4753)
,p_plug_name=>'Suchcontainer'
,p_region_template_options=>'#DEFAULT#'
...
,p_prompt=>'Suchen'
,p_placeholder=>'mitgelieferte Apps suchen'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
,p_name=>'Mitgelieferte Anwendung - Details'
,p_page_mode=>'NORMAL'
,p_step_title=>'Mitgelieferte Anwendung - Details'
...
wwv_flow_api.create_page(
 p_id=>83.4753
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4753)
,p_name=>'Mitgelieferte Anwendung installieren'
,p_page_mode=>'MODAL'
,p_step_title=>'Mitgelieferte Anwendung installieren'
...
,p_plug_name=>'Ungültige Websheet-Objekte'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(1164736283212438414.4753)
...
,p_process_error_message=>'Anwendung wurde nicht erfolgreich installiert.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'Wählen Sie eine Service-Änderungsanforderung, und klicken Sie auf <b>Weiter</b>.'
,p_attribute_01=>'3'
,p_attribute_02=>'NONE'
...
,p_error_message=>'Ungültige Speicherkapazität angefordert.'
,p_always_execute=>'N'
...
,p_prompt=>'Hinzuzufügende Speicherkapazität (MB):'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Geben Sie den hinzuzufügenden Speicherplatz an.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(805274418118000233.4753)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(805274700563000235.4753)
,p_query_column_id=>1
,p_column_alias=>'THE_NAME'
,p_column_display_sequence=>1
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(805274820294000235.4753)
,p_query_column_id=>2
,p_column_alias=>'THE_NAME'
,p_column_display_sequence=>2
,p_use_as_row_header=>'N'
...
wwv_flow_api.create_page(
 p_id=>104.4753
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4753)
,p_name=>'Speicherung anfordern - Bestätigen'
,p_page_mode=>'NORMAL'
,p_step_title=>'Speicherung anfordern - Bestätigen'
...
,p_plug_display_point=>'BODY'
,p_plug_query_row_template=>1
,p_plug_header=>'<p>Bestätigen Sie Ihre Anforderung.</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
'end;'))
,p_process_error_message=>'Fehler beim Anfordern von zusätzlichem Speicherplatz.'
,p_process_when_button_id=>wwv_flow_api.id(805366770901561427.4753)
,p_process_success_message=>'Sie haben zusätzliche &P101_STORAGE. MB Speicherplatz angefordert.'
...
,p_plug_name=>'Service-Ende bestätigen'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(740771588500180474.4753)
,p_plug_display_sequence=>10
...
'',
'<p>Prüfen Sie, ob Sie den Service beenden möchten.</p>'))
,p_plug_query_row_template=>1
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
...
,p_error_message=>'Für diesen Workspace ist bereits eine Anforderung für das Service-Ende vorhanden.'
,p_always_execute=>'N'
...
'    p_service_attribute_2  => wwv_flow_user_api.get_email(p_username => upper(wwv_flow.g_user)));',
'end;'))
,p_process_error_message=>'Fehler beim Weiterleiten von Anforderung für Service-Ende.'
,p_process_when_button_id=>wwv_flow_api.id(805380789015646517.4753)
,p_process_success_message=>'Die Anforderung für das Service-Ende wurde weitergeleitet.'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>209.4753
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4753)
,p_name=>'Setup von Application Express-Account'
,p_page_mode=>'MODAL'
,p_step_title=>'Setup von Application Express-Account'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(492818829813527218.4753)
,p_plug_name=>'Wizard Buttons'
,p_region_template_options=>'#DEFAULT#:a-ButtonRegion--noUI'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(492819635063527220.4753)
,p_plug_name=>'Account einrichten'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(770118466855390796.4753)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(492818829813527218.4753)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4753)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(492819215638527220.4753)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(492818829813527218.4753)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492819882805527221.4753)
,p_name=>'P209_APP_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4753)
,p_prompt=>'Anwendungsname:'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_tag_css_classes=>'fielddatabold'
,p_field_template=>wwv_flow_api.id(741376158824001765.4753)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820018143527222.4753)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820296100527225.4753)
,p_name=>'P209_SCHEMA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4753)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820409273527225.4753)
,p_name=>'P209_METHOD'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4753)
,p_item_default=>'E'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820697304527226.4753)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492820844713527226.4753)
,p_name=>'P209_EXISTING_USER'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4753)
,p_prompt=>'Vorhandener Benutzername'
,p_source=>'APP_USER'
,p_source_type=>'ITEM'
,p_display_as=>'NATIVE_SELECT_LIST'
...
'order by 1'))
,p_lov_display_null=>'YES'
,p_lov_null_text=>'- Benutzer auswählen -'
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492821075748527226.4753)
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Geben Sie den Benutzernamen zum Anmelden bei der mitgelieferten Anwendung an. Benutzernamen haben folgende Einschränkungen: <p/><ul><li>',
'maximale Länge von 100 Zeichen</li><li>',
'keine Leerzeichen</li>',
'<li>nur folgende Sonderzeichen sind zulässig: @ und Punkte (.)</li></ul>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492821585156527227.4753)
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4753)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Geben Sie ein Kennwort an. Bei Kennwörtern wird die Groß-/Kleinschreibung berücksichtigt.'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492822027856527228.4753)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(492822594676527228.4753)
,p_name=>'P209_EMAIL'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4753)
,p_prompt=>'E-Mail'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4753)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Geben Sie die E-Mail-Adresse für die allgemeine Korrespondenz, für Benachrichtigungen zum Zurücksetzen von Kennwörtern usw. an.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(656958442251052404.4753)
,p_name=>'P209_WARNING_MSG'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(492819635063527220.4753)
,p_prompt=>'Warnmeldung '
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'if :P81_APP_TYPE = ''DATABASE'' then',
...
,p_cSize=>30
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(750871254241940005.4753)
,p_item_template_options=>'#DEFAULT#:a-Form-fieldContainer--stretch:a-Form-fieldContainer--autoLabelWidth'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(777061579764817791.4753)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823118333527228.4753)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823384065527229.4753)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(492823728079527229.4753)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492823955896527229.4753)
...
,p_associated_item=>wwv_flow_api.id(492821075748527226.4753)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824175298527231.4753)
...
,p_associated_item=>wwv_flow_api.id(492822594676527228.4753)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824349197527231.4753)
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Ungültige E-Mail-Adresse.'
,p_always_execute=>'N'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824530875527231.4753)
...
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_api.id(492821585156527227.4753)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824717510527231.4753)
...
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_api.id(492822027856527228.4753)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492824939547527231.4753)
...
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Kennwort zur Bestätigung stimmt nicht mit dem eingegebenen Kennwort überein.'
,p_always_execute=>'N'
,p_validation_condition=>'P209_CREATE_USER'
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(492819215638527220.4753)
,p_associated_item=>wwv_flow_api.id(.4753)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825193741527232.4753)
,p_validation_name=>'strong password'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825374747527232.4753)
...
'return true;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Der Benutzername ist bereits vorhanden.'
,p_always_execute=>'N'
,p_validation_condition=>'P209_CREATE_USER'
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(492825541202527232.4753)
,p_validation_name=>'P209_EXISTING_USER Should Not Be Null'
,p_validation_sequence=>80
,p_validation=>'P209_EXISTING_USER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Wenn kein Benutzer vorhanden ist, müssen Sie einen neuen Benutzer erstellen.'
,p_always_execute=>'N'
...
,p_when_button_pressed=>wwv_flow_api.id(492819215638527220.4753)
,p_only_for_changed_rows=>'Y'
,p_associated_item=>wwv_flow_api.id(492820844713527226.4753)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(492826451491527234.4753)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492826790590527234.4753)
,p_event_id=>wwv_flow_api.id(492826451491527234.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492826968456527234.4753)
,p_event_id=>wwv_flow_api.id(492826451491527234.4753)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827153196527234.4753)
,p_event_id=>wwv_flow_api.id(492826451491527234.4753)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(492827265876527234.4753)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827513295527235.4753)
,p_event_id=>wwv_flow_api.id(492827265876527234.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827728196527235.4753)
,p_event_id=>wwv_flow_api.id(492827265876527234.4753)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492827960709527235.4753)
,p_event_id=>wwv_flow_api.id(492827265876527234.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(492828182378527235.4753)
,p_event_id=>wwv_flow_api.id(492827265876527234.4753)
,p_event_result=>'FALSE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(770119774478414886.4753)
,p_name=>'Close Dialog'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(770118466855390796.4753)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(770120016874414887.4753)
,p_event_id=>wwv_flow_api.id(770119774478414886.4753)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(492825632290527232.4753)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4753)
,p_process_when=>'wwv_flow_global.g_cloud and :P83_AUTH = ''NATIVE_APEX_ACCOUNTS'' and :P81_APP_TYPE = ''DATABASE'''
,p_process_when_type=>'PLSQL_EXPRESSION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(492825893428527233.4753)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'    ); ',
'end;'))
,p_process_error_message=>'Websheet-Administrator kann nicht definiert werden.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4753)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(770120150142419290.4753)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(492819215638527220.4753)
,p_process_success_message=>'Account zur Ausführung der Anwendung eingerichtet.'
);
end;
/
...
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_plug_header=>'Die mitgelieferte Anwendung wurde installiert. Die Installation von Datenbankobjekten und vordefinierten Daten war jedoch nicht erfolgreich.'
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
);
...
wwv_flow_api.create_page(
 p_id=>234.4753
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4753)
,p_name=>'Mitgelieferte Anwendung entsperren'
,p_page_mode=>'MODAL'
,p_step_title=>'Mitgelieferte Anwendung entsperren'
...
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_header=>'Wenn Sie eine mitgelieferte Anwendung entsperren, ist die Anwendung <strong>nicht mehr für zukünftige Upgrades zulässig</strong> und wird <strong>nicht mehr von Oracle Support unterstützt</strong>.'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page(
 p_id=>237.4753
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4753)
,p_name=>'Mitgelieferte Anwendung entfernen'
,p_page_mode=>'MODAL'
,p_step_title=>'Mitgelieferte Anwendung entfernen'
...
wwv_flow_api.create_page(
 p_id=>262.4753
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4753)
,p_name=>'Mitgelieferte Anwendung updaten'
,p_page_mode=>'MODAL'
,p_step_title=>'Mitgelieferte Anwendung updaten'
...
,p_cache_mode=>'NOCACHE'
,p_cache_timeout_seconds=>21600
,p_last_upd_yyyymmddhh24miss=>'20150428183451'
);
wwv_flow_api.create_page_plug(
...
,p_process_error_message=>'Anwendung wurde nicht erfolgreich upgedatet.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Anwendung erfolgreich upgedatet.'
);
wwv_flow_api.create_page_process(
...
,p_display_order=>11
,p_column_identifier=>'L'
,p_column_label=>'Datum für letzte Anmeldung beim Builder'
,p_column_type=>'DATE'
...
,p_display_order=>19
,p_column_identifier=>'S'
,p_column_label=>'Kennwortgültigkeitsdauer in Tagen'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>20
,p_column_identifier=>'T'
,p_column_label=>'Kennwortgültigkeitsdauer Zugriffe'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
...
,p_display_order=>26
,p_column_identifier=>'Z'
,p_column_label=>'Kennwort bei erster Verwendung ändern'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
...
,p_plug_name=>'Auswahl Regionsanzeige'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(404672496027804677.4753)
,p_plug_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'Y'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'Geben Sie das Standardschema für das Durchsuchen von Daten, Erstellen von Anwendungen und Ausführen von SQL-Skripts an. Wenn Sie Workspaces verwenden, bei denen mehrere Schemas verfügbar sind, ist dieses Schema das Standardschema zum Erstellen von An'
||'wendungen, Ausführen von SQL-Abfragen usw. Dieses Feature steuert nicht die Sicherheit, sondern nur die Benutzervoreinstellung.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
...
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(801868755606261949.4753)
,p_prompt=>'Verfügbare Schemas (Leer für alle)'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>32
,p_cMaxlength=>4000
,p_cHeight=>1
...
,p_help_text=>'Geben Sie eine durch Doppelpunkte getrennte Liste der Schemas ein, auf die dieser Entwickler Berechtigungen hat, wenn SQL Workshop verwendet wird. Die Schemaliste, die Sie hier angeben, beschränkt den Benutzer auf eine Teilmenge der gesamten Schemas,'
||' die für den Workspace bereitgestellt wurden. Sie bestimmt außerdem, welche Schemanamen der Benutzer in SQL Workshop sehen kann.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Geben Sie an, ob dieser Benutzer Workspace-Administratorberechtigungen haben soll. Administratoren erhalten Zugriff auf sämtliche Komponenten. Darüber hinaus können sie auch Benutzeraccounts, Gruppen und Entwicklungsservices verwalten.',
'',
'Komponenten stehen möglicherweise nicht zur Verfügung, wenn sie von Instanzadministratoren abgeschaltet wurden.'))
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'Geben Sie an, ob dieser Benutzer Entwicklerberechtigungen erhalten soll. Entwickler können mitgelieferte Anwendungen installieren, entfernen oder upgraden.'
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
,p_attribute_04=>'VERTICAL'
);
...
,p_use_cache_before_default=>'NO'
,p_item_default=>'Y'
,p_prompt=>'Zugriff auf Application Builder'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'YES_NO_RETURNS_Y_OR_N'
,p_lov=>'.'||wwv_flow_api.id(801893675976261985)||'.'
,p_cHeight=>1
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Legt fest, ob ein Entwickler Zugriff auf Application Builder hat.<br>',
'<br>',
'Administratoren erhalten automatisch Zugriff auf Application Builder.<br>',
'Entwickler müssen auf Application Builder und/oder SQL Workshop zugreifen können.<br>',
'<br>',
'Dieses Attribut wird deaktiviert, wenn der Administrator den Zugriff auf Application Builder für einen Workspace deaktiviert.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
'<br>',
'Dieses Attribut ist immer deaktiviert, wenn der Websheet-Entwicklungszugriff für den Workspace von einem Administrator deaktiviert wurde.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Legt fest, ob ein Entwickler Zugriff auf SQL Workshop hat.<br>',
'<br>',
'Ein Administrator hat immer Zugriff auf SQL Workshop.<br>',
'Ein Entwickler muss Zugriff auf Application Builder und/oder SQL Workshop haben.<br>',
'<br>',
'Dieses Attribut ist immer deaktiviert, wenn der SQL Workshop-Zugriff für den Workspace von einem Administrator deaktiviert wurde.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
'<br>',
'Dieses Attribut ist immer deaktiviert, wenn der Team Development-Zugriff für den Workspace von einem Administrator deaktiviert wurde.'))
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_use_cache_before_default=>'NO'
,p_item_default=>'N'
,p_prompt=>'Account-Verfügbarkeit festlegen'
,p_display_as=>'NATIVE_SELECT_LIST'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>'Wählen Sie <b>Gesperrt</b>, um zu verhindern, dass der Account verwendet wird. Wählen Sie <b>Freigegeben</b>, um die Verwendung dieses Accounts zuzulassen.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Geben Sie den Benutzernamen für die Anmeldung beim System an. Die Benutzernamen haben folgende Einschränkungen: <ul><li>',
'maximale Länge von 100 Zeichen</li><li>',
'keine Leerzeichen</li>',
'<li>nur folgende Sonderzeichen sind zulässig: @ und Punkte (.)</li></ul>',
'<p>Der Benutzername kann außerdem als Referenz zur Benutzeraktivität bei Monitoranwendungen verwendet werden. Die Bind-Variable <code>:app_user </code>gibt den Wert des aktuellen Benutzers zurück, wenn Anwendungen erstellt werden.</p>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4753)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Dieses Feld wird für die Erfassung von Kommentaren zum Benutzer verwendet und dient nur zu Informationszwecken.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'Y'
,p_attribute_04=>'NONE'
...
,p_use_cache_before_default=>'NO'
,p_prompt=>'Kennwort'
,p_post_element_text=>'<span class="instructiontext">Bei Kennwörtern wird die Groß-/Kleinschreibung beachtet</span>'
,p_display_as=>'NATIVE_PASSWORD'
,p_cSize=>30
,p_cMaxlength=>255
,p_field_template=>wwv_flow_api.id(741376307162001773.4753)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Geben Sie ein Kennwort an. Bei der Kennworteingabe wird die Groß-/Kleinschreibung berücksichtigt. Entwickler können ihre Kennwörter ändern. Wenn Entwickler mit der Administratorberechtigung ausgestattet sind, können sie die Kennwörter der Benutzer in'
||'nerhalb desselben Workspace ändern.'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Wählen Sie <b>Ja</b>, wenn der Benutzer dieses Accounts das Kennwort unmittelbar nach der ersten Anmeldung mit dem aktuellen Kennwort ändern muss. Diese Regel gilt bei Verwendung dieses Accounts für die Workspace-Administration oder Entwicklung sowie'
||' für die Anmeldung bei entwickelten Anwendungen.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_validation(
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Das Standardschema muss in den verfügbaren Schemas enthalten sein.'
,p_always_execute=>'N'
...
'END;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Ein Entwickler muss Zugriff auf Application Builder und/oder SQL Workshop haben.'
,p_always_execute=>'N'
,p_validation_condition=>'SUBMIT,CREATE_ANOTHER'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
...
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Benutzername stimmt nicht mit dem für die Instanz definierten Ausdruck überein.'
,p_always_execute=>'N'
,p_validation_condition=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>Sie können durch Komma, Semikolon oder Zeilenvorschub getrennte E-Mail-Adressen eingeben oder kopieren und einfügen. Wenn Sie E-Mail-Adressen aus E-Mail-Nachrichten kopieren und einfügen, wird zusätzlicher Text herausgefiltert. Alle angegebenen E-'
||'Mail-Benutzer werden in Form der gewählten Rolle hinzugefügt. Vorhandene oder doppelte E-Mail-Adressen werden ignoriert. ',
'',
'<p>Das von Ihnen angegebene Kennwort wird jedem Benutzer zugewiesen. Benutzer müssen ihre Kennwörter bei der Anmeldung ändern.</p>'))
,p_plug_query_row_template=>1
,p_plug_column_width=>'valign=top'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Geben Sie E-Mail-Adressen getrennt durch Kommas, Semikolons oder Zeilenvorschübe ein, bzw. kopieren Sie E-Mail-Adressen, und fügen Sie diese ein. Beachten Sie, dass überflüssiger Text beim Kopieren und Einfügen von E-Mail-Adressen aus E-Mail-Nachrich'
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Geben Sie an, ob die vollständige E-Mail-Adresse aufgenommen werden soll oder ob der Domainname ausgeschlossen wird. Es gibt folgende Optionen:',
'<ul>',
'<li>Benutzername auf vollständige E-Mail-Adresse festlegen - Enthält die vollständige E-Mail-Adresse.</li>',
'<li>@ Domain als Teil des Benutzernamens ausschließen - Entfernt den gesamten Text nach dem @-Symbol (Beispiel: <code>user1@xyz.com</code> wird zu <code>user1</code>).</li>',
'</ul>'))
,p_attribute_01=>'1'
,p_attribute_02=>'NONE'
);
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'Geben Sie an, ob diese Benutzer Workspace-Administratorberechtigungen erhalten sollen. Workspace-Administratoren können wie Entwickler Anwendungen und Datenbankobjekte erstellen und ändern. Außerdem können sie Benutzeraccounts, Gruppen und Entwicklun'
...
,p_escape_on_http_input=>'Y'
,p_escape_on_http_output=>'N'
,p_help_text=>'Geben Sie an, ob diese Benutzer Entwicklerberechtigungen erhalten sollen. Entwickler können Anwendungen und Datenbankobjekte erstellen und ändern.'
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_item(
...
,p_restricted_characters=>'WORKSPACE_SCHEMA'
,p_help_text=>'Gibt das Standardschema für das Durchsuchen von Daten, Erstellen von Anwendungen und Ausführen von SQL-Skripts an. Wenn Sie Workspaces verwenden, bei denen mehrere Schemas verfügbar sind, ist dieses Schema das Standardschema zum Erstellen von Anwendu'
||'ngen, Ausführen von SQL-Abfragen usw. Dieses Feature steuert nicht die Sicherheit, sondern nur die Benutzervoreinstellung.'
,p_attribute_01=>'Y'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
...
,p_error_message=>'Kennwort und Bestätigung stimmen nicht überein.'
,p_always_execute=>'N'
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'Keine gültigen E-Mail-Adressen gefunden.'
,p_query_num_rows_type=>'0'
,p_query_row_count_max=>5000
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_break_type_flag=>'DEFAULT_BREAK_FORMATTING'
...
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'Keine ungültigen neuen Benutzer gefunden'
,p_query_num_rows_type=>'0'
,p_query_row_count_max=>5000
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_break_type_flag=>'DEFAULT_BREAK_FORMATTING'
...
,p_column_display_sequence=>2
,p_column_heading=>'Warum ungültig?'
);
wwv_flow_api.create_page_plug(
...
,p_plug_name=>'Es sind keine gültigen Benutzer vorhanden.'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(404672496027804677.4753)
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>'<p>In der Benutzernamensliste auf der vorherigen Seite wurden keine gültigen Benutzernamen und &P303_INVALID_COUNT. ungültige Benutzernamen gefunden. Gehen Sie zurück, und prüfen Sie die angegebene Benutzernamensliste.</p>'
,p_plug_query_row_template=>1
,p_plug_query_num_rows=>15
...
,p_button_template_id=>wwv_flow_api.id(404710483554908976.4753)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Gültige Benutzer erstellen'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
...
wwv_flow_api.create_page(
 p_id=>305.4753
,p_user_interface_id=>wwv_flow_api.id(539940534604132427.4753)
,p_name=>'Mehrere Benutzer löschen'
,p_page_mode=>'NORMAL'
,p_step_title=>'Mehrere Benutzer löschen'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Es muss mindestens ein Benutzer für den Löschvorgang ausgewählt werden.'
,p_always_execute=>'N'
...
'end loop;'))
,p_process_error_message=>'Benutzer konnten nicht gelöscht werden.'
,p_process_when_button_id=>wwv_flow_api.id(805152655703739453.4753)
,p_process_success_message=>'Benutzer gelöscht.'
);
end;
/
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>Dieser Benutzer-Manager verwaltet Accounts für Authentifizierungsschemas, die die Authentifizierung in Bezug auf den Benutzernamen und das Kennwort für diese Accounts ausführen.</p>',
'<p>Wenn Sie ein Benutzerkennwort ändern möchten, geben Sie ein neues Kennwort ein. Wenn Sie in die Kennwortspalten nichts eingeben, wird das aktuelle Kennwort nicht geändert.</p>'))
,p_plug_query_row_template=>wwv_flow_api.id(1939532588110833.4753)
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4753)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Gibt an, welchem Workspace dieser Benutzer angehört.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Gibt den Benutzernamen für die Anmeldung beim System an. Die Benutzernamen haben folgende Einschränkungen: <ul><li>',
'maximale Länge von 100 Zeichen</li><li>',
'keine Leerzeichen</li>',
'<li>nur folgende Sonderzeichen sind zulässig: @ und Punkte (.)</li></ul>',
'<p>Der Benutzername kann außerdem als Referenz zur Benutzeraktivität bei Monitoranwendungen verwendet werden. Die Bind-Variable <code>:app_user </code>gibt den Wert des aktuellen Benutzers zurück, wenn Anwendungen erstellt werden.</p>'))
...
,p_field_template=>wwv_flow_api.id(741376307162001773.4753)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Gibt die E-Mail-Adresse zum Beispiel für die allgemeine Korrespondenz, für Benachrichtigungen zum Zurücksetzen von Kennwörtern an.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'EMAIL'
,p_attribute_05=>'BOTH'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>'Geben Sie das Oracle-Standarddatumsformat für den Benutzer ein. Dies bestimmt das Standarddatumsformat in SQL Workshop.'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_escape_on_http_output=>'N'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Geben Sie an, ob diesem Benutzer Workspace-Administratorberechtigungen zugewiesen werden sollen. Administratoren erhalten Zugriff auf alle Komponenten. Zudem können sie Benutzeraccounts und Entwicklungsdienste verwalten.',
'',
'Komponenten, die von Instanzadministratoren deaktiviert wurden, stehen nicht zur Verfügung.'))
,p_attribute_01=>'2'
,p_attribute_02=>'NONE'
,p_attribute_04=>'VERTICAL'
);
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Wählen Sie <b>Gesperrt</b>, um zu verhindern, dass der Account verwendet wird. Wählen Sie <b>Freigegeben</b>, um die Verwendung dieses Accounts zu ermöglichen.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
,p_lov_display_extra=>'NO'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p>Der Benutzer gehört den markierten Gruppen an. Um einen Benutzer zur Gruppe hinzuzufügen, markieren Sie den Namen, indem Sie darauf klicken. Um eine Gruppe zu entfernen, klicken Sie erneut darauf, damit die Markierung aufgehoben wird. </p>',
'<p>Über Gruppenzuweisungen können Entwickler den Zugriff auf bestimmte Features und Funktionen pro Gruppe steuern. Diese Gruppenfunktionalität ist in Application Builder integriert und kann am besten (und benutzerfreundlichsten) bei der auf Cookies b'
||'asierenden Authentifizierung verwendet werden. ',
'Diese Benutzergruppenfunktionalität ist jedoch nicht über verschiedene Authentifizierungsschemas portierbar. </p>',
''))
,p_attribute_01=>'Y'
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4753)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Das Kennwort für die Anmeldung beim System. Geben Sie nur dann ein Kennwort ein, wenn Sie das aktuelle Kennwort ändern möchten.'
,p_attribute_01=>'N'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4753)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Geben Sie das Kennwort erneut ein. Geben Sie nur dann ein Kennwort ein, wenn Sie das aktuelle Kennwort ändern möchten.'
,p_attribute_01=>'N'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4753)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Gibt an, ob das Kennwort abgelaufen ist oder für die Anmeldung als Entwickler oder Workspace-Administrator gültig ist.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_field_template=>wwv_flow_api.id(741376158824001765.4753)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Gibt an, ob das Kennwort abgelaufen ist oder für die Anmeldung als Endbenutzer gültig ist.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'N'
);
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'Aktivieren Sie dieses Kontrollkästchen, damit das Benutzerkennwort abläuft. Davon ist sowohl die Anmeldung als Entwickler/Administrator als auch der Zugriff als Endbenutzer betroffen. Wenn das Kennwort abgelaufen ist, muss der Benutzer beim nächsten '
||'Account-Zugriff das alte Kennwort zusammen mit einem neuen Kennwort eingeben, um sich anmelden zu können.'
,p_attribute_01=>'1'
);
wwv_flow_api.create_page_item(
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Sie müssen einen Benutzernamen angeben.'
,p_always_execute=>'N'
...
'end loop;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Wenn Sie den Benutzernamen ändern, müssen Sie ein neues Kennwort angeben.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(805491074986047781.4753)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Das Kennwort wurde nicht korrekt bestätigt. Die Bestätigung muss mit der ersten Kennworteingabe exakt übereinstimmen.'
,p_always_execute=>'N'
,p_validation_condition=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
'wwv_flow_fnd_user_api.remove_fnd_user(',
'             p_user_id => :F4750_P306_USER_ID);'))
,p_process_error_message=>'Fehler beim Löschen von &F4750_P306_USER_NAME..'
,p_process_when_button_id=>wwv_flow_api.id(805490871563047781.4753)
,p_process_success_message=>'Benutzer &F4750_P306_USER_NAME. wurde gelöscht.'
);
wwv_flow_api.create_page_process(
...
,p_cache_mode=>'NOCACHE'
,p_cache_timeout_seconds=>21600
,p_last_upd_yyyymmddhh24miss=>'20150428183452'
);
wwv_flow_api.create_page_plug(
...
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>'-'
,p_query_no_data_found=>'Für diese Seite wurde kein Feedback eingegeben.'
...
,p_column_display_sequence=>5
,p_column_heading=>'Öffentliche Antwort'
,p_use_as_row_header=>'N'
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
...
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(829721255038941612.4753)
,p_prompt=>'Feedback für Application Builder und APEX Application Development'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>96
,p_cMaxlength=>4000
,p_cHeight=>4
,p_field_template=>wwv_flow_api.id(741376307162001773.4753)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Helfen Sie uns bei der Verbesserung von &PRODUCT_NAME., indem Sie uns Ihre Kommentare senden.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
,p_help_text=>'Geben Sie an, zu welcher Komponente oder Funktion Sie einen Kommentar abgeben möchten.'
,p_attribute_01=>'3'
,p_attribute_02=>'NONE'
);
wwv_flow_api.create_page_validation(
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(829724817666941621.4753)
...
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(829724329405941619.4753)
,p_associated_item=>wwv_flow_api.id(829722489187941618.4753)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
