...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902293574956407359')
...
,p_substitution_value_04=>'Schließen'
...
,p_substitution_value_09=>'Zurück zu Anwendung'
...
,p_substitution_value_12=>'Copyright &copy; 1999, 2015, Oracle. All rights reserved. Alle Rechte vorbehalten.'
...
,p_list_item_link_text=>'Begründung'
...
,p_list_item_link_text=>'Bestätigung'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1352228430926978.4703)
...
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Nur mitgelieferte Anwedungen'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824976787312308427.4703)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4703)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977164944308427.4703)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4703)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977534964308429.4703)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4703)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824977932305308429.4703)
,p_page_template_id=>wwv_flow_api.id(728299018883563592.4703)
...
,p_last_upd_yyyymmddhh24miss=>'20150428183447'
);
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Service anfordern'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
...
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_header=>'<p class="a-Wizard-subHeading">Welche Art von Workspace möchten Sie anfordern?</p>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Workspace anfordern - Zweite Seite'
...
,p_item_template_options=>'#DEFAULT#'
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Ihre Accountinformationen werden an diese E-Mail-Adresse gesendet.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
,p_field_template=>wwv_flow_api.id(481972771960821314.4703)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Geben Sie den gewünschten Workspace-Namen ein. Wenn Ihr Service durch Provisioning bereitgestellt ist, melden Sie sich mit einer Kombination aus Workspace, Benutzername und Kennwort an.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'BOTH'
...
,p_error_message=>'Ungültige E-Mail'
,p_always_execute=>'N'
...
wwv_flow_api.create_page(
 p_id=>3.4703
,p_user_interface_id=>wwv_flow_api.id(4970202676302344.4703)
,p_name=>'Workspace anfordern - Bestätigung'
,p_page_mode=>'NORMAL'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18348331817861713.4703)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18348522944868646.4703)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18348331817861713.4703)
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Workspace anfordern - Schema angeben'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4703)
,p_page_template_options=>'#DEFAULT#'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Wählen Sie den benötigten Speicherplatz. Nachdem das Schema erstellt wurde, können Sie gegebenenfalls zusätzlichen Speicherplatz anfordern.'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
);
wwv_flow_api.create_page_item(
...
'Der Schemaname ist der Benutzer der Oracle-Datenbank, dem Ihre Datenbankobjekte gehören. Wählen Sie den Namen sorgfältig aus. Wenn Ihr Service durch Provisioning bereitgestellt wird, erhalten Sie das Kennwort für das Schema und die Anmeldung. Nachdem'
||' Ihr Workspace erstellt wurde, können Sie dort zusätzliche Schemas hinzufügen. ',
'Gültige Schemanamen müssen folgenden Richtlinien entsprechen:',
'',
'',
'',
'- Sie müssen zwischen 1 und 30 Byte lang sein',
'',
'- Sie dürfen keine Anführungszeichen enthalten',
'',
' - Sie müssen mit einem alphabetischen Zeichen beginnen',
'',
'- Sie dürfen mit Ausnahme folgender Zeichen nur alphanumerische Zeichen enthalten:',
'',
'Unterstriche (_), Dollar-Zeichen ($) und Nummernzeichen (#).',
'',
'- Verwenden Sie keine für Oracle reservierten Wörter',
'',
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Geben Sie den Namen des Schemas ein, das Sie für den neuen &PRODUCT_NAME.-Workspace zur Verfügung stellen möchten. Nachdem der Workspace erstellt wurde, können Sie dort zusätzliche Schemas hinzufügen.',
''))
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
...
,p_restricted_characters=>'WEB_SAFE'
,p_help_text=>'Wählen Sie, ob Sie ein neues Datenbankschema erstellen oder ein vorhandenes Datenbankschema für den neuen Workspace konfigurieren möchten.'
,p_attribute_01=>'1'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Der Schemaname darf keine Anführungszeichen enthalten.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4703)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Schemaname (&SCHEMA_NAME.) ist reserviert oder eingeschränkt. Geben Sie ein anderes Schema an.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4703)
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Der Schemaname ist nicht gültig. Geben Sie einen anderen Namen an.'
,p_always_execute=>'N'
,p_validation_condition=>':NEW_SCHEMA = ''YES'''
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(320269887457.4703)
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Workspace anfordern - Schemawarnungen'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4703)
,p_page_template_options=>'#DEFAULT#'
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Workspace anfordern - Projektbeschreibung'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4703)
,p_page_template_options=>'#DEFAULT#'
...
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<p class="a-Wizard-text">Mit diesen Informationen kann der &PRODUCT_NAME.-Administrator ermitteln, wozu dieser Service benötigt wird.</p>',
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'Geben Sie den Grund für den Service Request ein. Diese Informationen werden vom &PRODUCT_NAME.-Administrator verwendet.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(516409441539385628.4703)
,p_prompt=>'Begründung für den Service Request, optional'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>70
,p_cMaxlength=>32767
,p_cHeight=>8
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'Wenn Sie laut Ihrer Firmen- oder Service-Vereinbarung verpflichtet sind, Ihre Anforderung zu begründen, geben Sie die Begründung an.'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
,p_attribute_04=>'NONE'
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Sie müssen erläutern, warum Sie diesen Service anfordern.'
,p_always_execute=>'N'
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Servicevereinbarung'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(728298792391563586.4703)
,p_page_template_options=>'#DEFAULT#'
...
,p_error_message=>'Sie müssen die Bedingungen akzeptieren, um fortzufahren.'
,p_always_execute=>'N'
...
,p_name=>'Workspace anfordern - Bestätigung'
,p_page_mode=>'NORMAL'
,p_step_title=>'Workspace anfordern - Bestätigung'
...
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'BELOW'
,p_plug_source=>'<p class="a-Wizard-text">Prüfen Sie die Workspace-Anforderung.</p>'
,p_translate_title=>'N'
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Sie müssen den angezeigten Verifizierungscode im Feld eingeben. ',
'Achten Sie bei der Eingabe der Buchstaben auf die <b>Groß-/Kleinschreibung</b>.'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Ungültiger Verifizierungscode'
,p_always_execute=>'N'
...
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'Nicht alle Werte sind ordnungsgemäß festgelegt. Starten Sie den Workspace-Anforderungsprozess erneut.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(318141939408.4703)
,p_associated_item=>wwv_flow_api.id(.4703)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
...
'end;'))
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Bedingungen wurden nicht ordnungsgemäß akzeptiert.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(318141939408.4703)
,p_associated_item=>wwv_flow_api.id(.4703)
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Erstellen von &PRODUCT_NAME.-Workspace'
,p_allow_duplicate_submissions=>'N'
