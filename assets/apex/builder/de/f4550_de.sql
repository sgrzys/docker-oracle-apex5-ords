...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A902291706387405101')
...
,p_substitution_value_03=>'Schließen'
...
,p_substitution_value_08=>'Zurück zu Anwendung'
...
,p_substitution_value_11=>'Copyright &copy; 1999, 2015, Oracle. All rights reserved. Alle Rechte vorbehalten.'
...
,p_list_text_01=>'Homepage für Oracle Application Express, über die Sie die neueste Version herunterladen, Dokumentation einsehen und auf das umfassende Begleitmaterial zugreifen können.'
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>' alt=""'
,p_list_text_01=>'Sie erhalten kostenlosen communitygesteuerten Support für Ihre Application Express-Fragen in den OTN-Diskussionsforen. '
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Ressourcen'
...
,p_list_text_01=>'Eine Seite, die ausschließlich den ersten Schritten mit Oracle Application Express gewidmet ist, mit Informationen und zahlreichen Links.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Kostenloser Hosted-Demoservice, mit dem Sie die neueste Version von Application Express schnell einsetzen können.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Oracle by Examples (OBEs) stellen erforderliche Dateien und schrittweise Anweisungen mit Screenshots bereit, die Sie Schritt für Schritt durch das Erstellen verschiedener Anwendungskomponenten führen.'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list(
...
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Kennwort zurücksetzen'
,p_list_item_link_target=>'f?p=&APP_ID.:7:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Sie können sich nicht bei Ihrem Workspace anmelden? Versuchen Sie, Ihr Kennwort hier zurückzusetzen.'
,p_translate_list_text_y_n=>'Y'
...
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Haben Sie vergessen, mit welchem Workspace Sie verknüpft sind? Finden Sie es hier heraus.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>'!'||wwv_flow_api.id(6153929631135099)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
...
,p_list_text_01=>'Bei Instanzverwaltung anmelden'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>'!'||wwv_flow_api.id(6153929631135099)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(333182002517862192.4553)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'Administration'
,p_list_item_link_target=>'f?p=4050:3:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'menu/blue_function_16x16.gif'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'Navigieren Sie zu "Instanzverwaltung"'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>wwv_flow_api.id(6153929631135099)
...
,p_list_text_01=>'Schließen Sie diesen Assistenten ab, und fordern Sie Ihren eigenen Workspace an.'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1349046415926832.4553)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983000163308436.4553)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4553)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983424337308436.4553)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4553)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824983847896308436.4553)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4553)
,p_name=>'Wizard Title'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(824984287203308437.4553)
,p_page_template_id=>wwv_flow_api.id(788153963797526843.4553)
...
,p_shortcut_type=>'HTML_TEXT'
,p_shortcut=>'Verschaffen Sie sich direkten Zugriff auf eine Entwicklungs-Suite mit integrierten Onlineanwendungen. Mit &PRODUCT_NAME. können Sie stabile dynamische Webanwendungen erstellen und in Ihrem bevorzugten Browser von der Performance der Oracle-Datenbank '
||'profitieren.'
);
end;
/
...
,p_last_upd_yyyymmddhh24miss=>'20150428183431'
);
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(781649650278313424.4553)
,p_button_image_alt=>'Kennwort zurücksetzen'
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">Geben Sie Ihren Workspace ein. Beim Workspace-Namen wird die Groß-/Kleinschreibung nicht berücksichtigt.</div>',
'<div class="htmldbInfoBodyP">Hierbei handelt es sich um einen Online-Entwicklungs-Service für den Zugriff auf eine virtuelle private Datenbank. Da derselbe Benutzername in mehreren Workspaces vorhanden sein kann, müssen Sie auch den Workspace angeben'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">Geben Sie Ihren Benutzernamen ein. Hierbei wird die Groß-/Kleinschreibung nicht berücksichtigt.</div>',
'<div class="htmldbInfoBodyP">Sobald Sie die Authentifizierung ausgeführt haben und mit den geeigneten Zugangsdaten ausgestattet sind, können Sie zusätzliche Benutzer erstellen.</div>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_help_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="htmldbInfoBodyP">Geben Sie Ihr Kennwort ein. Bei Kennwörtern wird die Groß-/Kleinschreibung berücksichtigt. Das Kennwort bezieht sich auf diesen speziellen Service. Jeder Workspace kann mehrere Benutzer haben.</div>',
'<div class="htmldbInfoBodyP">Wenn Sie Ihr Kennwort vergessen haben, wählen Sie <span class="fielddatabold">Kennwort zurücksetzen</span>.</div>'))
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_item(
...
,p_process_success_message=>'Wenn &F4550_P4_EMAIL. registriert ist, werden die zu dieser E-Mail-Adresse gehörigen Workspace-Namen gesendet. Wenn Sie die Workspace-Namen nicht erhalten, wenden Sie sich an den Administrator.'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>7.4553
,p_user_interface_id=>wwv_flow_api.id(4972214035302345.4553)
,p_name=>'Kennwort zurücksetzen'
,p_page_mode=>'NORMAL'
,p_step_title=>'Kennwort zurücksetzen'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
,p_plug_name=>'Kennwort zurücksetzen'
,p_region_template_options=>'#DEFAULT#:a-Form--labelsAbove'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(781646415851311877.4553)
,p_plug_display_sequence=>10
...
,p_prompt=>'<span class="instructiontext">Sie haben keine gültige Kombination aus Workspace-Name und E-Mail-Adresse angegeben.</span>'
...
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Geben Sie Ihre E-Mail-Adresse ein, damit wir Ihnen Ihr Kennwort per E-Mail senden können.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'EMAIL'
,p_attribute_05=>'BOTH'
...
,p_error_message=>'Der Vorgang zum Zurücksetzen von Kennwörtern wird für den Workspace INTERNAL nicht unterstützt.'
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(47286220449334625.4553)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
...
,p_process_error_message=>'Zurücksetzen von Kennwort nicht möglich.'
,p_process_when_button_id=>wwv_flow_api.id(47286811980358498.4553)
,p_process_success_message=>'Anforderung auf Zurücksetzen des Kennworts wurde zur Verarbeitung gesendet.'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>8.4553
,p_user_interface_id=>wwv_flow_api.id(4972214035302345.4553)
,p_name=>'Abmelden bestätigen'
,p_page_mode=>'NORMAL'
,p_step_title=>'Abmelden bestätigen'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
,p_button_template_id=>wwv_flow_api.id(781653829819356486.4553)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Zu Anmeldeseite zurückgehen'
,p_button_position=>'REGION_TEMPLATE_NEXT'
...
,p_page_mode=>'NORMAL'
,p_step_title=>'Administration Services für &PRODUCT_NAME.'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_api.id(222575208632450607)
...
,p_item_css_classes=>'icon-login-username'
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Geben Sie Ihren Benutzernamen ein. Hierbei wird die Groß-/Kleinschreibung nicht berücksichtigt. Nachdem Sie die Authentifizierung ausgeführt haben und mit den geeigneten Zugangsdaten ausgestattet sind, können Sie zusätzliche Benutzernamen erstellen.'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
,p_item_template_options=>'#DEFAULT#'
,p_escape_on_http_input=>'Y'
,p_help_text=>'Geben Sie Ihr Kennwort ein. Hierbei wird die Groß-/Kleinschreibung berücksichtigt. Wenn Sie Ihr Kennwort vergessen haben, klicken Sie auf <b>Kennwort vergessen</b>. Jeder Workspace kann mehrere Benutzer haben.'
,p_attribute_01=>'Y'
,p_attribute_02=>'Y'
);
wwv_flow_api.create_page_computation(
...
,p_page_is_public_y_n=>'N'
,p_cache_mode=>'NOCACHE'
,p_last_upd_yyyymmddhh24miss=>'20150428183432'
);
wwv_flow_api.create_page_plug(
