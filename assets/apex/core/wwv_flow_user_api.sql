...
--
--    MODIFIED   (MM/DD/YYYY)
--    mhichwa     06/07/2001 - Created
--    mhichwa     06/18/2001 - Enhanced documentation
--    mhichwa     07/05/2001 - Added get attribute function
--    mhichwa     08/22/2001 - Added set procedures
--    mhichwa     09/18/2001 - Changed grant
--    rmattama    03/11/2002 - Added is_username_unique and is_login_password_valid
--    arayner     10/24/2008 - Added overloaded get_group_name function with p_group_id as a number (Bug 7488305)
--    pawolf      03/07/2014 - Added get_profile_image_url and get_profile_image_html
--
--------------------------------------------------------------------------------
...
--==============================================================================
-- Given a username returns URL to display the user profile image.
--==============================================================================
function get_profile_image_url (
    p_username    in varchar2,
    p_default_url in varchar2 default null )
    return varchar2;

--==============================================================================
-- Given a username returns HTML markup to display the user profile image or
-- his initials.
--==============================================================================
function get_profile_image_html (
    p_username           in varchar2,
    p_image_size         in number   default 32,
    p_image_css_class    in varchar2 default null,
    p_image_default_url  in varchar2 default null,
    p_initials_css_class in varchar2 default null )
    return varchar2;
