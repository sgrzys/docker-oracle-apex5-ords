...
,p_default_application_id=>108808
...
prompt APPLICATION 108808 - Theme: Orange
--
-- Application Export:
--   Application:     108808
--   Name:            Theme: Orange
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,108808)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'THEME_DEV')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Theme: Orange')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'108808')
...
,p_authentication_id=>wwv_flow_api.id(2239671869888281839)
,p_application_tab_set=>1
,p_logo_image=>'TEXT:Theme Testing Application'
,p_public_user=>'HTMLDB_PUBLIC_USER'
,p_proxy_server=> nvl(wwv_flow_application_install.get_proxy,'www-proxy.oracle.com')
,p_flow_version=>'1.0'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(2239563298655240958)
,p_name=>'wizard progress bar 38, 39, 40'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2239563467587240958)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2239563794531240959)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2239564090506240959)
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(2240323280107367113)
,p_name=>'Long List (progress test)'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2240323467845367114)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2240323768534367116)
,p_list_item_display_sequence=>20
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2240324070466367117)
,p_list_item_display_sequence=>30
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2240324381885367117)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2240324688296367117)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(2240326693959371095)
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(5828083427771934757)
,p_name=>'Calendar'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5828083837122937437)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5828084111626939502)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5828084416474940951)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(5967405100605007016)
,p_name=>'Page Templates'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5967405777533009762)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5967406383074011411)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(1330508448619261935)
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(5968000693503729723)
,p_name=>'MultiLevel'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5968001201815732044)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5968001475973734045)
,p_list_item_display_sequence=>20
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5968002794327739364)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Child 2.1'
,p_list_item_link_target=>'#'
,p_parent_list_item_id=>wwv_flow_api.id(5968001475973734045)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5968003097097740226)
,p_list_item_display_sequence=>50
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5968003400907741334)
,p_list_item_display_sequence=>60
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5968002085669736929)
,p_list_item_display_sequence=>30
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5968003976450743669)
,p_list_item_display_sequence=>70
,p_list_item_link_text=>'Child 3.1'
,p_list_item_link_target=>'#'
,p_parent_list_item_id=>wwv_flow_api.id(5968002085669736929)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5968004379913744689)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5968004684415746011)
,p_list_item_display_sequence=>100
,p_list_item_link_text=>'Child 3.2.1'
,p_list_item_link_target=>'#'
,p_parent_list_item_id=>wwv_flow_api.id(5968004379913744689)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5968007176581753208)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5968005292380748308)
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(5968018178968801228)
,p_name=>'DHTML Select'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5968019001131807580)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5968018693859805475)
,p_list_item_display_sequence=>20
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5968019275982809741)
,p_list_item_display_sequence=>30
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5968019583947812078)
,p_list_item_display_sequence=>40
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(5969211829129863805)
,p_name=>'Template Type'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5967829293728728209)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5828066607986550509)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Calendar'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5969213629953873491)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5969213900994874607)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5969214206535876192)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5967995484237708097)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5969213020949870868)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(5969213325797872264)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(6268506038601908068)
,p_name=>'Tasks'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(6293151639412385566)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(6293504344744273095)
,p_list_item_display_sequence=>20
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(6268506442757909248)
,p_list_item_display_sequence=>30
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(6268769027013718448)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Add a New Product'
,p_list_item_link_target=>'f?p=&APP_ID.:6:&SESSION.::&DEBUG.:6:::'
,p_security_scheme=>wwv_flow_api.id(6268718446640515942)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(6268586836019020837)
,p_name=>'Administration'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(6269734018708960173)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(6268587239482021897)
,p_list_item_display_sequence=>20
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(6285367340450505194)
,p_name=>'Order Wizard'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(6285367746337506864)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(6285377119157536830)
,p_list_item_display_sequence=>20
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(6293271941619445978)
,p_list_item_display_sequence=>30
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(6296628128788221841)
,p_name=>'Chart Tabs'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(6296629036753224136)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(6296637922601248452)
,p_list_item_display_sequence=>20
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(6296638226757249683)
,p_list_item_display_sequence=>30
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(186661913093712720)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(1765088377041712075)
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(6268718446640515942)
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(6269521821678049716)
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(6296607040207149487)
,p_name=>'Admin Users'
,p_scheme_type=>'NATIVE_EXISTS'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(5375958813849145953)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(6268135632379917768)
,p_icon_sequence=>20
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(2238227785425464477)
,p_icon_sequence=>30
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(6268135530915917767)
,p_icon_sequence=>40
...
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(6268136117702917923)
,p_name=>'FSP_AFTER_LOGIN_URL'
,p_item_comment=>'Used by Custom2 authentication for deep linking support'
);
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(6298362132637520391)
,p_name=>'G_PAGE_INFO'
);
end;
/
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(5372166436455657310)
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(6268135046947917761)
,p_tab_set=>'TS1'
,p_tab_sequence=>1
,p_tab_name=>'T_HOME'
,p_tab_text=>'Home'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(6268135246958917766)
,p_tab_set=>'TS1'
,p_tab_sequence=>3
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(6268135427241917767)
,p_tab_set=>'TS1'
,p_tab_sequence=>5
,p_tab_name=>'T_CHARTS'
,p_tab_text=>'Charts'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(6296663345204311728)
,p_tab_set=>'TS1'
,p_tab_sequence=>15
,p_tab_name=>'T_ADMIN'
,p_tab_text=>'Admin'
...
,p_tab_parent_tabset=>'Page Templates2'
,p_security_scheme=>wwv_flow_api.id(6296607040207149487)
);
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(5969203621221615488)
,p_tab_set=>'TS1'
,p_tab_sequence=>25
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(4810119655945185890)
,p_tab_set=>'TS1'
,p_tab_sequence=>35
,p_tab_name=>'T_RDS'
,p_tab_text=>'RDS'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(2239302178342625334)
,p_tab_set=>'TS1'
,p_tab_sequence=>45
,p_tab_name=>'Cal'
,p_tab_text=>'Cal'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(2239545270610012512)
,p_tab_set=>'TS1'
,p_tab_sequence=>55
,p_tab_name=>'T_PORTAL'
,p_tab_text=>'Portal'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(2239546797705066834)
,p_tab_set=>'TS1'
,p_tab_sequence=>65
,p_tab_name=>'T_TREE'
,p_tab_text=>'Tree'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(2239547267339071046)
,p_tab_set=>'TS1'
,p_tab_sequence=>75
,p_tab_name=>'T_SEARCH'
,p_tab_text=>'Search'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(2239550666676095182)
,p_tab_set=>'TS1'
,p_tab_sequence=>85
,p_tab_name=>'T_POP'
,p_tab_text=>'Pop'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(2239555175926100046)
,p_tab_set=>'TS1'
,p_tab_sequence=>95
,p_tab_name=>'Wiz'
,p_tab_text=>'Wiz'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(2239558886105144834)
,p_tab_set=>'TS1'
,p_tab_sequence=>105
,p_tab_name=>'Form'
,p_tab_text=>'Form'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(6268135321025917766)
,p_tab_set=>'TS1'
,p_tab_sequence=>106
,p_tab_name=>'T_ORDERS'
,p_tab_text=>'Orders'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(6268135127783917765)
,p_tab_set=>'TS1'
,p_tab_sequence=>107
...
wwv_flow_api.create_toplevel_tab(
 p_id=>wwv_flow_api.id(5967449379844502447)
...
wwv_flow_api.create_toplevel_tab(
 p_id=>wwv_flow_api.id(5967446401328484631)
,p_tab_set=>'Page Templates2'
,p_tab_sequence=>20
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(6269060321967278269)
,p_lov_name=>'CATEGORIES'
,p_lov_query=>'.'||wwv_flow_api.id(6269060321967278269)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(6269060639640278272)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Phones'
,p_lov_return_value=>'Phones'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(6269060841115278274)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Computer'
,p_lov_return_value=>'Computer'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(6269061016268278274)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Audio'
,p_lov_return_value=>'Audio'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(6269061233132278274)
,p_lov_disp_sequence=>4
,p_lov_disp_value=>'Video'
,p_lov_return_value=>'Video'
);
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(2238231098678525029)
,p_lov_name=>'EXAMPLE SEARCH SHOW OPTIONS'
,p_lov_query=>'.'||wwv_flow_api.id(2238231098678525029)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(2238231274919525031)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Report pages'
,p_lov_return_value=>'R'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(2238231496025525032)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'Form pages'
,p_lov_return_value=>'F'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(2238231667321525032)
,p_lov_disp_sequence=>30
,p_lov_disp_value=>'Chart pages'
,p_lov_return_value=>'C'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(2238231875809525032)
,p_lov_disp_sequence=>40
,p_lov_disp_value=>'Home page'
,p_lov_return_value=>'H'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(2238232089354525032)
,p_lov_disp_sequence=>50
,p_lov_disp_value=>'Other'
,p_lov_return_value=>'O'
);
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(6270344615084772870)
,p_lov_name=>'PRODUCTS'
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(6293208843754850512)
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(6269612115986736224)
,p_lov_name=>'STATES'
,p_lov_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(6268713439929504607)
,p_lov_name=>'Y OR N'
,p_lov_query=>'.'||wwv_flow_api.id(6268713439929504607)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(6268713730949504610)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Y'
,p_lov_return_value=>'Y'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(6268713940670504612)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'N'
...
wwv_flow_api.create_tree(
 p_id=>wwv_flow_api.id(6305019745810312165)
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(6268393332275499385)
,p_name=>'Main Menu'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(1330504660245249367)
,p_parent_id=>wwv_flow_api.id(5967358394287864847)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2238227486806461271)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
,p_short_name=>'Search'
,p_link=>'f?p=&FLOW_ID.:28:&SESSION.'
,p_page_id=>28
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2238228996748471705)
,p_parent_id=>wwv_flow_api.id(2238227486806461271)
,p_short_name=>'Search Results'
,p_link=>'f?p=&FLOW_ID.:33:&SESSION.'
,p_page_id=>33
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2239308398884664355)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2239545589664012513)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
,p_short_name=>'Portal'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2239547092496066834)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
,p_short_name=>'Tree'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2239550978528095182)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
,p_short_name=>'Pop'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2239558281692128113)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2239562779011144867)
,p_parent_id=>wwv_flow_api.id(2239603275980702466)
,p_short_name=>'Edit Employee'
,p_link=>'f?p=&APP_ID.:41:&SESSION.::&DEBUG.:::'
,p_page_id=>41
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2239569470927376176)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
,p_short_name=>'Step 3'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2239569997656378938)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
,p_short_name=>'Step 2'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2239603275980702466)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2240322192629347042)
,p_parent_id=>wwv_flow_api.id(2239558281692128113)
,p_short_name=>'Long Progress List'
,p_link=>'f?p=&FLOW_ID.:46:&SESSION.'
,p_page_id=>46
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2240434998757793371)
,p_parent_id=>wwv_flow_api.id(5967358394287864847)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(4810119958356185890)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(5372124443445716935)
,p_parent_id=>0
,p_short_name=>'test'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(5610569154319717422)
,p_parent_id=>wwv_flow_api.id(5967358394287864847)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(5610802548632629600)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
,p_short_name=>'Report'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(5611103442599442610)
,p_parent_id=>wwv_flow_api.id(5967358394287864847)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(5829534730014800299)
,p_parent_id=>wwv_flow_api.id(5967358394287864847)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(5829573007358826038)
,p_parent_id=>wwv_flow_api.id(5967358394287864847)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(5829736824370848539)
,p_parent_id=>wwv_flow_api.id(5967358394287864847)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(5967352402926845692)
,p_parent_id=>wwv_flow_api.id(5967358394287864847)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(5967358394287864847)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(5967360704626875246)
,p_parent_id=>wwv_flow_api.id(5967358394287864847)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(5967362890824881697)
,p_parent_id=>wwv_flow_api.id(5967358394287864847)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(5967382205414966082)
,p_parent_id=>wwv_flow_api.id(5967358394287864847)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(5967385082769976582)
,p_parent_id=>wwv_flow_api.id(5967358394287864847)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(5967845382881939072)
,p_parent_id=>wwv_flow_api.id(5967358394287864847)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6268397127557507497)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6268452624571866143)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6268457444442881348)
,p_parent_id=>wwv_flow_api.id(6268452624571866143)
,p_short_name=>'Add/Modify Customers'
,p_link=>'f?p=&APP_ID.:7:&SESSION.::&DEBUG.:::'
,p_page_id=>7
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6268585019742016220)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
,p_short_name=>'Admin'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6268778827191756383)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6268779133424758213)
,p_parent_id=>wwv_flow_api.id(6268778827191756383)
,p_short_name=>'Add/Modify Products'
,p_link=>'f?p=&APP_ID.:6:&SESSION.::&DEBUG.:::'
,p_page_id=>6
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6268897315286093525)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
,p_short_name=>'Orders'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6268990019299709747)
,p_parent_id=>wwv_flow_api.id(6268779133424758213)
,p_short_name=>'Add Product Image'
,p_link=>'f?p=&APP_ID.:10:&SESSION.::&DEBUG.:::'
,p_page_id=>10
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6269505514742971960)
,p_parent_id=>wwv_flow_api.id(6268897315286093525)
,p_short_name=>'View/Modify Orders'
,p_link=>'f?p=&APP_ID.:29:&SESSION.::&DEBUG.:::'
,p_page_id=>29
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6285361337024456867)
,p_parent_id=>wwv_flow_api.id(6268897315286093525)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6285425933112673323)
,p_parent_id=>wwv_flow_api.id(6268897315286093525)
,p_short_name=>'Enter New Order'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6293448218387962688)
,p_parent_id=>wwv_flow_api.id(6268897315286093525)
,p_short_name=>'Enter New Order'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6296738425745476438)
,p_parent_id=>wwv_flow_api.id(6268585019742016220)
,p_short_name=>'Reset Password'
,p_link=>'f?p=&APP_ID.:9:&SESSION.::&DEBUG.:::'
,p_page_id=>9
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6296740334056478892)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
,p_short_name=>'Charts'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6296742319989484306)
,p_parent_id=>wwv_flow_api.id(6296740334056478892)
,p_short_name=>'Cluster Bar'
,p_link=>'f?p=&APP_ID.:5:&SESSION.::&DEBUG.:::'
,p_page_id=>5
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6296743327261486379)
,p_parent_id=>wwv_flow_api.id(6296740334056478892)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6296774728487600312)
,p_parent_id=>wwv_flow_api.id(6296740334056478892)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(6305012129404298009)
,p_parent_id=>wwv_flow_api.id(6268397127557507497)
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1303605308731692036)
,p_theme_id=>8
,p_name=>'Login'
,p_is_popup=>false
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1303605523884692037)
,p_theme_id=>8
,p_name=>'No Tabs'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1303605828083692038)
,p_theme_id=>8
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1303606116519692038)
,p_theme_id=>8
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1303606426818692039)
,p_theme_id=>8
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1303606736490692039)
,p_theme_id=>8
,p_name=>'Popup'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1303607010666692039)
,p_theme_id=>8
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1303607327885692039)
,p_theme_id=>8
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1303607622009692039)
,p_theme_id=>8
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(3791799543325)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(1303608128369692040)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(1303608323197692040)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(1303608520319692040)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303608724481692041)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303609033663692041)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303609309595692041)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<tr> ',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303609613472692042)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303609910582692042)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303610233144692042)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303610536329692042)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303610814654692042)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<table cellpadding="0" cellspacing="0" border="0" summary="" class="t8FormRegion" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'<tr>',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303611114767692042)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303611413652692042)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303611708739692043)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303612031908692043)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303612318086692043)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303612635373692043)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303612928894692043)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<table cellpadding="0" cellspacing="0" border="0" summary="" class="t8ListRegionwithIcon" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'<tr>',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303613235944692043)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303613535248692043)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303613819853692044)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303614133057692044)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303614415584692044)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303614715550692044)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303615022422692044)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1303615335683692044)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303615633769692045)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303615936468692045)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303616225459692045)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303616512262692046)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303616816884692046)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303617127049692046)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303617409215692046)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303617709811692047)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303618009553692047)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303618311295692047)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303618624757692047)
,p_list_template_current=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303618908855692049)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303619237824692049)
,p_list_template_current=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303619510372692049)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303619809944692049)
,p_list_template_current=>'<li class="t8current">#TEXT#</li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(1303620127389692049)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(1303620417973692049)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(1303620736777692050)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(1303621223267692050)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(1303621723436692050)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(1303622233516692053)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(1303622707425692053)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(1303623213875692054)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(1303623721155692054)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(1303624008622692054)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(1303624508797692055)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(1303624631987692055)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(1303624717107692055)
,p_template_name=>'Optional with help'
,p_template_body1=>'<label for="#CURRENT_ITEM_NAME#" id="#LABEL_ID#"><a class="t8OptionalwithHelp" href="javascript:apex.theme.popupFieldHelp(''#CURRENT_ITEM_ID#'',''&SESSION.'')" tabindex="999">'
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(1303624818017692055)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(1303624920198692055)
,p_template_name=>'Required with help'
,p_template_body1=>'<label for="#CURRENT_ITEM_NAME#" id="#LABEL_ID#"><img src="#IMAGE_PREFIX#themes/theme_8/required.gif" alt="" style="margin-right:5px;"/><a class="t8RequiredwithHelp" href="javascript:apex.theme.popupFieldHelp(''#CURRENT_ITEM_ID#'',''&SESSION.'')" tabinde'
||'x="999">'
,p_template_body2=>'</a></label>'
,p_on_error_before_label=>'<div class="t8InlineError">'
,p_on_error_after_label=>'<br/>#ERROR_MESSAGE#</div>'
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(1303625030792692055)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(1303625126109692055)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(1303625809459692056)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(1303625232214692055)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(1303625432958692056)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(1303625610447692056)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(1303626019638692056)
,p_theme_id=>8
,p_theme_name=>'Orange'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(1303606116519692038)
,p_error_template=>wwv_flow_api.id(1303605523884692037)
,p_printer_friendly_template=>wwv_flow_api.id(1303607010666692039)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(1303605308731692036)
,p_default_button_template=>wwv_flow_api.id(1303607934904692040)
,p_default_region_template=>wwv_flow_api.id(1303613235944692043)
,p_default_chart_template=>wwv_flow_api.id(1303610536329692042)
,p_default_form_template=>wwv_flow_api.id(1303610814654692042)
,p_default_reportr_template=>wwv_flow_api.id(1303613235944692043)
,p_default_tabform_template=>wwv_flow_api.id(1303613235944692043)
,p_default_wizard_template=>wwv_flow_api.id(1303615022422692044)
,p_default_menur_template=>wwv_flow_api.id(1303609309595692041)
,p_default_listr_template=>wwv_flow_api.id(1303613235944692043)
,p_default_report_template=>wwv_flow_api.id(1303622233516692053)
,p_default_label_template=>wwv_flow_api.id(1303624717107692055)
,p_default_menu_template=>wwv_flow_api.id(1303625030792692055)
,p_default_calendar_template=>wwv_flow_api.id(1303625232214692055)
,p_default_list_template=>wwv_flow_api.id(1303619510372692049)
,p_default_option_label=>wwv_flow_api.id(1303624717107692055)
,p_default_required_label=>wwv_flow_api.id(1303624920198692055)
,p_default_page_transition=>'NONE'
,p_default_popup_transition=>'NONE'
,p_file_prefix => nvl(wwv_flow_application_install.get_static_theme_file_prefix(8),'#IMAGE_PREFIX#themes/theme_8/')
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(6268459617325886806)
,p_shortcut_name=>'DELETE_CONFIRM_MSG'
,p_shortcut_type=>'TEXT_ESCAPE_JS'
,p_shortcut=>'Would you like to perform this delete action?'
);
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(6269487338680906156)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(2239671869888281839)
,p_name=>'apex'
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(6229742669066236507)
,p_name=>'carl'
,p_scheme_type=>'NATIVE_APEX_ACCOUNTS'
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(6269581725280485939)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(186661812268712720)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>0
,p_user_interface_id=>wwv_flow_api.id(186661812268712720)
,p_name=>'Page Zero'
,p_page_mode=>'NORMAL'
,p_step_title=>'Page Zero'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(1303606426818692039)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6268396523402506224)
,p_plug_name=>'Application Breadcrumb'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303609309595692041)
...
,p_menu_id=>wwv_flow_api.id(6268393332275499385)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(1303625030792692055)
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'CURRENT_PAGE_NOT_IN_CONDITION'
,p_plug_display_when_condition=>'22,101,44,1'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6268804927331841577)
,p_plug_name=>'Charts'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303611413652692042)
...
,p_list_id=>wwv_flow_api.id(6296628128788221841)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303619237824692049)
,p_plug_query_row_template=>1
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1330449153365130828)
,p_plug_name=>'Theme Testing Application'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303613235944692043)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2240073281736535023)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6306540941944257300)
,p_plug_name=>'Sample Application v2.0'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303614415584692044)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6306547716233268818)
,p_plug_name=>'Tasks'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303614133057692044)
...
,p_plug_display_column=>1
,p_plug_display_point=>'REGION_POSITION_03'
,p_list_id=>wwv_flow_api.id(6268506038601908068)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303619510372692049)
,p_plug_query_row_template=>1
,p_plug_footer=>'<p>Theme testers, make sure this list of actions looks good.</p>'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4873752372162203486)
,p_button_sequence=>10
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
,p_button_image_alt=>'Cancel'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4873753560210203490)
,p_button_sequence=>10
,p_button_name=>'APPLY_CHANGES'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303608128369692040)
,p_button_image_alt=>'Apply Changes'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4873753376337203490)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4873752980862203490)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4873753177474203490)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4873752785113203489)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4873752560136203486)
,p_button_sequence=>20
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(5190440594959196814)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6270113720860566410)
,p_name=>'P1_QUOTA'
,p_item_sequence=>10
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6270170014888583538)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(6302717336585724816)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(6302716027581722210)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4283376547966143586)
,p_plug_name=>'Customers'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303612031908692043)
,p_plug_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(4283376647613143586)
,p_name=>'Customers'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4283376853842143589)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4283376962166143589)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4283377073785143589)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4283377159445143590)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4283377271564143590)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4283377374881143590)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(4283377466206143821)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6304982920166153420)
,p_name=>'Top Customers'
,p_template=>wwv_flow_api.id(1303614415584692044)
...
,p_ajax_enabled=>'N'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(1303623721155692054)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6304983223925153463)
,p_query_column_id=>1
,p_column_alias=>'CUST_NAME'
,p_column_display_sequence=>2
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6304983340649153463)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2228835384675994074)
,p_query_column_id=>3
,p_column_alias=>'CUSTOMER_ID'
,p_column_display_sequence=>3
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6311135519351313375)
,p_name=>'Customers'
,p_template=>wwv_flow_api.id(1303613235944692043)
...
,p_ajax_enabled=>'N'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(1303622233516692053)
,p_query_num_rows=>15
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6311135737226313407)
,p_query_column_id=>1
,p_column_alias=>'CUSTOMER_ID'
,p_column_display_sequence=>1
,p_column_heading=>'&nbsp;'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6311135823125313407)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6311135924739313407)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6311136030705313407)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6311136114960313407)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6311136223977313407)
,p_query_column_id=>6
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268448930889849098)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(6311135519351313375)
,p_button_name=>'P2_GO'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268463926696895197)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(6311135519351313375)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6268465431544896573)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6268449035578849103)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6311316821661506263)
,p_name=>'P2_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(6311135519351313375)
,p_prompt=>'Search'
...
,p_field_template=>wwv_flow_api.id(1303624717107692055)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4875114756002050086)
,p_plug_name=>'About'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5372168544960233839)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(5372168624020233839)
,p_name=>'Products'
,p_max_row_count=>'10000'
,p_max_row_count_message=>'This query returns more than 10,000 rows, please filter your data to ensure complete results.'
,p_no_data_found_message=>'No data found.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(5372168830365233912)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(5372168943705233942)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(5372169024266233942)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(5372169132819233943)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(5372169248142233943)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(5372169345630233946)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4815458873626400345)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(5372169436829234590)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6268789640397788580)
...
,p_ajax_enabled=>'N'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(1303621223267692050)
,p_query_headings_type=>'NO_HEADINGS'
,p_query_num_rows=>10
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_break_cols=>'0'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6268789925303788588)
,p_query_column_id=>1
,p_column_alias=>'PRODUCT_NAME'
,p_column_display_sequence=>1
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6268790016076788588)
,p_query_column_id=>2
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4875120955141087674)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(4875114756002050086)
,p_button_name=>'reset'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4875121156166087674)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(4875114756002050086)
,p_button_name=>'Apply'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2229422977737083609)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(5372168544960233839)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303608128369692040)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6268983531063689660)
,p_branch_action=>'f?p=&FLOW_ID.:6:&SESSION.::&DEBUG.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(6268983315228689658)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4875115278643066040)
,p_name=>'P3_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(4875114756002050086)
,p_prompt=>'Date'
...
,p_cAttributes=>'nowrap'
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(1303624631987692055)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4875115469981066043)
,p_name=>'P3_COMMENTS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(4875114756002050086)
,p_prompt=>'Comments'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5608523411269384965)
,p_plug_name=>'Orders'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6269495928763938130)
,p_name=>'My Orders'
,p_template=>wwv_flow_api.id(1303613235944692043)
...
,p_ajax_enabled=>'N'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(1303623213875692054)
,p_query_num_rows=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6269496424393938138)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6269496638773938140)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6269496933029938141)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6269497143214938141)
,p_query_column_id=>4
,p_column_alias=>'ORDER_TOTAL'
,p_column_display_sequence=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6269497342437938141)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6269498417533938148)
,p_query_column_id=>6
...
wwv_flow_api.create_calendar(
 p_id=>wwv_flow_api.id(6269547729961175064)
...
,p_cal_id=>wwv_flow_api.id(6269547946624175068)
...
,p_template_id=>wwv_flow_api.id(1303625232214692055)
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6271811221132541807)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(6269495928763938130)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6269548327461175079)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(6269547729961175064)
,p_button_name=>'Today'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303608128369692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6269548531927175080)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(6269547729961175064)
,p_button_name=>'Next'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6269548130796175074)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(6269547729961175064)
,p_button_name=>'Previous'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6271811419494541834)
,p_branch_action=>'f?p=&APP_ID.:11:&SESSION.::&DEBUG.:11::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(6271811221132541807)
,p_branch_sequence=>5
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6269548739800175083)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6269548035392175071)
,p_name=>'P4_CALENDAR_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(6269547729961175064)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6269548220035175078)
...
,p_process_when_button_id=>wwv_flow_api.id(6269548130796175074)
,p_process_comment=>'Generated 13-AUG-04'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6269548422864175080)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(6269548327461175079)
,p_process_comment=>'Generated 13-AUG-04'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6269548635052175080)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(6269548531927175080)
,p_process_comment=>'Generated 13-AUG-04'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6277711419002199690)
...
wwv_flow_api.create_flash_chart5(
 p_id=>wwv_flow_api.id(4811802471813936909)
...
wwv_flow_api.create_flash_chart5_series(
 p_id=>wwv_flow_api.id(4811802580350936909)
,p_chart_id=>wwv_flow_api.id(4811802471813936909)
,p_series_seq=>10
,p_series_name=>'Mens'
...
wwv_flow_api.create_flash_chart5_series(
 p_id=>wwv_flow_api.id(4811802666150936910)
,p_chart_id=>wwv_flow_api.id(4811802471813936909)
,p_series_seq=>20
...
wwv_flow_api.create_flash_chart5_series(
 p_id=>wwv_flow_api.id(4811802776669936910)
,p_chart_id=>wwv_flow_api.id(4811802471813936909)
,p_series_seq=>30
...
'</script>'))
,p_page_template_options=>'#DEFAULT#'
,p_required_role=>wwv_flow_api.id(6268718446640515942)
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6268781023166764691)
,p_plug_name=>'Add/Modify Products'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303610814654692042)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6301149034104602476)
,p_name=>'Product Image'
,p_template=>wwv_flow_api.id(1303614133057692044)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6301149235247602485)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6301149330160602486)
,p_query_column_id=>2
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6269047624812184431)
,p_button_sequence=>5
,p_button_plug_id=>wwv_flow_api.id(6301149034104602476)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268979126956664693)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(6301149034104602476)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268781320377764695)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(6268781023166764691)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268781516943764697)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(6268781023166764691)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268781227073764694)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(6268781023166764691)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268781420910764695)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(6268781023166764691)
,p_button_name=>'DELETE'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6268979319442664699)
,p_branch_action=>'f?p=&APP_ID.:10:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(6268979126956664693)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6269040523249146145)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6268781614909764700)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268781731707764703)
,p_name=>'P6_PRODUCT_ID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(6268781023166764691)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268781835223764714)
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(1303624920198692055)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268782047129764717)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268782119013764717)
,p_name=>'P6_CATEGORY'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(6268781023166764691)
,p_use_cache_before_default=>'NO'
...
,p_lov=>'.'||wwv_flow_api.id(6269060321967278269)||'.'
,p_cSize=>31
,p_cMaxlength=>255
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268782338706764717)
...
,p_named_lov=>'Y OR N'
,p_lov=>'.'||wwv_flow_api.id(6268713439929504607)||'.'
,p_cSize=>2
,p_cMaxlength=>255
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268782417516764718)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6301290037950906421)
,p_name=>'P6_IMAGE_ID'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(6268781023166764691)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(6268781924524764717)
...
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(6268781835223764714)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(6268782226744764717)
...
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(6268782119013764717)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(6304909337434429772)
...
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(6268782417516764718)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6268782524131764721)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6269063243223293835)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6268782644208764722)
,p_process_sequence=>1
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6268782718247764723)
...
,p_attribute_04=>'6'
,p_process_when_button_id=>wwv_flow_api.id(6268781420910764695)
,p_process_when=>'DELETE_IMAGE'
,p_process_when_type=>'REQUEST_NOT_EQUAL_CONDITION'
);
end;
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6268459030374886799)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6293526016056368836)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293530123721399477)
,p_query_column_id=>1
,p_column_alias=>'EDIT'
,p_column_display_sequence=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293540523122456088)
,p_query_column_id=>2
,p_column_alias=>'PRODUCT_NAME'
,p_column_display_sequence=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293539320396450231)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293539418308450231)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293541440222470506)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293550845641538313)
,p_query_column_id=>6
,p_column_alias=>'USER_NAME'
,p_column_display_sequence=>3
,p_column_heading=>'Sales Rep'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293550927223538314)
,p_query_column_id=>7
,p_column_alias=>'ORDER_TIMESTAMP'
,p_column_display_sequence=>2
,p_column_heading=>'Order Date'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268459341126886801)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(6268459030374886799)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303608128369692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268459525946886803)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(6268459030374886799)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268459219810886801)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(6268459030374886799)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268459425445886801)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(6268459030374886799)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(5634255321881518579)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268459846294886810)
,p_name=>'P7_CUSTOMER_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(6268459030374886799)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268459939885886817)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268460143051886821)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268460328256886822)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268460418155886822)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268460538501886822)
,p_name=>'P7_CUST_CITY'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(6268459030374886799)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268460637118886822)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268460734120886838)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268460820142886838)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268460943786886838)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268461042213886838)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268461116711886839)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6285403925746614466)
,p_name=>'P7_BRANCH'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(6268459030374886799)
,p_item_default=>'2'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(6268460018182886820)
...
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(6268459939885886817)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(6268460224577886821)
...
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(6268460143051886821)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(6269614728602751883)
...
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(6268461042213886838)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(6269719740422833981)
...
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(6268460820142886838)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(6269722323931838668)
...
,p_error_message=>'Phone number format not recognized'
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(6268460943786886838)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(6276821133087927801)
...
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(6268460734120886838)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(6304911824031558353)
,p_validation_name=>'P7_CREDIT_LIMIT'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(6247092246032338175)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6268461243103886842)
,p_process_sequence=>1
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6297945045734593911)
,p_process_sequence=>5
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_WEB_SERVICE'
,p_process_name=>'Get ZIP Code from Web Service'
,p_attribute_01=>wwv_flow_api.id(6297942039373589289)
,p_attribute_02=>'ITEMS'
,p_process_when_button_id=>wwv_flow_api.id(6268459219810886801)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6268461322293886844)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6268461426968886844)
...
,p_attribute_01=>'CLEAR_CACHE_FOR_PAGES'
,p_attribute_04=>'7'
,p_process_when_button_id=>wwv_flow_api.id(6268459425445886801)
...
'</script>'))
,p_page_template_options=>'#DEFAULT#'
,p_required_role=>wwv_flow_api.id(6296607040207149487)
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'N'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6268621039107144801)
,p_name=>'Manage Users'
,p_template=>wwv_flow_api.id(1303613235944692043)
,p_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6268622325039144843)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6268621220464144810)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6268621322320144812)
,p_query_column_id=>3
,p_column_alias=>'USER_NAME'
,p_column_display_sequence=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6268621522749144813)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6268621637526144813)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6268630637582167896)
,p_query_column_id=>6
,p_column_alias=>'RP'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6268711240820497392)
,p_query_column_id=>7
...
,p_named_lov=>wwv_flow_api.id(6268713439929504607)
,p_lov_show_nulls=>'NO'
,p_lov_display_extra=>'NO'
,p_ref_schema=>'CARL'
,p_ref_table_name=>'DEMO_USERS'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6269461920865670531)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6296602518915141249)
,p_query_column_id=>9
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268622046484144819)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(6268621039107144801)
,p_button_name=>'ADD'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268621837144144819)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(6268621039107144801)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268621725150144819)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(6268621039107144801)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268621932169144819)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(6268621039107144801)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6268622641707144844)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6268622117918144840)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(6268621039107144801)
,p_process_type=>'NATIVE_TABFORM_UPDATE'
,p_process_name=>'ApplyMRU'
,p_attribute_02=>'DEMO_USERS'
,p_attribute_03=>'USER_ID'
,p_process_error_message=>'Unable to process update'
,p_process_when_button_id=>wwv_flow_api.id(6268621837144144819)
,p_process_success_message=>'#MRU_COUNT# row(s) updated, #MRI_COUNT# row(s) inserted.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6268622234983144841)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(6268621039107144801)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6268622426403144844)
...
,p_attribute_03=>'USER_ID'
,p_process_error_message=>'Unable to process update'
,p_process_when_button_id=>wwv_flow_api.id(6268622046484144819)
,p_process_success_message=>'#MRU_COUNT# row(s) updated, #MRI_COUNT# row(s) inserted.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6268622524033144844)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6268659325919263952)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6269636637971905922)
,p_plug_name=>'Error!'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6269622844542832194)
,p_button_sequence=>5
,p_button_plug_id=>wwv_flow_api.id(6268659325919263952)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268730920714536848)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(6268659325919263952)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6268731126827536861)
,p_branch_action=>'f?p=&APP_ID.:8:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(6268730920714536848)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6269623038544832203)
,p_branch_action=>'f?p=&APP_ID.:8:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(6269622844542832194)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268660029382264961)
,p_name=>'P9_USER_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(6268659325919263952)
,p_display_as=>'NATIVE_HIDDEN'
,p_cMaxlength=>2000
,p_cAttributes=>'nowrap="nowrap"'
,p_begin_on_new_line=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268728335474531716)
,p_name=>'P9_NEW_PW'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(6268659325919263952)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268729140669533122)
,p_name=>'P9_NEW_PW_2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(6268659325919263952)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268734845994544206)
,p_name=>'P9_USER_NAME'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(6268659325919263952)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(6268742245218562862)
...
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(6268728335474531716)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6269590922818532592)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6268993639039715513)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6269098235153509127)
,p_button_sequence=>5
,p_button_plug_id=>wwv_flow_api.id(6268993639039715513)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268995924279720706)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(6268993639039715513)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6268996129744720708)
,p_branch_action=>'f?p=&FLOW_ID.:6:&SESSION.::&DEBUG.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(6268995924279720706)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6269098433199509130)
,p_branch_action=>'f?p=&APP_ID.:6:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(6269098235153509127)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268994547004717743)
,p_name=>'P10_IMAGE_URL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(6268993639039715513)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(6269075045047351197)
...
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(6268994547004717743)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6268999130643732020)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6285366130753502329)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6285368821880509275)
...
,p_plug_display_column=>1
,p_plug_display_point=>'REGION_POSITION_03'
,p_list_id=>wwv_flow_api.id(6285367340450505194)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303620127389692049)
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6293517726613334090)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(6285366130753502329)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6285378537857542247)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(6285366130753502329)
,p_button_name=>'NEW'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6285375740497533619)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(6285366130753502329)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6285375921241533626)
,p_branch_action=>'f?p=&FLOW_ID.:12:&SESSION.::&DEBUG.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(6285375740497533619)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6285378735247542250)
,p_branch_action=>'f?p=&APP_ID.:7:&SESSION.::&DEBUG.:7:P7_BRANCH:12&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(6285378537857542247)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6293517941618334093)
,p_branch_action=>'f?p=&FLOW_ID.:4:&SESSION.::&DEBUG.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(6293517726613334090)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6285373821103527948)
,p_name=>'P11_CUSTOMER_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(6285366130753502329)
,p_prompt=>'Customer'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(6285383017341555303)
...
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(6285375740497533619)
,p_associated_item=>wwv_flow_api.id(6285373821103527948)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6293294247216551719)
,p_process_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6293270045644437716)
,p_plug_name=>'Order Progress'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303614133057692044)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6293280925783498187)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293281135996498200)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293467721345077042)
,p_query_column_id=>2
,p_column_alias=>'PRODUCT_NAME'
,p_column_display_sequence=>2
,p_column_heading=>'Product Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293467240607073217)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293284929946516197)
,p_query_column_id=>4
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6293285714748523346)
,p_name=>'Order for &P12_CUSTOMER_NAME.'
,p_template=>wwv_flow_api.id(1303610814654692042)
,p_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293311230650651018)
,p_query_column_id=>1
,p_column_alias=>'C001'
,p_column_display_sequence=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293286246070523361)
,p_query_column_id=>2
,p_column_alias=>'C002'
,p_column_display_sequence=>1
,p_column_heading=>'Product Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293469846625084344)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293302843978616922)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293301936705614871)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293307844932636188)
,p_query_column_id=>6
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6293455832978995223)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6293453424536983419)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(6293285714748523346)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6293344742442805767)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(6293285714748523346)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6293344927985805778)
,p_branch_action=>'f?p=&FLOW_ID.:14:&SESSION.::&DEBUG.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(6293344742442805767)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6293453644274983425)
,p_branch_action=>'f?p=&FLOW_ID.:4:&SESSION.::&DEBUG.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(6293453424536983419)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6293273835994463247)
,p_name=>'P12_CUSTOMER_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(6293270045644437716)
,p_use_cache_before_default=>'NO'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>2000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6293337936724766311)
,p_name=>'P12_PRODUCT_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(6293280925783498187)
,p_display_as=>'NATIVE_HIDDEN'
,p_cMaxlength=>2000
,p_cAttributes=>'nowrap="nowrap"'
,p_begin_on_new_line=>'N'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(6293276328160470458)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6293478826072144688)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'end;'))
,p_process_when_button_id=>wwv_flow_api.id(6293344742442805767)
,p_process_success_message=>'Order Created'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6293295444230560299)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6293314932643670490)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6305621430488676754)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6305636944265775325)
,p_name=>'Order Lines'
,p_template=>wwv_flow_api.id(5967106798594068118)
,p_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6305639025480788903)
,p_query_column_id=>1
,p_column_alias=>'PRODUCT_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Product Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6305637436526775347)
,p_query_column_id=>2
,p_column_alias=>'UNIT_PRICE'
,p_column_display_sequence=>2
,p_column_heading=>'Unit Price'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6305637527138775347)
,p_query_column_id=>3
,p_column_alias=>'QUANTITY'
,p_column_display_sequence=>3
,p_column_heading=>'Quantity'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6305639145644788904)
,p_query_column_id=>4
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6305719229308941412)
,p_plug_name=>'Order Progress'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303614133057692044)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6305616240961660868)
,p_name=>'P14_ORDER_ID'
,p_item_sequence=>10
,p_display_as=>'NATIVE_HIDDEN'
,p_cMaxlength=>2000
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6305019825121312167)
...
,p_plug_display_point=>'BODY_3'
,p_plug_source=>'6305019745810312165'
,p_plug_source_type=>'NATIVE_TREE'
,p_plug_query_row_template=>1
,p_attribute_01=>wwv_flow_api.id(6305019745810312165)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6305038617984370405)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6305020020730312183)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(6305019825121312167)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6305020128410312187)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(6305019825121312167)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6305020218340312188)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(6305019825121312167)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6305020425550312193)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6305020314954312191)
,p_name=>'P15_TREE_ROOT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(6305019825121312167)
,p_prompt=>'Tree Root'
,p_source=>'0'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6296678133261346151)
...
wwv_flow_api.create_flash_chart5(
 p_id=>wwv_flow_api.id(4811803074658936911)
...
wwv_flow_api.create_flash_chart5_series(
 p_id=>wwv_flow_api.id(4811803155817936911)
,p_chart_id=>wwv_flow_api.id(4811803074658936911)
,p_series_seq=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6303723114739541664)
...
wwv_flow_api.create_flash_chart5(
 p_id=>wwv_flow_api.id(4811803379885936912)
...
wwv_flow_api.create_flash_chart5_series(
 p_id=>wwv_flow_api.id(4811803456516936912)
,p_chart_id=>wwv_flow_api.id(4811803379885936912)
,p_series_seq=>10
,p_series_name=>'Mens'
,p_series_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select null, to_char(o.order_timestamp, ''MON RRRR'') label, sum (oi.quantity * oi.unit_price) value',
...
wwv_flow_api.create_flash_chart5_series(
 p_id=>wwv_flow_api.id(4811803574584936912)
,p_chart_id=>wwv_flow_api.id(4811803379885936912)
,p_series_seq=>20
,p_series_name=>'Womens'
,p_series_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_flash_chart5_series(
 p_id=>wwv_flow_api.id(4811803675735936912)
,p_chart_id=>wwv_flow_api.id(4811803379885936912)
,p_series_seq=>30
,p_series_name=>'Accessories'
,p_series_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4810120178829185893)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4810120373524185893)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4810120576058185894)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4810120783234185894)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4810120980380185895)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4810122184277195044)
...
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(1303607327885692039)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5372165348556643659)
,p_plug_name=>'aaa'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5372165541815643703)
,p_plug_name=>'bbb'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5372165719624643709)
,p_plug_name=>'ccc'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5372165937734643710)
,p_plug_name=>'ddd'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5372166135726643712)
,p_plug_name=>'eee'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6293375439699382188)
,p_name=>'Product Info'
,p_template=>wwv_flow_api.id(1303613235944692043)
,p_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
,p_source_type=>'NATIVE_SQL_REPORT'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(1303620417973692049)
,p_query_num_rows=>15
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293375630104382213)
,p_query_column_id=>1
,p_column_alias=>'PRODUCT_ID'
,p_column_display_sequence=>1
,p_column_heading=>'Product Id'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293375742634382213)
,p_query_column_id=>2
,p_column_alias=>'PRODUCT_NAME'
,p_column_display_sequence=>2
,p_column_heading=>'Product Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293375819145382213)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293375917845382213)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293376038167382213)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293376114915382213)
,p_query_column_id=>6
,p_column_alias=>'LIST_PRICE'
,p_column_display_sequence=>6
,p_column_heading=>'List Price'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293376236544382214)
,p_query_column_id=>7
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6303868716685882879)
,p_name=>'Product Image'
,p_template=>wwv_flow_api.id(5967106798594068118)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6303868940244882894)
,p_query_column_id=>1
,p_column_alias=>'IMAGE_ID'
,p_column_display_sequence=>1
,p_hidden_column=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6303869027979882894)
,p_query_column_id=>2
,p_column_alias=>'IMAGE_NAME'
,p_column_display_sequence=>2
,p_column_html_expression=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6293389535338466065)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(6293375439699382188)
,p_button_name=>'CLOSE'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6293377046972384263)
,p_name=>'P20_PRODUCT_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(6293375439699382188)
,p_display_as=>'NATIVE_HIDDEN'
,p_cMaxlength=>2000
,p_cAttributes=>'nowrap="nowrap"'
,p_begin_on_new_line=>'N'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(5610801437372629588)
,p_name=>'Report'
,p_template=>wwv_flow_api.id(1303613819853692044)
,p_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5610801748561629597)
,p_query_column_id=>1
,p_column_alias=>'CUST_FIRST_NAME'
,p_column_display_sequence=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5610801853019629598)
,p_query_column_id=>2
,p_column_alias=>'CUST_LAST_NAME'
,p_column_display_sequence=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5610801957317629598)
,p_query_column_id=>3
,p_column_alias=>'CUST_CITY'
,p_column_display_sequence=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5610802034195629598)
,p_query_column_id=>4
,p_column_alias=>'ORDER_TOTAL'
,p_column_display_sequence=>4
,p_column_heading=>'Order Total'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5610802141670629598)
,p_query_column_id=>5
,p_column_alias=>'ORDER_TIMESTAMP'
,p_column_display_sequence=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5610802261824629598)
,p_query_column_id=>6
,p_column_alias=>'CUST_STATE'
,p_column_display_sequence=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5610802354008629598)
,p_query_column_id=>7
,p_column_alias=>'CUST_POSTAL_CODE'
,p_column_display_sequence=>7
...
wwv_flow_api.create_calendar(
 p_id=>wwv_flow_api.id(5828069408809560187)
,p_plug_name=>'Orders by Day'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select ''<a title="Order Detail" href="f?p=&APP_ID.:29:'' || :APP_SESSION || ''::::P29_ORDER_ID:'' || order_id || ''">'' || to_char(order_total, ''$999,999'') || ''</a><br />'' ord, order_timestamp',
'from demo_orders o, demo_users u',
...
,p_cal_id=>wwv_flow_api.id(5828069618867560195)
,p_begin_at_start_of_interval=>'Y'
...
,p_agenda_cal_days_type=>'MONTH'
,p_agenda_cal_days=>30
,p_template_id=>wwv_flow_api.id(1303625610447692056)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5828075811579911074)
...
,p_plug_display_column=>1
,p_plug_display_point=>'REGION_POSITION_02'
,p_list_id=>wwv_flow_api.id(5969211829129863805)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303619237824692049)
,p_plug_query_row_template=>1
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5828082206647928606)
...
,p_plug_display_column=>1
,p_plug_display_point=>'BODY_3'
,p_list_id=>wwv_flow_api.id(5828083427771934757)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303617709811692047)
,p_plug_query_row_template=>1
);
end;
/
...
wwv_flow_api.create_calendar(
 p_id=>wwv_flow_api.id(5430517523466863468)
...
,p_plug_display_point=>'BODY_3'
,p_plug_item_display_point=>'ABOVE'
,p_cal_id=>wwv_flow_api.id(5430517717851863470)
,p_begin_at_start_of_interval=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5828078412264917675)
,p_plug_name=>'Templates'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303611413652692042)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5828086216259950349)
,p_plug_name=>'Calendar List'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>0
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4801036762693609840)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(5430517523466863468)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5430518632109863472)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(5430517523466863468)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5430519010849863474)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(5430517523466863468)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5430519424220863475)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(5430517523466863468)
,p_button_name=>'DAILY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5430519828727863476)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(5430517523466863468)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5430520230524863476)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(5430517523466863468)
,p_button_name=>'TODAY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5430520628548863477)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(5430521033996863478)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5430518027249863471)
,p_name=>'P23_CALENDAR_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(5430517523466863468)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5430518231040863471)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5430518414611863472)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5430518809220863473)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(5430518632109863472)
,p_process_comment=>'Generated 02-DEC-09'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5430519213666863474)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(5430519010849863474)
,p_process_comment=>'Generated 02-DEC-09'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5430519632482863475)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(5430519424220863475)
,p_process_comment=>'Generated 02-DEC-09'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5430520024255863476)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Previous'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(5430519828727863476)
,p_process_comment=>'Generated 02-DEC-09'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5430520425369863477)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Today'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(5430520230524863476)
,p_process_comment=>'Generated 02-DEC-09'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5430520835521863478)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Next'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(5430520628548863477)
,p_process_comment=>'Generated 02-DEC-09'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4801037379662614802)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(4801036762693609840)
,p_process_comment=>'Generated 02-DEC-09'
);
end;
/
...
wwv_flow_api.create_calendar(
 p_id=>wwv_flow_api.id(5609458009391794016)
,p_plug_name=>'Calendar'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select ''<a title="Order Detail" href="f?p=&APP_ID.:29:'' || :APP_SESSION || ''::::P29_ORDER_ID:'' || order_id || ''">'' || to_char(order_total, ''$999,999'') || ''</a><br />'' ord, order_timestamp',
'from demo_orders o, demo_users u',
...
,p_plug_display_point=>'BODY_3'
,p_plug_item_display_point=>'ABOVE'
,p_cal_id=>wwv_flow_api.id(5609458208536794025)
,p_begin_at_start_of_interval=>'Y'
...
,p_agenda_cal_days_type=>'MONTH'
,p_agenda_cal_days=>30
,p_template_id=>wwv_flow_api.id(1303625432958692056)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5828080936327923176)
,p_plug_name=>'Templates'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303611413652692042)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5828086820415951523)
,p_plug_name=>'Calendar List'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>0
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4801071272352659975)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(5609458009391794016)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5609459137123794039)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(5609458009391794016)
,p_button_name=>'MONTHLY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5609459511333794046)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(5609458009391794016)
,p_button_name=>'WEEKLY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5609459919150794047)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(5609458009391794016)
,p_button_name=>'DAILY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5609460314343794050)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(5609458009391794016)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5609460734127794051)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(5609458009391794016)
,p_button_name=>'TODAY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5609461120351794052)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_api.id(5609458009391794016)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(5609461513128794054)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5609458506121794028)
,p_name=>'P24_CALENDAR_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(5609458009391794016)
,p_use_cache_before_default=>'NO'
,p_item_default=>'return to_char(localtimestamp,''YYYYMMDD'');'
,p_item_default_type=>'PLSQL_FUNCTION_BODY'
,p_prompt=>'Start Date'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5609458733435794035)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5609458910271794036)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5609459325129794041)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Monthly'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(5609459137123794039)
,p_process_comment=>'Generated 22-DEC-09'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5609459722348794046)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Weekly'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(5609459511333794046)
,p_process_comment=>'Generated 22-DEC-09'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5609460118885794050)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Daily'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(5609459919150794047)
,p_process_comment=>'Generated 22-DEC-09'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5609460510643794051)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Previous'
,p_process_sql_clob=>' apex_util.decrement_calendar;'
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(5609460314343794050)
,p_process_comment=>'Generated 22-DEC-09'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5609460906804794052)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Today'
,p_process_sql_clob=>' apex_util.today_calendar;'
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(5609460734127794051)
,p_process_comment=>'Generated 22-DEC-09'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5609461307252794053)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Next'
,p_process_sql_clob=>' apex_util.increment_calendar;'
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(5609461120351794052)
,p_process_comment=>'Generated 22-DEC-09'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4801071660362665904)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Custom'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(4801071272352659975)
,p_process_comment=>'Generated 22-DEC-09'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3537622722655873463)
,p_plug_name=>'First'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3537622923512873466)
,p_plug_name=>'Second'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_region_attributes=>'style="width:32%; float:left; margin-right: 1%; clear: none;"'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3537623149295873467)
,p_plug_name=>'Third'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3537623324167873467)
,p_plug_name=>'Fourth'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2229786184875930574)
,p_plug_name=>'One'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2229786371348930577)
,p_plug_name=>'Two'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2229786581425930578)
,p_plug_name=>'Three'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2229786798242930579)
...
wwv_flow_api.create_calendar(
 p_id=>wwv_flow_api.id(3499952931304080568)
...
,p_plug_display_point=>'BODY_3'
,p_plug_item_display_point=>'ABOVE'
,p_cal_id=>wwv_flow_api.id(3499953440590080608)
,p_begin_at_start_of_interval=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3499954236097080618)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(3499952931304080568)
,p_button_name=>'MONTHLY'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3499954828101080632)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(3499952931304080568)
,p_button_name=>'WEEKLY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3499955430379080632)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(3499952931304080568)
,p_button_name=>'DAILY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3499956034217080634)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(3499952931304080568)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3499956623344080635)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_api.id(3499952931304080568)
,p_button_name=>'TODAY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3499957221332080636)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3499954637736080627)
,p_branch_action=>'f?p=&FLOW_ID.:27:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(3499954236097080618)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3499955232787080632)
,p_branch_action=>'f?p=&FLOW_ID.:27:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(3499954828101080632)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3499955836794080633)
,p_branch_action=>'f?p=&FLOW_ID.:27:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(3499955430379080632)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3499956442708080635)
,p_branch_action=>'f?p=&FLOW_ID.:27:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(3499956034217080634)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3499957032801080636)
,p_branch_action=>'f?p=&FLOW_ID.:27:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(3499956623344080635)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3499957644185080637)
,p_branch_action=>'f?p=&FLOW_ID.:27:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(3499957221332080636)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3499953621805080609)
,p_name=>'P27_CALENDAR_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(3499952931304080568)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3499953825281080615)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3499954030560080615)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3499954438848080623)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Monthly'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(3499954236097080618)
,p_process_comment=>'Generated 5/26/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3499955035755080632)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Weekly'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(3499954828101080632)
,p_process_comment=>'Generated 5/26/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3499955629920080633)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Daily'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(3499955430379080632)
,p_process_comment=>'Generated 5/26/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3499956224785080635)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Previous'
,p_process_sql_clob=>' apex_util.decrement_calendar;'
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(3499956034217080634)
,p_process_comment=>'Generated 5/26/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3499956838663080636)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Today'
,p_process_sql_clob=>' apex_util.today_calendar;'
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(3499956623344080635)
,p_process_comment=>'Generated 5/26/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3499957420430080636)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Next'
,p_process_sql_clob=>' apex_util.increment_calendar;'
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(3499957221332080636)
,p_process_comment=>'Generated 5/26/2010'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2238227990966466054)
,p_plug_name=>'search'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2239312169286712187)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2238228197546467972)
,p_name=>'P28_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2238227990966466054)
,p_prompt=>'Search'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
...
,p_field_template=>wwv_flow_api.id(1303624508797692055)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
'</script>'))
,p_page_template_options=>'#DEFAULT#'
,p_required_role=>wwv_flow_api.id(6269521821678049716)
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6291861134456070014)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6291863315792070052)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6291864530076070071)
,p_query_column_id=>1
,p_column_alias=>'CHECK$01'
,p_column_display_sequence=>1
,p_column_heading=>'&nbsp;'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6291863434135070060)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6291863532688070060)
,p_query_column_id=>3
,p_column_alias=>'ORDER_ID'
,p_column_display_sequence=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6291863628534070061)
,p_query_column_id=>4
,p_column_alias=>'PRODUCT_ID'
,p_column_display_sequence=>4
,p_column_heading=>'Product Name'
...
,p_disable_sort_column=>'N'
,p_display_as=>'SELECT_LIST_FROM_LOV'
,p_named_lov=>wwv_flow_api.id(6293208843754850512)
,p_lov_show_nulls=>'NO'
,p_column_width=>16
,p_lov_display_extra=>'YES'
,p_ref_schema=>'CARL'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6291863736665070061)
,p_query_column_id=>5
,p_column_alias=>'UNIT_PRICE'
,p_column_display_sequence=>6
,p_column_heading=>'Unit Price'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6291863820312070061)
,p_query_column_id=>6
,p_column_alias=>'QUANTITY'
,p_column_display_sequence=>5
,p_column_heading=>'Quantity'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6293255238508360034)
,p_query_column_id=>7
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6291864221016070067)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(6291863315792070052)
,p_button_name=>'ADD'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303608128369692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6291862629621070035)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(6291861134456070014)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6291862521039070035)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_api.id(6291861134456070014)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6291861343881070015)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(6291861134456070014)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6291864017357070067)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(6291863315792070052)
,p_button_name=>'SUBMIT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6291861536648070016)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(6291861134456070014)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6291861220215070015)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(6291861134456070014)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6291861439839070015)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(6291861134456070014)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6291864134615070067)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(6291863315792070052)
,p_button_name=>'MULTI_ROW_DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6293514020680303993)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6291864841973070072)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6291863137852070050)
,p_branch_action=>'f?p=&FLOW_ID.:29:&SESSION.::&DEBUG.::P29_ORDER_ID:&P29_ORDER_ID_NEXT.'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(6291862521039070035)
,p_branch_sequence=>1
,p_save_state_before_branch_yn=>'Y'
,p_branch_comment=>'This button is needed for Get Next or Previous Primary Key Value process.'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(6291863214855070051)
,p_branch_action=>'f?p=&FLOW_ID.:29:&SESSION.::&DEBUG.::P29_ORDER_ID:&P29_ORDER_ID_PREV.'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(6291862629621070035)
,p_branch_sequence=>1
,p_save_state_before_branch_yn=>'Y'
,p_branch_comment=>'This button is needed for Get Next or Previous Primary Key Value process.'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6291861619279070019)
,p_name=>'P29_ORDER_ID'
,p_item_sequence=>99
,p_item_plug_id=>wwv_flow_api.id(6291861134456070014)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Order Id'
,p_source=>'ORDER_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6291861736008070027)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6291861934940070030)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6291862023645070030)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6291862131722070031)
,p_name=>'P29_USER_ID'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(6291861134456070014)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6291862734163070041)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6291862829499070041)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6291862920594070044)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6293244619830316631)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(6291861839372070028)
...
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(6291861736008070027)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6291862227112070032)
,p_process_sequence=>1
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6291863018647070047)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6291862333906070035)
,p_process_sequence=>1
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6291862438081070035)
,p_process_sequence=>2
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_FOR_PAGES'
,p_attribute_04=>'29'
,p_process_when_button_id=>wwv_flow_api.id(6291861439839070015)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6291864330089070069)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(6291863315792070052)
,p_process_type=>'NATIVE_TABFORM_UPDATE'
,p_process_name=>'ApplyMRU'
,p_attribute_02=>'DEMO_ORDER_ITEMS'
,p_attribute_03=>'ORDER_ITEM_ID'
,p_process_error_message=>'Unable to process update'
,p_process_when_button_id=>wwv_flow_api.id(6291864017357070067)
,p_process_success_message=>'#MRU_COUNT# row(s) updated, #MRI_COUNT# row(s) inserted.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6291864422627070069)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(6291863315792070052)
,p_process_type=>'NATIVE_TABFORM_DELETE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6291864620522070072)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(6291863315792070052)
,p_process_type=>'NATIVE_TABFORM_UPDATE'
...
,p_attribute_03=>'ORDER_ITEM_ID'
,p_process_error_message=>'Unable to process update'
,p_process_when_button_id=>wwv_flow_api.id(6291864221016070067)
,p_process_success_message=>'#MRU_COUNT# row(s) updated, #MRI_COUNT# row(s) inserted.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6291864728744070072)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(6291863315792070052)
,p_process_type=>'NATIVE_TABFORM_ADD_ROWS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2232694178200577554)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(2232694284481577554)
,p_name=>'Report 1'
,p_max_row_count=>'10000'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(2232694466833577566)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(2232694577600577571)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(2232694672902577571)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(2232694788240577571)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(2232694891632577572)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(2232694995067577572)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(2232695069900577572)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(2232695180647577572)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(2232695279682577743)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_api.create_calendar(
 p_id=>wwv_flow_api.id(3499997726933088834)
,p_plug_name=>'Calendar 1'
...
,p_plug_display_point=>'BODY_3'
,p_plug_item_display_point=>'ABOVE'
,p_cal_id=>wwv_flow_api.id(3499998248666088837)
,p_begin_at_start_of_interval=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3499999036823088840)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(3499997726933088834)
,p_button_name=>'MONTHLY'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3499999649122088844)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(3499997726933088834)
,p_button_name=>'WEEKLY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3500000240802088845)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(3499997726933088834)
,p_button_name=>'DAILY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3500002643423088852)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(3499997726933088834)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3500000838779088847)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(3499997726933088834)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3500001438620088848)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_api.id(3499997726933088834)
,p_button_name=>'TODAY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3500002031569088849)
,p_button_sequence=>70
,p_button_plug_id=>wwv_flow_api.id(3499997726933088834)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3499999420169088842)
,p_branch_action=>'f?p=&FLOW_ID.:31:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(3499999036823088840)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3500000049323088845)
,p_branch_action=>'f?p=&FLOW_ID.:31:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(3499999649122088844)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3500000641029088846)
,p_branch_action=>'f?p=&FLOW_ID.:31:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(3500000240802088845)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3500001221242088848)
,p_branch_action=>'f?p=&FLOW_ID.:31:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(3500000838779088847)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3500001826783088849)
,p_branch_action=>'f?p=&FLOW_ID.:31:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(3500001438620088848)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3500002447918088850)
,p_branch_action=>'f?p=&FLOW_ID.:31:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(3500002031569088849)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(3500003023319088853)
,p_branch_action=>'f?p=&FLOW_ID.:31:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(3500002643423088852)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3499998436233088838)
,p_name=>'P31_CALENDAR_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(3499997726933088834)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3499998646295088839)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3499998837783088839)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3499999218332088841)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Monthly'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(3499999036823088840)
,p_process_comment=>'Generated 5/26/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3499999832453088844)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Weekly'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(3499999649122088844)
,p_process_comment=>'Generated 5/26/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3500000430603088846)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Daily'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(3500000240802088845)
,p_process_comment=>'Generated 5/26/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3500001035383088847)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Previous'
,p_process_sql_clob=>' apex_util.decrement_calendar;'
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(3500000838779088847)
,p_process_comment=>'Generated 5/26/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3500001644753088849)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Today'
,p_process_sql_clob=>' apex_util.today_calendar;'
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(3500001438620088848)
,p_process_comment=>'Generated 5/26/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3500002220604088850)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Next'
,p_process_sql_clob=>' apex_util.increment_calendar;'
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(3500002031569088849)
,p_process_comment=>'Generated 5/26/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(3500002844610088852)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(3500002643423088852)
,p_process_comment=>'Generated 5/26/2010'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4265640073410768180)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967832597023766958)
,p_plug_name=>'Button Templates'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303613819853692044)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967839774569864567)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5967833483994772641)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(5967832597023766958)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5967835174429779360)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(5967832597023766958)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5967836089666783749)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(5967832597023766958)
,p_button_name=>'APPLY_CHANGES'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303608323197692040)
,p_button_image_alt=>'Button Alternative 2'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5967837192053831738)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(5967832597023766958)
,p_button_name=>'SUBMIT'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303608520319692040)
,p_button_image_alt=>'Hot Button (Alternative 3)'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(5967834093344775349)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(2238229290320494208)
,p_name=>'Search Results'
,p_template=>wwv_flow_api.id(1357117066362079306)
,p_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
,p_ajax_enabled=>'Y'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(1303620736777692050)
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
,p_query_no_data_found=>'no data found'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2238229575807494218)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2238229695984494222)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2238229766558494222)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2238229898341494222)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2238229978356494222)
,p_query_column_id=>5
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2238230479369500540)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2238291687605947528)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2239670371060541403)
,p_plug_name=>'search'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2238230691490504041)
,p_name=>'P33_SHOW'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2238230479369500540)
,p_prompt=>'Show'
,p_display_as=>'NATIVE_CHECKBOX'
,p_named_lov=>'EXAMPLE SEARCH SHOW OPTIONS'
,p_lov=>'.'||wwv_flow_api.id(2238231098678525029)||'.'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
,p_cAttributes=>'nowrap="nowrap"'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2238291977001953946)
,p_name=>'P33_SORT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(2238291687605947528)
,p_item_default=>'A'
,p_prompt=>'Sort'
,p_source=>'A'
,p_source_type=>'STATIC'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239673172228301423)
,p_name=>'P33_SEARCH'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(2239670371060541403)
,p_prompt=>'Search'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_calendar(
 p_id=>wwv_flow_api.id(2239301796373625328)
...
,p_plug_display_point=>'BODY_3'
,p_plug_item_display_point=>'ABOVE'
,p_cal_id=>wwv_flow_api.id(2239302473329625341)
,p_begin_at_start_of_interval=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239303288227625355)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(2239301796373625328)
,p_button_name=>'MONTHLY'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303608128369692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239303876911625364)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(2239301796373625328)
,p_button_name=>'WEEKLY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239304486005625366)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(2239301796373625328)
,p_button_name=>'DAILY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239305088850625367)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(2239301796373625328)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239305675834625367)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_api.id(2239301796373625328)
,p_button_name=>'TODAY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239306268428625370)
,p_button_sequence=>70
,p_button_plug_id=>wwv_flow_api.id(2239301796373625328)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2239303674669625362)
,p_branch_action=>'f?p=&FLOW_ID.:34:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(2239303288227625355)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2239304292745625365)
,p_branch_action=>'f?p=&FLOW_ID.:34:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(2239303876911625364)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2239304894957625366)
,p_branch_action=>'f?p=&FLOW_ID.:34:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(2239304486005625366)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2239305473374625367)
,p_branch_action=>'f?p=&FLOW_ID.:34:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(2239305088850625367)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2239306093483625368)
,p_branch_action=>'f?p=&FLOW_ID.:34:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(2239305675834625367)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2239306683153625371)
,p_branch_action=>'f?p=&FLOW_ID.:34:&SESSION.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(2239306268428625370)
,p_branch_sequence=>-1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239302684716625349)
,p_name=>'P34_CALENDAR_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2239301796373625328)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239302874650625354)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239303097293625354)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2239303498318625359)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Monthly'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(2239303288227625355)
,p_process_comment=>'Generated 10/14/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2239304088083625365)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Weekly'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(2239303876911625364)
,p_process_comment=>'Generated 10/14/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2239304694271625366)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Daily'
...
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(2239304486005625366)
,p_process_comment=>'Generated 10/14/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2239305286982625367)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Previous'
,p_process_sql_clob=>' apex_util.decrement_calendar;'
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(2239305088850625367)
,p_process_comment=>'Generated 10/14/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2239305899115625367)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Today'
,p_process_sql_clob=>' apex_util.today_calendar;'
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(2239305675834625367)
,p_process_comment=>'Generated 10/14/2010'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2239306489818625371)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Adjust Calendar Date -Next'
,p_process_sql_clob=>' apex_util.increment_calendar;'
,p_process_error_message=>'Error changing calendar date.'
,p_process_when_button_id=>wwv_flow_api.id(2239306268428625370)
,p_process_comment=>'Generated 10/14/2010'
);
end;
/
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(2239658974094861119)
,p_name=>'Pages'
,p_template=>wwv_flow_api.id(1303613235944692043)
,p_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2239659279204861123)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2239659372429861124)
,p_query_column_id=>2
,p_column_alias=>'LAST_UPDATED_ON'
,p_column_display_sequence=>2
,p_column_format=>'SINCE'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(2239659769507878725)
,p_name=>'Page Items'
,p_template=>wwv_flow_api.id(1303613235944692043)
,p_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1330439440027089145)
,p_query_column_id=>1
,p_column_alias=>'PAGE_NAME'
,p_column_display_sequence=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2239660081815878728)
,p_query_column_id=>2
,p_column_alias=>'LAST_UPDATED_ON'
,p_column_display_sequence=>1
,p_column_format=>'SINCE'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(2239663488844130297)
,p_name=>'Regions'
,p_template=>wwv_flow_api.id(1303613235944692043)
,p_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2239663688471130300)
,p_query_column_id=>1
,p_column_alias=>'PAGE_NAME'
,p_column_display_sequence=>1
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2239663789384130300)
,p_query_column_id=>2
,p_column_alias=>'LAST_UPDATED_ON'
,p_column_display_sequence=>2
,p_column_format=>'SINCE'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(2239664267635143049)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1330439743491090209)
,p_query_column_id=>1
,p_column_alias=>'PAGE_NAME'
,p_column_display_sequence=>2
,p_column_heading=>'Page Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2239664493635143052)
,p_query_column_id=>2
,p_column_alias=>'LAST_UPDATED_ON'
,p_column_display_sequence=>1
,p_column_format=>'SINCE'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2239665170537153392)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303611114767692042)
,p_plug_display_sequence=>50
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2239670074994531496)
,p_plug_name=>'Tree'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303613235944692043)
...
,p_attribute_02=>'S'
,p_attribute_04=>'N'
,p_attribute_06=>'tree2239669969544531496'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2239673798332318443)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2240316095325220137)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239674582664332853)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(2239673798332318443)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2240014788308761095)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(2239673798332318443)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2240173493810860140)
,p_name=>'P37_DATE_PICKER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2239673798332318443)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2240173672816863602)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2240173884590866963)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2240174091863869032)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2239551674130100041)
,p_plug_name=>'Step 1'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2239564382512240959)
...
,p_plug_display_column=>1
,p_plug_display_point=>'BODY_3'
,p_list_id=>wwv_flow_api.id(2239563298655240958)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303620127389692049)
,p_plug_query_row_template=>1
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2239565294200268006)
,p_plug_name=>'Button Bar'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303609910582692042)
,p_plug_display_sequence=>4
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2240326983354377527)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(2239551674130100041)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239552071965100042)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(2239565294200268006)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239552397726100042)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(2239565294200268006)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2239552676769100043)
,p_branch_action=>'f?p=&APP_ID.:39:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(2239552397726100042)
,p_branch_sequence=>20
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239551868824100042)
,p_name=>'P38_ITEM1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2239551674130100041)
,p_prompt=>'ITEM 1'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2239553270353100044)
,p_plug_name=>'Step 2'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303615022422692044)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2239564588900240961)
,p_plug_name=>'wizard progress bar 38, 39, 40'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>2
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239553684046100044)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(2239553270353100044)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303608323197692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239553997775100044)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(2239553270353100044)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239553883765100044)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(2239553270353100044)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2239554588434100045)
,p_branch_action=>'f?p=&APP_ID.:40:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(2239553997775100044)
,p_branch_sequence=>20
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2239554274315100045)
,p_branch_action=>'f?p=&APP_ID.:38:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(2239553883765100044)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239553486479100044)
,p_name=>'P39_ITEM1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2239553270353100044)
,p_prompt=>'ITEM 1'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2239555394775100046)
,p_plug_name=>'Step 3'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2239564767119240961)
,p_plug_name=>'wizard progress bar 38, 39, 40'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>20
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239555770242100047)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(2239555394775100046)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303608323197692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239555887378100047)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(2239555394775100046)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239555970701100047)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(2239555394775100046)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2239556695541100048)
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(2239555887378100047)
,p_branch_sequence=>1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2239556378899100047)
,p_branch_action=>'f?p=&APP_ID.:39:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(2239555970701100047)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239555589678100046)
,p_name=>'P40_ITEM1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2239555394775100046)
,p_prompt=>'ITEM 1'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2239647270874727786)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'null'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2239559093765144837)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2239565785243293861)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2240316885067226614)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2240328485610415973)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2240328697384419433)
,p_plug_name=>'Nested Region'
,p_parent_plug_id=>wwv_flow_api.id(2240328485610415973)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303608724481692041)
,p_plug_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2240328987472425950)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2240334394062503588)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2240329984964444168)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2240332175183460326)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2240333881464490498)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(2240329984964444168)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239559392781144840)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(2240316885067226614)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303608128369692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239559569719144840)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(2240316885067226614)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239559286853144840)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(2240316885067226614)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239559490365144840)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(2240316885067226614)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2239560278172144842)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239560488864144843)
,p_name=>'P41_EMPNO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2239559093765144837)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Empno'
,p_source=>'EMPNO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239560679986144859)
,p_name=>'P41_ENAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(2239559093765144837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239560868299144861)
,p_name=>'P41_JOB'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(2239559093765144837)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239561079316144862)
,p_name=>'P41_MGR'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(2239559093765144837)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239561283447144863)
,p_name=>'P41_HIREDATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(2239559093765144837)
,p_use_cache_before_default=>'NO'
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(1303624818017692055)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_04=>'button'
,p_attribute_05=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239561495729144863)
,p_name=>'P41_SAL'
,p_is_required=>true
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(2239559093765144837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239561676535144863)
,p_name=>'P41_COMM'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(2239559093765144837)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239561877944144864)
,p_name=>'P41_DEPTNO'
,p_is_required=>true
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(2239559093765144837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2240016071301803582)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2240330273667450345)
,p_name=>'P41_TEST'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(2240329984964444168)
,p_prompt=>'No template'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2240330484808450346)
,p_name=>'P41_TEST2'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(2240329984964444168)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2240330696944450346)
,p_name=>'P41_TEST3'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(2240329984964444168)
,p_prompt=>'Required with help'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2240330888168450346)
,p_name=>'P41_TEST4'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(2240329984964444168)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2240331068609450348)
,p_name=>'P41_TEST5'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(2240329984964444168)
,p_prompt=>'Optional with help'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2240332386958463673)
,p_name=>'P41_EXAMPLE_OF_LABEL_ABOVE'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(2240332175183460326)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2240333276831479647)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2240333597609485710)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2240334580687509137)
,p_name=>'P41_SHUTTLE'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_api.id(2239559093765144837)
,p_prompt=>'Shuttle'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2239562085063144865)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2239562281449144866)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2239562497420144866)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_FOR_PAGES'
,p_attribute_04=>'41'
,p_process_when_button_id=>wwv_flow_api.id(2239559490365144840)
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2239603495485702469)
,p_plug_name=>'Employees'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303612031908692043)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(2239603575406702469)
,p_name=>'Employees'
,p_max_row_count=>'10000'
,p_max_row_count_message=>'This query returns more than #MAX_ROW_COUNT# rows, please filter your data to ensure complete results.'
,p_no_data_found_message=>'No data found.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1330442065308096447)
,p_db_column_name=>'PRODUCT_ID'
,p_display_order=>1
,p_column_identifier=>'A'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1330442165540096449)
,p_db_column_name=>'PRODUCT_NAME'
,p_display_order=>2
,p_column_identifier=>'B'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1330442254285096449)
,p_db_column_name=>'PRODUCT_DESCRIPTION'
,p_display_order=>3
,p_column_identifier=>'C'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1330442345925096449)
,p_db_column_name=>'CATEGORY'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Category'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1330442450215096449)
,p_db_column_name=>'PRODUCT_AVAIL'
,p_display_order=>5
,p_column_identifier=>'E'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1330442550083096449)
,p_db_column_name=>'LIST_PRICE'
,p_display_order=>6
,p_column_identifier=>'F'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1330442651824096450)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1330442739322096450)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1330442835441096450)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1330442964410096450)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(2239604592262702727)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239606298889732951)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(2239603495485702469)
...
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(1303606736490692039)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2239674789936334992)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239783092768006303)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_api.id(2239674789936334992)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239783468658008794)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(2239674789936334992)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2239783273268006305)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239781769649980677)
,p_name=>'P44_X1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2239674789936334992)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239781985233985179)
,p_name=>'P44_X2'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(2239674789936334992)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239782493329996936)
,p_name=>'P44_X3'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(2239674789936334992)
,p_prompt=>'Optional with help'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239782669911999666)
,p_name=>'P44_X4'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(2239674789936334992)
,p_prompt=>'Required'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2239782879608002454)
,p_name=>'P44_X5'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(2239674789936334992)
,p_prompt=>'Required with Help'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2240322387117350165)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2240324974938367118)
...
,p_plug_display_column=>1
,p_plug_display_point=>'REGION_POSITION_02'
,p_list_id=>wwv_flow_api.id(2240323280107367113)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303620127389692049)
,p_plug_query_row_template=>1
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2240328172450412171)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2240327366863382203)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(2240322387117350165)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2240327568048382205)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(2240322387117350165)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(1303605308731692036)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6268134134795917734)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6268134541008917753)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(6268134134795917734)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268134234303917743)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(6268134134795917734)
,p_prompt=>'User Name'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>20
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6268134436807917753)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6268134745583917759)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6268134630191917755)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6268134918922917761)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(6268134841560917761)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5375957212068143618)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5375958017613143681)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(5375957212068143618)
,p_button_name=>'SUBMIT'
,p_button_static_id=>'SUBMIT'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(3791799543325)
,p_button_image_alt=>'Submit Feedback'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5375957436287143663)
,p_name=>'P102_FEEDBACK'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(5375957212068143618)
,p_prompt=>'Feedback'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>60
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5375957612261143664)
,p_name=>'P102_X'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(5375957212068143618)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5375957806864143665)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(5375958237130143704)
...
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(5375958017613143681)
,p_associated_item=>wwv_flow_api.id(5375957436287143663)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5375958411053143721)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5375958631625143722)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967998494065720392)
,p_plug_name=>'Templates'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303611413652692042)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5968007988356756554)
,p_plug_name=>'Tree'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303613819853692044)
...
,p_plug_display_column=>1
,p_plug_display_point=>'BODY_3'
,p_list_id=>wwv_flow_api.id(5968000693503729723)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303618009553692047)
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'REQUEST_EQUALS_CONDITION'
,p_plug_display_when_condition=>'TREE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5968012003378770373)
...
,p_list_id=>wwv_flow_api.id(5968000693503729723)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303616225459692045)
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'REQUEST_EQUALS_CONDITION'
,p_plug_display_when_condition=>'DTREE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5968013980437782638)
,p_plug_name=>'DHTML Menu with Sublist'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303613535248692043)
,p_plug_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
...
,p_list_id=>wwv_flow_api.id(5968000693503729723)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303615936468692045)
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'REQUEST_EQUALS_CONDITION'
,p_plug_display_when_condition=>'DMENU'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5968016689226794681)
...
,p_list_id=>wwv_flow_api.id(5968000693503729723)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303617127049692046)
,p_plug_query_row_template=>1
,p_plug_display_condition_type=>'REQUEST_EQUALS_CONDITION'
,p_plug_display_when_condition=>'DIMENU'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5968022399662826090)
...
,p_list_id=>wwv_flow_api.id(5968000693503729723)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303616512262692046)
,p_plug_query_row_template=>1
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2237625579094345812)
,p_plug_name=>'Search'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967243682400812494)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967410885760031077)
...
,p_plug_display_column=>1
,p_plug_display_point=>'REGION_POSITION_02'
,p_list_id=>wwv_flow_api.id(5967405100605007016)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303619237824692049)
,p_plug_query_row_template=>1
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5969212305019866273)
,p_plug_name=>'Templates'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303611413652692042)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2237640396541360280)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(2237625579094345812)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4269036553460765033)
,p_button_sequence=>10
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4269036753104765034)
,p_button_sequence=>20
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2237640576265360281)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2237640183381356527)
,p_name=>'P200_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2237625579094345812)
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1330409847411949331)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1330421640580004195)
,p_plug_name=>'Top Bar Region'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303614715550692044)
,p_plug_display_sequence=>1
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1330505446064251766)
,p_plug_name=>'Report Filter - Single Row Example'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303612635373692043)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5629546013212842250)
,p_plug_name=>'Report List'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303612928894692043)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5827182910482180951)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5827184133338187462)
,p_plug_name=>'Wizard Region with Icon'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303615335683692044)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5828038706105039018)
,p_plug_name=>'Chart Region'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303610536329692042)
...
wwv_flow_api.create_flash_chart5(
 p_id=>wwv_flow_api.id(4811803975948936913)
...
wwv_flow_api.create_flash_chart5_series(
 p_id=>wwv_flow_api.id(4811804074123936913)
,p_chart_id=>wwv_flow_api.id(4811803975948936913)
,p_series_seq=>10
,p_series_name=>'Series 1'
,p_series_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5969219717626955028)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5969220600095959440)
,p_plug_name=>'Bracketed Region'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303609033663692041)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5969222001958969468)
,p_plug_name=>'Button Region with Title'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303609613472692042)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5969222918581974261)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5969223600357978459)
,p_plug_name=>'List WIth Icon'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303610233144692042)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5969224310400981357)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5969225023560985214)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5969230722577088990)
,p_plug_name=>'Navigation Region, Alternative 1'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303611708739692043)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5969231810934095075)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5969234026995109169)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5969234704616112162)
,p_plug_name=>'Region without Title'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(1303612318086692043)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5969238515230181424)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5969239502547187219)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6230302168401813507)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6230302476178813539)
,p_query_column_id=>1
,p_column_alias=>'ORDER_ID'
,p_column_display_sequence=>1
,p_column_heading=>'Order Id'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6230302567008813539)
,p_query_column_id=>2
,p_column_alias=>'CUSTOMER_ID'
,p_column_display_sequence=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6230302679827813540)
,p_query_column_id=>3
,p_column_alias=>'ORDER_TOTAL'
,p_column_display_sequence=>3
,p_column_heading=>'Order Total'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6230302774551813540)
,p_query_column_id=>4
,p_column_alias=>'ORDER_TIMESTAMP'
,p_column_display_sequence=>4
,p_column_heading=>'Order Timestamp'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6230309863684821569)
,p_name=>'Reports Region 100% Width'
,p_template=>wwv_flow_api.id(1303613535248692043)
,p_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6230310058709821572)
,p_query_column_id=>1
,p_column_alias=>'ORDER_ID'
,p_column_display_sequence=>1
,p_column_heading=>'Order Id'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6230310161274821572)
,p_query_column_id=>2
,p_column_alias=>'CUSTOMER_ID'
,p_column_display_sequence=>2
,p_column_heading=>'Customer Id'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6230310265027821573)
,p_query_column_id=>3
,p_column_alias=>'ORDER_TOTAL'
,p_column_display_sequence=>3
,p_column_heading=>'Order Total'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6230310378414821573)
,p_query_column_id=>4
,p_column_alias=>'ORDER_TIMESTAMP'
,p_column_display_sequence=>4
,p_column_heading=>'Order Timestamp'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(6230314578921826033)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6230315084557826035)
,p_query_column_id=>1
,p_column_alias=>'ORDER_ID'
,p_column_display_sequence=>1
,p_column_heading=>'Order Id'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6230314781988826034)
,p_query_column_id=>2
,p_column_alias=>'CUSTOMER_ID'
,p_column_display_sequence=>2
,p_column_heading=>'Customer Id'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6230314880005826034)
,p_query_column_id=>3
,p_column_alias=>'ORDER_TOTAL'
,p_column_display_sequence=>3
,p_column_heading=>'Order Total'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(6230314955774826035)
,p_query_column_id=>4
,p_column_alias=>'ORDER_TIMESTAMP'
,p_column_display_sequence=>4
,p_column_heading=>'Order Timestamp'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1330508549658262222)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(1330505446064251766)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887332791098548737)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(5969224310400981357)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5827146834927425494)
,p_button_sequence=>130
,p_button_plug_id=>wwv_flow_api.id(5969222001958969468)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887339892318639313)
,p_button_sequence=>240
,p_button_plug_id=>wwv_flow_api.id(5827182910482180951)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887343464891697633)
,p_button_sequence=>360
,p_button_plug_id=>wwv_flow_api.id(5827184133338187462)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887332981744548738)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(5969224310400981357)
,p_button_name=>'CLOSE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5827147215314425496)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5827145226139411182)
,p_button_sequence=>180
,p_button_plug_id=>wwv_flow_api.id(5969222918581974261)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239778691382655833)
,p_button_sequence=>220
,p_button_plug_id=>wwv_flow_api.id(5969234704616112162)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887340083141639313)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887343685558697634)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887333176728548738)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(5969224310400981357)
,p_button_name=>'COPY'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5827145018174411179)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887340293228639314)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887343893501697634)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887333384524548739)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(5969224310400981357)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
begin
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5827145436360411182)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239778477876651948)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887340488888639314)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887344088367697635)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887333564395548739)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_api.id(5969224310400981357)
,p_button_name=>'CREATE2'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5827147028067425495)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887340680785639314)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887344288727697635)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887333769116548739)
,p_button_sequence=>70
,p_button_plug_id=>wwv_flow_api.id(5969224310400981357)
,p_button_name=>'DELETE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887340892175639315)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887344473196697635)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887333981405548740)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887341077429639315)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887344680187697636)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887334166180548740)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887341270481639316)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887344875671697636)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887334387183548741)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887341490491639316)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887345073884697637)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887334575647548741)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3510519732186449363)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887341687320639317)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887345268139697637)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887334780201548741)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3510519544560449338)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887341866099639317)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887345492974697638)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887332566840548735)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(5969224310400981357)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887339685681639310)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5887343290968697631)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1330507063379256781)
,p_name=>'P201_FILTER1'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(1330505446064251766)
,p_prompt=>'Filter 1'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1330507247516256782)
,p_name=>'P201_FILTER2'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(1330505446064251766)
,p_prompt=>'Filter 2'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6231135383290868105)
,p_name=>'P201_FOR_DEMO_FORM'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(5969224310400981357)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6231137763681871901)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967118399656162485)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967125085312830693)
,p_plug_name=>'Templates'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303611413652692042)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5967118701818162486)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(5967118399656162485)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5967118891588162487)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(5967118399656162485)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5967118586969162486)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(5967118399656162485)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5967118792495162486)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(5967118399656162485)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(5967119496075162491)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5882574974877831825)
,p_name=>'FVD'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(5967118399656162485)
,p_display_as=>'NATIVE_STOP_AND_START_HTML_TABLE'
,p_cSize=>30
,p_cMaxlength=>2000
,p_cAttributes=>'nowrap="nowrap"'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5967119684449162492)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5967119886426162498)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5967120094205162500)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5967120296091162500)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5967120483776162501)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5967120679885162501)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5967120878600162502)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(5887328282283467947)
...
,p_error_message=>'Value must be specified.'
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(5967119886426162498)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5967121105830162503)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from DEMO_PRODUCT_INFO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5967121491025162505)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_FOR_PAGES'
,p_attribute_04=>'202'
,p_process_when_button_id=>wwv_flow_api.id(5967118792495162486)
);
end;
/
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(1330428361405038547)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1330430860497047794)
,p_query_column_id=>1
,p_column_alias=>'PAGE_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Page Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1330430939494047794)
,p_query_column_id=>2
,p_column_alias=>'LAST_UPDATED_ON'
,p_column_display_sequence=>2
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(1330429037295041060)
...
,p_ajax_enabled=>'Y'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(1303621723436692050)
,p_query_num_rows=>5
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1330429253944041060)
,p_query_column_id=>1
,p_column_alias=>'PRODUCT_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Product Name'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(1330431348507053745)
...
,p_ajax_enabled=>'Y'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(1303624008622692054)
,p_query_num_rows=>5
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1330431559323053745)
,p_query_column_id=>1
,p_column_alias=>'PAGE_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Page Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1330431640823053745)
,p_query_column_id=>2
,p_column_alias=>'LAST_UPDATED_ON'
,p_column_display_sequence=>2
,p_column_heading=>'Last Updated On'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(2239802598437417569)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2239804692613417625)
,p_query_column_id=>1
,p_column_alias=>'CHECK$01'
,p_column_display_sequence=>1
,p_column_heading=>'&nbsp;'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1330426860650029243)
,p_query_column_id=>2
,p_column_alias=>'PRODUCT_NAME'
,p_column_display_sequence=>2
,p_column_heading=>'Product Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1330426952899029243)
,p_query_column_id=>3
,p_column_alias=>'PRODUCT_DESCRIPTION'
,p_column_display_sequence=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1330427055770029243)
,p_query_column_id=>4
,p_column_alias=>'CATEGORY'
,p_column_display_sequence=>4
,p_column_heading=>'Category'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1330427148564029243)
,p_query_column_id=>5
,p_column_alias=>'PRODUCT_AVAIL'
,p_column_display_sequence=>5
...
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(1330426461966029240)
,p_column_sequence=>1
,p_query_column_name=>'PRODUCT_NAME'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(1330426546624029242)
,p_column_sequence=>2
,p_query_column_name=>'PRODUCT_DESCRIPTION'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(1330426636322029242)
,p_column_sequence=>3
,p_query_column_name=>'CATEGORY'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(1330426741282029242)
,p_column_sequence=>4
,p_query_column_name=>'PRODUCT_AVAIL'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(5967225891994682775)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967226193788682801)
,p_query_column_id=>1
,p_column_alias=>'PRODUCT_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Product Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967226280560682804)
,p_query_column_id=>2
,p_column_alias=>'PRODUCT_DESCRIPTION'
,p_column_display_sequence=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967226404789682804)
,p_query_column_id=>3
,p_column_alias=>'CATEGORY'
,p_column_display_sequence=>3
,p_column_heading=>'Category'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967226484089682804)
,p_query_column_id=>4
,p_column_alias=>'PRODUCT_AVAIL'
,p_column_display_sequence=>4
,p_column_heading=>'Product Avail'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(5967227486238690583)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967227676967690586)
,p_query_column_id=>1
,p_column_alias=>'PRODUCT_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Product Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967227775038690586)
,p_query_column_id=>2
,p_column_alias=>'PRODUCT_DESCRIPTION'
,p_column_display_sequence=>2
,p_column_heading=>'Product<br>Description<br>Multiline'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967227886896690587)
,p_query_column_id=>3
,p_column_alias=>'CATEGORY'
,p_column_display_sequence=>3
,p_column_heading=>'Category'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967227989022690587)
,p_query_column_id=>4
,p_column_alias=>'PRODUCT_AVAIL'
,p_column_display_sequence=>4
,p_column_heading=>'Product Avail'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(5967230686762728614)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967230893320728616)
,p_query_column_id=>1
,p_column_alias=>'PRODUCT_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Product Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967231002750728617)
,p_query_column_id=>2
,p_column_alias=>'PRODUCT_DESCRIPTION'
,p_column_display_sequence=>2
,p_column_heading=>'Product<br>Description<br>Multiline'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967231096348728617)
,p_query_column_id=>3
,p_column_alias=>'CATEGORY'
,p_column_display_sequence=>3
,p_column_heading=>'Category'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967231173564728617)
,p_query_column_id=>4
,p_column_alias=>'PRODUCT_AVAIL'
,p_column_display_sequence=>4
,p_column_heading=>'Product Avail'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(5967232683776737166)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967232874773737167)
,p_query_column_id=>1
,p_column_alias=>'PRODUCT_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Product Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967232985739737167)
,p_query_column_id=>2
,p_column_alias=>'PRODUCT_DESCRIPTION'
,p_column_display_sequence=>2
,p_column_heading=>'Product<br>Description<br>Multiline'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967233097625737167)
,p_query_column_id=>3
,p_column_alias=>'CATEGORY'
,p_column_display_sequence=>3
,p_column_heading=>'Category'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967233197487737167)
,p_query_column_id=>4
,p_column_alias=>'PRODUCT_AVAIL'
,p_column_display_sequence=>4
,p_column_heading=>'Product Avail'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(5967235102393761532)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967235287904761534)
,p_query_column_id=>1
,p_column_alias=>'PRODUCT_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Product Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967235401304761534)
,p_query_column_id=>2
,p_column_alias=>'PRODUCT_DESCRIPTION'
,p_column_display_sequence=>2
,p_column_heading=>'Product<br>Description<br>Multiline'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967235485992761534)
,p_query_column_id=>3
,p_column_alias=>'CATEGORY'
,p_column_display_sequence=>3
,p_column_heading=>'Category'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5967235576306761535)
,p_query_column_id=>4
,p_column_alias=>'PRODUCT_AVAIL'
,p_column_display_sequence=>4
,p_column_heading=>'Product Avail'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967242990927805527)
,p_plug_name=>'Region 3'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303611413652692042)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239803571445417612)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(2239802598437417569)
,p_button_name=>'ADD'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(1303607934904692040)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239803373374417612)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(2239802598437417569)
,p_button_name=>'SUBMIT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239803294377417612)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(2239802598437417569)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2239803494567417612)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(2239802598437417569)
,p_button_name=>'MULTI_ROW_DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2239804767167417625)
...
begin
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2239804266541417620)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(2239802598437417569)
,p_process_type=>'NATIVE_TABFORM_UPDATE'
,p_process_name=>'ApplyMRU'
,p_attribute_02=>'DEPT'
,p_attribute_03=>'DEPTNO'
,p_process_error_message=>'Unable to process update.'
,p_process_when_button_id=>wwv_flow_api.id(2239803373374417612)
,p_process_success_message=>'#MRU_COUNT# row(s) updated, #MRI_COUNT# row(s) inserted.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2239804486685417624)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(2239802598437417569)
,p_process_type=>'NATIVE_TABFORM_DELETE'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2233455174609597810)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967242281230802716)
,p_plug_name=>'Region 3'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303611413652692042)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967768785102502094)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967770802548516542)
...
,p_list_id=>wwv_flow_api.id(5969211829129863805)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303619809944692049)
,p_plug_query_row_template=>1
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967805803053753246)
...
,p_list_id=>wwv_flow_api.id(5969211829129863805)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303618908855692049)
,p_plug_query_row_template=>1
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967807197297761095)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967807877688764880)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967828781954724741)
...
,p_list_id=>wwv_flow_api.id(5969211829129863805)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303615633769692045)
,p_plug_query_row_template=>1
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967987804660638265)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967988377087639756)
...
,p_list_id=>wwv_flow_api.id(5969211829129863805)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303616816884692046)
,p_plug_query_row_template=>1
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967990300766656086)
...
,p_list_id=>wwv_flow_api.id(5969211829129863805)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(1303618311295692047)
,p_plug_query_row_template=>1
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967248490281833642)
,p_plug_name=>'Region 3'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303611413652692042)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967175274932920843)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967175988091924690)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967176902982929025)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967178192724935452)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967179078310940776)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967179789046943930)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967180504630948378)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967181186753952659)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967181874763958684)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967182595888964777)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967183277665969034)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6231587353311720478)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967209996516521385)
,p_plug_name=>'Region Postion 3'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967210179301521401)
,p_plug_name=>'Region Postion 4'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967210403007521402)
,p_plug_name=>'Region Postion 7'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967210583359521402)
,p_plug_name=>'Region Postion 8'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967210793326521403)
,p_plug_name=>'Page Template Body (3)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967210983427521403)
,p_plug_name=>'Region Postion 6'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967211199946521404)
,p_plug_name=>'Region Position 2'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967211394720521404)
,p_plug_name=>'Page Template Body (2)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967211575736521405)
,p_plug_name=>'Region Postion 5'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967211788261521405)
,p_plug_name=>'After Header'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967211977353521407)
,p_plug_name=>'Page Template Body (1)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6231593759329731723)
,p_plug_name=>'Before Footer'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967414502069176984)
,p_plug_name=>'Region Postion 3'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967414676813176985)
,p_plug_name=>'Region Postion 4'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967415304956176988)
,p_plug_name=>'Page Template Body (3)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967415487862176988)
,p_plug_name=>'Region Postion 6'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967415696492176989)
,p_plug_name=>'Region Position 2'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967415898407176990)
,p_plug_name=>'Page Template Body (2)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967416076440176990)
,p_plug_name=>'Region Postion 5'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967416500673176991)
,p_plug_name=>'Page Template Body (1)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967416690033176992)
,p_plug_name=>'Region 1'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6231597479069737387)
,p_plug_name=>'Before Footer'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
'}',
'</style>'))
,p_step_template=>wwv_flow_api.id(1303607622009692039)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967418805700187290)
,p_plug_name=>'Region Postion 3'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967418973770187293)
,p_plug_name=>'Region Postion 4'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967419175040187294)
,p_plug_name=>'Region Postion 7'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967419402701187295)
,p_plug_name=>'Region Postion 8'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967419602839187296)
,p_plug_name=>'Page Template Body (3)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967419783179187300)
,p_plug_name=>'Region Postion 6'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967419995498187300)
,p_plug_name=>'Region Position 2'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967420188728187301)
,p_plug_name=>'Page Template Body (2)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967420391656187301)
,p_plug_name=>'Region Postion 5'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967420579084187302)
,p_plug_name=>'After Header'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967420783081187302)
,p_plug_name=>'Page Template Body (1)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6231603077468746363)
,p_plug_name=>'Before Footer'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
'}',
'</style>'))
,p_step_template=>wwv_flow_api.id(1303605523884692037)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967423083805202752)
,p_plug_name=>'Region Postion 3'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967423280644202753)
,p_plug_name=>'Region Postion 4'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967423474340202753)
,p_plug_name=>'Region Postion 7'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967423687276202754)
,p_plug_name=>'Region Postion 8'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967423888519202755)
,p_plug_name=>'Page Template Body (3)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967424086947202759)
,p_plug_name=>'Region Postion 6'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967424302274202759)
,p_plug_name=>'Region Position 2'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967424478299202760)
,p_plug_name=>'Page Template Body (2)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967424703418202760)
,p_plug_name=>'Region Postion 5'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967424888028202761)
,p_plug_name=>'After Header'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967425083967202761)
,p_plug_name=>'Page Template Body (1)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6231606364093751978)
,p_plug_name=>'Before Footer'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
'}',
'</style>'))
,p_step_template=>wwv_flow_api.id(1303605828083692038)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967427588285211919)
,p_plug_name=>'Region Postion 3'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967427797998211920)
,p_plug_name=>'Region Postion 4'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967427985556211920)
,p_plug_name=>'Region Postion 7'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967428200207211921)
,p_plug_name=>'Region Postion 8'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967428391740211921)
,p_plug_name=>'Page Template Body (3)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967428585354211922)
,p_plug_name=>'Region Postion 6'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967428799487211924)
,p_plug_name=>'Region Position 2'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967429001562211925)
,p_plug_name=>'Page Template Body (2)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967429189183211925)
,p_plug_name=>'Region Postion 5'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967429401947211926)
,p_plug_name=>'After Header'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967429599920211926)
,p_plug_name=>'Page Template Body (1)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5967429778447211927)
,p_plug_name=>'Region 1'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6231609154528758648)
,p_plug_name=>'Before Footer'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1330504750707249367)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1330504956694249368)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1330505149038249368)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1330507735460258206)
,p_plug_name=>'Page Layout'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(1303611413652692042)
...
/
prompt --application/shared_components/logic/webservices/google_geocode
begin
wwv_flow_api.create_web_service(
 p_id=>wwv_flow_api.id(1442433118721773687)
,p_name=>'google geocode'
,p_url=>'http://maps.google.com/maps/geo'
,p_action=>'REST'
...
wwv_flow_api.create_ws_operations(
 p_id=>wwv_flow_api.id(1442433320251773693)
,p_ws_id=>wwv_flow_api.id(1442433118721773687)
,p_name=>'doREST'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(1442433428508773694)
,p_ws_opers_id=>wwv_flow_api.id(1442433320251773693)
,p_name=>'g'
,p_input_or_output=>'I'
,p_parm_type=>'string'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(1442433535661773695)
,p_ws_opers_id=>wwv_flow_api.id(1442433320251773693)
,p_name=>'a'
,p_input_or_output=>'O'
,p_parm_type=>'string'
